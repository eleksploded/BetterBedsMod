...
public class FlyingPathNavigator extends PathNavigator {
   ...
   protected boolean canNavigate() {
      return this.getCanSwim() && this.isInLiquid() || !this.field_75515_a.isPassenger();
   }

   protected Vec3d getEntityPosition() {
      return new Vec3d(this.field_75515_a.posX, this.field_75515_a.posY, this.field_75515_a.posZ);
   }
   ...
   public boolean canEntityStandOnPos(BlockPos pos) {
      return this.world.getBlockState(pos).func_215682_a(this.world, pos, this.field_75515_a);
   }
}