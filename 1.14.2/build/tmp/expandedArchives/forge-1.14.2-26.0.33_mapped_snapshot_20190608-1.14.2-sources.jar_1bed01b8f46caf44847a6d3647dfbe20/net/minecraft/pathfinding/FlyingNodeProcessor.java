...
public class FlyingNodeProcessor extends WalkNodeProcessor {
   ...
   public PathPoint getStart() {
      ...
      PathNodeType pathnodetype1 = this.getPathNodeType(this.field_186326_b, blockpos1.getX(), i, blockpos1.getZ());
      if (this.field_186326_b.getPathPriority(pathnodetype1) < 0.0F) {
         ...
         for(BlockPos blockpos : set) {
            PathNodeType pathnodetype = this.getPathNodeType(this.field_186326_b, blockpos);
   ...
   public PathNodeType getPathNodeType(IBlockReader blockaccessIn, int x, int y, int z) {
      ...
      if (pathnodetype == PathNodeType.OPEN && y >= 1) {
         ...
         if (pathnodetype1 != PathNodeType.DAMAGE_FIRE && block != Blocks.MAGMA_BLOCK && pathnodetype1 != PathNodeType.LAVA && block != Blocks.field_222433_lV) {
   ...
   private PathNodeType getPathNodeType(MobEntity p_192558_1_, int p_192558_2_, int p_192558_3_, int p_192558_4_) {
      return this.getPathNodeType(this.field_176169_a, p_192558_2_, p_192558_3_, p_192558_4_, p_192558_1_, this.entitySizeX, this.entitySizeY, this.entitySizeZ, this.getCanOpenDoors(), this.getCanEnterDoors());
   }
}