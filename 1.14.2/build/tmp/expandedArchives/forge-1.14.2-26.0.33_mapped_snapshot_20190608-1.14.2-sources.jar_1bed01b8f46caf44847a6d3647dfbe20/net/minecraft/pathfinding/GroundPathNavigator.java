...
public class GroundPathNavigator extends PathNavigator {
   ...
   protected boolean canNavigate() {
      return this.field_75515_a.onGround || this.isInLiquid() || this.field_75515_a.isPassenger();
   }
   ...
   public Path getPathToPos(BlockPos pos) {
      if (this.world.getBlockState(pos).isAir()) {
         ...
         while(blockpos.getY() < this.world.func_217301_I() && this.world.getBlockState(blockpos).isAir()) {
      ...
      if (!this.world.getBlockState(pos).getMaterial().isSolid()) {
         ...
         BlockPos blockpos1;
         for(blockpos1 = pos.up(); blockpos1.getY() < this.world.func_217301_I() && this.world.getBlockState(blockpos1).getMaterial().isSolid(); blockpos1 = blockpos1.up()) {
            ;
         }
   ...
   private int getPathablePosY() {
      if (this.field_75515_a.isInWater() && this.getCanSwim()) {
         int i = MathHelper.floor(this.field_75515_a.getBoundingBox().minY);
         Block block = this.world.getBlockState(new BlockPos(this.field_75515_a.posX, (double)i, this.field_75515_a.posZ)).getBlock();
         int j = 0;

         while(block == Blocks.WATER) {
            ++i;
            block = this.world.getBlockState(new BlockPos(this.field_75515_a.posX, (double)i, this.field_75515_a.posZ)).getBlock();
            ++j;
            if (j > 16) {
               return MathHelper.floor(this.field_75515_a.getBoundingBox().minY);
            }
         }

         return i;
      } else {
         return MathHelper.floor(this.field_75515_a.getBoundingBox().minY + 0.5D);
      }
   }
   ...
   protected void trimPath() {
      ...
      if (this.shouldAvoidSun) {
         if (this.world.func_217337_f(new BlockPos(this.field_75515_a.posX, this.field_75515_a.getBoundingBox().minY + 0.5D, this.field_75515_a.posZ))) {
            return;
         }
