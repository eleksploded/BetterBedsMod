...
public class WalkAndSwimNodeProcessor extends WalkNodeProcessor {
   ...
   public void postProcess() {
      this.field_186326_b.setPathPriority(PathNodeType.WALKABLE, this.field_203247_k);
      this.field_186326_b.setPathPriority(PathNodeType.WATER_BORDER, this.field_203248_l);
      super.postProcess();
   }
   ...
   private double func_203246_a(BlockPos p_203246_1_) {
      if (!this.field_186326_b.isInWater()) {
         BlockPos blockpos = p_203246_1_.down();
         VoxelShape voxelshape = this.field_176169_a.getBlockState(blockpos).getCollisionShape(this.field_176169_a, blockpos);
   ...
   private PathPoint func_203245_a(int p_203245_1_, int p_203245_2_, int p_203245_3_, int p_203245_4_, double p_203245_5_) {
      ...
      if (d0 - p_203245_5_ > 1.125D) {
         ...
         PathNodeType pathnodetype = this.getPathNodeType(this.field_176169_a, p_203245_1_, p_203245_2_, p_203245_3_, this.field_186326_b, this.entitySizeX, this.entitySizeY, this.entitySizeZ, false, false);
         ...
         if (pathnodetype != PathNodeType.WATER && pathnodetype != PathNodeType.WALKABLE) {
            ...
            if (pathnodetype == PathNodeType.OPEN) {
               AxisAlignedBB axisalignedbb = new AxisAlignedBB((double)p_203245_1_ - d1 + 0.5D, (double)p_203245_2_ + 0.001D, (double)p_203245_3_ - d1 + 0.5D, (double)p_203245_1_ + d1 + 0.5D, (double)((float)p_203245_2_ + this.field_186326_b.getHeight()), (double)p_203245_3_ + d1 + 0.5D);
               if (!this.field_186326_b.world.isCollisionBoxesEmpty(this.field_186326_b, axisalignedbb)) {
                  return null;
               }

               PathNodeType pathnodetype1 = this.getPathNodeType(this.field_176169_a, p_203245_1_, p_203245_2_ - 1, p_203245_3_, this.field_186326_b, this.entitySizeX, this.entitySizeY, this.entitySizeZ, false, false);
               ...
               while(p_203245_2_ > 0 && pathnodetype == PathNodeType.OPEN) {
                  ...
                  pathnodetype = this.getPathNodeType(this.field_176169_a, p_203245_1_, p_203245_2_, p_203245_3_, this.field_186326_b, this.entitySizeX, this.entitySizeY, this.entitySizeZ, false, false);
            ...
            if (p_203245_2_ < this.field_186326_b.world.getSeaLevel() - 10 && pathpoint != null) {
               ++pathpoint.costMalus;
            }
