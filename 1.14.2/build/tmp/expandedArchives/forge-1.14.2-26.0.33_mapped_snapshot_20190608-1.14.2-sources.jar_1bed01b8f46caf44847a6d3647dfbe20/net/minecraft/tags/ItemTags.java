...
public class ItemTags {
   ...
   public static final Tag<Item> field_219777_j = makeWrapperTag("wooden_fences");
   ...
   public static final Tag<Item> field_219778_z = makeWrapperTag("walls");
   ...
   public static final Tag<Item> field_219770_E = makeWrapperTag("small_flowers");
   public static final Tag<Item> field_219771_F = makeWrapperTag("beds");
   public static final Tag<Item> field_219772_G = makeWrapperTag("fences");
   public static final Tag<Item> BOATS = makeWrapperTag("boats");
   public static final Tag<Item> FISHES = makeWrapperTag("fishes");
   public static final Tag<Item> field_219773_J = makeWrapperTag("signs");
   public static final Tag<Item> field_219774_K = makeWrapperTag("music_discs");
   public static final Tag<Item> field_219775_L = makeWrapperTag("coals");
   public static final Tag<Item> field_219776_M = makeWrapperTag("arrows");
