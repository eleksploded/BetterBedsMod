...
public class BlockParticleData implements IParticleData {
   ...
   private final BlockState field_197587_c;
   ...
   public BlockParticleData(ParticleType<BlockParticleData> particleTypeIn, BlockState blockStateIn) {
      ...
      this.field_197587_c = blockStateIn;
   }

   public void write(PacketBuffer buffer) {
      buffer.writeVarInt(Block.BLOCK_STATE_IDS.get(this.field_197587_c));
   }

   public String getParameters() {
      return Registry.field_212632_u.getKey(this.getType()) + " " + BlockStateParser.toString(this.field_197587_c);
   }
