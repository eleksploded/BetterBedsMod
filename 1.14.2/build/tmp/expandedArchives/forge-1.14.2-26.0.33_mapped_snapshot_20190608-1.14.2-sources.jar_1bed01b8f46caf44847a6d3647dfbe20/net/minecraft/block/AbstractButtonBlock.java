...
public abstract class AbstractButtonBlock extends HorizontalFaceBlock {
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      ...
      boolean flag = p_220053_1_.get(POWERED);
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      if (p_220051_1_.get(POWERED)) {
         return true;
      } else {
         p_220051_2_.setBlockState(p_220051_3_, p_220051_1_.with(POWERED, Boolean.valueOf(true)), 3);
         this.playSound(p_220051_4_, p_220051_2_, p_220051_3_, true);
         this.updateNeighbors(p_220051_1_, p_220051_2_, p_220051_3_);
         p_220051_2_.getPendingBlockTicks().scheduleTick(p_220051_3_, this, this.tickRate(p_220051_2_));
         return true;
      }
   }
