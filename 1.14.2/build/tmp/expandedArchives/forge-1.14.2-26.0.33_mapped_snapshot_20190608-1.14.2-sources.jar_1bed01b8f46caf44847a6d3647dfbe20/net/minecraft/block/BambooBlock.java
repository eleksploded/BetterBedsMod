...
public class BambooBlock extends Block implements IGrowable {
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      VoxelShape voxelshape = p_220053_1_.get(field_220265_e) == BambooLeaves.LARGE ? field_220262_b : field_220261_a;
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      if (!ifluidstate.isEmpty()) {
         ...
         if (blockstate.isIn(BlockTags.field_219749_R)) {
            ...
            if (block == Blocks.field_222404_kP) {
               ...
               return Blocks.field_222404_kP.getDefaultState();
            }
         } else {
            return null;
         }
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      return worldIn.getBlockState(pos.down()).isIn(BlockTags.field_219749_R);
   }
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      if (facing == Direction.UP && facingState.getBlock() == Blocks.field_222405_kQ && facingState.get(field_220264_d) > stateIn.get(field_220264_d)) {
   ...
   protected void func_220258_a(BlockState p_220258_1_, World p_220258_2_, BlockPos p_220258_3_, Random p_220258_4_, int p_220258_5_) {
      ...
      if (p_220258_5_ >= 1) {
         if (blockstate.getBlock() == Blocks.field_222405_kQ && blockstate.get(field_220265_e) != BambooLeaves.NONE) {
            if (blockstate.getBlock() == Blocks.field_222405_kQ && blockstate.get(field_220265_e) != BambooLeaves.NONE) {
               bambooleaves = BambooLeaves.LARGE;
               if (blockstate1.getBlock() == Blocks.field_222405_kQ) {
      ...
      int i = p_220258_1_.get(field_220264_d) != 1 && blockstate1.getBlock() != Blocks.field_222405_kQ ? 0 : 1;
   ...
   protected int func_220259_a(IBlockReader p_220259_1_, BlockPos p_220259_2_) {
      int i;
      for(i = 0; i < 16 && p_220259_1_.getBlockState(p_220259_2_.up(i + 1)).getBlock() == Blocks.field_222405_kQ; ++i) {
         ;
      }
   ...
   protected int func_220260_b(IBlockReader p_220260_1_, BlockPos p_220260_2_) {
      int i;
      for(i = 0; i < 16 && p_220260_1_.getBlockState(p_220260_2_.down(i + 1)).getBlock() == Blocks.field_222405_kQ; ++i) {
         ;
      }
