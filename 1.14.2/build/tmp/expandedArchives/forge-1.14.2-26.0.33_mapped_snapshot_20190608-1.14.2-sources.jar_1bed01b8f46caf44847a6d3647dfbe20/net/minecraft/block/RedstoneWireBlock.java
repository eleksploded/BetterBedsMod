...
public class RedstoneWireBlock extends Block {
   ...
   private RedstoneSide getSide(IBlockReader worldIn, BlockPos pos, Direction face) {
      ...
      return !canConnectTo(blockstate, worldIn, blockpos, face) && (blockstate.func_215686_e(worldIn, blockpos) || !canConnectTo(worldIn.getBlockState(blockpos.down()), worldIn, blockpos.down(), null)) ? RedstoneSide.NONE : RedstoneSide.SIDE;
   }
   ...
   private BlockState func_212568_b(World p_212568_1_, BlockPos p_212568_2_, BlockState p_212568_3_) {
      ...
      if (j < 15) {
         for(Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.func_215686_e(p_212568_1_, blockpos) && !p_212568_1_.getBlockState(blockpos1).func_215686_e(p_212568_1_, blockpos1)) {
               k = this.maxSignal(k, p_212568_1_.getBlockState(blockpos.up()));
            } else if (!blockstate1.func_215686_e(p_212568_1_, blockpos)) {
   ...
   public void onBlockAdded(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock() && !p_220082_2_.isRemote) {
         ...
         for(Direction direction : Direction.Plane.VERTICAL) {
            p_220082_2_.notifyNeighborsOfStateChange(p_220082_3_.offset(direction), this);
         }

         for(Direction direction1 : Direction.Plane.HORIZONTAL) {
            this.notifyWireNeighborsOfStateChange(p_220082_2_, p_220082_3_.offset(direction1));
         }

         for(Direction direction2 : Direction.Plane.HORIZONTAL) {
            BlockPos blockpos = p_220082_3_.offset(direction2);
            if (p_220082_2_.getBlockState(blockpos).func_215686_e(p_220082_2_, blockpos)) {
   ...
   private boolean isPowerSourceAt(IBlockReader worldIn, BlockPos pos, Direction side) {
      ...
      BlockPos blockpos1 = pos.up();
      boolean flag1 = worldIn.getBlockState(blockpos1).func_215686_e(worldIn, blockpos1);
