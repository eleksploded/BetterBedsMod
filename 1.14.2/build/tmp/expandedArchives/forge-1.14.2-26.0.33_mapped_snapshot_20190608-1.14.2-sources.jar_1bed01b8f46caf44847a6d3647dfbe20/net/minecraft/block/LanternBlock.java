...
public class LanternBlock extends Block {
   ...
   public LanternBlock(Block.Properties p_i49980_1_) {
      super(p_i49980_1_);
      this.setDefaultState(this.stateContainer.getBaseState().with(field_220278_a, Boolean.valueOf(false)));
   }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      for(Direction direction : context.getNearestLookingDirections()) {
         if (direction.getAxis() == Direction.Axis.Y) {
            BlockState blockstate = this.getDefaultState().with(field_220278_a, Boolean.valueOf(direction == Direction.UP));
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      return p_220053_1_.get(field_220278_a) ? field_220280_c : field_220279_b;
   }

   protected void fillStateContainer(StateContainer.Builder<Block, BlockState> builder) {
      builder.add(field_220278_a);
   }
   ...
   protected static Direction func_220277_j(BlockState p_220277_0_) {
      return p_220277_0_.get(field_220278_a) ? Direction.DOWN : Direction.UP;
   }
