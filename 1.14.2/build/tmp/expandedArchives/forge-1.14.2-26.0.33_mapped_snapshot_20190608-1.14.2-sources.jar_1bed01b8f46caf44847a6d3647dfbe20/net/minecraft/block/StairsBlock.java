...
public class StairsBlock extends Block implements IWaterLoggable {
   ...
   public void onBlockClicked(BlockState state, World worldIn, BlockPos pos, PlayerEntity player) {
      this.field_150151_M.onBlockClicked(worldIn, pos, player);
   }
   ...
   public void onBlockAdded(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_1_.getBlock() != p_220082_1_.getBlock()) {
         this.field_150151_M.neighborChanged(p_220082_2_, p_220082_3_, Blocks.AIR, p_220082_3_, false);
         this.modelBlock.onBlockAdded(this.field_150151_M, p_220082_2_, p_220082_3_, p_220082_4_, false);
      }
   }

   public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
      if (state.getBlock() != newState.getBlock()) {
         this.field_150151_M.onReplaced(worldIn, pos, newState, isMoving);
      }
   }
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      return this.field_150151_M.onBlockActivated(p_220051_2_, p_220051_4_, p_220051_5_, p_220051_6_);
   }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      BlockState blockstate = this.getDefaultState().with(FACING, context.getPlacementHorizontalFacing()).with(HALF, direction != Direction.DOWN && (direction == Direction.UP || !(context.func_221532_j().y - (double)blockpos.getY() > 0.5D)) ? Half.BOTTOM : Half.TOP).with(WATERLOGGED, Boolean.valueOf(ifluidstate.getFluid() == Fluids.WATER));
