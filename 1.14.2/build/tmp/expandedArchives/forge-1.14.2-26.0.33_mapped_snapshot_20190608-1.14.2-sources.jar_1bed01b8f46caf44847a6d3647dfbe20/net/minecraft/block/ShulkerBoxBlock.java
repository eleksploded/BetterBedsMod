...
public class ShulkerBoxBlock extends ContainerBlock {
      ...
      if (p_220051_2_.isRemote) {
         ...
         if (tileentity instanceof ShulkerBoxTileEntity) {
            ...
            if (shulkerboxtileentity.getAnimationStatus() == ShulkerBoxTileEntity.AnimationStatus.CLOSED) {
               ...
               flag = p_220051_2_.areCollisionShapesEmpty(axisalignedbb.offset(p_220051_3_.offset(direction)));
            } else {
               flag = true;
            }

            if (flag) {
               p_220051_4_.openContainer(shulkerboxtileentity);
               p_220051_4_.addStat(Stats.OPEN_SHULKER_BOX);
            }
   ...
   public List<ItemStack> getDrops(BlockState p_220076_1_, LootContext.Builder p_220076_2_) {
      TileEntity tileentity = p_220076_2_.get(LootParameters.field_216288_h);
      if (tileentity instanceof ShulkerBoxTileEntity) {
         ShulkerBoxTileEntity shulkerboxtileentity = (ShulkerBoxTileEntity)tileentity;
         p_220076_2_ = p_220076_2_.withDynamicDrop(field_220169_b, (p_220168_1_, p_220168_2_) -> {
