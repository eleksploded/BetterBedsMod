...
public class ChestBlock extends ContainerBlock implements IWaterLoggable {
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      if (p_220051_2_.isRemote) {
         ...
         INamedContainerProvider inamedcontainerprovider = this.getContainer(p_220051_1_, p_220051_2_, p_220051_3_);
         if (inamedcontainerprovider != null) {
            p_220051_4_.openContainer(inamedcontainerprovider);
   ...
   public INamedContainerProvider getContainer(BlockState p_220052_1_, World p_220052_2_, BlockPos p_220052_3_) {
      return func_220106_a(p_220052_1_, p_220052_2_, p_220052_3_, false, field_220110_j);
   }
   ...
   private static boolean isBelowSolidBlock(IBlockReader p_176456_0_, BlockPos worldIn) {
      ...
      return p_176456_0_.getBlockState(blockpos).func_215686_e(p_176456_0_, blockpos);
   }
