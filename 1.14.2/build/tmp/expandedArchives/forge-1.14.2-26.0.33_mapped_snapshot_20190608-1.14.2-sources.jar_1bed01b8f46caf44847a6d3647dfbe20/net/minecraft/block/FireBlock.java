...
public class FireBlock extends Block {
         ...
         if (!flag && worldIn.isRaining() && this.canDie(worldIn, pos) && random.nextFloat() < 0.2F + (float)i * 0.03F) {
            ...
            if (!flag) {
               ...
               if (!this.areNeighborsFlammable(worldIn, pos)) {
                  BlockPos blockpos = pos.down();
                  if (!Block.func_220056_d(worldIn.getBlockState(blockpos), worldIn, blockpos, Direction.UP) || i > 3) {
                     worldIn.removeBlock(pos, false);
                  }
   ...
   public void onBlockAdded(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         if (p_220082_2_.dimension.getType() != DimensionType.OVERWORLD && p_220082_2_.dimension.getType() != DimensionType.NETHER || !((NetherPortalBlock)Blocks.NETHER_PORTAL).trySpawnPortal(p_220082_2_, p_220082_3_)) {
   ...
   public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
      ...
      if (!this.canCatchFire(worldIn, blockpos, Direction.UP) && !Block.func_220056_d(blockstate, worldIn, blockpos, Direction.UP)) {
