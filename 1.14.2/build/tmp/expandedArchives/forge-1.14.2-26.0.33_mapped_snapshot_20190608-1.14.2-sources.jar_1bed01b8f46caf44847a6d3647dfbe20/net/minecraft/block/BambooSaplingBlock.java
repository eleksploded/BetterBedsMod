...
public class BambooSaplingBlock extends Block implements IGrowable {
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      if (!stateIn.isValidPosition(worldIn, currentPos)) {
         ...
         if (facing == Direction.UP && facingState.getBlock() == Blocks.field_222405_kQ) {
            worldIn.setBlockState(currentPos, Blocks.field_222405_kQ.getDefaultState(), 2);
         }
   ...
   public ItemStack getItem(IBlockReader worldIn, BlockPos pos, BlockState state) {
      return new ItemStack(Items.field_222068_kQ);
   }
   ...
   protected void func_220087_a(World p_220087_1_, BlockPos p_220087_2_) {
      p_220087_1_.setBlockState(p_220087_2_.up(), Blocks.field_222405_kQ.getDefaultState().with(BambooBlock.field_220265_e, BambooLeaves.SMALL), 3);
   }
}