...
public class NoteBlock extends Block {
   ...
   public void neighborChanged(BlockState p_220069_1_, World p_220069_2_, BlockPos p_220069_3_, Block p_220069_4_, BlockPos p_220069_5_, boolean p_220069_6_) {
      ...
      if (flag != p_220069_1_.get(POWERED)) {
         ...
         p_220069_2_.setBlockState(p_220069_3_, p_220069_1_.with(POWERED, Boolean.valueOf(flag)), 3);
      }
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      if (p_220051_2_.isRemote) {
         ...
         int _new = net.minecraftforge.common.ForgeHooks.onNoteChange(p_220051_2_, p_220051_3_, p_220051_1_, p_220051_1_.get(NOTE), p_220051_1_.cycle(NOTE).get(NOTE));
         if (_new == -1) return false;
         p_220051_1_ = (BlockState)p_220051_1_.with(NOTE, _new);
         p_220051_2_.setBlockState(p_220051_3_, p_220051_1_, 3);
         this.triggerNote(p_220051_2_, p_220051_3_);
         p_220051_4_.addStat(Stats.TUNE_NOTEBLOCK);
         return true;
      }
   }
