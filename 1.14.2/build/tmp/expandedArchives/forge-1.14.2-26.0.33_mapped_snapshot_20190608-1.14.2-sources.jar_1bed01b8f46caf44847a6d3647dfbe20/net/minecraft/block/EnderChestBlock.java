...
public class EnderChestBlock extends ContainerBlock implements IWaterLoggable {
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      EnderChestInventory enderchestinventory = p_220051_4_.getInventoryEnderChest();
      ...
      if (enderchestinventory != null && tileentity instanceof EnderChestTileEntity) {
         BlockPos blockpos = p_220051_3_.up();
         if (p_220051_2_.getBlockState(blockpos).func_215686_e(p_220051_2_, blockpos)) {
            return true;
         } else if (p_220051_2_.isRemote) {
            return true;
         } else {
            ...
            p_220051_4_.openContainer(new SimpleNamedContainerProvider((p_220114_1_, p_220114_2_, p_220114_3_) -> {
               return ChestContainer.func_216992_a(p_220114_1_, p_220114_2_, enderchestinventory);
            }, field_220115_d));
            p_220051_4_.addStat(Stats.OPEN_ENDERCHEST);
            return true;
         }
      } else {
         return true;
