...
public class RailState {
   ...
   public RailState(World p_i47755_1_, BlockPos p_i47755_2_, BlockState p_i47755_3_) {
      ...
      this.field_196922_c = (AbstractRailBlock)p_i47755_3_.getBlock();
      RailShape railshape = this.field_196922_c.getRailDirection(field_196923_d, p_i47755_1_, p_i47755_2_, null);
      this.disableCorners = !this.field_196922_c.isFlexibleRail(field_196923_d, p_i47755_1_, p_i47755_2_);
   ...
   private void func_208510_c(RailState p_208510_1_) {
      ...
      this.field_196923_d = this.field_196923_d.with(this.field_196922_c.getShapeProperty(), railshape);
      this.world.setBlockState(this.pos, this.field_196923_d, 3);
   }
   ...
   public RailState update(boolean powered, boolean placing) {
      ...
      this.reset(railshape);
      this.field_196923_d = this.field_196923_d.with(this.field_196922_c.getShapeProperty(), railshape);
      if (placing || this.world.getBlockState(this.pos) != this.field_196923_d) {
         this.world.setBlockState(this.pos, this.field_196923_d, 3);
