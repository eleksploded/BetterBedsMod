...
public class BlockMaterialMatcher implements Predicate<BlockState> {
   private static final BlockMaterialMatcher field_196961_a = new BlockMaterialMatcher(Material.AIR) {
   ...
   public static BlockMaterialMatcher forMaterial(Material materialIn) {
      return materialIn == Material.AIR ? field_196961_a : new BlockMaterialMatcher(materialIn);
   }
