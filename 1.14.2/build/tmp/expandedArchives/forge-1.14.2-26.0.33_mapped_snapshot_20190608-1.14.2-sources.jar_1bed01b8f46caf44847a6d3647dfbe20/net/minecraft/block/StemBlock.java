...
public class StemBlock extends BushBlock implements IGrowable {
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      return SHAPES[p_220053_1_.get(AGE)];
   }
         ...
         if (net.minecraftforge.common.ForgeHooks.onCropsGrowPre(worldIn, pos, state, random.nextInt((int)(25.0F / f) + 1) == 0)) {
            ...
            if (i < 7) {
               ...
               if (worldIn.getBlockState(blockpos).isAir(worldIn, blockpos) && (soil.canSustainPlant(worldIn, blockpos.down(), Direction.UP, this) || block == Blocks.FARMLAND || block == Blocks.DIRT || block == Blocks.COARSE_DIRT || block == Blocks.PODZOL || block == Blocks.GRASS_BLOCK)) {
                  worldIn.setBlockState(blockpos, this.field_149877_a.getDefaultState());
                  worldIn.setBlockState(pos, this.field_149877_a.getAttachedStem().getDefaultState().with(HorizontalBlock.HORIZONTAL_FACING, direction));
               }
            }
   ...
   protected Item getSeedItem() {
      if (this.field_149877_a == Blocks.PUMPKIN) {
         ...
         return this.field_149877_a == Blocks.MELON ? Items.MELON_SEEDS : null;
      }
   }
