...
public class AttachedStemBlock extends BushBlock {
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      return SHAPES.get(p_220053_1_.get(FACING));
   }
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      return facingState.getBlock() != this.field_196281_b && facing == stateIn.get(FACING) ? this.field_196281_b.getStem().getDefaultState().with(StemBlock.AGE, Integer.valueOf(7)) : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
   }
   ...
   protected Item getSeeds() {
      if (this.field_196281_b == Blocks.PUMPKIN) {
         return Items.PUMPKIN_SEEDS;
      } else {
         return this.field_196281_b == Blocks.MELON ? Items.MELON_SEEDS : Items.AIR;
      }
   }
