...
public class CampfireBlock extends ContainerBlock implements IWaterLoggable {
      ...
      if (p_220051_1_.get(LIT)) {
         ...
         if (tileentity instanceof CampfireTileEntity) {
            ...
            if (optional.isPresent()) {
               if (!p_220051_2_.isRemote && campfiretileentity.func_213984_a(p_220051_4_.playerAbilities.isCreativeMode ? itemstack.copy() : itemstack, optional.get().func_222137_e())) {
                  p_220051_4_.addStat(Stats.field_219736_at);
               }
   ...
   public void onReplaced(BlockState state, World worldIn, BlockPos pos, BlockState newState, boolean isMoving) {
      if (state.getBlock() != newState.getBlock()) {
         ...
         if (tileentity instanceof CampfireTileEntity) {
            InventoryHelper.func_219961_a(worldIn, pos, ((CampfireTileEntity)tileentity).func_213985_c());
         }
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return this.getDefaultState().with(WATERLOGGED, Boolean.valueOf(flag)).with(SIGNAL_FIRE, Boolean.valueOf(this.func_220099_j(iworld.getBlockState(blockpos.down())))).with(LIT, Boolean.valueOf(!flag)).with(FACING, context.getPlacementHorizontalFacing());
   }
   ...
   public BlockState updatePostPlacement(BlockState stateIn, Direction facing, BlockState facingState, IWorld worldIn, BlockPos currentPos, BlockPos facingPos) {
      ...
      return facing == Direction.DOWN ? stateIn.with(SIGNAL_FIRE, Boolean.valueOf(this.func_220099_j(facingState))) : super.updatePostPlacement(stateIn, facing, facingState, worldIn, currentPos, facingPos);
   }
   ...
   public void animateTick(BlockState stateIn, World worldIn, BlockPos pos, Random rand) {
      if (stateIn.get(LIT)) {
         if (rand.nextInt(10) == 0) {
            worldIn.playSound((double)((float)pos.getX() + 0.5F), (double)((float)pos.getY() + 0.5F), (double)((float)pos.getZ() + 0.5F), SoundEvents.field_219605_aC, SoundCategory.BLOCKS, 0.5F + rand.nextFloat(), rand.nextFloat() * 0.7F + 0.6F, false);
         }
   ...
   public void onProjectileCollision(World p_220066_1_, BlockState p_220066_2_, BlockRayTraceResult p_220066_3_, Entity p_220066_4_) {
      if (!p_220066_1_.isRemote && p_220066_4_ instanceof AbstractArrowEntity) {
         ...
         if (abstractarrowentity.isBurning() && !p_220066_2_.get(LIT) && !p_220066_2_.get(WATERLOGGED)) {
            BlockPos blockpos = p_220066_3_.getPos();
            p_220066_1_.setBlockState(blockpos, p_220066_2_.with(BlockStateProperties.LIT, Boolean.valueOf(true)), 11);
         }
      }
