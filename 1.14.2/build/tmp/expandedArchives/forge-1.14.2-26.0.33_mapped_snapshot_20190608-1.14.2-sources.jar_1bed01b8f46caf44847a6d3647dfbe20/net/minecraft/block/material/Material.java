...
public final class Material {
   ...
   public static class Builder {
      private PushReaction field_200512_a = PushReaction.NORMAL;
      ...
      public Material build() {
         return new Material(this.color, this.isLiquid, this.isSolid, this.blocksMovement, this.isOpaque, this.requiresNoTool, this.canBurn, this.isReplaceable, this.field_200512_a);
      }
   }
}