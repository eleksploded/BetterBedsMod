   ...
   public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
      ...
      if (blockstate.isAir()) {
         ...
         if (!worldIn.isRemote) {
            ...
            for(int i = 0; i < 2; ++i) {
               serverworld.spawnParticle(ParticleTypes.field_218422_X, (double)((float)pos.getX() + worldIn.rand.nextFloat()), (double)(pos.getY() + 1), (double)((float)pos.getZ() + worldIn.rand.nextFloat()), 1, 0.0D, 0.0D, 0.0D, 1.0D);
