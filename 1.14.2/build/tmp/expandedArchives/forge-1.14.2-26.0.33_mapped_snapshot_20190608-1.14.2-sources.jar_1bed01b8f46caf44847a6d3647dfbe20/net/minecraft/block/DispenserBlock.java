...
public class DispenserBlock extends ContainerBlock {
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      if (p_220051_2_.isRemote) {
         ...
         if (tileentity instanceof DispenserTileEntity) {
            p_220051_4_.openContainer((DispenserTileEntity)tileentity);
            if (tileentity instanceof DropperTileEntity) {
               p_220051_4_.addStat(Stats.INSPECT_DROPPER);
            } else {
               p_220051_4_.addStat(Stats.INSPECT_DISPENSER);
            }
         }
   ...
   public void neighborChanged(BlockState p_220069_1_, World p_220069_2_, BlockPos p_220069_3_, Block p_220069_4_, BlockPos p_220069_5_, boolean p_220069_6_) {
      boolean flag = p_220069_2_.isBlockPowered(p_220069_3_) || p_220069_2_.isBlockPowered(p_220069_3_.up());
      boolean flag1 = p_220069_1_.get(TRIGGERED);
      if (flag && !flag1) {
         p_220069_2_.getPendingBlockTicks().scheduleTick(p_220069_3_, this, this.tickRate(p_220069_2_));
         p_220069_2_.setBlockState(p_220069_3_, p_220069_1_.with(TRIGGERED, Boolean.valueOf(true)), 4);
      } else if (!flag && flag1) {
         p_220069_2_.setBlockState(p_220069_3_, p_220069_1_.with(TRIGGERED, Boolean.valueOf(false)), 4);
      }
