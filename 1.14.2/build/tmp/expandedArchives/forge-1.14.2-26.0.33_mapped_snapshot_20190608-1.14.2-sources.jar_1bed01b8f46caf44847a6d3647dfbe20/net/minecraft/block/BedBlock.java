...
public class BedBlock extends HorizontalBlock implements ITileEntityProvider {
   ...
   public MaterialColor getMaterialColor(BlockState state, IBlockReader worldIn, BlockPos pos) {
      return state.get(PART) == BedPart.FOOT ? this.field_196352_y.getMapColor() : MaterialColor.WOOL;
   }
   ...
   public boolean onBlockActivated(BlockState p_220051_1_, World p_220051_2_, BlockPos p_220051_3_, PlayerEntity p_220051_4_, Hand p_220051_5_, BlockRayTraceResult p_220051_6_) {
      if (p_220051_2_.isRemote) {
         ...
         if (p_220051_1_.get(PART) != BedPart.HEAD) {
            p_220051_3_ = p_220051_3_.offset(p_220051_1_.get(HORIZONTAL_FACING));
            p_220051_1_ = p_220051_2_.getBlockState(p_220051_3_);
            if (p_220051_1_.getBlock() != this) {
               return true;
            }
         }

         net.minecraftforge.common.extensions.IForgeDimension.SleepResult sleepResult = p_220051_2_.dimension.canSleepAt(p_220051_4_, p_220051_3_);
         if (sleepResult != net.minecraftforge.common.extensions.IForgeDimension.SleepResult.BED_EXPLODES) {
            ...
            if (p_220051_1_.get(OCCUPIED)) {
               p_220051_4_.sendStatusMessage(new TranslationTextComponent("block.minecraft.bed.occupied"), true);
               return true;
            } else {
               p_220051_4_.func_213819_a(p_220051_3_).ifLeft((p_220173_1_) -> {
                  if (p_220173_1_ != null) {
                     p_220051_4_.sendStatusMessage(p_220173_1_.func_221259_a(), true);
                  }
            ...
            p_220051_2_.removeBlock(p_220051_3_, false);
            BlockPos blockpos = p_220051_3_.offset(p_220051_1_.get(HORIZONTAL_FACING).getOpposite());
            if (p_220051_2_.getBlockState(blockpos).getBlock() == this) {
               p_220051_2_.removeBlock(blockpos, false);
            }

            p_220051_2_.createExplosion((Entity)null, DamageSource.netherBedExplosion(), (double)p_220051_3_.getX() + 0.5D, (double)p_220051_3_.getY() + 0.5D, (double)p_220051_3_.getZ() + 0.5D, 5.0F, true, Explosion.Mode.DESTROY);
            return true;
         }
      }
   }
   ...
   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      Direction direction = p_220053_1_.get(HORIZONTAL_FACING);
      Direction direction1 = p_220053_1_.get(PART) == BedPart.HEAD ? direction : direction.getOpposite();
      switch(direction1) {
      case NORTH:
      ...
      if (voxelshape.getEnd(Direction.Axis.Y) > 0.4375D) {
         ...
         if (voxelshape1.isEmpty()) {
            ...
            if ((double)p_220175_2_.getY() - d0 > 2.0D) {
               ...
               return p_220175_1_.areCollisionShapesEmpty(new AxisAlignedBB(vec3d.x - (double)f, vec3d.y, vec3d.z - (double)f, vec3d.x + (double)f, vec3d.y + (double)p_220175_0_.func_220344_i(), vec3d.z + (double)f)) ? Optional.of(vec3d) : Optional.empty();
            }
         }
      }
   }
