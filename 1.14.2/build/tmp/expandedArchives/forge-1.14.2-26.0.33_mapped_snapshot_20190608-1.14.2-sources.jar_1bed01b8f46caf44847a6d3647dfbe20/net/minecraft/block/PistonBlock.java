...
public class PistonBlock extends DirectionalBlock {
   ...
   public boolean func_220060_c(BlockState p_220060_1_, IBlockReader p_220060_2_, BlockPos p_220060_3_) {
      return !p_220060_1_.get(EXTENDED);
   }

   public VoxelShape getShape(BlockState p_220053_1_, IBlockReader p_220053_2_, BlockPos p_220053_3_, ISelectionContext p_220053_4_) {
      if (p_220053_1_.get(EXTENDED)) {
   ...
   public void onBlockAdded(BlockState p_220082_1_, World p_220082_2_, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         if (!p_220082_2_.isRemote && p_220082_2_.getTileEntity(p_220082_3_) == null) {
   ...
   public static boolean canPush(BlockState blockStateIn, World worldIn, BlockPos pos, Direction facing, boolean destroyBlocks, Direction p_185646_5_) {
      ...
      if (block == Blocks.OBSIDIAN) {
         ...
         if (pos.getY() <= worldIn.func_217301_I() - 1 && (facing != Direction.UP || pos.getY() != worldIn.func_217301_I() - 1)) {
   ...
   public boolean func_220074_n(BlockState p_220074_1_) {
      return p_220074_1_.get(EXTENDED);
   }
