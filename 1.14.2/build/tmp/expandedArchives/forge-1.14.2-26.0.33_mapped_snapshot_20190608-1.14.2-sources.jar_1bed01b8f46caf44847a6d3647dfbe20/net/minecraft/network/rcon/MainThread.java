...
public class MainThread extends RConThread {
   ...
   public MainThread(IServer p_i1538_1_) {
      ...
      ServerProperties serverproperties = p_i1538_1_.func_213221_d_();
      this.rconPort = serverproperties.field_219031_y;
      this.rconPassword = serverproperties.field_219032_z;
