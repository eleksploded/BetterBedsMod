...
public class SCombatPacket implements IPacket<IClientPlayNetHandler> {
   public SCombatPacket.Event field_179776_a;
   public int playerId;
   public int entityId;
   public int duration;
   ...
   public SCombatPacket(CombatTracker p_i49825_1_, SCombatPacket.Event p_i49825_2_, ITextComponent p_i49825_3_) {
      this.field_179776_a = p_i49825_2_;
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      this.field_179776_a = buf.readEnumValue(SCombatPacket.Event.class);
      if (this.field_179776_a == SCombatPacket.Event.END_COMBAT) {
         this.duration = buf.readVarInt();
         this.entityId = buf.readInt();
      } else if (this.field_179776_a == SCombatPacket.Event.ENTITY_DIED) {
   ...
   public boolean shouldSkipErrors() {
      return this.field_179776_a == SCombatPacket.Event.ENTITY_DIED;
   }
