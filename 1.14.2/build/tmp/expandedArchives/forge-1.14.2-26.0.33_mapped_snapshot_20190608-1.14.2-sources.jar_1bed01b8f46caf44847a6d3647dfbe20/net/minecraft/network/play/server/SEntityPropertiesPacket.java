   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      for(int j = 0; j < i; ++j) {
         ...
         for(int l = 0; l < k; ++l) {
            ...
            list.add(new AttributeModifier(uuid, "Unknown synced attribute modifier", buf.readDouble(), AttributeModifier.Operation.func_220372_a(buf.readByte())));
         }
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      for(SEntityPropertiesPacket.Snapshot sentitypropertiespacket$snapshot : this.snapshots) {
         ...
         for(AttributeModifier attributemodifier : sentitypropertiespacket$snapshot.getModifiers()) {
            ...
            buf.writeByte(attributemodifier.func_220375_c().func_220371_a());
         }
      }
