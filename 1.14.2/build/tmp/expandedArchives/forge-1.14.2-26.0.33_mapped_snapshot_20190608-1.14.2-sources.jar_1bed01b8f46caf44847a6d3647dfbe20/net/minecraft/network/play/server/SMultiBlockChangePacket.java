...
public class SMultiBlockChangePacket implements IPacket<IClientPlayNetHandler> {
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_179845_b = new SMultiBlockChangePacket.UpdateData[buf.readVarInt()];

      for(int i = 0; i < this.field_179845_b.length; ++i) {
         this.field_179845_b[i] = new SMultiBlockChangePacket.UpdateData(buf.readShort(), Block.BLOCK_STATE_IDS.getByValue(buf.readVarInt()));
      }
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      buf.writeVarInt(this.field_179845_b.length);
   ...
   public class UpdateData {
      ...
      public UpdateData(short p_i46545_2_, Chunk p_i46545_3_) {
         ...
         this.field_180092_c = p_i46545_3_.getBlockState(this.getPos());
      }
