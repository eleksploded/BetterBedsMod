...
public class SChangeBlockPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public SChangeBlockPacket(IBlockReader p_i48982_1_, BlockPos pos) {
      this.pos = pos;
      this.field_197686_b = p_i48982_1_.getBlockState(pos);
   }
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_197686_b = Block.BLOCK_STATE_IDS.getByValue(buf.readVarInt());
   }
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      buf.writeVarInt(Block.getStateId(this.field_197686_b));
   }
