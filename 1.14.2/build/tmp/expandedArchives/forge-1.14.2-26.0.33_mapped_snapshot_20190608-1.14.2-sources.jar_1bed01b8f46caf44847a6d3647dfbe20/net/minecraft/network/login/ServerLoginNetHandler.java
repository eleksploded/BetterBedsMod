...
public class ServerLoginNetHandler implements IServerLoginNetHandler {
   ...
   public void tick() {
      if (this.field_147328_g == State.NEGOTIATING) {
         ...
         boolean negotiationComplete = net.minecraftforge.fml.network.NetworkHooks.tickNegotiation(this, this.networkManager, this.field_181025_l);
         ...
         if (serverplayerentity == null) {
            ...
            this.server.getPlayerList().initializeConnectionToPlayer(this.networkManager, this.field_181025_l);
   ...
   public void tryAcceptPlayer() {
      ...
      if (itextcomponent != null) {
         ...
         if (serverplayerentity != null) {
            ...
            this.field_181025_l = this.server.getPlayerList().createPlayerForUser(this.loginGameProfile);
         } else {
   ...
   public void processLoginStart(CLoginStartPacket packetIn) {
      Validate.validState(this.field_147328_g == ServerLoginNetHandler.State.HELLO, "Unexpected hello packet");
