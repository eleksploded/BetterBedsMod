...
public class SSpawnPaintingPacket implements IPacket<IClientPlayNetHandler> {
   ...
   private Direction field_179839_c;
   private int title;
   ...
   public SSpawnPaintingPacket(PaintingEntity painting) {
      ...
      this.field_179839_c = painting.field_174860_b;
      this.title = Registry.field_212620_i.getId(painting.art);
   }
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_179839_c = Direction.byHorizontalIndex(buf.readUnsignedByte());
   }
   ...
   public PaintingType getType() {
      return Registry.field_212620_i.getByValue(this.title);
   }
}