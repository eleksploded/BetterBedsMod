...
public class SUpdateBossInfoPacket implements IPacket<IClientPlayNetHandler> {
   ...
   private SUpdateBossInfoPacket.Operation field_186912_b;
   ...
   public SUpdateBossInfoPacket(SUpdateBossInfoPacket.Operation operationIn, BossInfo data) {
      this.field_186912_b = operationIn;
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_186912_b = buf.readEnumValue(SUpdateBossInfoPacket.Operation.class);
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      buf.writeEnumValue(this.field_186912_b);
      switch(this.field_186912_b) {
      case ADD:
