...
public class SPlayerListItemPacket implements IPacket<IClientPlayNetHandler> {
   private SPlayerListItemPacket.Action field_179770_a;
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      this.field_179770_a = buf.readEnumValue(SPlayerListItemPacket.Action.class);
   ...
   public String toString() {
      return MoreObjects.toStringHelper(this).add("action", this.field_179770_a).add("entries", this.players).toString();
   }
