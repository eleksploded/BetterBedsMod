...
public class NettyPacketDecoder extends ByteToMessageDecoder {
   ...
   private final PacketDirection field_152499_c;

   public NettyPacketDecoder(PacketDirection direction) {
      this.field_152499_c = direction;
   }
   ...
   protected void decode(ChannelHandlerContext p_decode_1_, ByteBuf p_decode_2_, List<Object> p_decode_3_) throws Exception {
      if (p_decode_2_.readableBytes() != 0) {
         ...
         IPacket<?> ipacket = p_decode_1_.channel().attr(NetworkManager.PROTOCOL_ATTRIBUTE_KEY).get().getPacket(this.field_152499_c, i);
         if (ipacket == null) {
