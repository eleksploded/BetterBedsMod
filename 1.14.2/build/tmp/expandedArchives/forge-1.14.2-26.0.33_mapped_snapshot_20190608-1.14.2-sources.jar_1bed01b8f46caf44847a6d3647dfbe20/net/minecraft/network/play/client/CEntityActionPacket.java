...
public class CEntityActionPacket implements IPacket<IServerPlayNetHandler> {
   ...
   private CEntityActionPacket.Action field_149515_b;
   private int auxData;
   ...
   public void readPacketData(PacketBuffer buf) throws IOException {
      ...
      this.field_149515_b = buf.readEnumValue(CEntityActionPacket.Action.class);
   ...
   public void writePacketData(PacketBuffer buf) throws IOException {
      ...
      buf.writeEnumValue(this.field_149515_b);
