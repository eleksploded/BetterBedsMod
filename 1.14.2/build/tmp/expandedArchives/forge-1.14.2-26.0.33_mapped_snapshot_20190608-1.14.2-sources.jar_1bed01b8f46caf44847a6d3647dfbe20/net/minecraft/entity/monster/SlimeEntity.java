...
public class SlimeEntity extends MobEntity implements IMob {
   private static final DataParameter<Integer> SLIME_SIZE = EntityDataManager.createKey(SlimeEntity.class, DataSerializers.field_187192_b);
   ...
   public SlimeEntity(EntityType<? extends SlimeEntity> p_i48552_1_, World p_i48552_2_) {
      ...
      this.field_70765_h = new SlimeEntity.MoveHelperController(this);
   }

   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new SlimeEntity.FloatGoal(this));
      this.field_70714_bg.addTask(2, new SlimeEntity.AttackGoal(this));
      this.field_70714_bg.addTask(3, new SlimeEntity.FaceRandomGoal(this));
      this.field_70714_bg.addTask(5, new SlimeEntity.HopGoal(this));
      this.field_70715_bh.addTask(1, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, 10, true, false, (p_213811_1_) -> {
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      ...
      if (p_213380_1_.getWorldInfo().getGenerator().handleSlimeSpawnReduction(rand, world)) {
         return false;
      } else {
         if (p_213380_1_.getDifficulty() != Difficulty.PEACEFUL) {
            Biome biome = p_213380_1_.getBiome(blockpos);
            if (biome == Biomes.SWAMP && this.posY > 50.0D && this.posY < 70.0D && this.rand.nextFloat() < 0.5F && this.rand.nextFloat() < p_213380_1_.getCurrentMoonPhaseFactor() && p_213380_1_.getLight(new BlockPos(this)) <= this.rand.nextInt(8)) {
               return super.canSpawn(p_213380_1_, p_213380_2_);
            }

            ChunkPos chunkpos = new ChunkPos(blockpos);
            boolean flag = SharedSeedRandom.seedSlimeChunk(chunkpos.x, chunkpos.z, p_213380_1_.getSeed(), 987234911L).nextInt(10) == 0;
   ...
   static class AttackGoal extends Goal {
      ...
      public boolean shouldExecute() {
         LivingEntity livingentity = this.field_179466_a.getAttackTarget();
         if (livingentity == null) {
            return false;
         } else if (!livingentity.isAlive()) {
            return false;
         } else {
            return livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).playerAbilities.disableDamage ? false : this.field_179466_a.getMoveHelper() instanceof SlimeEntity.MoveHelperController;
         }
      }
      ...
      public boolean shouldContinueExecuting() {
         ...
         if (livingentity == null) {
            ...
            return false;
         } else if (livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).playerAbilities.disableDamage) {
            return false;
         } else {
      ...
      public void tick() {
         ...
         ((SlimeEntity.MoveHelperController)this.field_179466_a.getMoveHelper()).setDirection(this.field_179466_a.rotationYaw, this.field_179466_a.canDamagePlayer());
      }
   }
   ...
   static class FaceRandomGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         return this.field_179461_a.getAttackTarget() == null && (this.field_179461_a.onGround || this.field_179461_a.isInWater() || this.field_179461_a.isInLava() || this.field_179461_a.isPotionActive(Effects.field_188424_y)) && this.field_179461_a.getMoveHelper() instanceof SlimeEntity.MoveHelperController;
      }
      ...
      public void tick() {
         if (--this.nextRandomizeTime <= 0) {
            this.nextRandomizeTime = 40 + this.field_179461_a.getRNG().nextInt(60);
            this.chosenDegrees = (float)this.field_179461_a.getRNG().nextInt(360);
         }

         ((SlimeEntity.MoveHelperController)this.field_179461_a.getMoveHelper()).setDirection(this.chosenDegrees, false);
      }
   }
   ...
   static class FloatGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         return (this.field_179457_a.isInWater() || this.field_179457_a.isInLava()) && this.field_179457_a.getMoveHelper() instanceof SlimeEntity.MoveHelperController;
      }
      ...
      public void tick() {
         ...
         ((SlimeEntity.MoveHelperController)this.field_179457_a.getMoveHelper()).setSpeed(1.2D);
      }
   }
   ...
   static class HopGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         return !this.field_179458_a.isPassenger();
      }
       ...
       */
      public void tick() {
         ((SlimeEntity.MoveHelperController)this.field_179458_a.getMoveHelper()).setSpeed(1.0D);
      }
   }
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         this.field_75648_a.rotationYaw = this.limitAngle(this.field_75648_a.rotationYaw, this.yRot, 90.0F);
         this.field_75648_a.rotationYawHead = this.field_75648_a.rotationYaw;
         this.field_75648_a.renderYawOffset = this.field_75648_a.rotationYaw;
         if (this.field_188491_h != MovementController.Action.MOVE_TO) {
            ...
            if (this.field_75648_a.onGround) {
               ...
               if (this.jumpDelay-- <= 0) {
                  this.jumpDelay = this.field_179925_i.getJumpDelay();
                  ...
                  this.field_75648_a.setAIMoveSpeed(0.0F);
               }
            } else {
               this.field_75648_a.setAIMoveSpeed((float)(this.speed * this.field_75648_a.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getValue()));
            }
