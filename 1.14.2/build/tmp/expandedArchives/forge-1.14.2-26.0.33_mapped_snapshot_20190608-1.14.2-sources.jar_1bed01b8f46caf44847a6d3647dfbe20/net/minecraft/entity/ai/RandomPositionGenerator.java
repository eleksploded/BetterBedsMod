...
public class RandomPositionGenerator {
   ...
   private static Vec3d generateRandomPos(CreatureEntity creature, int p_191379_1_, int p_191379_2_, @Nullable Vec3d p_191379_3_, boolean p_191379_4_, double p_191379_5_, ToDoubleFunction<BlockPos> p_191379_7_) {
      ...
      boolean flag;
      if (creature.func_213394_dL()) {
         flag = creature.func_213384_dI().func_218137_a(creature.getPositionVec(), (double)(creature.func_213391_dJ() + (float)p_191379_1_) + 1.0D);
      } else {
         flag = false;
      }
      ...
      for(int l = 0; l < 10; ++l) {
         ...
         if (blockpos != null) {
            ...
            if (creature.func_213394_dL() && p_191379_1_ > 1) {
               BlockPos blockpos1 = creature.func_213384_dI();
            ...
            if ((!flag || creature.func_213389_a(blockpos2)) && pathnavigator.canEntityStandOnPos(blockpos2)) {
               if (!p_191379_4_) {
   ...
   private static BlockPos moveAboveSolid(BlockPos p_191378_0_, CreatureEntity p_191378_1_) {
      if (!p_191378_1_.world.getBlockState(p_191378_0_).getMaterial().isSolid()) {
         ...
         BlockPos blockpos;
         for(blockpos = p_191378_0_.up(); blockpos.getY() < p_191378_1_.world.func_217301_I() && p_191378_1_.world.getBlockState(blockpos).getMaterial().isSolid(); blockpos = blockpos.up()) {
            ;
         }
