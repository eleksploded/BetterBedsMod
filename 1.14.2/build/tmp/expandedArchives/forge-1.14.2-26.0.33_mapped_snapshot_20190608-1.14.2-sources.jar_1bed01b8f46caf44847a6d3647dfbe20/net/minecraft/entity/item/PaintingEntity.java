...
public class PaintingEntity extends HangingEntity {
   ...
   public PaintingEntity(World worldIn, BlockPos pos, Direction facing) {
      ...
      for(PaintingType paintingtype : Registry.field_212620_i) {
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      p_213281_1_.putString("Motive", Registry.field_212620_i.getKey(this.art).toString());
   ...
   public void readAdditional(CompoundNBT compound) {
      this.art = Registry.field_212620_i.getOrDefault(ResourceLocation.tryCreate(compound.getString("Motive")));
