...
public class PolarBearEntity extends AnimalEntity {
   private static final DataParameter<Boolean> IS_STANDING = EntityDataManager.createKey(PolarBearEntity.class, DataSerializers.field_187198_h);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new PolarBearEntity.MeleeAttackGoal());
      this.field_70714_bg.addTask(1, new PolarBearEntity.PanicGoal());
      this.field_70714_bg.addTask(4, new FollowParentGoal(this, 1.25D));
      this.field_70714_bg.addTask(5, new RandomWalkingGoal(this, 1.0D));
      ...
      this.field_70715_bh.addTask(1, new PolarBearEntity.HurtByTargetGoal());
      this.field_70715_bh.addTask(2, new PolarBearEntity.AttackPlayerGoal());
      this.field_70715_bh.addTask(3, new NearestAttackableTargetGoal<>(this, FoxEntity.class, 10, true, true, (Predicate<LivingEntity>)null));
   }
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      ...
      if (biome != Biomes.FROZEN_OCEAN && biome != Biomes.DEEP_FROZEN_OCEAN) {
         ...
         return p_213380_1_.getLightSubtracted(blockpos, 0) > 8 && p_213380_1_.getBlockState(blockpos.down()).getBlock() == Blocks.ICE;
      }
   }
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      if (this.clientSideStandAnimation > 0.0F) {
         ...
         float f1 = 1.0F + f;
         return super.getSize(p_213305_1_).scale(1.0F, f1);
      } else {
   ...
   public float getStandingAnimationScale(float p_189795_1_) {
      return MathHelper.func_219799_g(p_189795_1_, this.clientSideStandAnimation0, this.clientSideStandAnimation) / 6.0F;
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      if (p_213386_4_ instanceof PolarBearEntity.GroupData) {
         this.setGrowingAge(-24000);
      } else {
         p_213386_4_ = new PolarBearEntity.GroupData();
      }
