...
public class FarmTask extends Task<VillagerEntity> {
   ...
   public FarmTask() {
      super(ImmutableMap.of(MemoryModuleType.field_220951_l, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220950_k, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220944_e, MemoryModuleStatus.VALUE_PRESENT));
   }

   protected boolean shouldExecute(ServerWorld worldIn, VillagerEntity owner) {
      if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(worldIn, owner)) {
         return false;
      } else if (owner.func_213700_eh().getProfession() != VillagerProfession.field_221156_f) {
         return false;
      } else {
         Set<BlockPos> set = owner.getBrain().getMemory(MemoryModuleType.field_220944_e).get().stream().map(GlobalPos::func_218180_b).collect(Collectors.toSet());
   ...
   protected void startExecuting(ServerWorld p_212831_1_, VillagerEntity p_212831_2_, long p_212831_3_) {
      if (p_212831_3_ > this.field_220425_d && this.field_220422_a != null) {
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220951_l, new BlockPosWrapper(this.field_220422_a));
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(new BlockPosWrapper(this.field_220422_a), 0.5F, 1));
      }
   ...
   protected void updateTask(ServerWorld p_212833_1_, VillagerEntity p_212833_2_, long p_212833_3_) {
      if (this.field_220426_e > 15 && this.field_220422_a != null && p_212833_3_ > this.field_220425_d) {
         ...
         if (block instanceof CropsBlock && ((CropsBlock)block).isMaxAge(blockstate) && this.field_220424_c) {
            p_212833_1_.destroyBlock(this.field_220422_a, true);
            ...
            for(int i = 0; i < inventory.getSizeInventory(); ++i) {
               ...
               if (!itemstack.isEmpty()) {
                  if (itemstack.getItem() == Items.WHEAT_SEEDS) {
                     ...
                     if (((net.minecraftforge.common.IPlantable)itemstack.getItem()).getPlantType(p_212833_1_, field_220422_a) == net.minecraftforge.common.PlantType.Crop) {
                        p_212833_1_.setBlockState(field_220422_a, ((net.minecraftforge.common.IPlantable)itemstack.getItem()).getPlant(p_212833_1_, field_220422_a),3);
                        flag = true;
                     }
                  }
               }
               ...
               if (flag) {
                  p_212833_1_.playSound((PlayerEntity)null, (double)this.field_220422_a.getX(), (double)this.field_220422_a.getY(), (double)this.field_220422_a.getZ(), SoundEvents.field_219626_bz, SoundCategory.BLOCKS, 1.0F, 1.0F);
                  itemstack.shrink(1);
                  if (itemstack.isEmpty()) {
