...
public class InteractWithDoorTask extends Task<LivingEntity> {
   public InteractWithDoorTask() {
      super(ImmutableMap.of(MemoryModuleType.field_220954_o, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.field_220955_p, MemoryModuleStatus.VALUE_PRESENT));
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      Path path = brain.getMemory(MemoryModuleType.field_220954_o).get();
      List<GlobalPos> list = brain.getMemory(MemoryModuleType.field_220955_p).get();
   ...
   private Set<BlockPos> func_220436_a(ServerWorld p_220436_1_, List<GlobalPos> p_220436_2_, List<BlockPos> p_220436_3_) {
      return p_220436_2_.stream().filter((p_220432_1_) -> {
         return p_220432_1_.func_218177_a() == p_220436_1_.getDimension().getType();
      }).map(GlobalPos::func_218180_b).filter(p_220436_3_::contains).collect(Collectors.toSet());
   }
