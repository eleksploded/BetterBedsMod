...
public class EvokerEntity extends SpellcastingIllagerEntity {
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new EvokerEntity.CastingSpellGoal());
      this.field_70714_bg.addTask(2, new AvoidEntityGoal<>(this, PlayerEntity.class, 8.0F, 0.6D, 1.0D));
      this.field_70714_bg.addTask(4, new EvokerEntity.SummonSpellGoal());
      this.field_70714_bg.addTask(5, new EvokerEntity.AttackSpellGoal());
      this.field_70714_bg.addTask(6, new EvokerEntity.WololoSpellGoal());
      ...
      this.field_70715_bh.addTask(3, new NearestAttackableTargetGoal<>(this, IronGolemEntity.class, false));
   }
   ...
   class AttackSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      private void spawnFangs(double p_190876_1_, double p_190876_3_, double p_190876_5_, double p_190876_7_, float p_190876_9_, int p_190876_10_) {
         ...
         while(true) {
            ...
            if (Block.func_220056_d(blockstate, EvokerEntity.this.world, blockpos1, Direction.UP)) {
         ...
         if (flag) {
            EvokerEntity.this.world.func_217376_c(new EvokerFangsEntity(EvokerEntity.this.world, p_190876_1_, (double)blockpos.getY() + d0, p_190876_3_, p_190876_9_, p_190876_10_, EvokerEntity.this));
         }
   ...
   class CastingSpellGoal extends SpellcastingIllagerEntity.CastingASpellGoal {
      ...
      public void tick() {
         if (EvokerEntity.this.getAttackTarget() != null) {
            EvokerEntity.this.getLookHelper().setLookPositionWithEntity(EvokerEntity.this.getAttackTarget(), (float)EvokerEntity.this.getHorizontalFaceSpeed(), (float)EvokerEntity.this.getVerticalFaceSpeed());
         } else if (EvokerEntity.this.getWololoTarget() != null) {
            EvokerEntity.this.getLookHelper().setLookPositionWithEntity(EvokerEntity.this.getWololoTarget(), (float)EvokerEntity.this.getHorizontalFaceSpeed(), (float)EvokerEntity.this.getVerticalFaceSpeed());
         }
   ...
   class SummonSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      private final EntityPredicate field_220843_e = (new EntityPredicate()).func_221013_a(16.0D).func_221014_c().func_221010_e().func_221008_a().func_221011_b();
      ...
      protected void castSpell() {
         for(int i = 0; i < 3; ++i) {
            ...
            EvokerEntity.this.world.func_217376_c(vexentity);
         }
   ...
   public class WololoSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      private final EntityPredicate field_220845_e = (new EntityPredicate()).func_221013_a(16.0D).func_221008_a().func_221012_a((p_220844_0_) -> {
