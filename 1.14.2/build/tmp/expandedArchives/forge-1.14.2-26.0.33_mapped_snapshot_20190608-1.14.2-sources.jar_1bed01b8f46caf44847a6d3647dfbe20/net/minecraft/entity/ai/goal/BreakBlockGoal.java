...
public class BreakBlockGoal extends MoveToBlockGoal {
   ...
   private boolean func_220729_m() {
      return this.destinationBlock != null && this.field_179495_c.world.isBlockLoaded(this.destinationBlock) && this.shouldMoveTo(this.field_179495_c.world, this.destinationBlock) ? true : this.searchForDestination();
   }
   ...
   public void tick() {
      ...
      if (this.getIsAboveDestination() && blockpos1 != null) {
         if (this.breakingTime > 0) {
            Vec3d vec3d = this.field_203118_g.getMotion();
            this.field_203118_g.setMotion(vec3d.x, 0.3D, vec3d.z);
            if (!world.isRemote) {
               double d0 = 0.08D;
         ...
         if (this.breakingTime % 2 == 0) {
            Vec3d vec3d1 = this.field_203118_g.getMotion();
            this.field_203118_g.setMotion(vec3d1.x, -0.3D, vec3d1.z);
