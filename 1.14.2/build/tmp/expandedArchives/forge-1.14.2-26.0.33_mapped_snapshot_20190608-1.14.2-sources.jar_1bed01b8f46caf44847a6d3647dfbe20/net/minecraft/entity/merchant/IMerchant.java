...
public interface IMerchant {
   ...
   void func_213704_a(MerchantOffer p_213704_1_);
   ...
   default void func_213707_a(PlayerEntity p_213707_1_, ITextComponent p_213707_2_, int p_213707_3_) {
      ...
      if (optionalint.isPresent()) {
         ...
         if (!merchantoffers.isEmpty()) {
            p_213707_1_.func_213818_a(optionalint.getAsInt(), merchantoffers, p_213707_3_, this.func_213708_dV(), this.func_213705_dZ());
         }
      }
