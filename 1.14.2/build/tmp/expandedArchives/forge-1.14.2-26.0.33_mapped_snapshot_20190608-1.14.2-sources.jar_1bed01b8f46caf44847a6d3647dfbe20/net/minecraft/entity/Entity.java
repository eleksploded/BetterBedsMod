...
public abstract class Entity extends net.minecraftforge.common.capabilities.CapabilityProvider<Entity> implements INameable, ICommandSource, net.minecraftforge.common.extensions.IForgeEntity {
   ...
   private int entityId = field_213331_b.incrementAndGet();
   ...
   protected static final DataParameter<Byte> FLAGS = EntityDataManager.createKey(Entity.class, DataSerializers.field_187191_a);
   private static final DataParameter<Integer> AIR = EntityDataManager.createKey(Entity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Optional<ITextComponent>> CUSTOM_NAME = EntityDataManager.createKey(Entity.class, DataSerializers.field_200544_f);
   private static final DataParameter<Boolean> CUSTOM_NAME_VISIBLE = EntityDataManager.createKey(Entity.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> SILENT = EntityDataManager.createKey(Entity.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> NO_GRAVITY = EntityDataManager.createKey(Entity.class, DataSerializers.field_187198_h);
   protected static final DataParameter<Pose> POSE = EntityDataManager.createKey(Entity.class, DataSerializers.field_218815_s);
   ...
   public Entity(EntityType<?> entityTypeIn, World worldIn) {
      ...
      this.world = worldIn;
      this.size = entityTypeIn.func_220334_j();
   ...
   public void move(MoverType p_213315_1_, Vec3d p_213315_2_) {
      if (this.noClip) {
         ...
         p_213315_2_ = this.func_213289_a(p_213315_2_, p_213315_1_);
         Vec3d vec3d = this.func_213306_e(p_213315_2_);
         ...
         if (blockstate.isAir(this.world, blockpos)) {
            ...
            if (block.isIn(BlockTags.field_219748_G) || block.isIn(BlockTags.field_219757_z) || block instanceof FenceGateBlock) {
         ...
         if (this.canTriggerWalking() && (!this.onGround || !this.isSneaking() || !(this instanceof PlayerEntity)) && !this.isPassenger()) {
            ...
            double d0 = vec3d.y;
            double d1 = vec3d.z;
            if (block1 != Blocks.LADDER && block1 != Blocks.field_222420_lI) {
               d0 = 0.0D;
            }
   ...
   protected Vec3d func_213289_a(Vec3d p_213289_1_, MoverType p_213289_2_) {
      if (this instanceof PlayerEntity && (p_213289_2_ == MoverType.SELF || p_213289_2_ == MoverType.PLAYER) && this.onGround && this.isSneaking()) {
         double d0 = p_213289_1_.x;
         double d1 = p_213289_1_.z;
         double d2 = 0.05D;
         ...
         p_213289_1_ = new Vec3d(d0, p_213289_1_.y, d1);
      }

      return p_213289_1_;
   }

   protected Vec3d func_213308_a(Vec3d p_213308_1_) {
   ...
   private Vec3d func_213306_e(Vec3d p_213306_1_) {
      AxisAlignedBB axisalignedbb = this.getBoundingBox();
      ISelectionContext iselectioncontext = ISelectionContext.forEntity(this);
      VoxelShape voxelshape = this.world.getWorldBorder().func_222521_a();
      ...
      AxisAlignedBB axisalignedbb1 = axisalignedbb.func_216361_a(p_213306_1_).grow(1.0E-7D);
      ...
      Vec3d vec3d = p_213306_1_.lengthSquared() == 0.0D ? p_213306_1_ : func_213313_a(p_213306_1_, axisalignedbb, this.world, iselectioncontext, reuseablestream);
      ...
      if (this.stepHeight > 0.0F && flag3 && (flag || flag2)) {
         Vec3d vec3d1 = func_213313_a(new Vec3d(p_213306_1_.x, (double)this.stepHeight, p_213306_1_.z), axisalignedbb, this.world, iselectioncontext, reuseablestream);
         Vec3d vec3d2 = func_213313_a(new Vec3d(0.0D, (double)this.stepHeight, 0.0D), axisalignedbb.expand(p_213306_1_.x, 0.0D, p_213306_1_.z), this.world, iselectioncontext, reuseablestream);
         if (vec3d2.y < (double)this.stepHeight) {
            Vec3d vec3d3 = func_213313_a(new Vec3d(p_213306_1_.x, 0.0D, p_213306_1_.z), axisalignedbb.offset(vec3d2), this.world, iselectioncontext, reuseablestream).add(vec3d2);
         ...
         if (func_213296_b(vec3d1) > func_213296_b(vec3d)) {
            return vec3d1.add(func_213313_a(new Vec3d(0.0D, -vec3d1.y + p_213306_1_.y, 0.0D), axisalignedbb.offset(vec3d1), this.world, iselectioncontext, reuseablestream));
         }
      }
   ...
   public static Vec3d func_213313_a(Vec3d p_213313_0_, AxisAlignedBB p_213313_1_, IWorldReader p_213313_2_, ISelectionContext p_213313_3_, ReuseableStream<VoxelShape> p_213313_4_) {
      double d0 = p_213313_0_.x;
      double d1 = p_213313_0_.y;
      double d2 = p_213313_0_.z;
      if (d1 != 0.0D) {
         d1 = VoxelShapes.func_216383_a(Direction.Axis.Y, p_213313_1_, p_213313_2_, d1, p_213313_3_, p_213313_4_.createStream());
         if (d1 != 0.0D) {
      ...
      if (flag && d2 != 0.0D) {
         d2 = VoxelShapes.func_216383_a(Direction.Axis.Z, p_213313_1_, p_213313_2_, d2, p_213313_3_, p_213313_4_.createStream());
         if (d2 != 0.0D) {
      ...
      if (d0 != 0.0D) {
         d0 = VoxelShapes.func_216383_a(Direction.Axis.X, p_213313_1_, p_213313_2_, d0, p_213313_3_, p_213313_4_.createStream());
         if (!flag && d0 != 0.0D) {
   ...
   public final boolean isImmuneToFire() {
      return this.getType().func_220338_c();
   }
   ...
   protected void doWaterSplashEffect() {
      ...
      for(int j = 0; (float)j < 1.0F + this.size.width * 20.0F; ++j) {
         ...
         this.world.addParticle(ParticleTypes.field_218422_X, this.posX + (double)f5, (double)(f2 + 1.0F), this.posZ + (double)f6, vec3d.x, vec3d.y, vec3d.z);
      }
   ...
   public float getPitch(float partialTicks) {
      return partialTicks == 1.0F ? this.rotationPitch : MathHelper.func_219799_g(partialTicks, this.prevRotationPitch, this.rotationPitch);
   }
   ...
   public float getYaw(float partialTicks) {
      return partialTicks == 1.0F ? this.rotationYaw : MathHelper.func_219799_g(partialTicks, this.prevRotationYaw, this.rotationYaw);
   }
   ...
   public Vec3d getEyePosition(float partialTicks) {
      if (partialTicks == 1.0F) {
         ...
         double d0 = MathHelper.func_219803_d((double)partialTicks, this.prevPosX, this.posX);
         double d1 = MathHelper.func_219803_d((double)partialTicks, this.prevPosY, this.posY) + (double)this.getEyeHeight();
         double d2 = MathHelper.func_219803_d((double)partialTicks, this.prevPosZ, this.posZ);
         return new Vec3d(d0, d1, d2);
      }
   }
   ...
   public RayTraceResult func_213324_a(double p_213324_1_, float p_213324_3_, boolean p_213324_4_) {
      ...
      return this.world.func_217299_a(new RayTraceContext(vec3d, vec3d2, RayTraceContext.BlockMode.OUTLINE, p_213324_4_ ? RayTraceContext.FluidMode.ANY : RayTraceContext.FluidMode.NONE, this));
   }
   ...
   protected abstract void writeAdditional(CompoundNBT p_213281_1_);
   ...
   protected boolean func_213298_c(Pose p_213298_1_) {
      return this.world.isCollisionBoxesEmpty(this, this.func_213321_d(p_213298_1_));
   }
   ...
   public final void teleportKeepLoaded(double p_223102_1_, double p_223102_3_, double p_223102_5_) {
      if (this.world instanceof ServerWorld) {
         ...
         ((ServerWorld)this.world).getChunkProvider().func_217228_a(TicketType.field_223185_g, chunkpos, 0, this.getEntityId());
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      return this.type.func_220334_j();
   }
