...
public class StayNearPointTask extends Task<VillagerEntity> {
   ...
   public StayNearPointTask(MemoryModuleType<GlobalPos> p_i51501_1_, float p_i51501_2_, int p_i51501_3_, int p_i51501_4_, int p_i51501_5_) {
      super(ImmutableMap.of(MemoryModuleType.field_223021_x, MemoryModuleStatus.REGISTERED, MemoryModuleType.field_220950_k, MemoryModuleStatus.VALUE_ABSENT, p_i51501_1_, MemoryModuleStatus.VALUE_PRESENT));
      ...
      brain.getMemory(this.field_220548_a).ifPresent((p_220545_4_) -> {
         if (!this.func_220546_a(p_212831_1_, p_212831_2_, p_220545_4_) && !this.func_223017_a(p_212831_1_, p_212831_2_)) {
            if (!this.func_220547_b(p_212831_1_, p_212831_2_, p_220545_4_)) {
               brain.setMemory(MemoryModuleType.field_220950_k, new WalkTarget(p_220545_4_.func_218180_b(), this.field_220549_b, this.field_220550_c));
            }
         } else {
   ...
   private boolean func_223017_a(ServerWorld p_223017_1_, VillagerEntity p_223017_2_) {
      Optional<Long> optional = p_223017_2_.getBrain().getMemory(MemoryModuleType.field_223021_x);
   ...
   private boolean func_220546_a(ServerWorld p_220546_1_, VillagerEntity p_220546_2_, GlobalPos p_220546_3_) {
      return p_220546_3_.func_218177_a() != p_220546_1_.getDimension().getType() || p_220546_3_.func_218180_b().manhattanDistance(new BlockPos(p_220546_2_)) > this.field_220551_d;
   }

   private boolean func_220547_b(ServerWorld p_220547_1_, VillagerEntity p_220547_2_, GlobalPos p_220547_3_) {
      return p_220547_3_.func_218177_a() == p_220547_1_.getDimension().getType() && p_220547_3_.func_218180_b().manhattanDistance(new BlockPos(p_220547_2_)) <= this.field_220550_c;
   }
}