...
public class PigEntity extends AnimalEntity {
   private static final DataParameter<Boolean> SADDLED = EntityDataManager.createKey(PigEntity.class, DataSerializers.field_187198_h);
   private static final DataParameter<Integer> BOOST_TIME = EntityDataManager.createKey(PigEntity.class, DataSerializers.field_187192_b);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new PanicGoal(this, 1.25D));
      this.field_70714_bg.addTask(3, new BreedGoal(this, 1.0D));
      this.field_70714_bg.addTask(4, new TemptGoal(this, 1.2D, Ingredient.fromItems(Items.CARROT_ON_A_STICK), false));
      this.field_70714_bg.addTask(4, new TemptGoal(this, 1.2D, false, TEMPTATION_ITEMS));
      this.field_70714_bg.addTask(5, new FollowParentGoal(this, 1.1D));
      this.field_70714_bg.addTask(6, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
   ...
   public void onStruckByLightning(LightningBoltEntity lightningBolt) {
      ...
      this.world.func_217376_c(zombiepigmanentity);
      this.remove();
   }
