...
public class TradeTask extends Task<VillagerEntity> {
   ...
   private void func_220475_a(VillagerEntity p_220475_1_) {
      ...
      brain.setMemory(MemoryModuleType.field_220950_k, new WalkTarget(entityposwrapper, this.field_220476_a, 2));
      brain.setMemory(MemoryModuleType.field_220951_l, entityposwrapper);
   }
}