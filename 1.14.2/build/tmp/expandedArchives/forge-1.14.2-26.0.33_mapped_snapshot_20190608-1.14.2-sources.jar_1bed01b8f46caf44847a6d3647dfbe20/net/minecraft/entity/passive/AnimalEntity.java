...
public abstract class AnimalEntity extends AgeableEntity {
   ...
   protected AnimalEntity(EntityType<? extends AnimalEntity> type, World p_i48568_2_) {
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      ...
      return p_213380_1_.getBlockState(blockpos.down()).getBlock() == this.spawnableBlock && p_213380_1_.getLightSubtracted(blockpos, 0) > 8 && super.canSpawn(p_213380_1_, p_213380_2_);
   }
