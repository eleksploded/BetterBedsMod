...
public abstract class ContainerMinecartEntity extends AbstractMinecartEntity implements IInventory, INamedContainerProvider {
   ...
   public void addLoot(@Nullable PlayerEntity player) {
      if (this.lootTable != null && this.world.getServer() != null) {
         ...
         this.lootTable = null;
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withParameter(LootParameters.field_216286_f, new BlockPos(this)).withSeed(this.lootTableSeed);
         ...
         lootcontext$builder.withParameter(LootParameters.field_216284_d, this);
         if (player != null) {
            lootcontext$builder.withLuck(player.getLuck()).withParameter(LootParameters.field_216281_a, player);
         }

         loottable.func_216118_a(this, lootcontext$builder.build(LootParameterSets.field_216261_b));
      }
