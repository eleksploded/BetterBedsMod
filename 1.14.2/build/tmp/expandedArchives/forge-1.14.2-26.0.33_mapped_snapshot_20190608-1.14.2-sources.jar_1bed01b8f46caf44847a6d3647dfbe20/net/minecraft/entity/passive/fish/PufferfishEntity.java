...
public class PufferfishEntity extends AbstractFishEntity {
   private static final DataParameter<Integer> PUFF_STATE = EntityDataManager.createKey(PufferfishEntity.class, DataSerializers.field_187192_b);
   ...
   protected void initEntityAI() {
      super.initEntityAI();
      this.field_70714_bg.addTask(1, new PufferfishEntity.PuffGoal(this));
   }
   ...
   private void attack(MobEntity p_205719_1_) {
      ...
      if (p_205719_1_.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(1 + i))) {
         p_205719_1_.addPotionEffect(new EffectInstance(Effects.field_76436_u, 60 * i, 0));
   ...
   public void onCollideWithPlayer(PlayerEntity entityIn) {
      ...
      if (entityIn instanceof ServerPlayerEntity && i > 0 && entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(1 + i))) {
         ...
         entityIn.addPotionEffect(new EffectInstance(Effects.field_76436_u, 60 * i, 0));
      }
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      return super.getSize(p_213305_1_).scale(func_213806_q(this.getPuffState()));
   }
   ...
   static class PuffGoal extends Goal {
      ...
      public boolean shouldExecute() {
         List<LivingEntity> list = this.field_203789_a.world.getEntitiesWithinAABB(LivingEntity.class, this.field_203789_a.getBoundingBox().grow(2.0D), PufferfishEntity.ENEMY_MATCHER);
         return !list.isEmpty();
      }
