...
public abstract class MobEntity extends LivingEntity {
   private static final DataParameter<Byte> AI_FLAGS = EntityDataManager.createKey(MobEntity.class, DataSerializers.field_187191_a);
   ...
   private BlockPos field_213401_bK = BlockPos.ZERO;
   private float field_213402_bL = -1.0F;

   protected MobEntity(EntityType<? extends MobEntity> type, World worldIn) {
      super(type, worldIn);
      this.field_70714_bg = new GoalSelector(worldIn != null && worldIn.getProfiler() != null ? worldIn.getProfiler() : null);
      this.field_70715_bh = new GoalSelector(worldIn != null && worldIn.getProfiler() != null ? worldIn.getProfiler() : null);
      ...
      this.field_70762_j = this.createBodyHelper();
      this.field_70699_by = this.createNavigator(worldIn);
   ...
   protected void registerAttributes() {
      ...
      this.getAttributeMap().registerAttribute(SharedMonsterAttributes.field_221120_g);
   }
   ...
   public LookController getLookHelper() {
   ...
   public JumpController getJumpHelper() {
   ...
   protected float updateDistance(float p_110146_1_, float p_110146_2_) {
      this.field_70762_j.updateRenderAngles();
      return p_110146_2_;
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Leash", 10)) {
         this.field_110170_bx = compound.getCompound("Leash");
      }
   ...
   protected void checkDespawn() {
      if (!this.isNoDespawnRequired() && !this.func_213392_I()) {
         Entity entity = this.world.func_217362_a(this, -1.0D);
         ...
         if (entity != null) {
            ...
            if (this.idleTime > 600 && this.rand.nextInt(800) == 0 && d0 > 1024.0D && this.func_213397_c(d0)) {
               this.remove();
            } else if (d0 < 1024.0D) {
               this.idleTime = 0;
            }
   ...
   protected void func_213387_K() {
      DebugPacketSender.func_218800_a(this.world, this, this.field_70714_bg);
   }
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      return this.canSpawn(p_213380_1_, p_213380_2_, new BlockPos(this));
   }

   protected boolean canSpawn(IWorld p_213393_1_, SpawnReason p_213393_2_, BlockPos p_213393_3_) {
      BlockPos blockpos = p_213393_3_.down();
      return p_213393_2_ == SpawnReason.SPAWNER || p_213393_1_.getBlockState(blockpos).canEntitySpawn(p_213393_1_, blockpos, this.getType());
   }
   ...
   protected void func_213333_a(DamageSource p_213333_1_, int p_213333_2_, boolean p_213333_3_) {
      ...
      for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
         ...
         boolean flag = f > 1.0F;
         if (!itemstack.isEmpty() && !EnchantmentHelper.hasVanishingCurse(itemstack) && (p_213333_3_ || flag) && this.rand.nextFloat() - (float)p_213333_2_ * 0.01F < f) {
   ...
   public final boolean processInitialInteract(PlayerEntity player, Hand hand) {
      if (!this.isAlive()) {
         ...
         this.clearLeashed(true, !player.playerAbilities.isCreativeMode);
         return true;
      } else {
   ...
   public boolean func_213389_a(BlockPos p_213389_1_) {
      if (this.field_213402_bL == -1.0F) {
         ...
         return this.field_213401_bK.distanceSq(p_213389_1_) < (double)(this.field_213402_bL * this.field_213402_bL);
      }
   }

   public void func_213390_a(BlockPos p_213390_1_, int p_213390_2_) {
      this.field_213401_bK = p_213390_1_;
      this.field_213402_bL = (float)p_213390_2_;
   }
   ...
   public void clearLeashed(boolean sendPacket, boolean dropLead) {
      if (this.leashHolder != null) {
         ...
         if (!this.world.isRemote && sendPacket && this.world instanceof ServerWorld) {
            ((ServerWorld)this.world).getChunkProvider().func_217218_b(this, new SMountEntityPacket(this, (Entity)null));
         }
      }
   ...
   public void setLeashHolder(Entity entityIn, boolean sendAttachNotification) {
      ...
      if (!this.world.isRemote && sendAttachNotification && this.world instanceof ServerWorld) {
         ((ServerWorld)this.world).getChunkProvider().func_217218_b(this, new SMountEntityPacket(this, this.leashHolder));
      }
   ...
   private void recreateLeash() {
      if (this.field_110170_bx != null && this.world instanceof ServerWorld) {
         if (this.field_110170_bx.hasUniqueId("UUID")) {
            UUID uuid = this.field_110170_bx.getUniqueId("UUID");
            Entity entity = ((ServerWorld)this.world).func_217461_a(uuid);
            if (entity != null) {
               this.setLeashHolder(entity, true);
            }
         } else if (this.field_110170_bx.contains("X", 99) && this.field_110170_bx.contains("Y", 99) && this.field_110170_bx.contains("Z", 99)) {
            BlockPos blockpos = new BlockPos(this.field_110170_bx.getInt("X"), this.field_110170_bx.getInt("Y"), this.field_110170_bx.getInt("Z"));
   ...
   public boolean canAttack(LivingEntity p_213336_1_) {
      return p_213336_1_.getType() == EntityType.PLAYER && ((PlayerEntity)p_213336_1_).playerAbilities.disableDamage ? false : super.canAttack(p_213336_1_);
   }
