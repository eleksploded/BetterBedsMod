...
public class WalkTowardsRandomSecondaryPosTask extends Task<VillagerEntity> {
   ...
   public WalkTowardsRandomSecondaryPosTask(MemoryModuleType<List<GlobalPos>> p_i50340_1_, float p_i50340_2_, int p_i50340_3_, int p_i50340_4_, MemoryModuleType<GlobalPos> p_i50340_5_) {
      super(ImmutableMap.of(MemoryModuleType.field_220950_k, MemoryModuleStatus.REGISTERED, p_i50340_1_, MemoryModuleStatus.VALUE_PRESENT, p_i50340_5_, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, VillagerEntity owner) {
      ...
      if (optional.isPresent() && optional1.isPresent()) {
         ...
         if (!list.isEmpty()) {
            ...
            return this.field_220579_g != null && Objects.equals(worldIn.getDimension().getType(), this.field_220579_g.func_218177_a()) && optional1.get().func_218180_b().func_218137_a(owner.getPositionVec(), (double)this.field_220577_e);
         }
      }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, VillagerEntity p_212831_2_, long p_212831_3_) {
      if (p_212831_3_ > this.field_220578_f && this.field_220579_g != null) {
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(this.field_220579_g.func_218180_b(), this.field_220575_c, this.field_220576_d));
