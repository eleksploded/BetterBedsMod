...
public abstract class TargetGoal extends Goal {
   ...
   protected LivingEntity field_188509_g;
      ...
      if (livingentity == null) {
         ...
         if (team != null && team1 == team) {
            ...
            if (this.field_75299_d.getDistanceSq(livingentity) > d0 * d0) {
               ...
               if (livingentity instanceof PlayerEntity && ((PlayerEntity)livingentity).playerAbilities.disableDamage) {
                  return false;
               } else {
   ...
   protected boolean func_220777_a(@Nullable LivingEntity p_220777_1_, EntityPredicate p_220777_2_) {
      if (p_220777_1_ == null) {
         ...
         return false;
      } else if (!this.field_75299_d.func_213389_a(new BlockPos(p_220777_1_))) {
         return false;
      } else {
         if (this.nearbyOnly) {
