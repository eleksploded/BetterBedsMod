...
public class LlamaSpitEntity extends Entity implements IProjectile {
   ...
   public void tick() {
      ...
      RayTraceResult raytraceresult = ProjectileHelper.func_221267_a(this, this.getBoundingBox().func_216361_a(vec3d).grow(1.0D), (p_213879_1_) -> {
   ...
   public void onHit(RayTraceResult p_190536_1_) {
      ...
      if (raytraceresult$type == RayTraceResult.Type.ENTITY && this.field_190539_a != null) {
         ((EntityRayTraceResult)p_190536_1_).getEntity().attackEntityFrom(DamageSource.causeIndirectDamage(this, this.field_190539_a).setProjectile(), 1.0F);
   ...
   protected void readAdditional(CompoundNBT compound) {
      if (compound.contains("Owner", 10)) {
         this.field_190540_b = compound.getCompound("Owner");
      }
