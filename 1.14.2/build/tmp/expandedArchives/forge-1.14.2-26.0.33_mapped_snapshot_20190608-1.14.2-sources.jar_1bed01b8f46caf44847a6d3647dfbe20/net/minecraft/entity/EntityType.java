...
public class EntityType<T extends Entity> extends net.minecraftforge.registries.ForgeRegistryEntry<EntityType<?>> {
   ...
   public static final EntityType<CatEntity> field_220360_g = register("cat", EntityType.Builder.create(CatEntity::new, EntityClassification.CREATURE).size(0.6F, 0.7F));
   ...
   public static final EntityType<FoxEntity> field_220356_B = register("fox", EntityType.Builder.create(FoxEntity::new, EntityClassification.CREATURE).size(0.6F, 0.7F));
   ...
   public static final EntityType<PandaEntity> field_220353_aa = register("panda", EntityType.Builder.create(PandaEntity::new, EntityClassification.CREATURE).size(1.3F, 1.25F));
   ...
   public static final EntityType<TraderLlamaEntity> field_220354_ax = register("trader_llama", EntityType.Builder.create(TraderLlamaEntity::new, EntityClassification.CREATURE).size(0.9F, 1.87F));
   ...
   public static final EntityType<PillagerEntity> field_220350_aJ = register("pillager", EntityType.Builder.create(PillagerEntity::new, EntityClassification.MONSTER).size(0.6F, 1.95F));
   public static final EntityType<WanderingTraderEntity> field_220351_aK = register("wandering_trader", EntityType.Builder.create(WanderingTraderEntity::new, EntityClassification.CREATURE).size(0.6F, 1.95F));
   ...
   public static final EntityType<RavagerEntity> field_220352_aU = register("ravager", EntityType.Builder.create(RavagerEntity::new, EntityClassification.MONSTER).size(1.95F, 2.2F));
   ...
   public static ResourceLocation getId(EntityType<?> entityTypeIn) {
      return Registry.field_212629_r.getKey(entityTypeIn);
   }

   public static Optional<EntityType<?>> func_220327_a(String p_220327_0_) {
      return Registry.field_212629_r.func_218349_b(ResourceLocation.tryCreate(p_220327_0_));
   }
   ...
   public EntityType(IFactory<T> p_i50385_1_, EntityClassification p_i50385_2_, boolean p_i50385_3_, boolean p_i50385_4_, boolean p_i50385_5_, @Nullable Type<?> p_i50385_6_, EntitySize p_i50385_7_, final java.util.function.Predicate<EntityType<?>> velocityUpdateSupplier, final java.util.function.ToIntFunction<EntityType<?>> trackingRangeSupplier, final java.util.function.ToIntFunction<EntityType<?>> updateIntervalSupplier, final java.util.function.BiFunction<net.minecraftforge.fml.network.FMLPlayMessages.SpawnEntity, World, T> customClientFactory) {
      this.factory = p_i50385_1_;
      this.classification = p_i50385_2_;
      this.serializable = p_i50385_3_;
      this.summonable = p_i50385_4_;
      this.immuneToFire = p_i50385_5_;
      this.dataType = p_i50385_6_;
      this.size = p_i50385_7_;
   ...
   public Entity func_220331_a(World p_220331_1_, @Nullable ItemStack p_220331_2_, @Nullable PlayerEntity p_220331_3_, BlockPos p_220331_4_, SpawnReason p_220331_5_, boolean p_220331_6_, boolean p_220331_7_) {
      return this.func_220342_a(p_220331_1_, p_220331_2_ == null ? null : p_220331_2_.getTag(), p_220331_2_ != null && p_220331_2_.hasDisplayName() ? p_220331_2_.getDisplayName() : null, p_220331_3_, p_220331_4_, p_220331_5_, p_220331_6_, p_220331_7_);
   }
   ...
   public T func_220342_a(World p_220342_1_, @Nullable CompoundNBT p_220342_2_, @Nullable ITextComponent p_220342_3_, @Nullable PlayerEntity p_220342_4_, BlockPos p_220342_5_, SpawnReason p_220342_6_, boolean p_220342_7_, boolean p_220342_8_) {
      ...
      if (t instanceof net.minecraft.entity.MobEntity && net.minecraftforge.event.ForgeEventFactory.doSpecialSpawn((net.minecraft.entity.MobEntity) t, p_220342_1_, p_220342_5_.getX(), p_220342_5_.getY(), p_220342_5_.getZ(), null)) return null;
   ...
   protected static double func_208051_a(IWorldReader p_208051_0_, BlockPos p_208051_1_, boolean p_208051_2_, AxisAlignedBB p_208051_3_) {
      ...
      Stream<VoxelShape> stream = p_208051_0_.getCollisionShapes((Entity)null, axisalignedbb, Collections.emptySet());
   ...
   public EntityClassification getClassiciation() {
      return this.classification;
   }

   public String getTranslationKey() {
      if (this.translationKey == null) {
         this.translationKey = Util.makeTranslationKey("entity", Registry.field_212629_r.getKey(this));
      }
   ...
   public ResourceLocation getLootTable() {
      if (this.lootTable == null) {
         ResourceLocation resourcelocation = Registry.field_212629_r.getKey(this);
   ...
   public static Entity create(int id, World worldIn) {
      return create(worldIn, Registry.field_212629_r.getByValue(id));
   }
   ...
   public static Optional<EntityType<?>> func_220347_a(CompoundNBT p_220347_0_) {
      return Registry.field_212629_r.func_218349_b(new ResourceLocation(p_220347_0_.getString("id")));
   }
   ...
   public boolean func_220341_a(Tag<EntityType<?>> p_220341_1_) {
