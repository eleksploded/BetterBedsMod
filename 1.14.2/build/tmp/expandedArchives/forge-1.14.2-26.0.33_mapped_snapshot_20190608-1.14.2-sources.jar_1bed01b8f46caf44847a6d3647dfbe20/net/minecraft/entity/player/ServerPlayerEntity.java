...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener {
   ...
   public ServerPlayerEntity(MinecraftServer server, ServerWorld worldIn, GameProfile profile, PlayerInteractionManager interactionManagerIn) {
      ...
      this.field_147103_bO = server.getPlayerList().getPlayerStats(this);
   ...
   public void tick() {
      ...
      if (entity != this) {
         if (entity.isAlive()) {
            ...
            this.getServerWorld().getChunkProvider().func_217221_a(this);
            if (this.isSneaking()) {
   ...
   public Entity changeDimension(DimensionType destination) {
      ...
      if (dimensiontype == DimensionType.THE_END && destination == DimensionType.OVERWORLD) {
         this.func_213319_R();
         this.getServerWorld().func_217434_e(this);
         ...
         this.connection.sendPacket(new SPlayerAbilitiesPacket(this.playerAbilities));
   ...
   public Either<PlayerEntity.SleepResult, Unit> func_213819_a(BlockPos p_213819_1_) {
      return super.func_213819_a(p_213819_1_).ifRight((p_213849_1_) -> {
   ...
   public void wakeUpPlayer(boolean immediately, boolean updateWorldFlag, boolean setSpawn) {
      if (this.isPlayerSleeping()) {
         this.getServerWorld().getChunkProvider().func_217216_a(this, new SAnimateHandPacket(this, 2));
      }
   ...
   public boolean isInvulnerableTo(DamageSource source) {
      return super.isInvulnerableTo(source) || this.isInvulnerableDimensionChange() || this.playerAbilities.disableDamage && source == DamageSource.WITHER;
   }
   ...
   public void addStat(Stat<?> stat, int amount) {
      this.field_147103_bO.increment(this, stat, amount);
   ...
   public void takeStat(Stat<?> stat) {
      this.field_147103_bO.setValue(this, stat, 0);
   ...
   public void unlockRecipes(ResourceLocation[] p_193102_1_) {
      ...
      for(ResourceLocation resourcelocation : p_193102_1_) {
         this.server.getRecipeManager().func_215367_a(resourcelocation).ifPresent(list::add);
      }
   ...
   protected void onNewPotionEffect(EffectInstance id) {
      ...
      if (id.getPotion() == Effects.field_188424_y) {
   ...
   protected void onFinishedPotionEffect(EffectInstance effect) {
      ...
      if (effect.getPotion() == Effects.field_188424_y) {
   ...
   public void onCriticalHit(Entity entityHit) {
      this.getServerWorld().getChunkProvider().func_217216_a(this, new SAnimateHandPacket(entityHit, 4));
   }

   public void onEnchantmentCritical(Entity entityHit) {
      this.getServerWorld().getChunkProvider().func_217216_a(this, new SAnimateHandPacket(entityHit, 5));
   }
   ...
   public void handleClientSettings(CClientSettingsPacket packetIn) {
      ...
      this.field_71143_cn = packetIn.getChatVisibility();
