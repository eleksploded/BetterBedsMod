...
public class SkeletonHorseEntity extends AbstractHorseEntity {
   private final TriggerSkeletonTrapGoal field_184792_bN = new TriggerSkeletonTrapGoal(this);
   ...
   public void setTrap(boolean trap) {
      if (trap != this.skeletonTrap) {
         ...
         if (trap) {
            this.field_70714_bg.addTask(1, this.field_184792_bN);
         } else {
            this.field_70714_bg.removeTask(this.field_184792_bN);
         }
