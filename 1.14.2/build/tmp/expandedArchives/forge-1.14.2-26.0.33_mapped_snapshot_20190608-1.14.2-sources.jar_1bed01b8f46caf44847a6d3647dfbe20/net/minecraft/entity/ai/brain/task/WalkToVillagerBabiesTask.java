...
public class WalkToVillagerBabiesTask extends Task<CreatureEntity> {
   public WalkToVillagerBabiesTask() {
      super(ImmutableMap.of(MemoryModuleType.field_220947_h, MemoryModuleStatus.VALUE_PRESENT, MemoryModuleType.field_220950_k, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220951_l, MemoryModuleStatus.REGISTERED, MemoryModuleType.field_220952_m, MemoryModuleStatus.REGISTERED));
   }
   ...
   private void func_220508_a(ServerWorld p_220508_1_, CreatureEntity p_220508_2_, LivingEntity p_220508_3_) {
      for(int i = 0; i < 10; ++i) {
         ...
         if (vec3d != null && p_220508_1_.func_217483_b_(new BlockPos(vec3d))) {
            p_220508_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(vec3d, 0.6F, 0));
            return;
         }
      }
   ...
   private static void func_220498_a(CreatureEntity p_220498_0_, LivingEntity p_220498_1_) {
      ...
      brain.setMemory(MemoryModuleType.field_220952_m, p_220498_1_);
      brain.setMemory(MemoryModuleType.field_220951_l, new EntityPosWrapper(p_220498_1_));
      brain.setMemory(MemoryModuleType.field_220950_k, new WalkTarget(new EntityPosWrapper(p_220498_1_), 0.6F, 1));
   }
   ...
   private List<LivingEntity> func_220503_d(CreatureEntity p_220503_1_) {
      return p_220503_1_.getBrain().getMemory(MemoryModuleType.field_220947_h).get();
   }

   private LivingEntity func_220495_a(LivingEntity p_220495_1_) {
      return p_220495_1_.getBrain().getMemory(MemoryModuleType.field_220952_m).get();
   }

   @Nullable
   private LivingEntity func_220500_b(LivingEntity p_220500_1_) {
      return p_220500_1_.getBrain().getMemory(MemoryModuleType.field_220947_h).get().stream().filter((p_220507_2_) -> {
   ...
   private boolean func_220502_c(LivingEntity p_220502_1_) {
      return p_220502_1_.getBrain().getMemory(MemoryModuleType.field_220952_m).isPresent();
   }

   private boolean func_220499_a(LivingEntity p_220499_1_, LivingEntity p_220499_2_) {
      return p_220499_2_.getBrain().getMemory(MemoryModuleType.field_220952_m).filter((p_220496_1_) -> {
         return p_220496_1_ == p_220499_1_;
      }).isPresent();
   }

   private boolean func_220501_e(CreatureEntity p_220501_1_) {
      return p_220501_1_.getBrain().hasMemory(MemoryModuleType.field_220947_h);
   }
}