...
public abstract class HangingEntity extends Entity {
   ...
   @Nullable
   public Direction field_174860_b;
   ...
   protected void updateBoundingBox() {
      if (this.field_174860_b != null) {
         ...
         d0 = d0 - (double)this.field_174860_b.getXOffset() * 0.46875D;
         d2 = d2 - (double)this.field_174860_b.getZOffset() * 0.46875D;
         d1 = d1 + d5;
         Direction direction = this.field_174860_b.rotateYCCW();
         ...
         if (this.field_174860_b.getAxis() == Direction.Axis.Z) {
            d8 = 1.0D;
         } else {
            d6 = 1.0D;
         }
      ...
      if (!this.world.areCollisionShapesEmpty(this)) {
         ...
         for(int k = 0; k < i; ++k) {
            for(int l = 0; l < j; ++l) {
               ...
               if (net.minecraft.block.Block.func_220055_a(this.world, blockpos$mutableblockpos, this.field_174860_b))
                  continue;
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      p_213281_1_.putByte("Facing", (byte)this.field_174860_b.getHorizontalIndex());
   ...
   public ItemEntity entityDropItem(ItemStack stack, float offsetY) {
      ItemEntity itementity = new ItemEntity(this.world, this.posX + (double)((float)this.field_174860_b.getXOffset() * 0.15F), this.posY + (double)offsetY, this.posZ + (double)((float)this.field_174860_b.getZOffset() * 0.15F), stack);
   ...
   public float getRotatedYaw(Rotation transformRotation) {
      if (this.field_174860_b != null && this.field_174860_b.getAxis() != Direction.Axis.Y) {
         switch(transformRotation) {
         case CLOCKWISE_180:
            this.field_174860_b = this.field_174860_b.getOpposite();
            break;
         case COUNTERCLOCKWISE_90:
            this.field_174860_b = this.field_174860_b.rotateYCCW();
            break;
         case CLOCKWISE_90:
            this.field_174860_b = this.field_174860_b.rotateY();
         }
      }
   ...
   public float getMirroredYaw(Mirror transformMirror) {
      return this.getRotatedYaw(transformMirror.toRotation(this.field_174860_b));
   }
