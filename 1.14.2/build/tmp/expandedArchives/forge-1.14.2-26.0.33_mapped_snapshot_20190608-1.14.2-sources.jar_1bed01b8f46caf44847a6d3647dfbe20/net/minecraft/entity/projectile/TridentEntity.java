...
public class TridentEntity extends AbstractArrowEntity {
   private static final DataParameter<Byte> LOYALTY_LEVEL = EntityDataManager.createKey(TridentEntity.class, DataSerializers.field_187191_a);
   ...
   public void tick() {
      ...
      if ((this.dealtDamage || this.func_203047_q()) && entity != null) {
         ...
         if (i > 0 && !this.shouldReturnToThrower()) {
            if (!this.world.isRemote && this.field_70251_a == AbstractArrowEntity.PickupStatus.ALLOWED) {
   ...
   protected void func_213868_a(EntityRayTraceResult p_213868_1_) {
      ...
      if (this.world instanceof ServerWorld && this.world.isThundering() && EnchantmentHelper.hasChanneling(this.thrownStack)) {
         ...
         if (this.world.func_217337_f(blockpos)) {
            ...
            ((ServerWorld)this.world).func_217468_a(lightningboltentity);
