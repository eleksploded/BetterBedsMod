...
public class ItemFrameEntity extends HangingEntity {
   ...
   private static final DataParameter<ItemStack> ITEM = EntityDataManager.createKey(ItemFrameEntity.class, DataSerializers.field_187196_f);
   private static final DataParameter<Integer> ROTATION = EntityDataManager.createKey(ItemFrameEntity.class, DataSerializers.field_187192_b);
   ...
   protected void updateBoundingBox() {
      if (this.field_174860_b != null) {
         double d0 = 0.46875D;
         this.posX = (double)this.hangingPosition.getX() + 0.5D - (double)this.field_174860_b.getXOffset() * 0.46875D;
         this.posY = (double)this.hangingPosition.getY() + 0.5D - (double)this.field_174860_b.getYOffset() * 0.46875D;
         this.posZ = (double)this.hangingPosition.getZ() + 0.5D - (double)this.field_174860_b.getZOffset() * 0.46875D;
         double d1 = (double)this.getWidthPixels();
         double d2 = (double)this.getHeightPixels();
         double d3 = (double)this.getWidthPixels();
         Direction.Axis direction$axis = this.field_174860_b.getAxis();
   ...
   public boolean onValidSurface() {
      if (!this.world.areCollisionShapesEmpty(this)) {
         ...
         BlockState blockstate = this.world.getBlockState(this.hangingPosition.offset(this.field_174860_b.getOpposite()));
         return blockstate.getMaterial().isSolid() || this.field_174860_b.getAxis().isHorizontal() && RedstoneDiodeBlock.isDiode(blockstate) ? this.world.getEntitiesInAABBexcluding(this, this.getBoundingBox(), IS_HANGING_ENTITY).isEmpty() : false;
      }
   }
   ...
   public void dropItemOrSelf(@Nullable Entity entityIn, boolean p_146065_2_) {
      if (!this.world.getGameRules().getBoolean("doEntityDrops")) {
         ...
         if (entityIn instanceof PlayerEntity) {
            ...
            if (playerentity.playerAbilities.isCreativeMode) {
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.putByte("Facing", (byte)this.field_174860_b.getIndex());
   }
   ...
   public IPacket<?> createSpawnPacket() {
      return new SSpawnObjectPacket(this, this.getType(), this.field_174860_b.getIndex(), this.getHangingPosition());
   }
}