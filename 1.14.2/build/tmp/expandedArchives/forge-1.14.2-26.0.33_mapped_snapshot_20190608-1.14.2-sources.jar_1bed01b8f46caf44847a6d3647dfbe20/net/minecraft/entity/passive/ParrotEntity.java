...
public class ParrotEntity extends ShoulderRidingEntity implements IFlyingAnimal {
   private static final DataParameter<Integer> VARIANT = EntityDataManager.createKey(ParrotEntity.class, DataSerializers.field_187192_b);
   ...
   private static final Map<EntityType<?>, SoundEvent> IMITATION_SOUND_EVENTS = Util.make(Maps.newHashMap(), (p_200609_0_) -> {
      ...
      p_200609_0_.put(EntityType.GUARDIAN, SoundEvents.field_219654_hI);
      ...
      p_200609_0_.put(EntityType.field_220353_aa, SoundEvents.field_219655_hM);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(2, new FollowOwnerFlyingGoal(this, 1.0D, 5.0F, 1.0F));
      this.field_70714_bg.addTask(2, new WaterAvoidingRandomFlyingGoal(this, 1.0D));
      this.field_70714_bg.addTask(3, new LandOnOwnersShoulderGoal(this));
      this.field_70714_bg.addTask(3, new FollowMobGoal(this, 1.0D, 3.0F, 7.0F));
   }
   ...
   public void livingTick() {
      ...
      if (this.jukeboxPosition == null || !this.jukeboxPosition.func_218137_a(this.getPositionVec(), 3.46D) || this.world.getBlockState(this.jukeboxPosition).getBlock() != Blocks.JUKEBOX) {
   ...
   public boolean processInteract(PlayerEntity player, Hand hand) {
      ...
      if (!this.isTamed() && TAME_ITEMS.contains(itemstack.getItem())) {
         ...
         this.addPotionEffect(new EffectInstance(Effects.field_76436_u, 900));
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      ...
      return block.isIn(BlockTags.LEAVES) || block == Blocks.GRASS_BLOCK || block instanceof LogBlock || block == Blocks.AIR && super.canSpawn(p_213380_1_, p_213380_2_); //Forge: GRASS -> GRASS_BLOCK
   }
