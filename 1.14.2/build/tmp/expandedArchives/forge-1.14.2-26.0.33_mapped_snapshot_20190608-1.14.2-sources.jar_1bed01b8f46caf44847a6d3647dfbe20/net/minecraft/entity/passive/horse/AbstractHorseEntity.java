...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount {
   ...
   private static final EntityPredicate field_213618_bK = (new EntityPredicate()).func_221013_a(16.0D).func_221008_a().func_221011_b().func_221014_c().func_221012_a(IS_HORSE_BREEDING);
   ...
   private static final DataParameter<Byte> STATUS = EntityDataManager.createKey(AbstractHorseEntity.class, DataSerializers.field_187191_a);
   private static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(AbstractHorseEntity.class, DataSerializers.field_187203_m);
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new PanicGoal(this, 1.2D));
      this.field_70714_bg.addTask(1, new RunAroundLikeCrazyGoal(this, 1.2D));
      this.field_70714_bg.addTask(2, new BreedGoal(this, 1.0D, AbstractHorseEntity.class));
      this.field_70714_bg.addTask(4, new FollowParentGoal(this, 1.0D));
      this.field_70714_bg.addTask(6, new WaterAvoidingRandomWalkingGoal(this, 0.7D));
      this.field_70714_bg.addTask(7, new LookAtGoal(this, PlayerEntity.class, 6.0F));
   ...
   protected void initHorseChest() {
      ...
      this.field_110296_bG = new Inventory(this.getInventorySize());
      if (inventory != null) {
         inventory.removeListener(this);
         int i = Math.min(inventory.getSizeInventory(), this.field_110296_bG.getSizeInventory());
      ...
      this.field_110296_bG.addListener(this);
   ...
   protected void updateHorseSlots() {
      if (!this.world.isRemote) {
         this.setHorseSaddled(!this.field_110296_bG.getStackInSlot(0).isEmpty() && this.canBeSaddled());
      }
   }
   ...
   public void openGUI(PlayerEntity playerEntity) {
      if (!this.world.isRemote && (!this.isBeingRidden() || this.isPassenger(playerEntity)) && this.isTame()) {
         playerEntity.openHorseInventory(this, this.field_110296_bG);
      }
   ...
   protected void func_213337_cE() {
      ...
      if (this.field_110296_bG != null) {
         for(int i = 0; i < this.field_110296_bG.getSizeInventory(); ++i) {
   ...
   protected void followMother() {
      if (this.isBreeding() && this.isChild() && !this.isEatingHaystack()) {
         LivingEntity livingentity = this.world.func_217360_a(AbstractHorseEntity.class, field_213618_bK, this, this.posX, this.posY, this.posZ, this.getBoundingBox().expand(16.0D, 16.0D, 16.0D));
         if (livingentity != null && this.getDistanceSq(livingentity) > 4.0D) {
            this.field_70699_by.getPathToEntityLiving(livingentity);
         }
      }
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (!this.field_110296_bG.getStackInSlot(0).isEmpty()) {
         p_213281_1_.put("SaddleItem", this.field_110296_bG.getStackInSlot(0).write(new CompoundNBT()));
      }
   ...
   public float getGrassEatingAmount(float p_110258_1_) {
      return MathHelper.func_219799_g(p_110258_1_, this.prevHeadLean, this.headLean);
   }

   @OnlyIn(Dist.CLIENT)
   public float getRearingAmount(float p_110223_1_) {
      return MathHelper.func_219799_g(p_110223_1_, this.prevRearingAmount, this.rearingAmount);
   }

   @OnlyIn(Dist.CLIENT)
   public float getMouthOpennessAngle(float p_110201_1_) {
      return MathHelper.func_219799_g(p_110201_1_, this.prevMouthOpenness, this.mouthOpenness);
   }
   ...
   public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
      ...
      if (i >= 0 && i < 2 && i < this.field_110296_bG.getSizeInventory()) {
         if (i == 0 && itemStackIn.getItem() != Items.SADDLE) {
            return false;
         } else if (i != 1 || this.wearsArmor() && this.isArmor(itemStackIn)) {
            this.field_110296_bG.setInventorySlotContents(i, itemStackIn);
            this.updateHorseSlots();
            return true;
         } else {
            return false;
         ...
         if (j >= 2 && j < this.field_110296_bG.getSizeInventory()) {
            this.field_110296_bG.setInventorySlotContents(j, itemStackIn);
            return true;
         } else {
            return false;
         }
