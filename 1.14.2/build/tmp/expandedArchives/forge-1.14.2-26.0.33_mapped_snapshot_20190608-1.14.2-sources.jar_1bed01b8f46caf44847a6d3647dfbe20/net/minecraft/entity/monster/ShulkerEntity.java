...
public class ShulkerEntity extends GolemEntity implements IMob {
   ...
   protected static final DataParameter<Direction> ATTACHED_FACE = EntityDataManager.createKey(ShulkerEntity.class, DataSerializers.field_187202_l);
   protected static final DataParameter<Optional<BlockPos>> ATTACHED_BLOCK_POS = EntityDataManager.createKey(ShulkerEntity.class, DataSerializers.field_187201_k);
   protected static final DataParameter<Byte> PEEK_TICK = EntityDataManager.createKey(ShulkerEntity.class, DataSerializers.field_187191_a);
   protected static final DataParameter<Byte> COLOR = EntityDataManager.createKey(ShulkerEntity.class, DataSerializers.field_187191_a);
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new LookAtGoal(this, PlayerEntity.class, 8.0F));
      this.field_70714_bg.addTask(4, new ShulkerEntity.AttackGoal());
      this.field_70714_bg.addTask(7, new ShulkerEntity.PeekGoal());
      ...
      this.field_70715_bh.addTask(2, new ShulkerEntity.AttackNearestGoal(this));
      this.field_70715_bh.addTask(3, new ShulkerEntity.DefenseAttackGoal(this));
   }
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.putByte("AttachFace", (byte)this.dataManager.get(ATTACHED_FACE).getIndex());
      p_213281_1_.putByte("Peek", this.dataManager.get(PEEK_TICK));
      p_213281_1_.putByte("Color", this.dataManager.get(COLOR));
   ...
   public float getClientPeekAmount(float p_184688_1_) {
      return MathHelper.func_219799_g(p_184688_1_, this.prevPeekAmount, this.peekAmount);
   }
   ...
   class AttackGoal extends Goal {
      ...
      public void tick() {
         if (ShulkerEntity.this.world.getDifficulty() != Difficulty.PEACEFUL) {
            --this.attackTime;
            LivingEntity livingentity = ShulkerEntity.this.getAttackTarget();
            ShulkerEntity.this.getLookHelper().setLookPositionWithEntity(livingentity, 180.0F, 180.0F);
            double d0 = ShulkerEntity.this.getDistanceSq(livingentity);
            if (d0 < 400.0D) {
               if (this.attackTime <= 0) {
                  this.attackTime = 20 + ShulkerEntity.this.rand.nextInt(10) * 20 / 2;
                  ShulkerEntity.this.world.func_217376_c(new ShulkerBulletEntity(ShulkerEntity.this.world, ShulkerEntity.this, livingentity, ShulkerEntity.this.getAttachmentFacing().getAxis()));
