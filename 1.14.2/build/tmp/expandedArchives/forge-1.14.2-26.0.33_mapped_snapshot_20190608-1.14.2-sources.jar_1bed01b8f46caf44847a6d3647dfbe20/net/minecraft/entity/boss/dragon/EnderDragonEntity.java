...
public class EnderDragonEntity extends MobEntity implements IMob {
   ...
   public static final DataParameter<Integer> PHASE = EntityDataManager.createKey(EnderDragonEntity.class, DataSerializers.field_187192_b);
   ...
   public double[] getMovementOffsets(int p_70974_1_, float p_70974_2_) {
      ...
      adouble[2] = MathHelper.func_219803_d((double)p_70974_2_, this.ringBuffer[i][2], this.ringBuffer[j][2]);
      return adouble;
   }
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         if (this.isAIDisabled()) {
            ...
            if (!this.world.isRemote && this.hurtTime == 0) {
               ...
               this.attackEntitiesInList(this.world.getEntitiesInAABBexcluding(this, this.field_184673_bv.getBoundingBox().grow(1.0D), EntityPredicates.CAN_AI_TARGET));
            }
            ...
            this.field_184673_bv.setLocationAndAngles(this.posX + (double)(f19 * 5.5F * f16), this.posY + (double)f20 + (double)(f2 * 5.5F), this.posZ - (double)(f4 * 5.5F * f16), 0.0F, 0.0F);
            ...
            if (!this.world.isRemote) {
               this.slowed = this.destroyBlocksInAABB(this.field_70986_h.getBoundingBox()) | this.destroyBlocksInAABB(this.field_184673_bv.getBoundingBox()) | this.destroyBlocksInAABB(this.field_70987_i.getBoundingBox());
   ...
   private void dropExperience(int p_184668_1_) {
      while(p_184668_1_ > 0) {
         ...
         p_184668_1_ -= i;
         this.world.func_217376_c(new ExperienceOrbEntity(this.world, this.posX, this.posY, this.posZ, i));
      }
   ...
   public float getHeadPartYOffset(int p_184667_1_, double[] p_184667_2_, double[] p_184667_3_) {
      ...
      if (phasetype != PhaseType.LANDING && phasetype != PhaseType.TAKEOFF) {
         ...
         float f = Math.max(MathHelper.sqrt(blockpos.func_218138_a(this.getPositionVec(), true)) / 4.0F, 1.0F);
