...
public class WalkToHouseTask extends Task<LivingEntity> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      if (worldIn.getGameTime() - this.field_220525_b < 40L) {
         ...
         Optional<BlockPos> optional = pointofinterestmanager.func_219147_b(PointOfInterestType.field_221069_q.func_221045_c(), (p_220522_0_) -> {
            return true;
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      pointofinterestmanager.func_219147_b(PointOfInterestType.field_221069_q.func_221045_c(), predicate, new BlockPos(p_212831_2_), 48, PointOfInterestManager.Status.ANY).ifPresent((p_220521_3_) -> {
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(p_220521_3_, this.field_220524_a, 1));
