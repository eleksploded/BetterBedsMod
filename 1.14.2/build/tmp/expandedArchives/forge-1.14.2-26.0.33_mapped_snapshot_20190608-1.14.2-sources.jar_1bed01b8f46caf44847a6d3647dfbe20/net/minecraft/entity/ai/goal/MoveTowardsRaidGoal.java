...
public class MoveTowardsRaidGoal<T extends AbstractRaiderEntity> extends Goal {
   ...
   public boolean shouldExecute() {
      return this.field_220744_a.getAttackTarget() == null && !this.field_220744_a.isBeingRidden() && this.field_220744_a.func_213657_el() && !this.field_220744_a.func_213663_ek().func_221319_a() && !((ServerWorld)this.field_220744_a.world).func_217483_b_(new BlockPos(this.field_220744_a));
   }
   ...
   public boolean shouldContinueExecuting() {
      return this.field_220744_a.func_213657_el() && !this.field_220744_a.func_213663_ek().func_221319_a() && this.field_220744_a.world instanceof ServerWorld && !((ServerWorld)this.field_220744_a.world).func_217483_b_(new BlockPos(this.field_220744_a));
   }
   ...
   public void tick() {
      if (this.field_220744_a.func_213657_el()) {
         Raid raid = this.field_220744_a.func_213663_ek();
   ...
   private void func_220743_a(Raid p_220743_1_) {
      if (p_220743_1_.func_221333_v()) {
         ...
         List<AbstractRaiderEntity> list = this.field_220744_a.world.getEntitiesWithinAABB(AbstractRaiderEntity.class, this.field_220744_a.getBoundingBox().grow(16.0D), (p_220742_1_) -> {
            return !p_220742_1_.func_213657_el() && RaidManager.func_215165_a(p_220742_1_, p_220743_1_);
         });
         set.addAll(list);
