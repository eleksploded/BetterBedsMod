...
public class MinecartCommandBlockEntity extends AbstractMinecartEntity {
   private static final DataParameter<String> COMMAND = EntityDataManager.createKey(MinecartCommandBlockEntity.class, DataSerializers.field_187194_d);
   private static final DataParameter<ITextComponent> LAST_OUTPUT = EntityDataManager.createKey(MinecartCommandBlockEntity.class, DataSerializers.field_187195_e);
   ...
   protected void readAdditional(CompoundNBT compound) {
      ...
      this.field_145824_a.read(compound);
   ...
   protected void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      this.field_145824_a.write(p_213281_1_);
   }
   ...
   public boolean processInitialInteract(PlayerEntity player, Hand hand) {
      ...
      this.field_145824_a.tryOpenEditCommandBlock(player);
      return true;
   }
   ...
   public void notifyDataManagerChange(DataParameter<?> key) {
      ...
      if (LAST_OUTPUT.equals(key)) {
         try {
            this.field_145824_a.setLastOutput(this.getDataManager().get(LAST_OUTPUT));
         } catch (Throwable var3) {
            ;
         }
      } else if (COMMAND.equals(key)) {
         this.field_145824_a.setCommand(this.getDataManager().get(COMMAND));
      }
