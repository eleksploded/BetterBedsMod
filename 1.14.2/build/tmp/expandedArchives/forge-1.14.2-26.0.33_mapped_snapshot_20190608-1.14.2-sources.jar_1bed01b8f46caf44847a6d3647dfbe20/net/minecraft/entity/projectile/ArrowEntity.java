...
public class ArrowEntity extends AbstractArrowEntity {
   private static final DataParameter<Integer> COLOR = EntityDataManager.createKey(ArrowEntity.class, DataSerializers.field_187192_b);
   ...
   public void setPotionEffect(ItemStack stack) {
      if (stack.getItem() == Items.TIPPED_ARROW) {
         this.field_184560_g = PotionUtils.getPotionFromItem(stack);
   ...
   private void refreshColor() {
      ...
      this.dataManager.set(COLOR, PotionUtils.getPotionColorFromEffectList(PotionUtils.mergeEffects(this.field_184560_g, this.customPotionEffects)));
   }

   public void addEffect(EffectInstance effect) {
      this.customPotionEffects.add(effect);
      this.getDataManager().set(COLOR, PotionUtils.getPotionColorFromEffectList(PotionUtils.mergeEffects(this.field_184560_g, this.customPotionEffects)));
   }
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (this.field_184560_g != Potions.field_185229_a && this.field_184560_g != null) {
         p_213281_1_.putString("Potion", Registry.field_212621_j.getKey(this.field_184560_g).toString());
      }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Potion", 8)) {
         this.field_184560_g = PotionUtils.getPotionTypeFromNBT(compound);
      }
   ...
   protected void arrowHit(LivingEntity living) {
      ...
      for(EffectInstance effectinstance : this.field_184560_g.getEffects()) {
   ...
   protected ItemStack getArrowStack() {
      if (this.customPotionEffects.isEmpty() && this.field_184560_g == Potions.field_185229_a) {
         return new ItemStack(Items.ARROW);
      } else {
         ItemStack itemstack = new ItemStack(Items.TIPPED_ARROW);
         PotionUtils.addPotionToItemStack(itemstack, this.field_184560_g);
