...
public class WitherEntity extends MonsterEntity implements IRangedAttackMob {
   private static final DataParameter<Integer> FIRST_HEAD_TARGET = EntityDataManager.createKey(WitherEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> SECOND_HEAD_TARGET = EntityDataManager.createKey(WitherEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> THIRD_HEAD_TARGET = EntityDataManager.createKey(WitherEntity.class, DataSerializers.field_187192_b);
   ...
   private static final DataParameter<Integer> INVULNERABILITY_TIME = EntityDataManager.createKey(WitherEntity.class, DataSerializers.field_187192_b);
   ...
   private final ServerBossInfo field_184744_bE = (ServerBossInfo)(new ServerBossInfo(this.getDisplayName(), BossInfo.Color.PURPLE, BossInfo.Overlay.PROGRESS)).setDarkenSky(true);
   ...
   private static final EntityPredicate field_213798_bB = (new EntityPredicate()).func_221013_a(20.0D).func_221012_a(NOT_UNDEAD);
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(0, new WitherEntity.DoNothingGoal());
      this.field_70714_bg.addTask(2, new RangedAttackGoal(this, 1.0D, 40, 20.0F));
      ...
      this.field_70715_bh.addTask(2, new NearestAttackableTargetGoal<>(this, MobEntity.class, 0, false, false, NOT_UNDEAD));
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (this.hasCustomName()) {
         this.field_184744_bE.setName(this.getDisplayName());
      }
            ...
            if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
               ...
               if (k1 > 0) {
                  ...
                  if (entity != null && entity.isAlive() && !(this.getDistanceSq(entity) > 900.0D) && this.canEntityBeSeen(entity)) {
                     if (entity instanceof PlayerEntity && ((PlayerEntity)entity).playerAbilities.disableDamage) {
                  ...
                  for(int j2 = 0; j2 < 10 && !list.isEmpty(); ++j2) {
                     ...
                     if (livingentity != this && livingentity.isAlive() && this.canEntityBeSeen(livingentity)) {
                        if (livingentity instanceof PlayerEntity) {
                           if (!((PlayerEntity)livingentity).playerAbilities.disableDamage) {
   ...
   public static boolean canDestroyBlock(BlockState blockIn) {
      return !blockIn.isAir() && !BlockTags.field_219755_X.contains(blockIn.getBlock());
   }
   ...
   public void addTrackingPlayer(ServerPlayerEntity player) {
      ...
      this.field_184744_bE.addPlayer(player);
   }
   ...
   public void removeTrackingPlayer(ServerPlayerEntity player) {
      ...
      this.field_184744_bE.removePlayer(player);
   }
   ...
   private void launchWitherSkullToCoords(int p_82209_1_, double x, double y, double z, boolean invulnerable) {
      ...
      this.world.func_217376_c(witherskullentity);
   }
   ...
   public boolean isPotionApplicable(EffectInstance potioneffectIn) {
      return potioneffectIn.getPotion() == Effects.field_82731_v ? false : super.isPotionApplicable(potioneffectIn);
   }
