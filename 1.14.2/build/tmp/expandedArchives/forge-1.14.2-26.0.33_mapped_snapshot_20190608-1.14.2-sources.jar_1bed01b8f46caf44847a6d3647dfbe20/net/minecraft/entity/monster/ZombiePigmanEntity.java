...
public class ZombiePigmanEntity extends ZombieEntity {
   ...
   protected void applyEntityAI() {
      ...
      this.field_70715_bh.addTask(1, new ZombiePigmanEntity.HurtByAggressorGoal(this));
      this.field_70715_bh.addTask(2, new ZombiePigmanEntity.TargetAggressorGoal(this));
   }
   ...
   static class HurtByAggressorGoal extends HurtByTargetGoal {
      public HurtByAggressorGoal(ZombiePigmanEntity p_i45828_1_) {
         super(p_i45828_1_);
         this.func_220794_a(new Class[]{ZombieEntity.class});
      }

      protected void func_220793_a(MobEntity p_220793_1_, LivingEntity p_220793_2_) {
         super.func_220793_a(p_220793_1_, p_220793_2_);
         if (p_220793_1_ instanceof ZombiePigmanEntity) {
            ((ZombiePigmanEntity)p_220793_1_).becomeAngryAt(p_220793_2_);
         }
