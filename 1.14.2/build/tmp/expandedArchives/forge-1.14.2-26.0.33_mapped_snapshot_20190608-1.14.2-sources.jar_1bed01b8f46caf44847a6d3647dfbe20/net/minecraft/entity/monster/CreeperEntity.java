...
public class CreeperEntity extends MonsterEntity {
   private static final DataParameter<Integer> STATE = EntityDataManager.createKey(CreeperEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Boolean> POWERED = EntityDataManager.createKey(CreeperEntity.class, DataSerializers.field_187198_h);
   private static final DataParameter<Boolean> IGNITED = EntityDataManager.createKey(CreeperEntity.class, DataSerializers.field_187198_h);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(2, new CreeperSwellGoal(this));
      this.field_70714_bg.addTask(3, new AvoidEntityGoal<>(this, OcelotEntity.class, 6.0F, 1.0D, 1.2D));
      this.field_70714_bg.addTask(3, new AvoidEntityGoal<>(this, CatEntity.class, 6.0F, 1.0D, 1.2D));
      ...
      this.field_70715_bh.addTask(1, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, true));
   ...
   public float getCreeperFlashIntensity(float partialTicks) {
      return MathHelper.func_219799_g(partialTicks, (float)this.lastActiveTime, (float)this.timeSinceIgnited) / (float)(this.fuseTime - 2);
   }
   ...
   protected boolean processInteract(PlayerEntity player, Hand hand) {
      ...
      if (itemstack.getItem() == Items.FLINT_AND_STEEL) {
         ...
         if (!this.world.isRemote) {
            this.ignite();
            itemstack.func_222118_a(1, player, (p_213625_1_) -> {
               p_213625_1_.func_213334_d(hand);
            });
            return true;
         }
      }
   ...
   private void spawnLingeringCloud() {
      ...
      if (!collection.isEmpty()) {
         ...
         this.world.func_217376_c(areaeffectcloudentity);
      }
