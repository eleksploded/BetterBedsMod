...
public class FindInteractionAndLookTargetTask extends Task<LivingEntity> {
   ...
   public FindInteractionAndLookTargetTask(EntityType<?> p_i50347_1_, int p_i50347_2_, Predicate<LivingEntity> p_i50347_3_, Predicate<LivingEntity> p_i50347_4_) {
      super(ImmutableMap.of(MemoryModuleType.field_220951_l, MemoryModuleStatus.REGISTERED, MemoryModuleType.field_220952_m, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220946_g, MemoryModuleStatus.VALUE_PRESENT));
   ...
   public void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      brain.getMemory(MemoryModuleType.field_220946_g).ifPresent((p_220526_3_) -> {
         p_220526_3_.stream().filter((p_220529_2_) -> {
            ...
            brain.setMemory(MemoryModuleType.field_220952_m, p_220527_1_);
            brain.setMemory(MemoryModuleType.field_220951_l, new EntityPosWrapper(p_220527_1_));
         });
      });
   }
   ...
   private List<LivingEntity> func_220530_b(LivingEntity p_220530_1_) {
      return p_220530_1_.getBrain().getMemory(MemoryModuleType.field_220946_g).get();
   }
}