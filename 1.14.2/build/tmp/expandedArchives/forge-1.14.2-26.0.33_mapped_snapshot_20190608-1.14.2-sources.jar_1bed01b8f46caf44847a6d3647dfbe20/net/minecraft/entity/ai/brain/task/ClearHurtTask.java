...
public class ClearHurtTask extends Task<LivingEntity> {
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      if (!flag) {
         p_212831_2_.getBrain().removeMemory(MemoryModuleType.field_220957_r);
         p_212831_2_.getBrain().removeMemory(MemoryModuleType.field_220958_s);
   ...
   private static boolean func_220394_a(LivingEntity p_220394_0_) {
      return p_220394_0_.getBrain().getMemory(MemoryModuleType.field_220958_s).filter((p_220393_1_) -> {
