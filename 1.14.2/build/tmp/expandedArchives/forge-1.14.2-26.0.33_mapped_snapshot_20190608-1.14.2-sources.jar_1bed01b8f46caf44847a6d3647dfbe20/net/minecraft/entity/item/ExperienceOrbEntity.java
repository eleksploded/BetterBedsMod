...
public class ExperienceOrbEntity extends Entity {
   ...
   public void tick() {
      ...
      if (!this.world.areCollisionShapesEmpty(this.getBoundingBox())) {
         this.func_213282_i(this.posX, (this.getBoundingBox().minY + this.getBoundingBox().maxY) / 2.0D, this.posZ);
      }

      double d0 = 8.0D;
      if (this.xpTargetColor < this.xpColor - 20 + this.getEntityId() % 100) {
         if (this.field_80001_f == null || this.field_80001_f.getDistanceSq(this) > 64.0D) {
            this.field_80001_f = this.world.func_217362_a(this, 8.0D);
         }

         this.xpTargetColor = this.xpColor;
      }

      if (this.field_80001_f != null && this.field_80001_f.isSpectator()) {
         this.field_80001_f = null;
      }

      if (this.field_80001_f != null) {
         Vec3d vec3d = new Vec3d(this.field_80001_f.posX - this.posX, this.field_80001_f.posY + (double)this.field_80001_f.getEyeHeight() / 2.0D - this.posY, this.field_80001_f.posZ - this.posZ);
