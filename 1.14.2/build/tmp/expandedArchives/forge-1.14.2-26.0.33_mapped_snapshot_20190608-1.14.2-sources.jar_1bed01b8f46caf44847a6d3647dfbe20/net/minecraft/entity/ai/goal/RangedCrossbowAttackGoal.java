...
public class RangedCrossbowAttackGoal<T extends MonsterEntity & IRangedAttackMob & ICrossbowUser> extends Goal {
   ...
   public void resetTask() {
      super.resetTask();
      this.field_220748_a.func_213395_q(false);
      ...
      if (this.field_220748_a.isHandActive()) {
         ...
         ((ICrossbowUser)this.field_220748_a).func_213671_a(false);
         CrossbowItem.func_220011_a(this.field_220748_a.getActiveItemStack(), false);
      }
   ...
   public void tick() {
      ...
      if (livingentity != null) {
         ...
         this.field_220748_a.getLookHelper().setLookPositionWithEntity(livingentity, 30.0F, 30.0F);
         if (this.field_220749_b == RangedCrossbowAttackGoal.CrossbowState.UNCHARGED) {
            if (!flag2) {
               this.field_220748_a.setActiveHand(ProjectileHelper.func_221274_a(this.field_220748_a, Items.field_222114_py));
            ...
            ItemStack itemstack1 = this.field_220748_a.getHeldItem(ProjectileHelper.func_221274_a(this.field_220748_a, Items.field_222114_py));
