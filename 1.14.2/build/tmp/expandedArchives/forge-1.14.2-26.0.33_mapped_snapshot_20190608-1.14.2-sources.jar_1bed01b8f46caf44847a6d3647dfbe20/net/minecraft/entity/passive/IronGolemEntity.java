...
public class IronGolemEntity extends GolemEntity {
   protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager.createKey(IronGolemEntity.class, DataSerializers.field_187191_a);
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new MeleeAttackGoal(this, 1.0D, true));
      this.field_70714_bg.addTask(2, new MoveTowardsTargetGoal(this, 0.9D, 32.0F));
      this.field_70714_bg.addTask(2, new MoveTowardsVillageGoal(this, 0.6D));
      this.field_70714_bg.addTask(3, new MoveThroughVillageGoal(this, 0.6D, false, 4, () -> {
         return false;
      }));
      this.field_70714_bg.addTask(5, new ShowVillagerFlowerGoal(this));
      ...
      this.field_70715_bh.addTask(1, new DefendVillageTargetGoal(this));
      this.field_70715_bh.addTask(2, new HurtByTargetGoal(this));
      this.field_70715_bh.addTask(3, new NearestAttackableTargetGoal<>(this, MobEntity.class, 5, false, false, (p_213619_0_) -> {
