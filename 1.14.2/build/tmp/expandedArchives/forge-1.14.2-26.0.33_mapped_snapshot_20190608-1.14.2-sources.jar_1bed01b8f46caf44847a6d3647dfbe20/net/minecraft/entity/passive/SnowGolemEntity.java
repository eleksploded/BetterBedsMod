...
public class SnowGolemEntity extends GolemEntity implements IRangedAttackMob, net.minecraftforge.common.IShearable {
   private static final DataParameter<Byte> PUMPKIN_EQUIPPED = EntityDataManager.createKey(SnowGolemEntity.class, DataSerializers.field_187191_a);
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new RangedAttackGoal(this, 1.25D, 20, 10.0F));
      this.field_70714_bg.addTask(2, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 1.0000001E-5F));
      ...
      this.field_70715_bh.addTask(1, new NearestAttackableTargetGoal<>(this, MobEntity.class, 10, true, false, (p_213621_0_) -> {
   ...
   public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
      ...
      this.world.func_217376_c(snowballentity);
   }
   ...
   protected boolean processInteract(PlayerEntity player, Hand hand) {
      ...
      if (false &&  itemstack.getItem() == Items.SHEARS && this.isPumpkinEquipped() && !this.world.isRemote) { //Forge: Moved to onSheared
         ...
         itemstack.func_222118_a(1, player, (p_213622_1_) -> {
            p_213622_1_.func_213334_d(hand);
         });
      }
