...
public class EvokerFangsEntity extends Entity {
   ...
   private LivingEntity field_190557_e;
   ...
   public LivingEntity getCaster() {
      if (this.field_190557_e == null && this.casterUuid != null && this.world instanceof ServerWorld) {
         Entity entity = ((ServerWorld)this.world).func_217461_a(this.casterUuid);
         if (entity instanceof LivingEntity) {
            this.field_190557_e = (LivingEntity)entity;
         }
      }
