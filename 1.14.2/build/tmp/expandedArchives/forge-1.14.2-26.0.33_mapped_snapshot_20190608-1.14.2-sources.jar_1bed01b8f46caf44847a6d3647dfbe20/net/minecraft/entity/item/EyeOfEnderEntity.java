...
public class EyeOfEnderEntity extends Entity implements IRendersAsItem {
   private static final DataParameter<ItemStack> field_213864_b = EntityDataManager.createKey(EyeOfEnderEntity.class, DataSerializers.field_187196_f);
   ...
   public void tick() {
      ...
      if (!this.world.isRemote) {
         ...
         double d2 = MathHelper.func_219803_d(0.0025D, (double)f, (double)f1);
         double d3 = vec3d.y;
         if (f1 < 1.0F) {
            d2 *= 0.8D;
            d3 *= 0.8D;
      ...
      if (!this.world.isRemote) {
         ...
         if (this.despawnTimer > 80 && !this.world.isRemote) {
            ...
            if (this.shatterOrDrop) {
               this.world.func_217376_c(new ItemEntity(this.world, this.posX, this.posY, this.posZ, this.getPotion()));
            } else {
