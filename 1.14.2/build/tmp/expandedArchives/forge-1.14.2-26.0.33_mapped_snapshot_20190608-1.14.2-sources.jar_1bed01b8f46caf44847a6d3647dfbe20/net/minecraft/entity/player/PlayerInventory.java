         ...
         try {
            if (p_191971_2_.isDamaged()) {
               ...
               if (p_191971_1_ >= 0) {
                  ...
                  return true;
               } else if (this.player.playerAbilities.isCreativeMode) {
                  p_191971_2_.setCount(0);
                  return true;
               } else {
                  return false;
               ...
               if (p_191971_2_.getCount() == i && this.player.playerAbilities.isCreativeMode) {
                  p_191971_2_.setCount(0);
                  return true;
               } else {
      ...
      if (!(damage <= 0.0F)) {
         ...
         for(int i = 0; i < this.armorInventory.size(); ++i) {
            ...
            if (itemstack.getItem() instanceof ArmorItem) {
               int i_f = i;
               itemstack.func_222118_a((int)damage, this.player, (p_214023_1_) -> {
