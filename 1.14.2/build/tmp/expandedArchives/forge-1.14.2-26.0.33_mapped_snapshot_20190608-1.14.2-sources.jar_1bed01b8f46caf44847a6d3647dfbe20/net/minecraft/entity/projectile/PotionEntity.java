...
public class PotionEntity extends ThrowableEntity implements IRendersAsItem {
   private static final DataParameter<ItemStack> ITEM = EntityDataManager.createKey(PotionEntity.class, DataSerializers.field_187196_f);
   ...
   private void extinguishFires(BlockPos pos, Direction p_184542_2_) {
      ...
      } else if (block == Blocks.field_222433_lV && blockstate.get(CampfireBlock.LIT)) {
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      ItemStack itemstack = this.getPotion();
      if (!itemstack.isEmpty()) {
         p_213281_1_.put("Potion", itemstack.write(new CompoundNBT()));
      }
