...
public class SquidEntity extends WaterMobEntity {
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(0, new SquidEntity.MoveRandomGoal(this));
      this.field_70714_bg.addTask(1, new SquidEntity.FleeGoal());
   }
      ...
      if (this.isInWaterOrBubbleColumn()) {
         ...
         if (!this.world.isRemote) {
            ...
            if (this.isPotionActive(Effects.field_188424_y)) {
               d0 = 0.05D * (double)(this.getActivePotionEffect(Effects.field_188424_y).getAmplifier() + 1);
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      return this.posY > 45.0D && this.posY < (double)p_213380_1_.getSeaLevel();
   }
   ...
   class MoveRandomGoal extends Goal {
       ...
       */
      public void tick() {
         int i = this.field_179476_a.getIdleTime();
         if (i > 100) {
            this.field_179476_a.setMovementVector(0.0F, 0.0F, 0.0F);
         } else if (this.field_179476_a.getRNG().nextInt(50) == 0 || !this.field_179476_a.inWater || !this.field_179476_a.hasMovementVector()) {
            float f = this.field_179476_a.getRNG().nextFloat() * ((float)Math.PI * 2F);
            float f1 = MathHelper.cos(f) * 0.2F;
            float f2 = -0.1F + this.field_179476_a.getRNG().nextFloat() * 0.2F;
            float f3 = MathHelper.sin(f) * 0.2F;
            this.field_179476_a.setMovementVector(f1, f2, f3);
         }
