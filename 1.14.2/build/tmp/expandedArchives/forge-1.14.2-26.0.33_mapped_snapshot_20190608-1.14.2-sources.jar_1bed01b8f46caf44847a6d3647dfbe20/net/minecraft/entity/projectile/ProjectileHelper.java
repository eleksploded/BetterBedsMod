...
public final class ProjectileHelper {
   public static RayTraceResult func_221266_a(Entity p_221266_0_, boolean p_221266_1_, boolean p_221266_2_, @Nullable Entity p_221266_3_, RayTraceContext.BlockMode p_221266_4_) {
      ...
      }, p_221266_0_.getBoundingBox().func_216361_a(p_221266_0_.getMotion()).grow(1.0D));
   }
   ...
   private static RayTraceResult func_221268_a(Entity p_221268_0_, boolean p_221268_1_, boolean p_221268_2_, @Nullable Entity p_221268_3_, RayTraceContext.BlockMode p_221268_4_, boolean p_221268_5_, Predicate<Entity> p_221268_6_, AxisAlignedBB p_221268_7_) {
      ...
      if (p_221268_5_ && !world.isCollisionBoxesEmpty(p_221268_0_, p_221268_0_.getBoundingBox(), (Set<Entity>)(!p_221268_2_ && p_221268_3_ != null ? getEntityAndMount(p_221268_3_) : ImmutableSet.of()))) {
         ...
         RayTraceResult raytraceresult = world.func_217299_a(new RayTraceContext(vec3d1, vec3d2, p_221268_4_, RayTraceContext.FluidMode.NONE, p_221268_0_));
         if (p_221268_1_) {
   ...
   public static final void rotateTowardsMovement(Entity projectile, float rotationSpeed) {
      ...
      projectile.rotationPitch = MathHelper.func_219799_g(rotationSpeed, projectile.prevRotationPitch, projectile.rotationPitch);
      projectile.rotationYaw = MathHelper.func_219799_g(rotationSpeed, projectile.prevRotationYaw, projectile.rotationYaw);
   }
