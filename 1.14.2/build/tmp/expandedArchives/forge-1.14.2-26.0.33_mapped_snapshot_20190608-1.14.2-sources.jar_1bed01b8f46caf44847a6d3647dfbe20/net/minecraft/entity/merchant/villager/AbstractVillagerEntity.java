...
public abstract class AbstractVillagerEntity extends AgeableEntity implements INPC, IMerchant {
   private static final DataParameter<Integer> SHAKE_HEAD_TICKS = EntityDataManager.createKey(AbstractVillagerEntity.class, DataSerializers.field_187192_b);
   @Nullable
   ...
   public void func_213711_eb() {
      this.playSound(SoundEvents.field_219721_mv, this.getSoundVolume(), this.getSoundPitch());
   }
