...
public class PhantomEntity extends FlyingEntity implements IMob {
   private static final DataParameter<Integer> SIZE = EntityDataManager.createKey(PhantomEntity.class, DataSerializers.field_187192_b);
   private Vec3d orbitOffset = Vec3d.ZERO;
   private BlockPos orbitPosition = BlockPos.ZERO;
   private PhantomEntity.AttackPhase field_203038_bx = PhantomEntity.AttackPhase.CIRCLE;

   public PhantomEntity(EntityType<? extends PhantomEntity> p_i50200_1_, World p_i50200_2_) {
      super(p_i50200_1_, p_i50200_2_);
      this.experienceValue = 5;
      this.field_70765_h = new PhantomEntity.MoveHelperController(this);
      this.field_70749_g = new PhantomEntity.LookHelperController(this);
   }
   ...
   protected void initEntityAI() {
      this.field_70714_bg.addTask(1, new PhantomEntity.PickAttackGoal());
      this.field_70714_bg.addTask(2, new PhantomEntity.SweepAttackGoal());
      this.field_70714_bg.addTask(3, new PhantomEntity.OrbitPointGoal());
      this.field_70715_bh.addTask(1, new PhantomEntity.AttackPlayerGoal());
   }
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      int i = this.getPhantomSize();
      EntitySize entitysize = super.getSize(p_213305_1_);
   ...
   class AttackPlayerGoal extends Goal {
      private final EntityPredicate field_220842_b = (new EntityPredicate()).func_221013_a(64.0D);
   ...
   class OrbitPointGoal extends PhantomEntity.MoveGoal {
       ...
       */
      public boolean shouldExecute() {
         return PhantomEntity.this.getAttackTarget() == null || PhantomEntity.this.field_203038_bx == PhantomEntity.AttackPhase.CIRCLE;
      }
   ...
   class PickAttackGoal extends Goal {
      ...
      public void startExecuting() {
         this.tickDelay = 10;
         PhantomEntity.this.field_203038_bx = PhantomEntity.AttackPhase.CIRCLE;
         this.func_203143_f();
      }
       ...
       */
      public void tick() {
         if (PhantomEntity.this.field_203038_bx == PhantomEntity.AttackPhase.CIRCLE) {
            --this.tickDelay;
            if (this.tickDelay <= 0) {
               PhantomEntity.this.field_203038_bx = PhantomEntity.AttackPhase.SWOOP;
               this.func_203143_f();
   ...
   class SweepAttackGoal extends PhantomEntity.MoveGoal {
       ...
       */
      public boolean shouldExecute() {
         return PhantomEntity.this.getAttackTarget() != null && PhantomEntity.this.field_203038_bx == PhantomEntity.AttackPhase.SWOOP;
      }
