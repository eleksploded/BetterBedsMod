...
public abstract class AbstractArrowEntity extends Entity implements IProjectile {
   private static final DataParameter<Byte> CRITICAL = EntityDataManager.createKey(AbstractArrowEntity.class, DataSerializers.field_187191_a);
   protected static final DataParameter<Optional<UUID>> field_212362_a = EntityDataManager.createKey(AbstractArrowEntity.class, DataSerializers.field_187203_m);
   private static final DataParameter<Byte> field_213876_as = EntityDataManager.createKey(AbstractArrowEntity.class, DataSerializers.field_187191_a);
   @Nullable
   ...
   public void tick() {
      ...
      if (this.inGround && !flag) {
         if (this.field_195056_av != blockstate && this.world.areCollisionShapesEmpty(this.getBoundingBox().grow(0.06D))) {
            this.inGround = false;
         ...
         RayTraceResult raytraceresult = this.world.func_217299_a(new RayTraceContext(vec3d1, vec3d2, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, this));
   ...
   protected void onHit(RayTraceResult raytraceResultIn) {
      ...
      if (raytraceresult$type == RayTraceResult.Type.ENTITY) {
         ...
         this.field_195056_av = blockstate;
   ...
   protected EntityRayTraceResult func_213866_a(Vec3d p_213866_1_, Vec3d p_213866_2_) {
      return ProjectileHelper.func_221271_a(this.world, this, p_213866_1_, p_213866_2_, this.getBoundingBox().func_216361_a(this.getMotion()).grow(1.0D), (p_213871_1_) -> {
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (this.field_195056_av != null) {
         p_213281_1_.put("inBlockState", NBTUtil.writeBlockState(this.field_195056_av));
      }

      p_213281_1_.putByte("shake", (byte)this.arrowShake);
      p_213281_1_.putByte("inGround", (byte)(this.inGround ? 1 : 0));
      p_213281_1_.putByte("pickup", (byte)this.field_70251_a.ordinal());
      ...
      p_213281_1_.putString("SoundEvent", Registry.field_212633_v.getKey(this.field_213877_ay).toString());
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("inBlockState", 10)) {
         this.field_195056_av = NBTUtil.readBlockState(compound.getCompound("inBlockState"));
      }
      ...
      if (compound.contains("pickup", 99)) {
         this.field_70251_a = AbstractArrowEntity.PickupStatus.getByOrdinal(compound.getByte("pickup"));
      } else if (compound.contains("player", 99)) {
         this.field_70251_a = compound.getBoolean("player") ? AbstractArrowEntity.PickupStatus.ALLOWED : AbstractArrowEntity.PickupStatus.DISALLOWED;
      }
      ...
      if (compound.contains("SoundEvent", 8)) {
         this.field_213877_ay = Registry.field_212633_v.func_218349_b(new ResourceLocation(compound.getString("SoundEvent"))).orElse(this.func_213867_k());
      }
   ...
   public void setShooter(@Nullable Entity p_212361_1_) {
      ...
      if (p_212361_1_ instanceof PlayerEntity) {
         this.field_70251_a = ((PlayerEntity)p_212361_1_).playerAbilities.isCreativeMode ? AbstractArrowEntity.PickupStatus.CREATIVE_ONLY : AbstractArrowEntity.PickupStatus.ALLOWED;
      }
   ...
   public Entity getShooter() {
      return this.shootingEntity != null && this.world instanceof ServerWorld ? ((ServerWorld)this.world).func_217461_a(this.shootingEntity) : null;
   }
   ...
   public void onCollideWithPlayer(PlayerEntity entityIn) {
      if (!this.world.isRemote && (this.inGround || this.func_203047_q()) && this.arrowShake <= 0) {
         boolean flag = this.field_70251_a == AbstractArrowEntity.PickupStatus.ALLOWED || this.field_70251_a == AbstractArrowEntity.PickupStatus.CREATIVE_ONLY && entityIn.playerAbilities.isCreativeMode || this.func_203047_q() && this.getShooter().getUniqueID() == entityIn.getUniqueID();
         if (this.field_70251_a == AbstractArrowEntity.PickupStatus.ALLOWED && !entityIn.inventory.addItemStackToInventory(this.getArrowStack())) {
            flag = false;
         }
