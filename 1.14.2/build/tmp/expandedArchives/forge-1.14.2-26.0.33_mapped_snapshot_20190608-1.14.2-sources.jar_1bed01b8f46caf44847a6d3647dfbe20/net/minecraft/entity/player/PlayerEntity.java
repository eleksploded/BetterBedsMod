...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static final EntitySize field_213835_bs = EntitySize.flexible(0.6F, 1.8F);
   ...
   private static final DataParameter<Float> ABSORPTION = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_187193_c);
   private static final DataParameter<Integer> PLAYER_SCORE = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_187192_b);
   protected static final DataParameter<Byte> PLAYER_MODEL_FLAG = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_187191_a);
   protected static final DataParameter<Byte> MAIN_HAND = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_187191_a);
   protected static final DataParameter<CompoundNBT> LEFT_SHOULDER_ENTITY = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_192734_n);
   protected static final DataParameter<CompoundNBT> RIGHT_SHOULDER_ENTITY = EntityDataManager.createKey(PlayerEntity.class, DataSerializers.field_192734_n);
   ...
   public void tick() {
      ...
      if (this.isPlayerSleeping()) {
         ...
         if (!this.world.isRemote && !net.minecraftforge.event.ForgeEventFactory.fireSleepingTimeCheck(this, func_213374_dv())) {
      ...
      if (this.isBurning() && this.playerAbilities.disableDamage) {
         this.extinguish();
      }
   ...
   private void updateTurtleHelmet() {
      ...
      if (itemstack.getItem() == Items.TURTLE_HELMET && !this.areEyesInFluid(FluidTags.WATER)) {
         this.addPotionEffect(new EffectInstance(Effects.field_76427_o, 200, 0, false, false, true));
      }
   ...
   protected void func_213832_dB() {
      if (this.func_213298_c(Pose.SWIMMING)) {
         ...
         } else if (this.isSneaking() && !this.playerAbilities.isFlying) {
            pose = Pose.SNEAKING;
         } else {
            pose = Pose.STANDING;
         }
   ...
   public int getMaxInPortalTime() {
      return this.playerAbilities.disableDamage ? 1 : 80;
   }
   ...
   public void livingTick() {
      ...
      if (!this.world.isRemote) {
         iattributeinstance.setBaseValue((double)this.playerAbilities.getWalkSpeed());
      }
      ...
      if (!this.world.isRemote && (this.fallDistance > 0.5F || this.isInWater() || this.isPassenger()) || this.playerAbilities.isFlying) {
   ...
   private void playShoulderEntityAmbientSound(@Nullable CompoundNBT p_192028_1_) {
      if (p_192028_1_ != null && !p_192028_1_.contains("Silent") || !p_192028_1_.getBoolean("Silent")) {
         ...
         EntityType.func_220327_a(s).filter((p_213830_0_) -> {
   ...
   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
      if (damageSourceIn == DamageSource.ON_FIRE) {
         ...
         return damageSourceIn == DamageSource.field_220302_v ? SoundEvents.field_219671_iL : SoundEvents.ENTITY_PLAYER_HURT;
      }
   }
   ...
   public float getDigSpeed(BlockState state, @Nullable BlockPos pos) {
      ...
      if (this.isPotionActive(Effects.field_76419_f)) {
         float f1;
         switch(this.getActivePotionEffect(Effects.field_76419_f).getAmplifier()) {
         case 0:
            f1 = 0.3F;
            break;
         case 1:
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      this.playerAbilities.read(compound);
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      this.playerAbilities.write(p_213281_1_);
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      ...
      if (this.isInvulnerableTo(source)) {
         return false;
      } else if (this.playerAbilities.disableDamage && !source.canHarmInCreative()) {
         return false;
      } else {
         this.idleTime = 0;
   ...
   protected void damageShield(float damage) {
      if (damage >= 3.0F && this.activeItemStack.isShield(this)) {
         ...
         this.activeItemStack.func_222118_a(i, this, (p_213833_1_) -> {
   ...
   public ActionResultType interactOn(Entity entityToInteractOn, Hand hand) {
      if (this.isSpectator()) {
         ...
         if (entityToInteractOn.processInitialInteract(this, hand)) {
            if (this.playerAbilities.isCreativeMode && itemstack == this.getHeldItem(hand) && itemstack.getCount() < itemstack1.getCount()) {
               itemstack.setCount(itemstack1.getCount());
            }

            if (!this.playerAbilities.isCreativeMode && itemstack.isEmpty()) {
            ...
            if (!itemstack.isEmpty() && entityToInteractOn instanceof LivingEntity) {
               ...
               if (itemstack.interactWithEntity(this, (LivingEntity)entityToInteractOn, hand)) {
                  if (itemstack.isEmpty() && !this.playerAbilities.isCreativeMode) {
                     net.minecraftforge.event.ForgeEventFactory.onPlayerDestroyItem(this, itemstack1, hand);
   ...
   protected boolean isMovementBlocked() {
      return super.isMovementBlocked() || this.isPlayerSleeping();
   }
      ...
      if (targetEntity.canBeAttackedWithItem()) {
         if (!targetEntity.hitByEntity(this)) {
            ...
            if (f > 0.0F || f1 > 0.0F) {
               ...
               boolean flag2 = flag && this.fallDistance > 0.0F && !this.onGround && !this.isOnLadder() && !this.isInWater() && !this.isPotionActive(Effects.field_76440_q) && !this.isPassenger() && targetEntity instanceof LivingEntity;
   ...
   public Either<PlayerEntity.SleepResult, Unit> func_213819_a(BlockPos p_213819_1_) {
      PlayerEntity.SleepResult ret = net.minecraftforge.event.ForgeEventFactory.onPlayerSleepInBed(this, func_213374_dv());
      if (ret != null) return Either.left(ret);
      Direction direction = this.world.getBlockState(p_213819_1_).get(HorizontalBlock.HORIZONTAL_FACING);
      if (!this.world.isRemote) {
         ...
         if (!net.minecraftforge.event.ForgeEventFactory.fireSleepingTimeCheck(this, func_213374_dv())) {
         ...
         if (!this.isCreative()) {
            double d0 = 8.0D;
            double d1 = 5.0D;
            List<MonsterEntity> list = this.world.getEntitiesWithinAABB(MonsterEntity.class, new AxisAlignedBB((double)p_213819_1_.getX() - 8.0D, (double)p_213819_1_.getY() - 5.0D, (double)p_213819_1_.getZ() - 8.0D, (double)p_213819_1_.getX() + 8.0D, (double)p_213819_1_.getY() + 5.0D, (double)p_213819_1_.getZ() + 8.0D), (p_213820_1_) -> {
   ...
   public boolean isPlayerFullyAsleep() {
      return this.isPlayerSleeping() && this.sleepTimer >= 100;
   }
   ...
   public void travel(Vec3d p_213352_1_) {
      ...
      if (this.playerAbilities.isFlying && !this.isPassenger()) {
         ...
         this.jumpMovementFactor = this.playerAbilities.getFlySpeed() * (float)(this.isSprinting() ? 2 : 1);
   ...
   public void addExhaustion(float exhaustion) {
      if (!this.playerAbilities.disableDamage) {
         if (!this.world.isRemote) {
   ...
   public boolean canEat(boolean ignoreHunger) {
      return !this.playerAbilities.disableDamage && (ignoreHunger || this.foodStats.needFood());
   }
   ...
   private void spawnShoulderEntity(@Nullable CompoundNBT p_192026_1_) {
      if (!this.world.isRemote && !p_192026_1_.isEmpty()) {
         EntityType.func_220330_a(p_192026_1_, this.world).ifPresent((p_213827_1_) -> {
   ...
   public boolean isSwimming() {
      return !this.playerAbilities.isFlying && !this.isSpectator() && super.isSwimming();
   }
   ...
   public boolean canUseCommandBlock() {
      return this.playerAbilities.isCreativeMode && this.getPermissionLevel() >= 2;
   }
   ...
   public ItemStack func_213356_f(ItemStack p_213356_1_) {
      if (!(p_213356_1_.getItem() instanceof ShootableItem)) {
         ...
         Predicate<ItemStack> predicate = ((ShootableItem)p_213356_1_.getItem()).func_220006_d();
         ItemStack itemstack = ShootableItem.func_220005_a(this, predicate);
         if (!itemstack.isEmpty()) {
            return itemstack;
         } else {
            predicate = ((ShootableItem)p_213356_1_.getItem()).func_220004_b();
            ...
            return this.playerAbilities.isCreativeMode ? new ItemStack(Items.ARROW) : ItemStack.EMPTY;
         }
      }
   }

   public ItemStack func_213357_a(World p_213357_1_, ItemStack p_213357_2_) {
      this.getFoodStats().func_221410_a(p_213357_2_.getItem(), p_213357_2_);
