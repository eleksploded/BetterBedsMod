...
public class DrownedEntity extends ZombieEntity implements IRangedAttackMob {
   ...
   public DrownedEntity(EntityType<? extends DrownedEntity> p_i50212_1_, World p_i50212_2_) {
      ...
      this.field_70765_h = new DrownedEntity.MoveHelperController(this);
      this.setPathPriority(PathNodeType.WATER, 0.0F);
      this.field_204716_a = new SwimmerPathNavigator(this, p_i50212_2_);
      this.field_204717_b = new GroundPathNavigator(this, p_i50212_2_);
   }

   protected void applyEntityAI() {
      this.field_70714_bg.addTask(1, new DrownedEntity.GoToWaterGoal(this, 1.0D));
      this.field_70714_bg.addTask(2, new DrownedEntity.TridentAttackGoal(this, 1.0D, 40, 10.0F));
      this.field_70714_bg.addTask(2, new DrownedEntity.AttackGoal(this, 1.0D, false));
      this.field_70714_bg.addTask(5, new DrownedEntity.GoToBeachGoal(this, 1.0D));
      this.field_70714_bg.addTask(6, new DrownedEntity.SwimUpGoal(this, 1.0D, this.world.getSeaLevel()));
      this.field_70714_bg.addTask(7, new RandomWalkingGoal(this, 1.0D));
      this.field_70715_bh.addTask(1, (new HurtByTargetGoal(this, DrownedEntity.class)).func_220794_a(ZombiePigmanEntity.class));
      this.field_70715_bh.addTask(2, new NearestAttackableTargetGoal<>(this, PlayerEntity.class, 10, true, false, this::shouldAttack));
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      Biome biome = p_213380_1_.getBiome(new BlockPos(this.posX, this.posY, this.posZ));
      if (biome != Biomes.RIVER && biome != Biomes.FROZEN_RIVER) {
         return this.rand.nextInt(40) == 0 && this.func_204712_dC() && super.canSpawn(p_213380_1_, p_213380_2_);
      } else {
         return this.rand.nextInt(15) == 0 && super.canSpawn(p_213380_1_, p_213380_2_);
      }
   }
   ...
   public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
      ...
      this.world.func_217376_c(tridententity);
   }
   ...
   static class GoToBeachGoal extends MoveToBlockGoal {
       ...
       */
      public boolean shouldExecute() {
         return super.shouldExecute() && !this.field_204727_f.world.isDaytime() && this.field_204727_f.isInWater() && this.field_204727_f.posY >= (double)(this.field_204727_f.world.getSeaLevel() - 3);
      }
      ...
      protected boolean shouldMoveTo(IWorldReader worldIn, BlockPos pos) {
         ...
         return worldIn.isAirBlock(blockpos) && worldIn.isAirBlock(blockpos.up()) ? worldIn.getBlockState(pos).func_215682_a(worldIn, pos, this.field_204727_f) : false;
      }
      ...
      public void startExecuting() {
         this.field_204727_f.setSwimmingUp(false);
   ...
   static class MoveHelperController extends MovementController {
      ...
      public void tick() {
         LivingEntity livingentity = this.field_204725_i.getAttackTarget();
         if (this.field_204725_i.func_204715_dF() && this.field_204725_i.isInWater()) {
            if (livingentity != null && livingentity.posY > this.field_204725_i.posY || this.field_204725_i.swimmingUp) {
               this.field_204725_i.setMotion(this.field_204725_i.getMotion().add(0.0D, 0.002D, 0.0D));
            }

            if (this.field_188491_h != MovementController.Action.MOVE_TO || this.field_204725_i.getNavigator().noPath()) {
               this.field_204725_i.setAIMoveSpeed(0.0F);
               return;
            }

            double d0 = this.posX - this.field_204725_i.posX;
            double d1 = this.posY - this.field_204725_i.posY;
            double d2 = this.posZ - this.field_204725_i.posZ;
            double d3 = (double)MathHelper.sqrt(d0 * d0 + d1 * d1 + d2 * d2);
            d1 = d1 / d3;
            float f = (float)(MathHelper.atan2(d2, d0) * (double)(180F / (float)Math.PI)) - 90.0F;
            this.field_204725_i.rotationYaw = this.limitAngle(this.field_204725_i.rotationYaw, f, 90.0F);
            this.field_204725_i.renderYawOffset = this.field_204725_i.rotationYaw;
            float f1 = (float)(this.speed * this.field_204725_i.getAttribute(SharedMonsterAttributes.MOVEMENT_SPEED).getValue());
            float f2 = MathHelper.func_219799_g(0.125F, this.field_204725_i.getAIMoveSpeed(), f1);
            this.field_204725_i.setAIMoveSpeed(f2);
            this.field_204725_i.setMotion(this.field_204725_i.getMotion().add((double)f2 * d0 * 0.005D, (double)f2 * d1 * 0.1D, (double)f2 * d2 * 0.005D));
         } else {
            if (!this.field_204725_i.onGround) {
               this.field_204725_i.setMotion(this.field_204725_i.getMotion().add(0.0D, -0.008D, 0.0D));
            }
