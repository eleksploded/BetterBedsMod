...
public class ExpirePOITask extends Task<LivingEntity> {
   ...
   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      ...
      return Objects.equals(worldIn.getDimension().getType(), globalpos.func_218177_a()) && globalpos.func_218180_b().func_218137_a(owner.getPositionVec(), 5.0D);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      ServerWorld serverworld = p_212831_1_.getServer().getWorld(globalpos.func_218177_a());
      if (this.func_223020_a(serverworld, globalpos.func_218180_b()) || this.func_223019_a(serverworld, globalpos.func_218180_b(), p_212831_2_)) {
   ...
   private boolean func_223019_a(ServerWorld p_223019_1_, BlockPos p_223019_2_, LivingEntity p_223019_3_) {
      ...
      return blockstate.getBlock().isIn(BlockTags.field_219747_F) && blockstate.get(BedBlock.OCCUPIED) && !p_223019_3_.isPlayerSleeping();
   }
