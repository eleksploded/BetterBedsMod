...
public class ShulkerBulletEntity extends Entity {
   ...
   protected void writeAdditional(CompoundNBT p_213281_1_) {
      if (this.field_184570_a != null) {
         ...
         CompoundNBT compoundnbt = NBTUtil.writeUniqueId(this.field_184570_a.getUniqueID());
      ...
      if (this.field_184573_c != null) {
         p_213281_1_.putInt("Dir", this.field_184573_c.getIndex());
      }
   ...
   protected void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Dir", 99)) {
         this.field_184573_c = Direction.byIndex(compound.getInt("Dir"));
      }
   ...
   private void selectNextMoveDirection(@Nullable Direction.Axis p_184569_1_) {
      ...
      if (!blockpos.func_218137_a(this.getPositionVec(), 2.0D)) {
   ...
   public void tick() {
      if (!this.world.isRemote && this.world.getDifficulty() == Difficulty.PEACEFUL) {
         ...
         if (!this.world.isRemote) {
            ...
            if (this.field_184570_a == null && this.ownerUniqueId != null) {
         ...
         if (this.world.isRemote) {
            ...
            if (this.steps > 0) {
               --this.steps;
               if (this.steps == 0) {
                  this.selectNextMoveDirection(this.field_184573_c == null ? null : this.field_184573_c.getAxis());
               }
            }

            if (this.field_184573_c != null) {
               BlockPos blockpos1 = new BlockPos(this);
               Direction.Axis direction$axis = this.field_184573_c.getAxis();
               if (this.world.func_217400_a(blockpos1.offset(this.field_184573_c), this)) {
   ...
   protected void bulletHit(RayTraceResult result) {
      if (result.getType() == RayTraceResult.Type.ENTITY) {
         ...
         boolean flag = entity.attackEntityFrom(DamageSource.causeIndirectDamage(this, this.field_184570_a).setProjectile(), 4.0F);
         if (flag) {
            this.applyEnchantments(this.field_184570_a, entity);
            if (entity instanceof LivingEntity) {
               ((LivingEntity)entity).addPotionEffect(new EffectInstance(Effects.field_188424_y, 200));
            }
         }
      } else {
