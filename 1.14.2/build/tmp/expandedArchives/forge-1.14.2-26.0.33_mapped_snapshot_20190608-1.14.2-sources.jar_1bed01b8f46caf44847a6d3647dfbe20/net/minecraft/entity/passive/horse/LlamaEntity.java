...
public class LlamaEntity extends AbstractChestedHorseEntity implements IRangedAttackMob {
   private static final DataParameter<Integer> DATA_STRENGTH_ID = EntityDataManager.createKey(LlamaEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> DATA_COLOR_ID = EntityDataManager.createKey(LlamaEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.createKey(LlamaEntity.class, DataSerializers.field_187192_b);
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (!this.field_110296_bG.getStackInSlot(1).isEmpty()) {
         p_213281_1_.put("DecorItem", this.field_110296_bG.getStackInSlot(1).write(new CompoundNBT()));
      }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("DecorItem", 10)) {
         this.field_110296_bG.setInventorySlotContents(1, ItemStack.read(compound.getCompound("DecorItem")));
      }
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(2, new LlamaFollowCaravanGoal(this, (double)2.1F));
      this.field_70714_bg.addTask(3, new RangedAttackGoal(this, 1.25D, 40, 20.0F));
      this.field_70714_bg.addTask(3, new PanicGoal(this, 1.2D));
      this.field_70714_bg.addTask(4, new BreedGoal(this, 1.0D));
      this.field_70714_bg.addTask(5, new FollowParentGoal(this, 1.0D));
      ...
      this.field_70715_bh.addTask(1, new LlamaEntity.HurtByTargetGoal(this));
      this.field_70715_bh.addTask(2, new LlamaEntity.DefendTargetGoal(this));
   }
   ...
   protected void updateHorseSlots() {
      if (!this.world.isRemote) {
         ...
         this.setColor(getCarpetColor(this.field_110296_bG.getStackInSlot(1)));
      }
   }
   ...
   private void spit(LivingEntity target) {
      ...
      this.world.func_217376_c(llamaspitentity);
      this.didSpit = true;
   }
