...
public class MoveThroughVillageGoal extends Goal {
   ...
   public MoveThroughVillageGoal(CreatureEntity p_i50324_1_, double p_i50324_2_, boolean p_i50324_4_, int p_i50324_5_, BooleanSupplier p_i50324_6_) {
      this.field_75420_a = p_i50324_1_;
   ...
   public boolean shouldExecute() {
      this.resizeDoorList();
      if (this.isNocturnal && this.field_75420_a.world.isDaytime()) {
         return false;
      } else {
         ServerWorld serverworld = (ServerWorld)this.field_75420_a.world;
         BlockPos blockpos = new BlockPos(this.field_75420_a);
         if (!serverworld.func_217471_a(blockpos, 6)) {
            return false;
         } else {
            Vec3d vec3d = RandomPositionGenerator.func_221024_a(this.field_75420_a, 15, 7, (p_220734_3_) -> {
            ...
            if (vec3d == null) {
               ...
               if (!optional.isPresent()) {
                  ...
                  GroundPathNavigator groundpathnavigator = (GroundPathNavigator)this.field_75420_a.getNavigator();
                  ...
                  if (this.path == null) {
                     Vec3d vec3d1 = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_75420_a, 10, 7, new Vec3d((double)this.field_220735_d.getX(), (double)this.field_220735_d.getY(), (double)this.field_220735_d.getZ()));
                     if (vec3d1 == null) {
                        return false;
                     }

                     groundpathnavigator.setBreakDoors(this.field_220737_h.getAsBoolean());
                     this.path = this.field_75420_a.getNavigator().getPathToXYZ(vec3d1.x, vec3d1.y, vec3d1.z);
                     groundpathnavigator.setBreakDoors(flag);
                     if (this.path == null) {
                        return false;
                     }
                  ...
                  for(int i = 0; i < this.path.getCurrentPathLength(); ++i) {
                     ...
                     if (InteractDoorGoal.func_220695_a(this.field_75420_a.world, blockpos1)) {
                        this.path = this.field_75420_a.getNavigator().getPathToXYZ((double)pathpoint.x, (double)pathpoint.y, (double)pathpoint.z);
                        break;
                     }
                  }
   ...
   public boolean shouldContinueExecuting() {
      if (this.field_75420_a.getNavigator().noPath()) {
         return false;
      } else {
         return !this.field_220735_d.func_218137_a(this.field_75420_a.getPositionVec(), (double)(this.field_75420_a.getWidth() + (float)this.field_220736_g));
      }
   }
   ...
   public void startExecuting() {
      this.field_75420_a.getNavigator().setPath(this.path, this.movementSpeed);
   }
   ...
   public void resetTask() {
      if (this.field_75420_a.getNavigator().noPath() || this.field_220735_d.func_218137_a(this.field_75420_a.getPositionVec(), (double)this.field_220736_g)) {
