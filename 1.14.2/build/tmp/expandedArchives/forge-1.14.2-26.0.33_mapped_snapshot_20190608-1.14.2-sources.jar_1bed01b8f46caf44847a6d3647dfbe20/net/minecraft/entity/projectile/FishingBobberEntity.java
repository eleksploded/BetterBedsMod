...
public class FishingBobberEntity extends Entity {
   private static final DataParameter<Integer> DATA_HOOKED_ENTITY = EntityDataManager.createKey(FishingBobberEntity.class, DataSerializers.field_187192_b);
   ...
   private FishingBobberEntity(World p_i50219_1_, PlayerEntity p_i50219_2_, int p_i50219_3_, int p_i50219_4_) {
      ...
      this.field_146042_b.fishingBobber = this;
   ...
   public FishingBobberEntity(PlayerEntity p_i50220_1_, World p_i50220_2_, int p_i50220_3_, int p_i50220_4_) {
      ...
      float f = this.field_146042_b.rotationPitch;
      float f1 = this.field_146042_b.rotationYaw;
      float f2 = MathHelper.cos(-f1 * ((float)Math.PI / 180F) - (float)Math.PI);
      float f3 = MathHelper.sin(-f1 * ((float)Math.PI / 180F) - (float)Math.PI);
      float f4 = -MathHelper.cos(-f * ((float)Math.PI / 180F));
      float f5 = MathHelper.sin(-f * ((float)Math.PI / 180F));
      double d0 = this.field_146042_b.posX - (double)f3 * 0.3D;
      double d1 = this.field_146042_b.posY + (double)this.field_146042_b.getEyeHeight();
      double d2 = this.field_146042_b.posZ - (double)f2 * 0.3D;
   ...
   private boolean shouldStopFishing() {
      ItemStack itemstack = this.field_146042_b.getHeldItemMainhand();
      ItemStack itemstack1 = this.field_146042_b.getHeldItemOffhand();
      ...
      if (!this.field_146042_b.removed && this.field_146042_b.isAlive() && (flag || flag1) && !(this.getDistanceSq(this.field_146042_b) > 1024.0D)) {
         return false;
      } else {
         this.remove();
         return true;
   ...
   private void checkCollision() {
      RayTraceResult raytraceresult = ProjectileHelper.func_221267_a(this, this.getBoundingBox().func_216361_a(this.getMotion()).grow(1.0D), (p_213856_1_) -> {
         return !p_213856_1_.isSpectator() && (p_213856_1_.canBeCollidedWith() || p_213856_1_ instanceof ItemEntity) && (p_213856_1_ != this.field_146042_b || this.ticksInAir >= 5);
      ...
      if (this.ticksCatchable > 0) {
         ...
         if (this.rand.nextFloat() < f5) {
            ...
            if (serverworld.getBlockState(new BlockPos(d4, d5 - 1.0D, d6)).getMaterial() == net.minecraft.block.material.Material.WATER) {
               serverworld.spawnParticle(ParticleTypes.field_218422_X, d4, d5, d6, 2 + this.rand.nextInt(2), (double)0.1F, 0.0D, (double)0.1F, 0.0D);
            }
         }
   ...
   public int handleHookRetraction(ItemStack p_146034_1_) {
      if (!this.world.isRemote && this.field_146042_b != null) {
         int i = 0;
         ...
         if (this.caughtEntity != null) {
            ...
            LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withParameter(LootParameters.field_216286_f, new BlockPos(this)).withParameter(LootParameters.field_216289_i, p_146034_1_).withRandom(this.rand).withLuck((float)this.luck + this.field_146042_b.getLuck());
            lootcontext$builder.withParameter(LootParameters.field_216284_d, this.field_146042_b).withParameter(LootParameters.field_216281_a, this);
            LootTable loottable = this.world.getServer().getLootTableManager().getLootTableFromLocation(LootTables.GAMEPLAY_FISHING);
            List<ItemStack> list = loottable.func_216113_a(lootcontext$builder.build(LootParameterSets.field_216262_c));
   ...
   protected void bringInHookedEntity() {
      if (this.field_146042_b != null) {
         Vec3d vec3d = (new Vec3d(this.field_146042_b.posX - this.posX, this.field_146042_b.posY - this.posY, this.field_146042_b.posZ - this.posZ)).scale(0.1D);
   ...
   public void remove() {
      super.remove();
      if (this.field_146042_b != null) {
         this.field_146042_b.fishingBobber = null;
      }
