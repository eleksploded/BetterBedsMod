...
public class InteractWithEntityTask<E extends LivingEntity, T extends LivingEntity> extends Task<E> {
   ...
   public InteractWithEntityTask(EntityType<? extends T> p_i50363_1_, int p_i50363_2_, Predicate<E> p_i50363_3_, Predicate<T> p_i50363_4_, MemoryModuleType<T> p_i50363_5_, float p_i50363_6_, int p_i50363_7_) {
      super(ImmutableMap.of(MemoryModuleType.field_220951_l, MemoryModuleStatus.REGISTERED, MemoryModuleType.field_220950_k, MemoryModuleStatus.VALUE_ABSENT, p_i50363_5_, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220946_g, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, E owner) {
      return this.field_220451_f.test(owner) && owner.getBrain().getMemory(MemoryModuleType.field_220946_g).get().stream().anyMatch((p_220444_1_) -> {
   ...
   protected void startExecuting(ServerWorld p_212831_1_, E p_212831_2_, long p_212831_3_) {
      ...
      brain.getMemory(MemoryModuleType.field_220946_g).ifPresent((p_220437_3_) -> {
         p_220437_3_.stream().filter((p_220440_1_) -> {
            ...
            brain.setMemory(MemoryModuleType.field_220951_l, new EntityPosWrapper(p_220438_2_));
            brain.setMemory(MemoryModuleType.field_220950_k, new WalkTarget(new EntityPosWrapper(p_220438_2_), this.field_220447_b, this.field_220446_a));
         });
      });
   }
}