...
public class NearestBedSensor extends Sensor<MobEntity> {
   ...
   protected void update(ServerWorld p_212872_1_, MobEntity p_212872_2_) {
      if (p_212872_2_.isChild()) {
         p_212872_2_.getBrain().setMemory(MemoryModuleType.field_220956_q, this.func_220977_b(p_212872_1_, p_212872_2_));
      }
   }
   ...
   private Optional<BlockPos> func_220977_b(ServerWorld p_220977_1_, MobEntity p_220977_2_) {
      ...
      return pointofinterestmanager.func_219147_b(PointOfInterestType.field_221069_q.func_221045_c(), predicate, new BlockPos(p_220977_2_), 16, PointOfInterestManager.Status.ANY);
   }
}