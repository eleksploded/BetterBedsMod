...
public class EntitySpawnPlacementRegistry {
   ...
   static {
      ...
      register(EntityType.field_220350_aJ, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES);
   ...
   static class Entry {
      ...
      private final EntitySpawnPlacementRegistry.PlacementType field_209340_b;

      public Entry(Heightmap.Type p_i50583_1_, EntitySpawnPlacementRegistry.PlacementType p_i50583_2_) {
         this.type = p_i50583_1_;
         this.field_209340_b = p_i50583_2_;
      }
   }
