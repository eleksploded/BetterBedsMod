...
public abstract class MoveToBlockGoal extends Goal {
   ...
   public MoveToBlockGoal(CreatureEntity creatureIn, double speed, int length, int p_i48796_5_) {
      this.field_179495_c = creatureIn;
   ...
   public boolean shouldExecute() {
      if (this.runDelay > 0) {
         ...
         this.runDelay = this.getRunDelay(this.field_179495_c);
   ...
   public boolean shouldContinueExecuting() {
      return this.timeoutCounter >= -this.maxStayTicks && this.timeoutCounter <= 1200 && this.shouldMoveTo(this.field_179495_c.world, this.destinationBlock);
   }
   ...
   public void startExecuting() {
      ...
      this.maxStayTicks = this.field_179495_c.getRNG().nextInt(this.field_179495_c.getRNG().nextInt(1200) + 1200) + 1200;
   }

   protected void func_220725_g() {
      this.field_179495_c.getNavigator().tryMoveToXYZ((double)((float)this.destinationBlock.getX()) + 0.5D, (double)(this.destinationBlock.getY() + 1), (double)((float)this.destinationBlock.getZ()) + 0.5D, this.movementSpeed);
   }
    ...
    */
   public void tick() {
      if (!this.destinationBlock.up().func_218137_a(this.field_179495_c.getPositionVec(), this.getTargetDistanceSq())) {
         ...
         for(int l = 0; l < i; ++l) {
            for(int i1 = 0; i1 <= l; i1 = i1 > 0 ? -i1 : 1 - i1) {
               for(int j1 = i1 < l && i1 > -l ? l : 0; j1 <= l; j1 = j1 > 0 ? -j1 : 1 - j1) {
                  ...
                  if (this.field_179495_c.func_213389_a(blockpos$mutableblockpos) && this.shouldMoveTo(this.field_179495_c.world, blockpos$mutableblockpos)) {
