...
public class LookAtEntityTask extends Task<LivingEntity> {
   ...
   public LookAtEntityTask(EntityClassification p_i50350_1_, float p_i50350_2_) {
      this((p_220514_1_) -> {
         return p_i50350_1_.equals(p_220514_1_.getType().getClassiciation());
      }, p_i50350_2_);
   }
   ...
   public LookAtEntityTask(Predicate<LivingEntity> p_i50352_1_, float p_i50352_2_) {
      super(ImmutableMap.of(MemoryModuleType.field_220951_l, MemoryModuleStatus.VALUE_ABSENT, MemoryModuleType.field_220946_g, MemoryModuleStatus.VALUE_PRESENT));
      this.field_220519_a = p_i50352_1_;
      this.field_220520_b = p_i50352_2_ * p_i50352_2_;
   }

   protected boolean shouldExecute(ServerWorld worldIn, LivingEntity owner) {
      return owner.getBrain().getMemory(MemoryModuleType.field_220946_g).get().stream().anyMatch(this.field_220519_a);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, LivingEntity p_212831_2_, long p_212831_3_) {
      ...
      brain.getMemory(MemoryModuleType.field_220946_g).ifPresent((p_220515_3_) -> {
         p_220515_3_.stream().filter(this.field_220519_a).filter((p_220517_2_) -> {
            ...
            brain.setMemory(MemoryModuleType.field_220951_l, new EntityPosWrapper(p_220516_1_));
         });
      });
   }
}