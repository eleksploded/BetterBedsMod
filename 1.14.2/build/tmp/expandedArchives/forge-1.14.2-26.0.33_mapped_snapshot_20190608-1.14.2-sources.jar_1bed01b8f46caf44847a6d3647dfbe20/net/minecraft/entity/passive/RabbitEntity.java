...
public class RabbitEntity extends AnimalEntity {
   private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager.createKey(RabbitEntity.class, DataSerializers.field_187192_b);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new RabbitEntity.PanicGoal(this, 2.2D));
      this.field_70714_bg.addTask(2, new BreedGoal(this, 0.8D));
      this.field_70714_bg.addTask(3, new TemptGoal(this, 1.0D, Ingredient.fromItems(Items.CARROT, Items.GOLDEN_CARROT, Blocks.DANDELION), false));
      this.field_70714_bg.addTask(4, new RabbitEntity.AvoidEntityGoal<>(this, PlayerEntity.class, 8.0F, 2.2D, 2.2D));
      this.field_70714_bg.addTask(4, new RabbitEntity.AvoidEntityGoal<>(this, WolfEntity.class, 10.0F, 2.2D, 2.2D));
      this.field_70714_bg.addTask(4, new RabbitEntity.AvoidEntityGoal<>(this, MonsterEntity.class, 4.0F, 2.2D, 2.2D));
      this.field_70714_bg.addTask(5, new RabbitEntity.RaidFarmGoal(this));
      this.field_70714_bg.addTask(6, new WaterAvoidingRandomWalkingGoal(this, 0.6D));
      this.field_70714_bg.addTask(11, new LookAtGoal(this, PlayerEntity.class, 10.0F));
   }

   protected float getJumpUpwardsMotion() {
      if (!this.collidedHorizontally && (!this.field_70765_h.isUpdating() || !(this.field_70765_h.getY() > this.posY + 0.5D))) {
         Path path = this.field_70699_by.getPath();
         ...
         return this.field_70765_h.getSpeed() <= 0.6D ? 0.2F : 0.3F;
      } else {
         return 0.5F;
      }
   }
   ...
   protected void jump() {
      super.jump();
      double d0 = this.field_70765_h.getSpeed();
      if (d0 > 0.0D) {
   ...
   public void setMovementSpeed(double newSpeed) {
      ...
      this.field_70765_h.setMoveTo(this.field_70765_h.getX(), this.field_70765_h.getY(), this.field_70765_h.getZ(), newSpeed);
   }
      ...
      if (this.onGround) {
         ...
         if (this.getRabbitType() == 99 && this.currentMoveTypeDuration == 0) {
            ...
            if (livingentity != null && this.getDistanceSq(livingentity) < 16.0D) {
               ...
               this.field_70765_h.setMoveTo(livingentity.posX, livingentity.posY, livingentity.posZ, this.field_70765_h.getSpeed());
               this.startJumping();
               this.wasOnGround = true;
            }
         }

         RabbitEntity.JumpHelperController rabbitentity$jumphelpercontroller = (RabbitEntity.JumpHelperController)this.field_70767_i;
         if (!rabbitentity$jumphelpercontroller.getIsJumping()) {
            if (this.field_70765_h.isUpdating() && this.currentMoveTypeDuration == 0) {
               Path path = this.field_70699_by.getPath();
               Vec3d vec3d = new Vec3d(this.field_70765_h.getX(), this.field_70765_h.getY(), this.field_70765_h.getZ());
               if (path != null && path.getCurrentPathIndex() < path.getCurrentPathLength()) {
   ...
   private void enableJumpControl() {
      ((RabbitEntity.JumpHelperController)this.field_70767_i).setCanJump(true);
   }

   private void disableJumpControl() {
      ((RabbitEntity.JumpHelperController)this.field_70767_i).setCanJump(false);
   }

   private void updateMoveTypeDuration() {
      if (this.field_70765_h.getSpeed() < 2.2D) {
   ...
   public void setRabbitType(int rabbitTypeId) {
      if (rabbitTypeId == 99) {
         ...
         this.field_70714_bg.addTask(4, new RabbitEntity.EvilAttackGoal(this));
         ...
         this.field_70715_bh.addTask(2, new NearestAttackableTargetGoal<>(this, WolfEntity.class, true));
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      ...
      Block block = p_213380_1_.getBlockState(blockpos.down()).getBlock();
      return block != Blocks.GRASS_BLOCK && block != Blocks.SNOW && block != Blocks.SAND ? super.canSpawn(p_213380_1_, p_213380_2_) : true; //Forge: GRASS -> GRASS_BLOCk
   }
   ...
   static class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
      ...
      public boolean shouldExecute() {
         return this.field_179511_d.getRabbitType() != 99 && super.shouldExecute();
      }
   }
   ...
   public class JumpHelperController extends JumpController {
      ...
      public void tick() {
         if (this.isJumping) {
            this.field_180070_c.startJumping();
   ...
   static class MoveHelperController extends MovementController {
      ...
      public MoveHelperController(RabbitEntity rabbit) {
         super(rabbit);
         this.field_179929_g = rabbit;
      }

      public void tick() {
         if (this.field_179929_g.onGround && !this.field_179929_g.isJumping && !((RabbitEntity.JumpHelperController)this.field_179929_g.field_70767_i).getIsJumping()) {
            this.field_179929_g.setMovementSpeed(0.0D);
         } else if (this.isUpdating()) {
            this.field_179929_g.setMovementSpeed(this.nextJumpSpeed);
         }
      ...
      public void setMoveTo(double x, double y, double z, double speedIn) {
         if (this.field_179929_g.isInWater()) {
            speedIn = 1.5D;
         }
   ...
   static class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
      ...
      public void tick() {
         super.tick();
         this.field_179486_b.setMovementSpeed(this.speed);
      }
   }
   ...
   static class RaidFarmGoal extends MoveToBlockGoal {
      ...
      public boolean shouldExecute() {
         if (this.runDelay <= 0) {
            if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.field_179500_c.world, this.field_179500_c)) {
               return false;
            }

            this.canRaid = false;
            this.wantsToRaid = this.field_179500_c.isCarrotEaten();
      ...
      public void tick() {
         ...
         if (this.getIsAboveDestination()) {
            ...
            if (this.canRaid && block instanceof CarrotBlock) {
               ...
               this.field_179500_c.carrotTicks = 40;
            }
