...
public class FleeTask extends Task<CreatureEntity> {
   ...
   public FleeTask(MemoryModuleType<? extends Entity> p_i50346_1_, float p_i50346_2_) {
      super(ImmutableMap.of(MemoryModuleType.field_220950_k, MemoryModuleStatus.VALUE_ABSENT, p_i50346_1_, MemoryModuleStatus.VALUE_PRESENT));
   ...
   public static void func_220540_a(CreatureEntity p_220540_0_, Entity p_220540_1_, float p_220540_2_) {
      for(int i = 0; i < 10; ++i) {
         ...
         if (vec3d3 != null) {
            p_220540_0_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(vec3d3, p_220540_2_, 0));
            return;
         }
      }
