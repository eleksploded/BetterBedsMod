...
public class ArmorStandEntity extends LivingEntity {
   ...
   public static final DataParameter<Byte> STATUS = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187191_a);
   public static final DataParameter<Rotations> HEAD_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   public static final DataParameter<Rotations> BODY_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   public static final DataParameter<Rotations> LEFT_ARM_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   public static final DataParameter<Rotations> RIGHT_ARM_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   public static final DataParameter<Rotations> LEFT_LEG_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   public static final DataParameter<Rotations> RIGHT_LEG_ROTATION = EntityDataManager.createKey(ArmorStandEntity.class, DataSerializers.field_187199_i);
   ...
   private void swapItem(PlayerEntity player, EquipmentSlotType p_184795_2_, ItemStack p_184795_3_, Hand hand) {
      ...
      if (itemstack.isEmpty() || (this.disabledSlots & 1 << p_184795_2_.getSlotIndex() + 8) == 0) {
         if (!itemstack.isEmpty() || (this.disabledSlots & 1 << p_184795_2_.getSlotIndex() + 16) == 0) {
            if (player.playerAbilities.isCreativeMode && itemstack.isEmpty() && !p_184795_3_.isEmpty()) {
      ...
      if (!this.world.isRemote && !this.removed) {
         if (DamageSource.OUT_OF_WORLD.equals(source)) {
            ...
            if (source.isExplosion()) {
               ...
               if (!flag2 && !flag) {
                  return false;
               } else if (source.getTrueSource() instanceof PlayerEntity && !((PlayerEntity)source.getTrueSource()).playerAbilities.allowEdit) {
                  return false;
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      ...
      return this.getType().func_220334_j().scale(f);
   }
}