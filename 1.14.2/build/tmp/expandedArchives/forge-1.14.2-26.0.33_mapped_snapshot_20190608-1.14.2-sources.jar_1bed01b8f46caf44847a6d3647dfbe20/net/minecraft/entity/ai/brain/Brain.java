...
public class Brain<E extends LivingEntity> implements IDynamicSerializable {
   ...
   private Schedule schedule = Schedule.field_221383_a;
   ...
   public <T> Brain(Collection<MemoryModuleType<?>> p_i50378_1_, Collection<SensorType<? extends Sensor<? super E>>> p_i50378_2_, Dynamic<T> p_i50378_3_) {
      ...
      for(Entry<Dynamic<T>, Dynamic<T>> entry : p_i50378_3_.get("memories").asMap(Function.identity(), Function.identity()).entrySet()) {
         this.setMemory(Registry.field_218372_N.getOrDefault(new ResourceLocation(entry.getKey().asString(""))), entry.getValue());
      }
   ...
   public void updateActivity(long p_218211_1_, long p_218211_3_) {
      if (p_218211_3_ - this.lastGameTime > 20L) {
         ...
         Activity activity = this.getSchedule().getScheduledActivity((int)(p_218211_1_ % 24000L));
   ...
   public void stopAllTasks(ServerWorld p_218227_1_, E p_218227_2_) {
      long i = p_218227_2_.world.getGameTime();
      this.getRunningTasks().forEach((p_218206_4_) -> {
         p_218206_4_.stop(p_218227_1_, p_218227_2_, i);
      });
   }
   ...
   public <T> T serializeDynamic(DynamicOps<T> p_218175_1_) {
      T t = p_218175_1_.createMap(this.memories.entrySet().stream().filter((p_218197_0_) -> {
         ...
         return Pair.of(p_218175_1_.createString(Registry.field_218372_N.getKey(p_218186_1_.getKey()).toString()), ((IDynamicSerializable)p_218186_1_.getValue().get()).serializeDynamic(p_218175_1_));
