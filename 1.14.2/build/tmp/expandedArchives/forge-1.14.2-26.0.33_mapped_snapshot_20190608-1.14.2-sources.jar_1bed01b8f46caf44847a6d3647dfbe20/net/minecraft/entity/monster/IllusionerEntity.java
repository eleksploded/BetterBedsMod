...
public class IllusionerEntity extends SpellcastingIllagerEntity implements IRangedAttackMob {
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new SpellcastingIllagerEntity.CastingASpellGoal());
      this.field_70714_bg.addTask(4, new IllusionerEntity.MirrorSpellGoal());
      this.field_70714_bg.addTask(5, new IllusionerEntity.BlindnessSpellGoal());
      this.field_70714_bg.addTask(6, new RangedBowAttackGoal<>(this, 0.5D, 20, 15.0F));
   ...
   class BlindnessSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      protected void castSpell() {
         IllusionerEntity.this.getAttackTarget().addPotionEffect(new EffectInstance(Effects.field_76440_q, 400));
      }
   ...
   class MirrorSpellGoal extends SpellcastingIllagerEntity.UseSpellGoal {
      ...
      public boolean shouldExecute() {
         if (!super.shouldExecute()) {
            ...
            return !IllusionerEntity.this.isPotionActive(Effects.field_76441_p);
         }
      }
      ...
      protected void castSpell() {
         IllusionerEntity.this.addPotionEffect(new EffectInstance(Effects.field_76441_p, 1200));
      }
