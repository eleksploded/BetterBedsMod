...
public class SheepEntity extends AnimalEntity implements net.minecraftforge.common.IShearable {
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(3, new TemptGoal(this, 1.1D, Ingredient.fromItems(Items.WHEAT), false));
      this.field_70714_bg.addTask(4, new FollowParentGoal(this, 1.1D));
      this.field_70714_bg.addTask(5, this.field_146087_bs);
   ...
   protected void updateAITasks() {
      this.sheepTimer = this.field_146087_bs.getEatingGrassTimer();
      super.updateAITasks();
   }
   ...
   public boolean processInteract(PlayerEntity player, Hand hand) {
      ...
      if (false && itemstack.getItem() == Items.SHEARS && !this.getSheared() && !this.isChild()) { //Forge: Moved to onSheared
         this.func_213612_dV();
         if (!this.world.isRemote) {
            itemstack.func_222118_a(1, player, (p_213613_1_) -> {
