...
public class WalkTowardsPosTask extends Task<CreatureEntity> {
   ...
   public WalkTowardsPosTask(MemoryModuleType<GlobalPos> p_i50341_1_, int p_i50341_2_, int p_i50341_3_) {
      super(ImmutableMap.of(MemoryModuleType.field_220950_k, MemoryModuleStatus.REGISTERED, p_i50341_1_, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, CreatureEntity owner) {
      ...
      return optional.isPresent() && Objects.equals(worldIn.getDimension().getType(), optional.get().func_218177_a()) && optional.get().func_218180_b().func_218137_a(owner.getPositionVec(), (double)this.field_220583_c);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, CreatureEntity p_212831_2_, long p_212831_3_) {
      if (p_212831_3_ > this.field_220584_d) {
         ...
         optional.ifPresent((p_220580_2_) -> {
            brain.setMemory(MemoryModuleType.field_220950_k, new WalkTarget(p_220580_2_.func_218180_b(), 0.4F, this.field_220582_b));
         });
