...
public class EndermanEntity extends MonsterEntity {
   ...
   private static final DataParameter<Optional<BlockState>> CARRIED_BLOCK = EntityDataManager.createKey(EndermanEntity.class, DataSerializers.field_187197_g);
   private static final DataParameter<Boolean> SCREAMING = EntityDataManager.createKey(EndermanEntity.class, DataSerializers.field_187198_h);
   ...
   protected void initEntityAI() {
      ...
      this.field_70714_bg.addTask(1, new EndermanEntity.StareGoal(this));
      this.field_70714_bg.addTask(2, new MeleeAttackGoal(this, 1.0D, false));
      this.field_70714_bg.addTask(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 0.0F));
      ...
      this.field_70714_bg.addTask(10, new EndermanEntity.PlaceBlockGoal(this));
      this.field_70714_bg.addTask(11, new EndermanEntity.TakeBlockGoal(this));
      this.field_70715_bh.addTask(1, new EndermanEntity.FindPlayerGoal(this));
      this.field_70715_bh.addTask(2, new HurtByTargetGoal(this));
      this.field_70715_bh.addTask(3, new NearestAttackableTargetGoal<>(this, EndermiteEntity.class, 10, true, false, field_213627_bA));
   }
   ...
   static class FindPlayerGoal extends NearestAttackableTargetGoal<PlayerEntity> {
      ...
      public FindPlayerGoal(EndermanEntity p_i45842_1_) {
         ...
         this.field_220791_m = (new EntityPredicate()).func_221013_a(this.getTargetDistance()).func_221012_a((p_220790_1_) -> {
      ...
      public boolean shouldExecute() {
         this.field_179448_g = this.field_179449_j.world.func_217370_a(this.field_220791_m, this.field_179449_j);
      ...
      public boolean shouldContinueExecuting() {
         if (this.field_179448_g != null) {
            ...
            return this.field_75309_a != null && this.field_220792_n.canTarget(this.field_179449_j, this.field_75309_a) ? true : super.shouldContinueExecuting();
         }
      }
      ...
      public void tick() {
         if (this.field_179448_g != null) {
            ...
            if (this.field_75309_a != null && !this.field_179449_j.isPassenger()) {
               if (this.field_179449_j.shouldAttackPlayer((PlayerEntity)this.field_75309_a)) {
                  if (this.field_75309_a.getDistanceSq(this.field_179449_j) < 16.0D) {
                     this.field_179449_j.teleportRandomly();
                  }

                  this.teleportTime = 0;
               } else if (this.field_75309_a.getDistanceSq(this.field_179449_j) > 256.0D && this.teleportTime++ >= 30 && this.field_179449_j.teleportToEntity(this.field_75309_a)) {
                  this.teleportTime = 0;
               }
            }
   ...
   static class PlaceBlockGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         if (this.field_179475_a.getHeldBlockState() == null) {
            return false;
         } else if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.field_179475_a.world, this.field_179475_a)) {
            return false;
         } else {
            return this.field_179475_a.getRNG().nextInt(2000) == 0;
         }
      }
      ...
      public void tick() {
         ...
         IWorld iworld = this.field_179475_a.world;
         int i = MathHelper.floor(this.field_179475_a.posX - 1.0D + random.nextDouble() * 2.0D);
         int j = MathHelper.floor(this.field_179475_a.posY + random.nextDouble() * 2.0D);
         int k = MathHelper.floor(this.field_179475_a.posZ - 1.0D + random.nextDouble() * 2.0D);
         BlockPos blockpos = new BlockPos(i, j, k);
         BlockState blockstate = iworld.getBlockState(blockpos);
         BlockPos blockpos1 = blockpos.down();
         BlockState blockstate1 = iworld.getBlockState(blockpos1);
         BlockState blockstate2 = this.field_179475_a.getHeldBlockState();
   ...
   static class TakeBlockGoal extends Goal {
       ...
       */
      public boolean shouldExecute() {
         if (this.field_179473_a.getHeldBlockState() != null) {
            return false;
         } else if (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.field_179473_a.world, this.field_179473_a)) {
            return false;
         } else {
            return this.field_179473_a.getRNG().nextInt(20) == 0;
         }
      }
      ...
      public void tick() {
         ...
         World world = this.field_179473_a.world;
         int i = MathHelper.floor(this.field_179473_a.posX - 2.0D + random.nextDouble() * 4.0D);
         int j = MathHelper.floor(this.field_179473_a.posY + random.nextDouble() * 3.0D);
         int k = MathHelper.floor(this.field_179473_a.posZ - 2.0D + random.nextDouble() * 4.0D);
         BlockPos blockpos = new BlockPos(i, j, k);
         BlockState blockstate = world.getBlockState(blockpos);
         Block block = blockstate.getBlock();
         Vec3d vec3d = new Vec3d((double)MathHelper.floor(this.field_179473_a.posX) + 0.5D, (double)j + 0.5D, (double)MathHelper.floor(this.field_179473_a.posZ) + 0.5D);
         Vec3d vec3d1 = new Vec3d((double)i + 0.5D, (double)j + 0.5D, (double)k + 0.5D);
         BlockRayTraceResult blockraytraceresult = world.func_217299_a(new RayTraceContext(vec3d, vec3d1, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, this.field_179473_a));
