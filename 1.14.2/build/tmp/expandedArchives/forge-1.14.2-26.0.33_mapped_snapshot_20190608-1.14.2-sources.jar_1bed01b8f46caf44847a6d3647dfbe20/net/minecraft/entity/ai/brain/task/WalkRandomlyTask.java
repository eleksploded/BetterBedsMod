...
public class WalkRandomlyTask extends Task<CreatureEntity> {
   ...
   protected void startExecuting(ServerWorld p_212831_1_, CreatureEntity p_212831_2_, long p_212831_3_) {
      ...
      List<BlockPos> list = BlockPos.func_218281_b(blockpos.add(-1, -1, -1), blockpos.add(1, 1, 1)).map(BlockPos::toImmutable).collect(Collectors.toList());
      ...
      optional.ifPresent((p_220430_2_) -> {
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, new WalkTarget(p_220430_2_, this.field_220431_a, 0));
      });
   }
}