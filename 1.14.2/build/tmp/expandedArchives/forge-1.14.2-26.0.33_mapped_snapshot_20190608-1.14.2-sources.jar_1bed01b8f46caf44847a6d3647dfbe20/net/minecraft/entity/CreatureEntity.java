...
public abstract class CreatureEntity extends MobEntity {
   protected CreatureEntity(EntityType<? extends CreatureEntity> type, World p_i48575_2_) {
   ...
   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      return super.canSpawn(p_213380_1_, p_213380_2_) && this.getBlockPathWeight(new BlockPos(this.posX, this.getBoundingBox().minY, this.posZ), p_213380_1_) >= 0.0F;
   }
   ...
   protected void updateLeashedState() {
      ...
      if (entity != null && entity.world == this.world) {
         this.func_213390_a(new BlockPos(entity), 5);
         ...
         if (f > 10.0F) {
            this.clearLeashed(true, true);
            this.field_70714_bg.disableFlag(Goal.Flag.MOVE);
         } else if (f > 6.0F) {
            ...
            this.field_70714_bg.enableFlag(Goal.Flag.MOVE);
            float f1 = 2.0F;
