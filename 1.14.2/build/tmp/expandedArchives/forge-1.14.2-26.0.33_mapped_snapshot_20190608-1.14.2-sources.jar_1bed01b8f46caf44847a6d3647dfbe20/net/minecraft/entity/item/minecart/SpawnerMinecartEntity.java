...
public class SpawnerMinecartEntity extends AbstractMinecartEntity {
   private final AbstractSpawner field_98040_a = new AbstractSpawner() {
   ...
   protected void readAdditional(CompoundNBT compound) {
      ...
      this.field_98040_a.read(compound);
   }

   protected void writeAdditional(CompoundNBT p_213281_1_) {
      super.writeAdditional(p_213281_1_);
      this.field_98040_a.write(p_213281_1_);
   }
   ...
   public void handleStatusUpdate(byte id) {
      this.field_98040_a.setDelayToMin(id);
   }
