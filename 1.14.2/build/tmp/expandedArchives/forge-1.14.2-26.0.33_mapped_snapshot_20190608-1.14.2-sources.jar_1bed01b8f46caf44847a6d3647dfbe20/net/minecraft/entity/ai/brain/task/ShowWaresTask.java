...
public class ShowWaresTask extends Task<VillagerEntity> {
   ...
   public ShowWaresTask(int p_i50343_1_, int p_i50343_2_) {
      super(ImmutableMap.of(MemoryModuleType.field_220952_m, MemoryModuleStatus.VALUE_PRESENT), p_i50343_1_, p_i50343_2_);
   }

   public boolean shouldExecute(ServerWorld worldIn, VillagerEntity owner) {
      Brain<?> brain = owner.getBrain();
      if (!brain.getMemory(MemoryModuleType.field_220952_m).isPresent()) {
         return false;
      } else {
         LivingEntity livingentity = brain.getMemory(MemoryModuleType.field_220952_m).get();
   ...
   public boolean shouldContinueExecuting(ServerWorld p_212834_1_, VillagerEntity p_212834_2_, long p_212834_3_) {
      return this.shouldExecute(p_212834_1_, p_212834_2_) && this.field_220563_e > 0 && p_212834_2_.getBrain().getMemory(MemoryModuleType.field_220952_m).isPresent();
   }
   ...
   public void updateTask(ServerWorld p_212833_1_, VillagerEntity p_212833_2_, long p_212833_3_) {
      LivingEntity livingentity = this.func_220557_c(p_212833_2_);
      this.func_220556_a(livingentity, p_212833_2_);
   ...
   private void func_220555_b(VillagerEntity p_220555_1_) {
      for(MerchantOffer merchantoffer : p_220555_1_.func_213706_dY()) {
   ...
   private LivingEntity func_220557_c(VillagerEntity p_220557_1_) {
      ...
      LivingEntity livingentity = brain.getMemory(MemoryModuleType.field_220952_m).get();
      brain.setMemory(MemoryModuleType.field_220951_l, new EntityPosWrapper(livingentity));
      return livingentity;
   }
