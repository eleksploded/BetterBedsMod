...
public abstract class AbstractGroupFishEntity extends AbstractFishEntity {
   ...
   protected void initEntityAI() {
      super.initEntityAI();
      this.field_70714_bg.addTask(5, new FollowSchoolLeaderGoal(this));
   }
   ...
   public ILivingEntityData onInitialSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      super.onInitialSpawn(p_213386_1_, p_213386_2_, p_213386_3_, p_213386_4_, p_213386_5_);
      if (p_213386_4_ == null) {
         p_213386_4_ = new AbstractGroupFishEntity.GroupData(this);
      } else {
         this.func_212803_a(((AbstractGroupFishEntity.GroupData)p_213386_4_).field_212822_a);
      }
