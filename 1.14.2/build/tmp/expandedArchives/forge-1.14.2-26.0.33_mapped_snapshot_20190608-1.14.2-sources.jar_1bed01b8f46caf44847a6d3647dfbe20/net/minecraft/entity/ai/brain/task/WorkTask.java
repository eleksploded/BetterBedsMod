...
public class WorkTask extends Task<CreatureEntity> {
   ...
   public WorkTask(MemoryModuleType<GlobalPos> p_i50342_1_, int p_i50342_2_) {
      super(ImmutableMap.of(MemoryModuleType.field_220950_k, MemoryModuleStatus.REGISTERED, p_i50342_1_, MemoryModuleStatus.VALUE_PRESENT));
   ...
   protected boolean shouldExecute(ServerWorld worldIn, CreatureEntity owner) {
      ...
      return optional.isPresent() && Objects.equals(worldIn.getDimension().getType(), optional.get().func_218177_a()) && optional.get().func_218180_b().func_218137_a(owner.getPositionVec(), (double)this.field_220567_c);
   }
   ...
   protected void startExecuting(ServerWorld p_212831_1_, CreatureEntity p_212831_2_, long p_212831_3_) {
      if (p_212831_3_ > this.field_220566_b) {
         ...
         p_212831_2_.getBrain().setMemory(MemoryModuleType.field_220950_k, optional.map((p_220564_0_) -> {
