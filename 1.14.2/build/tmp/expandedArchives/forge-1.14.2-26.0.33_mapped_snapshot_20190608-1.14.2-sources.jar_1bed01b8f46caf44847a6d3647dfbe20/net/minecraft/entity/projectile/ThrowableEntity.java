...
public abstract class ThrowableEntity extends Entity implements IProjectile {
   ...
   protected ThrowableEntity(EntityType<? extends ThrowableEntity> type, World p_i48540_2_) {
      super(type, p_i48540_2_);
   }

   protected ThrowableEntity(EntityType<? extends ThrowableEntity> type, double p_i48541_2_, double p_i48541_4_, double p_i48541_6_, World p_i48541_8_) {
      this(type, p_i48541_8_);
      this.setPosition(p_i48541_2_, p_i48541_4_, p_i48541_6_);
   }

   protected ThrowableEntity(EntityType<? extends ThrowableEntity> type, LivingEntity p_i48542_2_, World p_i48542_3_) {
   ...
   public void tick() {
      ...
      AxisAlignedBB axisalignedbb = this.getBoundingBox().func_216361_a(this.getMotion()).grow(1.0D);
      ...
      for(Entity entity : this.world.getEntitiesInAABBexcluding(this, axisalignedbb, (p_213881_0_) -> {
         ...
         if (this.field_70192_c != null && this.ticksExisted < 2 && this.ignoreEntity == null) {
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (this.field_200218_h != null) {
         p_213281_1_.put("owner", NBTUtil.writeUniqueId(this.field_200218_h));
      }
   ...
   public LivingEntity getThrower() {
      if (this.field_70192_c == null && this.field_200218_h != null && this.world instanceof ServerWorld) {
         Entity entity = ((ServerWorld)this.world).func_217461_a(this.field_200218_h);
