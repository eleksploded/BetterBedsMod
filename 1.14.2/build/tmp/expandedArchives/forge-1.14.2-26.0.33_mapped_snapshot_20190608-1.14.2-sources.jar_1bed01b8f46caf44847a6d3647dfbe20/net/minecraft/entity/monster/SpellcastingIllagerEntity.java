...
public abstract class SpellcastingIllagerEntity extends AbstractIllagerEntity {
   private static final DataParameter<Byte> SPELL = EntityDataManager.createKey(SpellcastingIllagerEntity.class, DataSerializers.field_187191_a);
   protected int spellTicks;
   private SpellcastingIllagerEntity.SpellType field_193089_bx = SpellcastingIllagerEntity.SpellType.NONE;
   ...
   protected SpellcastingIllagerEntity.SpellType getSpellType() {
      return !this.world.isRemote ? this.field_193089_bx : SpellcastingIllagerEntity.SpellType.getFromId(this.dataManager.get(SPELL));
   }
   ...
   public class CastingASpellGoal extends Goal {
      ...
      public void startExecuting() {
         ...
         SpellcastingIllagerEntity.this.field_70699_by.clearPath();
      }
      ...
      public void tick() {
         if (SpellcastingIllagerEntity.this.getAttackTarget() != null) {
            SpellcastingIllagerEntity.this.getLookHelper().setLookPositionWithEntity(SpellcastingIllagerEntity.this.getAttackTarget(), (float)SpellcastingIllagerEntity.this.getHorizontalFaceSpeed(), (float)SpellcastingIllagerEntity.this.getVerticalFaceSpeed());
         }
