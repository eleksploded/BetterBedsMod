...
public class HorseEntity extends AbstractHorseEntity {
   ...
   private static final DataParameter<Integer> HORSE_VARIANT = EntityDataManager.createKey(HorseEntity.class, DataSerializers.field_187192_b);
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      if (!this.field_110296_bG.getStackInSlot(1).isEmpty()) {
         p_213281_1_.put("ArmorItem", this.field_110296_bG.getStackInSlot(1).write(new CompoundNBT()));
      }
   ...
   protected void updateHorseSlots() {
      ...
      this.func_213804_l(this.field_110296_bG.getStackInSlot(1));
   }
   ...
   public void tick() {
      ...
      ItemStack stack = this.field_110296_bG.getStackInSlot(1);
