...
public abstract class AbstractChestedHorseEntity extends AbstractHorseEntity {
   private static final DataParameter<Boolean> DATA_ID_CHEST = EntityDataManager.createKey(AbstractChestedHorseEntity.class, DataSerializers.field_187198_h);
      ...
      if (this.hasChest()) {
         ...
         for(int i = 0; i < listnbt.size(); ++i) {
            ...
            if (j >= 2 && j < this.field_110296_bG.getSizeInventory()) {
               this.field_110296_bG.setInventorySlotContents(j, ItemStack.read(compoundnbt));
            }
         }
      }
