...
public class InteractableDoorsSensor extends Sensor<LivingEntity> {
   protected void update(ServerWorld p_212872_1_, LivingEntity p_212872_2_) {
      ...
      if (!list.isEmpty()) {
         brain.setMemory(MemoryModuleType.field_220955_p, list);
      } else {
         brain.removeMemory(MemoryModuleType.field_220955_p);
      }

   }

   public Set<MemoryModuleType<?>> getUsedMemories() {
      return ImmutableSet.of(MemoryModuleType.field_220955_p);
   }
}