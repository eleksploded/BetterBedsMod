...
public abstract class LivingEntity extends Entity {
   ...
   protected static final DataParameter<Byte> LIVING_FLAGS = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187191_a);
   private static final DataParameter<Float> HEALTH = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187193_c);
   private static final DataParameter<Integer> POTION_EFFECTS = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Boolean> HIDE_PARTICLES = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187198_h);
   private static final DataParameter<Integer> ARROW_COUNT_IN_ENTITY = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187192_b);
   private static final DataParameter<Optional<BlockPos>> field_213379_bs = EntityDataManager.createKey(LivingEntity.class, DataSerializers.field_187201_k);
   ...
   protected void registerData() {
      ...
      this.dataManager.register(field_213379_bs, Optional.empty());
   }
   ...
   public float getSwimAnimation(float partialTicks) {
      return MathHelper.func_219799_g(partialTicks, this.lastSwimAnimation, this.swimAnimation);
   }
   ...
   public void baseTick() {
      ...
      boolean flag1 = flag && ((PlayerEntity)this).playerAbilities.disableDamage;
      if (this.isAlive()) {
      ...
      if (this.field_110150_bn != null && !this.field_110150_bn.isAlive()) {
         this.field_110150_bn = null;
      }

      if (this.field_70755_b != null) {
         if (!this.field_70755_b.isAlive()) {
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTime == 20) {
         if (!this.world.isRemote && (this.isPlayer() || this.recentlyHit > 0 && this.canDropLoot() && this.world.getGameRules().getBoolean("doMobLoot"))) {
            int i = this.getExperiencePoints(this.field_70717_bb);

            i = net.minecraftforge.event.ForgeEventFactory.getExperienceDrop(this, this.field_70717_bb, i);
            while(i > 0) {
               int j = ExperienceOrbEntity.getXPSplit(i);
               i -= j;
               this.world.func_217376_c(new ExperienceOrbEntity(this.world, this.posX, this.posY, this.posZ, j));
            }
         }
   ...
   public void setLastAttackedEntity(Entity entityIn) {
      if (entityIn instanceof LivingEntity) {
         this.field_110150_bn = (LivingEntity)entityIn;
      } else {
         this.field_110150_bn = null;
      }
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.put("Attributes", SharedMonsterAttributes.writeAttributes(this.getAttributeMap()));
      ...
      for(EquipmentSlotType equipmentslottype1 : EquipmentSlotType.values()) {
         ...
         if (!itemstack1.isEmpty()) {
            this.getAttributeMap().applyAttributeModifiers(itemstack1.getAttributeModifiers(equipmentslottype1));
         }
      }
      ...
      p_213281_1_.put("Brain", this.field_213378_br.serializeDynamic(NBTDynamicOps.INSTANCE));
   }
   ...
   public void readAdditional(CompoundNBT compound) {
      ...
      if (compound.contains("Brain", 10)) {
         this.field_213378_br = this.func_213364_a(new Dynamic<>(NBTDynamicOps.INSTANCE, compound.get("Brain")));
      }
   ...
   protected void updatePotionMetadata() {
      if (this.activePotionsMap.isEmpty()) {
         ...
         this.setInvisible(this.isPotionActive(Effects.field_76441_p));
      }
   ...
   protected void onChangedPotionEffect(EffectInstance id, boolean p_70695_2_) {
      ...
      if (p_70695_2_ && !this.world.isRemote) {
         ...
         effect.removeAttributesModifiersFromEntity(this, this.getAttributeMap(), id.getAmplifier());
         effect.applyAttributesModifiersToEntity(this, this.getAttributeMap(), id.getAmplifier());
      }
   ...
   public boolean attackEntityFrom(DamageSource source, float amount) {
      ...
      if (this.isInvulnerableTo(source)) {
         ...
         if ((source == DamageSource.ANVIL || source == DamageSource.FALLING_BLOCK) && !this.getItemStackFromSlot(EquipmentSlotType.HEAD).isEmpty()) {
            this.getItemStackFromSlot(EquipmentSlotType.HEAD).func_222118_a((int)(amount * 4.0F + this.rand.nextFloat() * amount * 2.0F), this, (p_213341_0_) -> {
         ...
         if (flag1) {
            if (flag) {
               ...
               if (source == DamageSource.DROWN) {
                  ...
                  b0 = 37;
               } else if (source == DamageSource.field_220302_v) {
                  b0 = 44;
               } else {
                  b0 = 2;
               }
   ...
   private boolean checkTotemDeathProtection(DamageSource p_190628_1_) {
      if (p_190628_1_.canHarmInCreative()) {
         ...
         if (itemstack != null) {
            ...
            this.addPotionEffect(new EffectInstance(Effects.field_76428_l, 900, 1));
            this.addPotionEffect(new EffectInstance(Effects.field_76444_x, 100, 1));
         ...
         if (!this.world.isRemote) {
            ...
            if (livingentity instanceof WitherEntity) {
               if (this.world.getGameRules().getBoolean("mobGriefing")) {
                  ...
                  BlockState blockstate = Blocks.field_222388_bz.getDefaultState();
               ...
               if (!flag) {
                  ItemEntity itementity = new ItemEntity(this.world, this.posX, this.posY, this.posZ, new ItemStack(Items.field_221690_bg));
   ...
   protected void func_213345_d(DamageSource p_213345_1_) {
      ...
      if (!net.minecraftforge.common.ForgeHooks.onLivingDrops(this, p_213345_1_, drops, i, recentlyHit > 0))
         drops.forEach(e -> world.func_217376_c(e));
   }
   ...
   protected void func_213354_a(DamageSource p_213354_1_, boolean p_213354_2_) {
      ...
      loottable.func_216120_b(lootcontext$builder.build(LootParameterSets.field_216263_d), this::entityDropItem);
   }

   protected LootContext.Builder func_213363_a(boolean p_213363_1_, DamageSource p_213363_2_) {
      LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withRandom(this.rand).withParameter(LootParameters.field_216281_a, this).withParameter(LootParameters.field_216286_f, new BlockPos(this)).withParameter(LootParameters.field_216283_c, p_213363_2_).withNullableParameter(LootParameters.field_216284_d, p_213363_2_.getTrueSource()).withNullableParameter(LootParameters.field_216285_e, p_213363_2_.getImmediateSource());
      if (p_213363_1_ && this.field_70717_bb != null) {
         lootcontext$builder = lootcontext$builder.withParameter(LootParameters.field_216282_b, this.field_70717_bb).withLuck(this.field_70717_bb.getLuck());
      }
   ...
   public void fall(float distance, float damageMultiplier) {
      ...
      EffectInstance effectinstance = this.getActivePotionEffect(Effects.field_76430_j);
   ...
   protected float applyPotionDamageCalculations(DamageSource source, float damage) {
      if (source.isDamageAbsolute()) {
         ...
         if (this.isPotionActive(Effects.field_76429_m) && source != DamageSource.OUT_OF_WORLD) {
            int i = (this.getActivePotionEffect(Effects.field_76429_m).getAmplifier() + 1) * 5;
            int j = 25 - i;
   ...
   private int getArmSwingAnimationEnd() {
      if (EffectUtils.hasMiningSpeedup(this)) {
         ...
         return this.isPotionActive(Effects.field_76419_f) ? 6 + (1 + this.getActivePotionEffect(Effects.field_76419_f).getAmplifier()) * 2 : 6;
      }
   }
   ...
   public void swingArm(Hand hand) {
      ...
      if (!this.isSwingInProgress || this.swingProgressInt >= this.getArmSwingAnimationEnd() / 2 || this.swingProgressInt < 0) {
         ...
         if (this.world instanceof ServerWorld) {
            ((ServerWorld)this.world).getChunkProvider().func_217218_b(this, new SAnimateHandPacket(this, hand == Hand.MAIN_HAND ? 0 : 3));
         }
      }
   ...
   public void handleStatusUpdate(byte id) {
      ...
      case 46:
         ...
         for(int j = 0; j < 128; ++j) {
            ...
            double d1 = MathHelper.func_219803_d(d0, this.prevPosX, this.posX) + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth() * 2.0D;
            double d2 = MathHelper.func_219803_d(d0, this.prevPosY, this.posY) + this.rand.nextDouble() * (double)this.getHeight();
            double d3 = MathHelper.func_219803_d(d0, this.prevPosZ, this.posZ) + (this.rand.nextDouble() - 0.5D) * (double)this.getWidth() * 2.0D;
   ...
   protected void jump() {
      ...
      if (this.isPotionActive(Effects.field_76430_j)) {
         f = this.getJumpUpwardsMotion() + 0.1F * (float)(this.getActivePotionEffect(Effects.field_76430_j).getAmplifier() + 1);
      } else {
   ...
   public void travel(Vec3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (flag && this.isPotionActive(Effects.field_204839_B)) {
            d0 = 0.01D;
            this.fallDistance = 0.0F;
         }

         if (!this.isInWater() || this instanceof PlayerEntity && ((PlayerEntity)this).playerAbilities.isFlying) {
            if (!this.isInLava() || this instanceof PlayerEntity && ((PlayerEntity)this).playerAbilities.isFlying) {
               if (this.isElytraFlying()) {
                  ...
                  double d10 = vec3d5.y;
                  if (this.isPotionActive(Effects.field_188424_y)) {
                     d10 += (0.05D * (double)(this.getActivePotionEffect(Effects.field_188424_y).getAmplifier() + 1) - vec3d5.y) * 0.2D;
                     this.fallDistance = 0.0F;
            ...
            if (this.isPotionActive(Effects.field_206827_D)) {
               f = 0.96F;
            }
   ...
   private Vec3d func_213362_f(Vec3d p_213362_1_) {
      if (this.isOnLadder()) {
         ...
         if (d2 < 0.0D && this.func_213339_cH().getBlock() != Blocks.field_222420_lI && this.isSneaking() && this instanceof PlayerEntity) {
            d2 = 0.0D;
         }
      ...
      if (!this.world.isRemote) {
         ...
         for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
            ...
            if (!ItemStack.areItemStacksEqual(itemstack1, itemstack)) {
               ...
               ((ServerWorld)this.world).getChunkProvider().func_217218_b(this, new SEntityEquipmentPacket(this.getEntityId(), equipmentslottype, itemstack1));
         ...
         if (!this.glowing) {
            boolean flag = this.isPotionActive(Effects.field_188423_x);
            if (this.getFlag(6) != flag) {
               this.setFlag(6, flag);
            }
         }

         if (this.isPlayerSleeping() && !this.func_213359_p()) {
            this.func_213366_dy();
         }
      }
      ...
      if (flag && !this.onGround && !this.isPassenger()) {
         ...
         if (itemstack.getItem() == Items.ELYTRA && ElytraItem.isUsable(itemstack)) {
            ...
            if (!this.world.isRemote && (this.ticksElytraFlying + 1) % 20 == 0) {
               itemstack.func_222118_a(1, this, (p_213360_0_) -> {
                  p_213360_0_.func_213361_c(EquipmentSlotType.CHEST);
               });
            }
         } else {
            flag = false;
   ...
   public void onItemPickup(Entity entityIn, int quantity) {
      if (!entityIn.removed && !this.world.isRemote && (entityIn instanceof ItemEntity || entityIn instanceof AbstractArrowEntity || entityIn instanceof ExperienceOrbEntity)) {
         ((ServerWorld)this.world).getChunkProvider().func_217218_b(entityIn, new SCollectItemPacket(entityIn.getEntityId(), this.getEntityId(), quantity));
      }
   ...
   public boolean canEntityBeSeen(Entity entityIn) {
      ...
      return this.world.func_217299_a(new RayTraceContext(vec3d, vec3d1, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, this)).getType() == RayTraceResult.Type.MISS;
   }
   ...
   public float getYaw(float partialTicks) {
      return partialTicks == 1.0F ? this.rotationYawHead : MathHelper.func_219799_g(partialTicks, this.prevRotationYawHead, this.rotationYawHead);
   }
   ...
   protected void updateItemUse(ItemStack stack, int eatingParticleCount) {
      if (!stack.isEmpty() && this.isHandActive()) {
         if (stack.getUseAction() == UseAction.DRINK) {
            this.playSound(this.func_213351_c(stack), 0.5F, this.world.rand.nextFloat() * 0.1F + 0.9F);
         }

         if (stack.getUseAction() == UseAction.EAT) {
            this.addItemParticles(stack, eatingParticleCount);
            this.playSound(this.func_213353_d(stack), 0.5F + 0.5F * (float)this.rand.nextInt(2), (this.rand.nextFloat() - this.rand.nextFloat()) * 0.2F + 1.0F);
         }
   ...
   public EntitySize getSize(Pose p_213305_1_) {
      return p_213305_1_ == Pose.SLEEPING ? SLEEPING_SIZE : super.getSize(p_213305_1_).scale(this.func_213355_cm());
   }

   public Optional<BlockPos> func_213374_dv() {
      return this.dataManager.get(field_213379_bs);
   }

   public void func_213369_d(BlockPos p_213369_1_) {
      this.dataManager.set(field_213379_bs, Optional.of(p_213369_1_));
   }

   public void func_213372_dw() {
      this.dataManager.set(field_213379_bs, Optional.empty());
   }
   ...
   public void func_213366_dy() {
      this.func_213374_dv().filter(this.world::isBlockLoaded).ifPresent((p_213368_1_) -> {
...
//      });
   ...
   public boolean isEntityInsideOpaqueBlock() {
      return !this.isPlayerSleeping() && super.isEntityInsideOpaqueBlock();
   }
   ...
   public ItemStack func_213357_a(World p_213357_1_, ItemStack p_213357_2_) {
      if (p_213357_2_.func_222117_E()) {
         p_213357_1_.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, this.func_213353_d(p_213357_2_), SoundCategory.NEUTRAL, 1.0F, 1.0F + (p_213357_1_.rand.nextFloat() - p_213357_1_.rand.nextFloat()) * 0.4F);
