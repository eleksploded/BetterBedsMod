...
public class TakeoffPhase extends Phase {
   ...
   public void serverTick() {
      if (!this.firstTick && this.currentPath != null) {
         ...
         if (!blockpos.func_218137_a(this.field_188661_a.getPositionVec(), 10.0D)) {
   ...
   private void findNewTarget() {
      ...
      Vec3d vec3d = this.field_188661_a.getHeadLookVec(1.0F);
      int j = this.field_188661_a.getNearestPpIdx(-vec3d.x * 40.0D, 105.0D, -vec3d.z * 40.0D);
   ...
   private void navigateToNextPathNode() {
      if (this.currentPath != null) {
         ...
         if (!this.currentPath.isFinished()) {
            ...
            double d0;
            while(true) {
               d0 = vec3d.y + (double)(this.field_188661_a.getRNG().nextFloat() * 20.0F);
               if (!(d0 < vec3d.y)) {
                  break;
               }
            }
