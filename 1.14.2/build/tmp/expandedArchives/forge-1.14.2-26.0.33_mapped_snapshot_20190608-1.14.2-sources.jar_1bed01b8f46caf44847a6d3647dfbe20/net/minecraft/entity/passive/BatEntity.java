...
public class BatEntity extends AmbientEntity {
   private static final DataParameter<Byte> HANGING = EntityDataManager.createKey(BatEntity.class, DataSerializers.field_187191_a);
   private static final EntityPredicate field_213813_c = (new EntityPredicate()).func_221013_a(4.0D).func_221011_b();
   ...
   protected void updateAITasks() {
      ...
      if (this.getIsBatHanging()) {
         if (this.world.getBlockState(blockpos1).func_215686_e(this.world, blockpos)) {
         ...
         if (this.spawnPosition == null || this.rand.nextInt(30) == 0 || this.spawnPosition.func_218137_a(this.getPositionVec(), 2.0D)) {
         ...
         this.rotationYaw += f1;
         if (this.rand.nextInt(100) == 0 && this.world.getBlockState(blockpos1).func_215686_e(this.world, blockpos1)) {
            this.setIsBatHanging(true);
         }
      }
   ...
   public void writeAdditional(CompoundNBT p_213281_1_) {
      ...
      p_213281_1_.putByte("BatFlags", this.dataManager.get(HANGING));
   }

   public boolean canSpawn(IWorld p_213380_1_, SpawnReason p_213380_2_) {
      BlockPos blockpos = new BlockPos(this.posX, this.getBoundingBox().minY, this.posZ);
      if (blockpos.getY() >= p_213380_1_.getSeaLevel()) {
         return false;
      } else {
         int i = p_213380_1_.getLight(blockpos);
         int j = 4;
         ...
         return i > this.rand.nextInt(j) ? false : super.canSpawn(p_213380_1_, p_213380_2_);
      }
   }
