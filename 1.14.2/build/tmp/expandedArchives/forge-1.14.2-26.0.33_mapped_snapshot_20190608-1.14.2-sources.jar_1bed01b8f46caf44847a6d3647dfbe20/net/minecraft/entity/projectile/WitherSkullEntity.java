...
public class WitherSkullEntity extends DamagingProjectileEntity {
   private static final DataParameter<Boolean> INVULNERABLE = EntityDataManager.createKey(WitherSkullEntity.class, DataSerializers.field_187198_h);
      ...
      if (!this.world.isRemote) {
         if (result.getType() == RayTraceResult.Type.ENTITY) {
            ...
            if (entity instanceof LivingEntity) {
               ...
               if (i > 0) {
                  ((LivingEntity)entity).addPotionEffect(new EffectInstance(Effects.field_82731_v, 20 * i, 1));
               }
            }
         }
