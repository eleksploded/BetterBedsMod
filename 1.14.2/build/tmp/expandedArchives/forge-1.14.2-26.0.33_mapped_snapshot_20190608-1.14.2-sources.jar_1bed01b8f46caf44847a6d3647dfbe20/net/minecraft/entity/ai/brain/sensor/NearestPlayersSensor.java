...
public class NearestPlayersSensor extends Sensor<LivingEntity> {
   protected void update(ServerWorld p_212872_1_, LivingEntity p_212872_2_) {
      ...
      brain.setMemory(MemoryModuleType.field_220948_i, list);
      brain.setMemory(MemoryModuleType.field_220949_j, list.stream().filter(p_212872_2_::canEntityBeSeen).findFirst());
   }
