...
public class ZombieVillagerEntity extends ZombieEntity implements IVillagerDataHolder {
   private static final DataParameter<Boolean> CONVERTING = EntityDataManager.createKey(ZombieVillagerEntity.class, DataSerializers.field_187198_h);
   private static final DataParameter<VillagerData> field_213795_c = EntityDataManager.createKey(ZombieVillagerEntity.class, DataSerializers.field_218813_q);
   ...
   public ZombieVillagerEntity(EntityType<? extends ZombieVillagerEntity> p_i50186_1_, World p_i50186_2_) {
      ...
      this.func_213792_a(this.func_213700_eh().func_221126_a(Registry.field_218370_L.getRandom(this.rand)));
   }

   protected void registerData() {
      super.registerData();
      this.dataManager.register(CONVERTING, false);
      this.dataManager.register(field_213795_c, new VillagerData(IVillagerType.field_221175_c, VillagerProfession.field_221151_a, 1));
   }
   ...
   public boolean processInteract(PlayerEntity player, Hand hand) {
      ...
      if (itemstack.getItem() == Items.GOLDEN_APPLE && this.isPotionActive(Effects.field_76437_t)) {
   ...
   protected void startConverting(@Nullable UUID conversionStarterIn, int conversionTimeIn) {
      ...
      this.removePotionEffect(Effects.field_76437_t);
      this.addPotionEffect(new EffectInstance(Effects.field_76420_g, conversionTimeIn, Math.min(this.world.getDifficulty().getId() - 1, 0)));
   ...
   protected void func_213791_a(ServerWorld p_213791_1_) {
      ...
      if (this.converstionStarter != null) {
         ...
         if (playerentity instanceof ServerPlayerEntity) {
            ...
            p_213791_1_.func_217489_a(IReputationType.field_221029_a, playerentity, villagerentity);
         }
      }

      villagerentity.addPotionEffect(new EffectInstance(Effects.field_76431_k, 200, 0));
   ...
   public ILivingEntityData onInitialSpawn(IWorld p_213386_1_, DifficultyInstance p_213386_2_, SpawnReason p_213386_3_, @Nullable ILivingEntityData p_213386_4_, @Nullable CompoundNBT p_213386_5_) {
      this.func_213792_a(this.func_213700_eh().func_221134_a(IVillagerType.func_221170_a(p_213386_1_.getBiome(new BlockPos(this)))));
