...
public abstract class WorldCarver<C extends ICarverConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<WorldCarver<?>> {
   ...
   public static final WorldCarver<ProbabilityConfig> field_222712_d = func_222699_a("underwater_canyon", new UnderwaterCanyonWorldCarver(ProbabilityConfig::func_214645_a));
   public static final WorldCarver<ProbabilityConfig> field_222713_e = func_222699_a("underwater_cave", new UnderwaterCaveWorldCarver(ProbabilityConfig::func_214645_a));
   protected static final BlockState field_222714_f = Blocks.AIR.getDefaultState();
   protected static final BlockState field_222715_g = Blocks.CAVE_AIR.getDefaultState();
   protected static final IFluidState field_222716_h = Fluids.WATER.getDefaultState();
   protected static final IFluidState field_222717_i = Fluids.LAVA.getDefaultState();
   ...
   private static <C extends ICarverConfig, F extends WorldCarver<C>> F func_222699_a(String p_222699_0_, F p_222699_1_) {
      return (F)(Registry.<WorldCarver<?>>register(Registry.field_218377_o, p_222699_0_, p_222699_1_));
   }
   ...
   protected boolean func_222705_a(IChunk p_222705_1_, long p_222705_2_, int p_222705_4_, int p_222705_5_, int p_222705_6_, double p_222705_7_, double p_222705_9_, double p_222705_11_, double p_222705_13_, double p_222705_15_, BitSet p_222705_17_) {
      ...
      if (!(p_222705_7_ < d0 - 16.0D - p_222705_13_ * 2.0D) && !(p_222705_11_ < d1 - 16.0D - p_222705_13_ * 2.0D) && !(p_222705_7_ > d0 + 16.0D + p_222705_13_ * 2.0D) && !(p_222705_11_ > d1 + 16.0D + p_222705_13_ * 2.0D)) {
         ...
         if (this.func_222700_a(p_222705_1_, p_222705_5_, p_222705_6_, i, j, k, l, i1, j1)) {
            return false;
         } else {
            boolean flag = false;
                  ...
                  if (!(d2 * d2 + d3 * d3 >= 1.0D)) {
                     ...
                     for(int k2 = l; k2 > k; --k2) {
                        ...
                        if (!this.func_222708_a(d2, d4, d3, k2)) {
                           flag |= this.func_222703_a(p_222705_1_, p_222705_17_, random, blockpos$mutableblockpos, blockpos$mutableblockpos1, blockpos$mutableblockpos2, p_222705_4_, p_222705_5_, p_222705_6_, l1, j2, k1, k2, i2, atomicboolean);
                        }
                     }
                  }
               }
   ...
   protected boolean func_222703_a(IChunk p_222703_1_, BitSet p_222703_2_, Random p_222703_3_, BlockPos.MutableBlockPos p_222703_4_, BlockPos.MutableBlockPos p_222703_5_, BlockPos.MutableBlockPos p_222703_6_, int p_222703_7_, int p_222703_8_, int p_222703_9_, int p_222703_10_, int p_222703_11_, int p_222703_12_, int p_222703_13_, int p_222703_14_, AtomicBoolean p_222703_15_) {
      ...
      if (p_222703_2_.get(i)) {
         ...
         BlockState blockstate = p_222703_1_.getBlockState(p_222703_4_);
         BlockState blockstate1 = p_222703_1_.getBlockState(p_222703_5_.setPos(p_222703_4_).move(Direction.UP));
         ...
         if (!this.func_222707_a(blockstate, blockstate1)) {
            ...
            if (p_222703_13_ < 11) {
               p_222703_1_.setBlockState(p_222703_4_, field_222717_i.getBlockState(), false);
            } else {
               p_222703_1_.setBlockState(p_222703_4_, field_222715_g, false);
               if (p_222703_15_.get()) {
                  p_222703_6_.setPos(p_222703_4_).move(Direction.DOWN);
                  if (p_222703_1_.getBlockState(p_222703_6_).getBlock() == Blocks.DIRT) {
                     p_222703_1_.setBlockState(p_222703_6_, p_222703_1_.getBiome(p_222703_4_).getSurfaceBuilderConfig().getTopMaterial(), false);
                  }
               }
            }
   ...
   public abstract boolean func_212867_a_(IChunk p_212867_1_, Random p_212867_2_, int p_212867_3_, int p_212867_4_, int p_212867_5_, int p_212867_6_, int p_212867_7_, BitSet p_212867_8_, C p_212867_9_);
