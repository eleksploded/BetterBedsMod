...
public abstract class AbstractSpawner {
   ...
   public void setEntityType(EntityType<?> type) {
      this.spawnData.getNbt().putString("id", Registry.field_212629_r.getKey(type).toString());
   }
   ...
   private boolean isActivated() {
      BlockPos blockpos = this.getSpawnerPosition();
      return this.getWorld().func_217358_a((double)blockpos.getX() + 0.5D, (double)blockpos.getY() + 0.5D, (double)blockpos.getZ() + 0.5D, (double)this.activatingRangeFromPlayer);
   }
