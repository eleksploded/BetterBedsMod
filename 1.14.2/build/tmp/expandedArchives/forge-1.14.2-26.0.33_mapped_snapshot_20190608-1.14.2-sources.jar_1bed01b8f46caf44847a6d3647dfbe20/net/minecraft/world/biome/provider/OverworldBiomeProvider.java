...
public class OverworldBiomeProvider extends BiomeProvider {
   private final Layer field_201543_c;
   private final Layer field_201544_d;
   ...
   public OverworldBiomeProvider(OverworldBiomeProviderSettings settingsProvider) {
      ...
      this.field_201543_c = alayer[0];
      this.field_201544_d = alayer[1];
   }
   ...
   public Biome getBiome(int x, int y) {
      return this.field_201544_d.func_215738_a(x, y);
   }

   public Biome func_222366_b(int p_222366_1_, int p_222366_2_) {
      return this.field_201543_c.func_215738_a(p_222366_1_, p_222366_2_);
   }

   public Biome[] getBiomes(int x, int z, int width, int length, boolean cacheFlag) {
      return this.field_201544_d.generateBiomes(x, z, width, length);
   }
   ...
   public Set<Biome> getBiomesInSquare(int centerX, int centerZ, int sideLength) {
      ...
      Collections.addAll(set, this.field_201543_c.generateBiomes(i, j, i1, j1));
      return set;
   }
   ...
   public BlockPos findBiomePosition(int x, int z, int range, List<Biome> biomes, Random random) {
      ...
      int i1 = k - i + 1;
      int j1 = l - j + 1;
      Biome[] abiome = this.field_201543_c.generateBiomes(i, j, i1, j1);
