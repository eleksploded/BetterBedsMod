...
public class TagMatchRuleTest extends RuleTest {
   ...
   public TagMatchRuleTest(Tag<Block> p_i51318_1_) {
      this.field_215189_a = p_i51318_1_;
   }
   ...
   public boolean test(BlockState p_215181_1_, Random p_215181_2_) {
      return p_215181_1_.isIn(this.field_215189_a);
   }
   ...
   protected <T> Dynamic<T> doSerialize(DynamicOps<T> p_215182_1_) {
      return new Dynamic<>(p_215182_1_, p_215182_1_.createMap(ImmutableMap.of(p_215182_1_.createString("tag"), p_215182_1_.createString(this.field_215189_a.getId().toString()))));
   }
}