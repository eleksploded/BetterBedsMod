...
public class DebugChunkGenerator extends ChunkGenerator<DebugGenerationSettings> {
   private static final List<BlockState> ALL_VALID_STATES = StreamSupport.stream(Registry.field_212618_g.spliterator(), false).flatMap((p_199812_0_) -> {
   ...
   protected static final BlockState field_185934_a = Blocks.AIR.getDefaultState();
   protected static final BlockState field_185935_b = Blocks.BARRIER.getDefaultState();
   ...
   public void decorate(WorldGenRegion region) {
      ...
      for(int k = 0; k < 16; ++k) {
         for(int l = 0; l < 16; ++l) {
            int i1 = (i << 4) + k;
            int j1 = (j << 4) + l;
            region.setBlockState(blockpos$mutableblockpos.setPos(i1, 60, j1), field_185935_b, 2);
