...
public class JigsawManager {
   ...
   static {
      field_214891_a.register(JigsawPattern.field_214949_a);
   }
   ...
   static final class Assembler {
      ...
      public Assembler(ResourceLocation p_i50691_1_, int p_i50691_2_, JigsawManager.IPieceFactory p_i50691_3_, ChunkGenerator<?> p_i50691_4_, TemplateManager p_i50691_5_, BlockPos p_i50691_6_, List<StructurePiece> p_i50691_7_, Random p_i50691_8_) {
         ...
         abstractvillagepiece.offset(0, k - (mutableboundingbox.minY + abstractvillagepiece.func_214830_d()), 0);
      ...
      private void func_214881_a(AbstractVillagePiece p_214881_1_, AtomicReference<VoxelShape> p_214881_2_, int p_214881_3_, int p_214881_4_) {
         ...
         Rotation rotation = p_214881_1_.func_214809_Y_();
         ...
         for(Template.BlockInfo template$blockinfo : jigsawpiece.func_214849_a(this.field_214885_d, blockpos, rotation, this.field_214887_f)) {
            Direction direction = template$blockinfo.blockState.get(JigsawBlock.FACING);
            BlockPos blockpos1 = template$blockinfo.pos;
            BlockPos blockpos2 = blockpos1.offset(direction);
            int j = blockpos1.getY() - i;
            int k = -1;
            JigsawPattern jigsawpattern = JigsawManager.field_214891_a.get(new ResourceLocation(template$blockinfo.tileentityData.getString("target_pool")));
            JigsawPattern jigsawpattern1 = JigsawManager.field_214891_a.get(jigsawpattern.func_214948_a());
            if (jigsawpattern != JigsawPattern.field_214950_b && (jigsawpattern.func_214946_c() != 0 || jigsawpattern == JigsawPattern.field_214949_a)) {
                  ...
                  for(Rotation rotation1 : Rotation.func_222467_b(this.field_214887_f)) {
                     ...
                     if (mutableboundingbox1.getYSize() > 16) {
                        ...
                        i1 = list1.stream().mapToInt((p_214880_2_) -> {
                           if (!mutableboundingbox1.isVecInside(p_214880_2_.pos.offset(p_214880_2_.blockState.get(JigsawBlock.FACING)))) {
                              return 0;
                           } else {
                              ResourceLocation resourcelocation = new ResourceLocation(p_214880_2_.tileentityData.getString("target_pool"));
                     ...
                     for(Template.BlockInfo template$blockinfo1 : list1) {
                        if (JigsawBlock.func_220171_a(template$blockinfo, template$blockinfo1)) {
                           ...
                           int l1 = j - k1 + template$blockinfo.blockState.get(JigsawBlock.FACING).getYOffset();
                           int i2;
                           if (flag && flag2) {
                              i2 = i + l1;
                           } else {
                           ...
                           if (!VoxelShapes.compare(atomicreference1.get(), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox3).shrink(0.25D)), IBooleanFunction.ONLY_SECOND)) {
                              ...
                              int j3 = p_214881_1_.func_214830_d();
                              int l2;
                              if (flag2) {
                                 l2 = j3 - l1;
                              } else {
                              ...
                              p_214881_1_.func_214831_a(new JigsawJunction(blockpos2.getX(), i3 - j + j3, blockpos2.getZ(), l1, jigsawpattern$placementbehaviour1));
                              abstractvillagepiece.func_214831_a(new JigsawJunction(blockpos1.getX(), i3 - k1 + l2, blockpos1.getZ(), -l1, jigsawpattern$placementbehaviour));
               ...
               JigsawManager.field_214892_b.warn("Empty or none existent pool: {}", (Object)template$blockinfo.tileentityData.getString("target_pool"));
            }
         }
