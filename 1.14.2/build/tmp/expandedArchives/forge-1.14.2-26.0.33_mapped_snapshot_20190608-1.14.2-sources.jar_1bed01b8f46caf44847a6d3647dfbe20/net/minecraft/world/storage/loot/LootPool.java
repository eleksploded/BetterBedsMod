...
public class LootPool {
   ...
   private LootPool(LootEntry[] p_i51268_1_, ILootCondition[] p_i51268_2_, ILootFunction[] p_i51268_3_, IRandomRange p_i51268_4_, RandomValueRange p_i51268_5_, String name) {
      ...
      this.field_216101_c = LootConditionManager.and(p_i51268_2_);
      this.field_216102_d = p_i51268_3_;
      this.field_216103_e = LootFunctionManager.combine(p_i51268_3_);
   ...
   public void func_216091_a(Consumer<ItemStack> p_216091_1_, LootContext p_216091_2_) {
      if (this.field_216101_c.test(p_216091_2_)) {
         Consumer<ItemStack> consumer = ILootFunction.func_215858_a(this.field_216103_e, p_216091_1_, p_216091_2_);
         Random random = p_216091_2_.getRandom();
         int i = this.field_186455_c.generateInt(random) + MathHelper.floor(this.bonusRolls.generateFloat(random) * p_216091_2_.getLuck());
   ...
   public static class Builder implements ILootFunctionConsumer<LootPool.Builder>, ILootConditionConsumer<LootPool.Builder> {
      ...
      public LootPool.Builder func_216045_a(LootEntry.Builder<?> p_216045_1_) {
         this.field_216047_a.add(p_216045_1_.func_216081_b());
         return this;
      }

      public LootPool.Builder acceptCondition(ILootCondition.IBuilder p_212840_1_) {
         this.field_216048_b.add(p_212840_1_.build());
         return this;
      }

      public LootPool.Builder func_212841_b_(ILootFunction.IBuilder p_212841_1_) {
         this.field_216049_c.add(p_212841_1_.build());
         return this;
      }
   ...
   public static class Serializer implements JsonDeserializer<LootPool>, JsonSerializer<LootPool> {
      ...
      public JsonElement serialize(LootPool p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
         ...
         if (!ArrayUtils.isEmpty((Object[])p_serialize_1_.field_216102_d)) {
            jsonobject.add("functions", p_serialize_3_.serialize(p_serialize_1_.field_216102_d));
         }
