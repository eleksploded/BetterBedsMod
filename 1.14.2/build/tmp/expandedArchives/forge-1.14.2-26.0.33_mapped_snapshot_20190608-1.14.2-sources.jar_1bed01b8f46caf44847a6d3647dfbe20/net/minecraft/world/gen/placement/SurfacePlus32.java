...
public class SurfacePlus32 extends Placement<FrequencyConfig> {
   ...
   public Stream<BlockPos> getPositions(IWorld p_212848_1_, ChunkGenerator<? extends GenerationSettings> p_212848_2_, Random p_212848_3_, FrequencyConfig p_212848_4_, BlockPos p_212848_5_) {
      return IntStream.range(0, p_212848_4_.frequency).mapToObj((p_215047_3_) -> {
         int i = p_212848_3_.nextInt(16);
         int j = p_212848_3_.nextInt(16);
         int k = p_212848_1_.getHeight(Heightmap.Type.MOTION_BLOCKING, p_212848_5_.add(i, 0, j)).getY() + 32;
         if (k <= 0) {
            return null;
         } else {
