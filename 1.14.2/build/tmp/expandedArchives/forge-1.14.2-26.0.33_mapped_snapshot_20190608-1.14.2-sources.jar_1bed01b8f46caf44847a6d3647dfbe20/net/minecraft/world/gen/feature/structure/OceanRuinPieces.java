...
public class OceanRuinPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public Piece(TemplateManager p_i50592_1_, CompoundNBT p_i50592_2_) {
         super(IStructurePieceType.field_214763_J, p_i50592_2_);
      ...
      private void func_204034_a(TemplateManager p_204034_1_) {
         ...
         PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).func_215222_a(BlockIgnoreStructureProcessor.field_215206_c);
      ...
      protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
         if ("chest".equals(function)) {
            ...
            worldIn.func_217376_c(drownedentity);
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         this.placeSettings.func_215219_b().func_215222_a(new IntegrityProcessor(this.integrity)).func_215222_a(BlockIgnoreStructureProcessor.field_215206_c);
