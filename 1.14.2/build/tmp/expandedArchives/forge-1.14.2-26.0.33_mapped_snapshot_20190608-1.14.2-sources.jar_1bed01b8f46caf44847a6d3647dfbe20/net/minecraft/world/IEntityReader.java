...
public interface IEntityReader {
   ...
   default PlayerEntity func_217362_a(Entity p_217362_1_, double p_217362_2_) {
      return this.func_217366_a(p_217362_1_.posX, p_217362_1_.posY, p_217362_1_.posZ, p_217362_2_, false);
   }
   ...
   default PlayerEntity func_217366_a(double p_217366_1_, double p_217366_3_, double p_217366_5_, double p_217366_7_, boolean p_217366_9_) {
      Predicate<Entity> predicate = p_217366_9_ ? EntityPredicates.CAN_AI_TARGET : EntityPredicates.NOT_SPECTATING;
      return this.getClosestPlayer(p_217366_1_, p_217366_3_, p_217366_5_, p_217366_7_, predicate);
   }
   ...
   default boolean func_217358_a(double p_217358_1_, double p_217358_3_, double p_217358_5_, double p_217358_7_) {
      for(PlayerEntity playerentity : this.getPlayers()) {
         if (EntityPredicates.NOT_SPECTATING.test(playerentity) && EntityPredicates.IS_LIVING_ALIVE.test(playerentity)) {
            double d0 = playerentity.getDistanceSq(p_217358_1_, p_217358_3_, p_217358_5_);
   ...
   default PlayerEntity getPlayerByUuid(UUID p_217371_1_) {
      for(int i = 0; i < this.getPlayers().size(); ++i) {
         ...
         if (p_217371_1_.equals(playerentity.getUniqueID())) {
            return playerentity;
         }
      }
