...
public class Chunk extends net.minecraftforge.common.capabilities.CapabilityProvider<Chunk> implements IChunk, net.minecraftforge.common.extensions.IForgeChunk {
   ...
   public Chunk(World p_i49946_1_, ChunkPos p_i49946_2_, Biome[] p_i49946_3_, UpgradeData p_i49946_4_, ITickList<Block> p_i49946_5_, ITickList<Fluid> p_i49946_6_, long p_i49946_7_, @Nullable ChunkSection[] p_i49946_9_, @Nullable Consumer<Chunk> p_i49946_10_) {
      ...
      for(Heightmap.Type heightmap$type : Heightmap.Type.values()) {
         if (ChunkStatus.FULL.func_222595_h().contains(heightmap$type)) {
   ...
   public Chunk(World p_i49947_1_, ChunkPrimer p_i49947_2_) {
      ...
      for(Entry<Heightmap.Type, Heightmap> entry : p_i49947_2_.func_217311_f()) {
         if (ChunkStatus.FULL.func_222595_h().contains(entry.getKey())) {
   ...
   @OnlyIn(Dist.CLIENT)
   public void func_217326_a(PacketBuffer p_217326_1_, CompoundNBT p_217326_2_, int p_217326_3_, boolean p_217326_4_) {
      Predicate<BlockPos> predicate = p_217326_4_ ? (p_217315_0_) -> {
         return true;
      } : (p_217323_1_) -> {
         return (p_217326_3_ & 1 << (p_217323_1_.getY() >> 4)) != 0;
      };
      ...
      for(int i = 0; i < this.sections.length; ++i) {
         ...
         if ((p_217326_3_ & 1 << i) == 0) {
            if (p_217326_4_ && chunksection != EMPTY_SECTION) {
            ...
            chunksection.func_222634_a(p_217326_1_);
         }
      }

      if (p_217326_4_) {
         for(int j = 0; j < this.blockBiomeArray.length; ++j) {
            this.blockBiomeArray[j] = Registry.field_212624_m.getByValue(p_217326_1_.readInt());
         }
      }

      for(Heightmap.Type heightmap$type : Heightmap.Type.values()) {
         String s = heightmap$type.getId();
         if (p_217326_2_.contains(s, 12)) {
            this.setHeightmap(heightmap$type, p_217326_2_.getLongArray(s));
         }
      }
   ...
   public void func_222880_a(ServerWorld p_222880_1_) {
      if (this.blocksToBeTicked == EmptyTickList.<Block>get()) {
         this.blocksToBeTicked = new SerializableTickList<>(Registry.field_212618_g::getKey, p_222880_1_.getPendingBlockTicks().func_223188_a(this.pos, true, false));
         this.setModified(true);
      }

      if (this.fluidsToBeTicked == EmptyTickList.<Fluid>get()) {
         this.fluidsToBeTicked = new SerializableTickList<>(Registry.field_212619_h::getKey, p_222880_1_.getPendingFluidTicks().func_223188_a(this.pos, true, false));
         this.setModified(true);
      }
