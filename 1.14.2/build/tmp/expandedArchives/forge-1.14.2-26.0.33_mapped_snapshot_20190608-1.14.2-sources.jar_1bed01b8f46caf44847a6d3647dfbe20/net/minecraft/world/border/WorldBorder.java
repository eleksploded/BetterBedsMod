...
public class WorldBorder {
   ...
   public VoxelShape func_222521_a() {
      return this.state.func_222517_m();
   }
   ...
   class MovingBorderInfo implements WorldBorder.IBorderInfo {
      ...
      public double getSize() {
         ...
         return d0 < 1.0D ? MathHelper.func_219803_d(d0, this.oldSize, this.newSize) : this.newSize;
      }
      ...
      public VoxelShape func_222517_m() {
         return VoxelShapes.combineAndSimplify(VoxelShapes.field_216389_a, VoxelShapes.create(Math.floor(this.getMinX()), Double.NEGATIVE_INFINITY, Math.floor(this.getMinZ()), Math.ceil(this.getMaxX()), Double.POSITIVE_INFINITY, Math.ceil(this.getMaxZ())), IBooleanFunction.ONLY_FIRST);
      }
   }
   ...
   class StationaryBorderInfo implements WorldBorder.IBorderInfo {
      ...
      private void func_212665_m() {
         ...
         this.field_222518_g = VoxelShapes.combineAndSimplify(VoxelShapes.field_216389_a, VoxelShapes.create(Math.floor(this.getMinX()), Double.NEGATIVE_INFINITY, Math.floor(this.getMinZ()), Math.ceil(this.getMaxX()), Double.POSITIVE_INFINITY, Math.ceil(this.getMaxZ())), IBooleanFunction.ONLY_FIRST);
      }
