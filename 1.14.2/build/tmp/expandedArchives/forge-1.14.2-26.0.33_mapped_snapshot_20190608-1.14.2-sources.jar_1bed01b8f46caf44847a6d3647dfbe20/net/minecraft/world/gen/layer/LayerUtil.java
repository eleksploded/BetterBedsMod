...
public class LayerUtil {
   protected static final int WARM_OCEAN = Registry.field_212624_m.getId(Biomes.WARM_OCEAN);
   protected static final int LUKEWARM_OCEAN = Registry.field_212624_m.getId(Biomes.LUKEWARM_OCEAN);
   protected static final int OCEAN = Registry.field_212624_m.getId(Biomes.OCEAN);
   protected static final int COLD_OCEAN = Registry.field_212624_m.getId(Biomes.COLD_OCEAN);
   protected static final int FROZEN_OCEAN = Registry.field_212624_m.getId(Biomes.FROZEN_OCEAN);
   protected static final int DEEP_WARM_OCEAN = Registry.field_212624_m.getId(Biomes.DEEP_WARM_OCEAN);
   protected static final int DEEP_LUKEWARM_OCEAN = Registry.field_212624_m.getId(Biomes.DEEP_LUKEWARM_OCEAN);
   protected static final int DEEP_OCEAN = Registry.field_212624_m.getId(Biomes.DEEP_OCEAN);
   protected static final int DEEP_COLD_OCEAN = Registry.field_212624_m.getId(Biomes.DEEP_COLD_OCEAN);
   protected static final int DEEP_FROZEN_OCEAN = Registry.field_212624_m.getId(Biomes.DEEP_FROZEN_OCEAN);
   ...
   public static boolean areBiomesSimilar(int p_202826_0_, int p_202826_1_) {
      if (p_202826_0_ == p_202826_1_) {
         ...
         Biome biome = Registry.field_212624_m.getByValue(p_202826_0_);
         Biome biome1 = Registry.field_212624_m.getByValue(p_202826_1_);
