...
public class OreFeature extends Feature<OreFeatureConfig> {
   ...
   protected boolean func_207803_a(IWorld p_207803_1_, Random p_207803_2_, OreFeatureConfig p_207803_3_, double p_207803_4_, double p_207803_6_, double p_207803_8_, double p_207803_10_, double p_207803_12_, double p_207803_14_, int p_207803_16_, int p_207803_17_, int p_207803_18_, int p_207803_19_, int p_207803_20_) {
      ...
      for(int j = 0; j < p_207803_3_.size; ++j) {
         ...
         double d0 = MathHelper.func_219803_d((double)f, p_207803_4_, p_207803_6_);
         double d2 = MathHelper.func_219803_d((double)f, p_207803_12_, p_207803_14_);
         double d4 = MathHelper.func_219803_d((double)f, p_207803_8_, p_207803_10_);
                        ...
                        for(int j2 = l; j2 <= k1; ++j2) {
                           ...
                           if (d8 * d8 + d9 * d9 + d10 * d10 < 1.0D) {
                              ...
                              if (!bitset.get(k2)) {
                                 ...
                                 if (p_207803_3_.field_202442_b.func_214738_b().test(p_207803_1_.getBlockState(blockpos$mutableblockpos))) {
                                    p_207803_1_.setBlockState(blockpos$mutableblockpos, p_207803_3_.field_202444_d, 2);
                                    ++i;
                                 }
                              }
                           }
