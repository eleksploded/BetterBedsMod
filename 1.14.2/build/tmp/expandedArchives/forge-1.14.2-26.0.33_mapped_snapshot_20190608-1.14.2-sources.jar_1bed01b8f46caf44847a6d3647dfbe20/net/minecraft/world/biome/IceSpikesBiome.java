...
public final class IceSpikesBiome extends Biome {
   public IceSpikesBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215396_G, new SurfaceBuilderConfig(Blocks.SNOW_BLOCK.getDefaultState(), Blocks.DIRT.getDefaultState(), Blocks.GRAVEL.getDefaultState())).precipitation(Biome.RainType.SNOW).category(Biome.Category.ICY).depth(0.425F).scale(0.45000002F).temperature(0.0F).downfall(0.5F).waterColor(4159204).waterFogColor(329011).parent("snowy_tundra"));
      ...
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, func_222280_a(Feature.ICE_SPIKE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215015_a, new FrequencyConfig(3)));
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, func_222280_a(Feature.ICE_PATH, new FeatureRadiusConfig(2), Placement.field_215015_a, new FrequencyConfig(2)));
