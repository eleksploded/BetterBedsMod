...
public class EnchantRandomly extends LootFunction {
   ...
   public ItemStack doApply(ItemStack p_215859_1_, LootContext p_215859_2_) {
      ...
      if (this.enchantments.isEmpty()) {
         ...
         for(Enchantment enchantment1 : Registry.field_212628_q) {
            if (p_215859_1_.getItem() == Items.BOOK || enchantment1.canApply(p_215859_1_)) {
      ...
      if (p_215859_1_.getItem() == Items.BOOK) {
         ...
         EnchantedBookItem.addEnchantment(p_215859_1_, new EnchantmentData(enchantment, i));
      } else {
         p_215859_1_.addEnchantment(enchantment, i);
      }
   ...
   public static LootFunction.Builder<?> func_215900_c() {
      return func_215860_a((p_215899_0_) -> {
      ...
      public void serialize(JsonObject object, EnchantRandomly functionClazz, JsonSerializationContext serializationContext) {
         ...
         if (!functionClazz.enchantments.isEmpty()) {
            ...
            for(Enchantment enchantment : functionClazz.enchantments) {
               ResourceLocation resourcelocation = Registry.field_212628_q.getKey(enchantment);
      ...
      public EnchantRandomly deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn) {
         ...
         if (object.has("enchantments")) {
            for(JsonElement jsonelement : JSONUtils.getJsonArray(object, "enchantments")) {
               ...
               Enchantment enchantment = Registry.field_212628_q.func_218349_b(new ResourceLocation(s)).orElseThrow(() -> {
