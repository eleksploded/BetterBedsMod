...
public class JigsawReplacementStructureProcessor extends StructureProcessor {
   public static final JigsawReplacementStructureProcessor field_215196_a = new JigsawReplacementStructureProcessor();
   ...
   public Template.BlockInfo process(IWorldReader p_215194_1_, BlockPos p_215194_2_, Template.BlockInfo p_215194_3_, Template.BlockInfo p_215194_4_, PlacementSettings p_215194_5_) {
      Block block = p_215194_4_.blockState.getBlock();
      if (block != Blocks.field_222435_lY) {
         return p_215194_4_;
      } else {
         String s = p_215194_4_.tileentityData.getString("final_state");
