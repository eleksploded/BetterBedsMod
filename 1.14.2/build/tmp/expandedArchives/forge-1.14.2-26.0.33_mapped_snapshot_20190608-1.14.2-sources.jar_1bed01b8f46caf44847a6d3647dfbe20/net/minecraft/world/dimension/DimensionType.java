...
public class DimensionType extends net.minecraftforge.registries.ForgeRegistryEntry<DimensionType> implements IDynamicSerializable {
   ...
   private static DimensionType register(String key, DimensionType type) {
      return Registry.register(Registry.field_212622_k, type.id, key, type);
   }
   ...
   public DimensionType(int p_i49935_1_, String p_i49935_2_, String p_i49935_3_, BiFunction<World, DimensionType, ? extends Dimension> p_i49935_4_, boolean p_i49935_5_, @Nullable net.minecraftforge.common.ModDimension modType, @Nullable net.minecraft.network.PacketBuffer data) {
      this.id = p_i49935_1_;
      this.suffix = p_i49935_2_;
      this.directory = p_i49935_3_;
   ...
   public static DimensionType func_218271_a(Dynamic<?> p_218271_0_) {
      return Registry.field_212622_k.getOrDefault(new ResourceLocation(p_218271_0_.asString("")));
   }
   ...
   public static DimensionType getById(int id) {
      return Registry.field_212622_k.getByValue(id - -1);
   }
   ...
   public static DimensionType byName(ResourceLocation nameIn) {
      return Registry.field_212622_k.getOrDefault(nameIn);
   }

   @Nullable
   public static ResourceLocation getKey(DimensionType dim) {
      return Registry.field_212622_k.getKey(dim);
   }
