...
public final class ModifiedBadlandsPlateauBiome extends Biome {
   public ModifiedBadlandsPlateauBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215402_M, SurfaceBuilder.field_215392_C).precipitation(Biome.RainType.NONE).category(Biome.Category.MESA).depth(0.45F).scale(0.3F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("badlands_plateau"));
