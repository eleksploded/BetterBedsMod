...
public class ErodedBadlandsSurfaceBuilder extends BadlandsSurfaceBuilder {
   private static final BlockState field_215444_S = Blocks.WHITE_TERRACOTTA.getDefaultState();
   private static final BlockState field_215445_T = Blocks.ORANGE_TERRACOTTA.getDefaultState();
   private static final BlockState field_215446_U = Blocks.TERRACOTTA.getDefaultState();
   ...
   public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, SurfaceBuilderConfig config) {
      ...
      int l = x & 15;
      int i = z & 15;
      BlockState blockstate2 = field_215444_S;
      BlockState blockstate = biomeIn.getSurfaceBuilderConfig().getUnderMaterial();
         ...
         if (blockstate1.isAir()) {
            ...
            if (j == -1) {
               ...
               if (i1 <= 0) {
                  ...
                  blockstate2 = field_215444_S;
                  blockstate = biomeIn.getSurfaceBuilderConfig().getUnderMaterial();
               }
               ...
               if (k >= seaLevel - 1) {
                  if (k <= seaLevel + 3 + i1) {
                     ...
                     if (k >= 64 && k <= 127) {
                        if (flag) {
                           blockstate3 = field_215446_U;
                        } else {
                           blockstate3 = this.func_215431_a(x, k, z);
                        }
                     } else {
                        blockstate3 = field_215445_T;
                     }
                  ...
                  if (block == Blocks.WHITE_TERRACOTTA || block == Blocks.ORANGE_TERRACOTTA || block == Blocks.MAGENTA_TERRACOTTA || block == Blocks.LIGHT_BLUE_TERRACOTTA || block == Blocks.YELLOW_TERRACOTTA || block == Blocks.LIME_TERRACOTTA || block == Blocks.PINK_TERRACOTTA || block == Blocks.GRAY_TERRACOTTA || block == Blocks.LIGHT_GRAY_TERRACOTTA || block == Blocks.CYAN_TERRACOTTA || block == Blocks.PURPLE_TERRACOTTA || block == Blocks.BLUE_TERRACOTTA || block == Blocks.BROWN_TERRACOTTA || block == Blocks.GREEN_TERRACOTTA || block == Blocks.RED_TERRACOTTA || block == Blocks.BLACK_TERRACOTTA) {
                     chunkIn.setBlockState(blockpos$mutableblockpos, field_215445_T, false);
                  }
               }
            } else if (j > 0) {
               --j;
