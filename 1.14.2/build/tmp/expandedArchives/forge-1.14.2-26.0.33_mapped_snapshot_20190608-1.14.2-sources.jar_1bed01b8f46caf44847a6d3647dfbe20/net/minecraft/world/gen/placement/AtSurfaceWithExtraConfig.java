...
public class AtSurfaceWithExtraConfig implements IPlacementConfig {
   ...
   public <T> Dynamic<T> func_214719_a(DynamicOps<T> p_214719_1_) {
      return new Dynamic<>(p_214719_1_, p_214719_1_.createMap(ImmutableMap.of(p_214719_1_.createString("count"), p_214719_1_.createInt(this.baseCount), p_214719_1_.createString("extra_chance"), p_214719_1_.createFloat(this.extraChance), p_214719_1_.createString("extra_count"), p_214719_1_.createInt(this.extraCount))));
   }
