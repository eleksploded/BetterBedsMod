...
public class FeatureJigsawPiece extends JigsawPiece {
   ...
   public List<Template.BlockInfo> func_214849_a(TemplateManager p_214849_1_, BlockPos p_214849_2_, Rotation p_214849_3_, Random p_214849_4_) {
      ...
      list.add(new Template.BlockInfo(p_214849_2_, Blocks.field_222435_lY.getDefaultState().with(JigsawBlock.FACING, Direction.DOWN), this.field_214871_b));
      return list;
   }
   ...
   public String toString() {
      return "Feature[" + Registry.field_218379_q.getKey(this.field_214870_a.feature) + "]";
   }
}