...
public class Teleporter {
   ...
   private static final NetherPortalBlock field_196236_a = (NetherPortalBlock)Blocks.NETHER_PORTAL;
   protected final ServerWorld field_85192_a;
   protected final Random random;
   protected final Map<ColumnPos, Teleporter.PortalPosition> field_85191_c = Maps.newHashMapWithExpectedSize(4096);
   ...
   public BlockPattern.PortalInfo func_222272_a(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction p_222272_3_, double p_222272_4_, double p_222272_6_, boolean p_222272_8_) {
      ...
      if (!p_222272_8_ && this.field_222275_f.containsKey(columnpos)) {
         ...
         Teleporter.PortalPosition teleporter$portalposition = this.field_85191_c.get(columnpos);
         if (teleporter$portalposition != null) {
            blockpos = teleporter$portalposition.field_222267_a;
            teleporter$portalposition.lastUpdateTime = this.field_85192_a.getGameTime();
            flag = false;
         } else {
            ...
            for(int j = -128; j <= 128; ++j) {
               ...
               for(int k = -128; k <= 128; ++k) {
                  for(BlockPos blockpos1 = p_222272_1_.add(j, this.field_85192_a.getActualHeight() - 1 - p_222272_1_.getY(), k); blockpos1.getY() >= 0; blockpos1 = blockpos2) {
                     blockpos2 = blockpos1.down();
                     if (this.field_85192_a.getBlockState(blockpos1).getBlock() == field_196236_a) {
                        for(blockpos2 = blockpos1.down(); this.field_85192_a.getBlockState(blockpos2).getBlock() == field_196236_a; blockpos2 = blockpos2.down()) {
                           blockpos1 = blockpos2;
                        }
         ...
         if (blockpos == null) {
            long l = this.field_85192_a.getGameTime() + 300L;
            this.field_222275_f.put(columnpos, l);
            return null;
         } else {
            if (flag) {
               this.field_85191_c.put(columnpos, new Teleporter.PortalPosition(blockpos, this.field_85192_a.getGameTime()));
               Logger logger = field_222274_a;
               Supplier[] asupplier = new Supplier[2];
               Dimension dimension = this.field_85192_a.getDimension();
               asupplier[0] = dimension::getType;
               asupplier[1] = () -> {
                  return columnpos;
               };
               logger.debug("Adding nether portal ticket for {}:{}", asupplier);
               this.field_85192_a.getChunkProvider().func_217228_a(TicketType.field_219493_f, new ChunkPos(blockpos), 3, columnpos);
            }

            BlockPattern.PatternHelper blockpattern$patternhelper = field_196236_a.createPatternHelper(this.field_85192_a, blockpos);
   ...
   public boolean makePortal(Entity entityIn) {
      ...
      for(int j2 = j - 16; j2 <= j + 16; ++j2) {
         ...
         for(int l2 = l - 16; l2 <= l + 16; ++l2) {
            ...
            label276:
            for(int j3 = this.field_85192_a.getActualHeight() - 1; j3 >= 0; --j3) {
               if (this.field_85192_a.isAirBlock(blockpos$mutableblockpos.setPos(j2, j3, l2))) {
                  while(j3 > 0 && this.field_85192_a.isAirBlock(blockpos$mutableblockpos.setPos(j2, j3 - 1, l2))) {
                     --j3;
                  }
                     ...
                     for(int j4 = 0; j4 < 3; ++j4) {
                        for(int k4 = 0; k4 < 4; ++k4) {
                           for(int l4 = -1; l4 < 4; ++l4) {
                              ...
                              if (l4 < 0 && !this.field_85192_a.getBlockState(blockpos$mutableblockpos).getMaterial().isSolid() || l4 >= 0 && !this.field_85192_a.isAirBlock(blockpos$mutableblockpos)) {
                                 continue label276;
                              }
                           }
                        }
      ...
      if (d0 < 0.0D) {
         for(int l5 = j - 16; l5 <= j + 16; ++l5) {
            ...
            for(int j6 = l - 16; j6 <= l + 16; ++j6) {
               ...
               label214:
               for(int i7 = this.field_85192_a.getActualHeight() - 1; i7 >= 0; --i7) {
                  if (this.field_85192_a.isAirBlock(blockpos$mutableblockpos.setPos(l5, i7, j6))) {
                     while(i7 > 0 && this.field_85192_a.isAirBlock(blockpos$mutableblockpos.setPos(l5, i7 - 1, j6))) {
                        --i7;
                     }
                     ...
                     for(int l7 = i2; l7 < i2 + 2; ++l7) {
                        ...
                        for(int i10 = 0; i10 < 4; ++i10) {
                           for(int k10 = -1; k10 < 4; ++k10) {
                              ...
                              if (k10 < 0 && !this.field_85192_a.getBlockState(blockpos$mutableblockpos).getMaterial().isSolid() || k10 >= 0 && !this.field_85192_a.isAirBlock(blockpos$mutableblockpos)) {
                                 continue label214;
                              }
                           }
                        }
      ...
      if (d0 < 0.0D) {
         j1 = MathHelper.clamp(j1, 70, this.field_85192_a.getActualHeight() - 10);
         k2 = j1;
         ...
         for(int j7 = -1; j7 <= 1; ++j7) {
            for(int i8 = 1; i8 < 3; ++i8) {
               for(int i9 = -1; i9 < 3; ++i9) {
                  ...
                  this.field_85192_a.setBlockState(blockpos$mutableblockpos, flag ? Blocks.OBSIDIAN.getDefaultState() : Blocks.AIR.getDefaultState());
               }
            }
         }
      }
      ...
      for(int k7 = -1; k7 < 3; ++k7) {
         for(int j8 = -1; j8 < 4; ++j8) {
            if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
               ...
               this.field_85192_a.setBlockState(blockpos$mutableblockpos, Blocks.OBSIDIAN.getDefaultState(), 3);
            }
         }
      }

      BlockState blockstate = field_196236_a.getDefaultState().with(NetherPortalBlock.AXIS, l6 == 0 ? Direction.Axis.Z : Direction.Axis.X);

      for(int k8 = 0; k8 < 2; ++k8) {
         for(int j9 = 0; j9 < 3; ++j9) {
            blockpos$mutableblockpos.setPos(i6 + k8 * l6, k2 + j9, k6 + k8 * i3);
            this.field_85192_a.setBlockState(blockpos$mutableblockpos, blockstate, 18);
         }
      }
   ...
   private void func_222269_c(long p_222269_1_) {
      ...
      Iterator<Entry<ColumnPos, Teleporter.PortalPosition>> iterator = this.field_85191_c.entrySet().iterator();
      ...
      while(iterator.hasNext()) {
         ...
         if (teleporter$portalposition.lastUpdateTime < i) {
            ...
            this.field_85192_a.getChunkProvider().func_217222_b(TicketType.field_219493_f, new ChunkPos(teleporter$portalposition.field_222267_a), 3, columnpos);
            iterator.remove();
         }
      }
