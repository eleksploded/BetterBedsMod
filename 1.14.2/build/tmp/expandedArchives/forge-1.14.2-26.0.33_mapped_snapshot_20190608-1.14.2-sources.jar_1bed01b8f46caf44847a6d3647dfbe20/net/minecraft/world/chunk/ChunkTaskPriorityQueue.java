...
public class ChunkTaskPriorityQueue<T> {
   ...
   protected void func_219407_a(int p_219407_1_, ChunkPos p_219407_2_, int p_219407_3_) {
      if (p_219407_1_ < field_219419_a) {
         ...
         List<Optional<T>> list = long2objectlinkedopenhashmap.remove(p_219407_2_.asLong());
         ...
         if (list != null && !list.isEmpty()) {
            this.field_219420_b.get(p_219407_3_).computeIfAbsent(p_219407_2_.asLong(), (p_219411_0_) -> {
