...
public class ServerTickList<T> implements ITickList<T> {
   ...
   public void tick() {
      ...
      if (i != this.pendingTickListEntriesHashSet.size()) {
         ...
         ServerChunkProvider serverchunkprovider = this.field_205376_f.getChunkProvider();
         Iterator<NextTickListEntry<T>> iterator = this.pendingTickListEntriesTreeSet.iterator();
         this.field_205376_f.getProfiler().startSection("cleaning");

         while(i > 0 && iterator.hasNext()) {
            NextTickListEntry<T> nextticklistentry = iterator.next();
            if (nextticklistentry.scheduledTime > this.field_205376_f.getGameTime()) {
               break;
            }
         ...
         this.field_205376_f.getProfiler().endStartSection("ticking");
         ...
         this.field_205376_f.getProfiler().endSection();
   ...
   public boolean isTickPending(BlockPos pos, T obj) {
      return this.field_205377_g.contains(new NextTickListEntry(pos, obj));
   }
   ...
   public List<NextTickListEntry<T>> getPending(MutableBoundingBox p_205366_1_, boolean remove, boolean p_205366_3_) {
      ...
      list = this.func_223187_a(list, this.field_205377_g, p_205366_1_, remove);
      if (!p_205366_3_) {
   ...
   public ListNBT func_219503_a(ChunkPos p_219503_1_) {
      ...
      return func_219502_a(this.serializer, list, this.field_205376_f.getGameTime());
   }
   ...
   public void scheduleTick(BlockPos pos, T itemIn, int scheduledTime, TickPriority priority) {
      if (!this.filter.test(itemIn)) {
         this.func_219504_a(new NextTickListEntry<>(pos, itemIn, (long)scheduledTime + this.field_205376_f.getGameTime(), priority));
      }
