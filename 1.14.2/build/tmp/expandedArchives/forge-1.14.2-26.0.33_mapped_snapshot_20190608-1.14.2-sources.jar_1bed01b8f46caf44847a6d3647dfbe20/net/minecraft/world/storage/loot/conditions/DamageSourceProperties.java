...
public class DamageSourceProperties implements ILootCondition {
   ...
   public Set<LootParameter<?>> getRequiredParameters() {
      return ImmutableSet.of(LootParameters.field_216286_f, LootParameters.field_216283_c);
   }

   public boolean test(LootContext p_test_1_) {
      DamageSource damagesource = p_test_1_.get(LootParameters.field_216283_c);
      BlockPos blockpos = p_test_1_.get(LootParameters.field_216286_f);
