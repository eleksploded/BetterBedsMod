...
public final class ShatteredSavannaBiome extends Biome {
   public ShatteredSavannaBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215398_I, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.NONE).category(Biome.Category.SAVANNA).depth(0.3625F).scale(1.225F).temperature(1.1F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("savanna"));
