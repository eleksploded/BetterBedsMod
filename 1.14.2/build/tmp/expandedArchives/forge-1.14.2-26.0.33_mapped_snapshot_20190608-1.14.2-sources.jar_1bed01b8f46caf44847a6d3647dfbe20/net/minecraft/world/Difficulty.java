...
public enum Difficulty {
   ...
   private static final Difficulty[] field_151530_e = Arrays.stream(values()).sorted(Comparator.comparingInt(Difficulty::getId)).toArray((p_199928_0_) -> {
   ...
   public static Difficulty byId(int id) {
      return field_151530_e[id % field_151530_e.length];
   }
