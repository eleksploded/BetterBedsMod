...
public class CanyonWorldCarver extends WorldCarver<ProbabilityConfig> {
   ...
   public boolean func_212867_a_(IChunk p_212867_1_, Random p_212867_2_, int p_212867_3_, int p_212867_4_, int p_212867_5_, int p_212867_6_, int p_212867_7_, BitSet p_212867_8_, ProbabilityConfig p_212867_9_) {
      ...
      double d1 = (double)(p_212867_2_.nextInt(p_212867_2_.nextInt(40) + 8) + 20);
      double d2 = (double)(p_212867_5_ * 16 + p_212867_2_.nextInt(16));
      float f = p_212867_2_.nextFloat() * ((float)Math.PI * 2F);
      float f1 = (p_212867_2_.nextFloat() - 0.5F) * 2.0F / 8.0F;
      double d3 = 3.0D;
      float f2 = (p_212867_2_.nextFloat() * 2.0F + p_212867_2_.nextFloat()) * 2.0F;
      int j = i - p_212867_2_.nextInt(i / 4);
      int k = 0;
      this.func_222729_a(p_212867_1_, p_212867_2_.nextLong(), p_212867_3_, p_212867_6_, p_212867_7_, d0, d1, d2, f2, f, f1, 0, j, 3.0D, p_212867_8_);
      return true;
   }
