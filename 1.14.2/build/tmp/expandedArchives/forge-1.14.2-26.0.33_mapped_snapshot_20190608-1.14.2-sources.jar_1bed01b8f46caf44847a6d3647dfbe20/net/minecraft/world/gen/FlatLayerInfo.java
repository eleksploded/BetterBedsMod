...
public class FlatLayerInfo {
   ...
   public FlatLayerInfo(int p_i45467_1_, Block layerMaterialIn) {
      ...
      this.field_175901_b = layerMaterialIn.getDefaultState();
   }
   ...
   public String toString() {
      return (this.layerCount > 1 ? this.layerCount + "*" : "") + Registry.field_212618_g.getKey(this.field_175901_b.getBlock());
   }
}