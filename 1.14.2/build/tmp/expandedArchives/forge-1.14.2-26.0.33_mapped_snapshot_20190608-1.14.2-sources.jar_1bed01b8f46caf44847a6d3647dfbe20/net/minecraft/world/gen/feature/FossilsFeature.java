...
public class FossilsFeature extends Feature<NoFeatureConfig> {
   ...
   public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, NoFeatureConfig config) {
      ...
      TemplateManager templatemanager = ((ServerWorld)worldIn.getWorld()).func_217485_w().getStructureTemplateManager();
      ...
      PlacementSettings placementsettings = (new PlacementSettings()).setRotation(rotation).setBoundingBox(mutableboundingbox).setRandom(random).func_215222_a(BlockIgnoreStructureProcessor.field_215206_c);
      ...
      placementsettings.func_215219_b().func_215222_a(integrityprocessor);
      ...
      placementsettings.func_215219_b().func_215222_a(integrityprocessor1);
