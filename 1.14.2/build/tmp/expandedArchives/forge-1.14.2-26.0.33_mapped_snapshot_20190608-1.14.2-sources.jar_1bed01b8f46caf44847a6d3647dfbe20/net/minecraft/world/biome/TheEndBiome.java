...
public final class TheEndBiome extends Biome {
   public TheEndBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, func_222280_a(Feature.END_CRYSTAL_TOWER, new EndSpikeFeatureConfig(false, ImmutableList.of(), (BlockPos)null), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG));
