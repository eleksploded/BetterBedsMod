...
public class SkyLightStorage extends SectionLightStorage<SkyLightStorage.StorageMap> {
   ...
   protected int func_215525_d(long p_215525_1_) {
      ...
      if (k != skylightstorage$storagemap.field_215652_b && j < k) {
         ...
         return nibblearray.get(SectionPos.func_218171_b(BlockPos.unpackX(p_215525_1_)), SectionPos.func_218171_b(BlockPos.unpackY(p_215525_1_)), SectionPos.func_218171_b(BlockPos.unpackZ(p_215525_1_)));
      } else {
         return 15;
      }
   }
   ...
   protected void func_215522_a(LightEngine<SkyLightStorage.StorageMap, ?> p_215522_1_, boolean p_215522_2_, boolean p_215522_3_) {
      super.func_215522_a(p_215522_1_, p_215522_2_, p_215522_3_);
      if (p_215522_2_) {
                  ...
                  if (j == 1) {
                        ...
                        if ((this.field_215557_n.contains(j1) || !this.field_215555_l.contains(j1) && !this.field_215556_m.contains(j1)) && this.func_215518_g(j1)) {
                           for(int k1 = 0; k1 < 16; ++k1) {
                              for(int l1 = 0; l1 < 16; ++l1) {
                                 ...
                                 p_215522_1_.func_215469_a(i2, j2, p_215522_1_.func_215480_b(i2, j2, 0), true);
                              }
                           }
                        }
                     }
                     ...
                     for(int j4 = 0; j4 < 16; ++j4) {
                        for(int k4 = 0; k4 < 16; ++k4) {
                           ...
                           p_215522_1_.func_215469_a(l4, i5, p_215522_1_.func_215480_b(l4, i5, 0), true);
                        }
                     }
                  } else {
                     for(int k = 0; k < 16; ++k) {
                        for(int l = 0; l < 16; ++l) {
                           ...
                           p_215522_1_.func_215469_a(Long.MAX_VALUE, i1, 0, true);
                        }
                     }
                  }
               }
   ...
   protected boolean func_215551_l(long p_215551_1_) {
      ...
      if ((i & 15) != 15) {
         ...
         long j = SectionPos.func_218162_e(p_215551_1_);
