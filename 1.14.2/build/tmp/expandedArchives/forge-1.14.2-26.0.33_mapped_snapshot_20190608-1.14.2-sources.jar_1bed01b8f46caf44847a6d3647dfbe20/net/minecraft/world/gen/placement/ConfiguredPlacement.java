...
public class ConfiguredPlacement<DC extends IPlacementConfig> {
   ...
   public <T> Dynamic<T> func_215094_a(DynamicOps<T> p_215094_1_) {
      return new Dynamic<>(p_215094_1_, p_215094_1_.createMap(ImmutableMap.of(p_215094_1_.createString("name"), p_215094_1_.createString(Registry.field_218380_r.getKey(this.placement).toString()), p_215094_1_.createString("config"), this.config.func_214719_a(p_215094_1_).getValue())));
   }

   public static <T> ConfiguredPlacement<?> func_215095_a(Dynamic<T> p_215095_0_) {
      Placement<? extends IPlacementConfig> placement = Registry.field_218380_r.getOrDefault(new ResourceLocation(p_215095_0_.get("name").asString("")));
