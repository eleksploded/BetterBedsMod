         ...
         for(int k = -p_222839_3_; k <= p_222839_3_ + 1; ++k) {
            ...
            if (l + i1 < 7 && l * l + i1 * i1 <= i) {
               ...
               if (func_214572_g(p_222839_1_, blockpos)) {
                  this.setLogState(p_222839_5_, p_222839_1_, blockpos, this.field_76521_c, p_222839_4_);
               }
            }
         }
      }
         ...
         for(int k = -p_222838_3_; k <= p_222838_3_; ++k) {
            if (j * j + k * k <= i) {
               ...
               if (func_214572_g(p_222838_1_, blockpos)) {
                  this.setLogState(p_222838_5_, p_222838_1_, blockpos, this.field_76521_c, p_222838_4_);
               }
            }
         }
      }
