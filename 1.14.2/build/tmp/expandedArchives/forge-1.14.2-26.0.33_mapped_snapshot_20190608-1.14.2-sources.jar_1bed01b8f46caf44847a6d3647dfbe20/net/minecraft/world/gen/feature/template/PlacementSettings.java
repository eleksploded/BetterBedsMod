...
public class PlacementSettings {
   ...
   private final List<StructureProcessor> field_215224_k = Lists.newArrayList();
   ...
   public PlacementSettings copy() {
      ...
      placementsettings.field_215224_k.addAll(this.field_215224_k);
   ...
   public PlacementSettings func_215219_b() {
      this.field_215224_k.clear();
      return this;
   }

   public PlacementSettings func_215222_a(StructureProcessor p_215222_1_) {
      this.field_215224_k.add(p_215222_1_);
      return this;
   }

   public PlacementSettings func_215220_b(StructureProcessor p_215220_1_) {
      this.field_215224_k.remove(p_215220_1_);
      return this;
   }
   ...
   public List<StructureProcessor> func_215221_j() {
      return this.field_215224_k;
   }
