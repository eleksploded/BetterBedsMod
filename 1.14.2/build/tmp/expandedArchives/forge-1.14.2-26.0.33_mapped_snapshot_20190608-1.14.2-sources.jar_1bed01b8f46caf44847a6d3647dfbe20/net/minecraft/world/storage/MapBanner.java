...
public class MapBanner {
   ...
   public MapBanner(BlockPos p_i48876_1_, DyeColor p_i48876_2_, @Nullable ITextComponent p_i48876_3_) {
      ...
      this.field_204307_b = p_i48876_2_;
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return Objects.equals(this.pos, mapbanner.pos) && this.field_204307_b == mapbanner.field_204307_b && Objects.equals(this.name, mapbanner.name);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      return Objects.hash(this.pos, this.field_204307_b, this.name);
   }

   public CompoundNBT write() {
      CompoundNBT compoundnbt = new CompoundNBT();
      compoundnbt.put("Pos", NBTUtil.writeBlockPos(this.pos));
      compoundnbt.putString("Color", this.field_204307_b.getTranslationKey());
      if (this.name != null) {
