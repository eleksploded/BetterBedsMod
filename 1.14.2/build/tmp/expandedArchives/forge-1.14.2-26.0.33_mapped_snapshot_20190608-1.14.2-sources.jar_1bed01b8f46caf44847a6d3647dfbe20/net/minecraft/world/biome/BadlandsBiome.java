...
public final class BadlandsBiome extends Biome {
   public BadlandsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215402_M, SurfaceBuilder.field_215392_C).precipitation(Biome.RainType.NONE).category(Biome.Category.MESA).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
