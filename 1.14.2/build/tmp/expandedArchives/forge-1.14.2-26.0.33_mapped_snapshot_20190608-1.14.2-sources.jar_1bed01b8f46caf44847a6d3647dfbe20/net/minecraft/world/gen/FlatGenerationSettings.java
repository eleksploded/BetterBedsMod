...
public class FlatGenerationSettings extends GenerationSettings {
   ...
   private static final ConfiguredFeature<?> field_202250_m = Biome.func_222280_a(Feature.MINESHAFT, new MineshaftConfig(0.004D, MineshaftStructure.Type.NORMAL), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202251_n = Biome.func_222280_a(Feature.field_214550_p, new VillageConfig("village/plains/town_centers", 6), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202252_o = Biome.func_222280_a(Feature.STRONGHOLD, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202253_p = Biome.func_222280_a(Feature.field_202334_l, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202254_q = Biome.func_222280_a(Feature.DESERT_PYRAMID, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202255_r = Biome.func_222280_a(Feature.JUNGLE_PYRAMID, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202256_s = Biome.func_222280_a(Feature.IGLOO, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_204750_v = Biome.func_222280_a(Feature.SHIPWRECK, new ShipwreckConfig(false), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202257_t = Biome.func_222280_a(Feature.OCEAN_MONUMENT, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202258_u = Biome.func_222280_a(Feature.LAKES, new LakesConfig(Blocks.WATER.getDefaultState()), Placement.field_215006_E, new LakeChanceConfig(4));
   private static final ConfiguredFeature<?> field_202259_v = Biome.func_222280_a(Feature.LAKES, new LakesConfig(Blocks.LAVA.getDefaultState()), Placement.field_215005_D, new LakeChanceConfig(80));
   private static final ConfiguredFeature<?> field_202260_w = Biome.func_222280_a(Feature.BURIED_TREASURE, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202261_x = Biome.func_222280_a(Feature.WOODLAND_MANSION, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_202262_y = Biome.func_222280_a(Feature.FORTRESS, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_204028_A = Biome.func_222280_a(Feature.OCEAN_RUIN, new OceanRuinConfig(OceanRuinStructure.Type.COLD, 0.3F, 0.1F), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   private static final ConfiguredFeature<?> field_214991_M = Biome.func_222280_a(Feature.field_214536_b, new PillagerOutpostConfig(0.004D), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG);
   ...
   public static final Map<ConfiguredFeature<?>, IFeatureConfig> FEATURE_CONFIGS = Util.make(Maps.newHashMap(), (p_209405_0_) -> {
      ...
      p_209405_0_.put(field_202252_o, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202253_p, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202254_q, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202255_r, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202256_s, IFeatureConfig.NO_FEATURE_CONFIG);
      ...
      p_209405_0_.put(field_202257_t, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202260_w, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202261_x, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_202262_y, IFeatureConfig.NO_FEATURE_CONFIG);
      p_209405_0_.put(field_214991_M, new PillagerOutpostConfig(0.004D));
   });
   ...
   public static Block getBlock(String p_212683_0_) {
      try {
         ...
         return Registry.field_212618_g.func_218349_b(resourcelocation).orElse((Block)null);
   ...
   public String toString() {
      ...
      stringbuilder.append(";");
      stringbuilder.append((Object)Registry.field_212624_m.getKey(this.biomeToUse));
      stringbuilder.append(";");
   ...
   public <T> Dynamic<T> func_210834_a(DynamicOps<T> p_210834_1_) {
      T t = p_210834_1_.createList(this.flatLayers.stream().map((p_210837_1_) -> {
         return p_210834_1_.createMap(ImmutableMap.of(p_210834_1_.createString("height"), p_210834_1_.createInt(p_210837_1_.getLayerCount()), p_210834_1_.createString("block"), p_210834_1_.createString(Registry.field_212618_g.getKey(p_210837_1_.getLayerMaterial().getBlock()).toString())));
      }));
      ...
      return new Dynamic<>(p_210834_1_, p_210834_1_.createMap(ImmutableMap.of(p_210834_1_.createString("layers"), t, p_210834_1_.createString("biome"), p_210834_1_.createString(Registry.field_212624_m.getKey(this.biomeToUse).toString()), p_210834_1_.createString("structures"), t1)));
   }
   ...
   public static FlatGenerationSettings createFlatGenerator(Dynamic<?> settings) {
      ...
      if (list.stream().anyMatch((p_211743_0_) -> {
         ...
         if (list1.isEmpty()) {
            ...
            flatgenerationsettings.setBiome(Registry.field_212624_m.getOrDefault(new ResourceLocation(settings.get("biome").asString(""))));
   ...
   public static FlatGenerationSettings createFlatGeneratorFromString(String flatGeneratorSettings) {
      ...
      if (!iterator.hasNext()) {
         ...
         if (list.isEmpty()) {
            ...
            flatgenerationsettings.updateLayers();
            Biome biome = iterator.hasNext() ? Registry.field_212624_m.getOrDefault(new ResourceLocation(iterator.next())) : null;
   ...
   public void func_214990_a(int p_214990_1_) {
      this.field_202244_C[p_214990_1_] = null;
   }
}