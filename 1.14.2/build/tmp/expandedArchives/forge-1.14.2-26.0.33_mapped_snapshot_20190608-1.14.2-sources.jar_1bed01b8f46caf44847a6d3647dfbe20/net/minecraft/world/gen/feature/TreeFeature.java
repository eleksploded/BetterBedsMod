...
public class TreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState field_181653_a = Blocks.OAK_LOG.getDefaultState();
   private static final BlockState field_181654_b = Blocks.OAK_LEAVES.getDefaultState();
   ...
   public TreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51421_1_, boolean p_i51421_2_) {
      this(p_i51421_1_, p_i51421_2_, 4, field_181653_a, field_181654_b, false);
   }
      ...
      if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getMaxHeight()) {
         ...
         if (!flag) {
            ...
            for(int i3 = 0; i3 < i; ++i3) {
               if (func_214572_g(worldIn, position.up(i3)) || func_214576_j(worldIn, position.up(i3))) {
                  this.setLogState(changedBlocks, worldIn, position.up(i3), this.field_76532_c, p_208519_5_);
                  if (this.vinesGrow && i3 > 0) {
                     if (rand.nextInt(3) > 0 && func_214574_b(worldIn, position.add(-1, i3, 0))) {
                     ...
                     if (rand.nextInt(3) > 0 && func_214574_b(worldIn, position.add(0, i3, -1))) {
                  ...
                  for(int l4 = position.getX() - k4; l4 <= position.getX() + k4; ++l4) {
                     for(int i5 = position.getZ() - k4; i5 <= position.getZ() + k4; ++i5) {
                        ...
                        if (func_214570_f(worldIn, blockpos$mutableblockpos1)) {
                           ...
                           if (rand.nextInt(4) == 0 && func_214574_b(worldIn, blockpos3)) {
