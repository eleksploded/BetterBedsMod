...
public class RaidManager extends WorldSavedData {
   ...
   public static boolean func_215165_a(AbstractRaiderEntity p_215165_0_, Raid p_215165_1_) {
      if (p_215165_0_ != null && p_215165_1_ != null && p_215165_1_.func_221316_i() != null) {
         return p_215165_0_.isAlive() && p_215165_0_.func_213658_ej() && p_215165_0_.getIdleTime() <= 2400 && p_215165_0_.world.getDimension().getType() == p_215165_1_.func_221316_i().getDimension().getType();
      } else {
         return false;
      }
   }
      ...
      if (p_215170_1_.isSpectator()) {
         ...
         if (dimensiontype == DimensionType.NETHER) {
            ...
            Optional<BlockPos> optional = this.world.func_217443_B().func_219147_b((p_215166_0_) -> {
               return p_215166_0_ == PointOfInterestType.field_221070_r;
            ...
            if (!raid.func_221301_k()) {
               if (!this.byId.containsKey(raid.func_221325_u())) {
                  this.byId.put(raid.func_221325_u(), raid);
               }
               ...
               p_215170_1_.removePotionEffect(Effects.field_220309_E);
            ...
            if (flag) {
               ...
               if (!raid.func_221297_c()) {
                  p_215170_1_.addStat(Stats.field_219741_ay);
                  CriteriaTriggers.field_215102_I.trigger(p_215170_1_);
               }
            }
