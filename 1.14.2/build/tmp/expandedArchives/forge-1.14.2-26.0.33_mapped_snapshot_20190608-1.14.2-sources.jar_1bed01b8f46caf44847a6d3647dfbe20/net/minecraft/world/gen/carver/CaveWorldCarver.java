...
public class CaveWorldCarver extends WorldCarver<ProbabilityConfig> {
   ...
   public boolean func_212867_a_(IChunk p_212867_1_, Random p_212867_2_, int p_212867_3_, int p_212867_4_, int p_212867_5_, int p_212867_6_, int p_212867_7_, BitSet p_212867_8_, ProbabilityConfig p_212867_9_) {
      int i = (this.func_222704_c() * 2 - 1) * 16;
      int j = p_212867_2_.nextInt(p_212867_2_.nextInt(p_212867_2_.nextInt(this.func_222724_a()) + 1) + 1);

      for(int k = 0; k < j; ++k) {
         double d0 = (double)(p_212867_4_ * 16 + p_212867_2_.nextInt(16));
         double d1 = (double)this.func_222726_b(p_212867_2_);
         double d2 = (double)(p_212867_5_ * 16 + p_212867_2_.nextInt(16));
         int l = 1;
         if (p_212867_2_.nextInt(4) == 0) {
            double d3 = 0.5D;
            float f1 = 1.0F + p_212867_2_.nextFloat() * 6.0F;
            this.func_222723_a(p_212867_1_, p_212867_2_.nextLong(), p_212867_3_, p_212867_6_, p_212867_7_, d0, d1, d2, f1, 0.5D, p_212867_8_);
            l += p_212867_2_.nextInt(4);
         }

         for(int k1 = 0; k1 < l; ++k1) {
            float f = p_212867_2_.nextFloat() * ((float)Math.PI * 2F);
            float f3 = (p_212867_2_.nextFloat() - 0.5F) / 4.0F;
            float f2 = this.func_222722_a(p_212867_2_);
            int i1 = i - p_212867_2_.nextInt(i / 4);
            int j1 = 0;
            this.func_222727_a(p_212867_1_, p_212867_2_.nextLong(), p_212867_3_, p_212867_6_, p_212867_7_, d0, d1, d2, f2, f, f3, 0, i1, this.func_222725_b(), p_212867_8_);
         }
      }
