...
public class ShipwreckPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public Piece(TemplateManager p_i50445_1_, CompoundNBT p_i50445_2_) {
         super(IStructurePieceType.field_214753_ac, p_i50445_2_);
      ...
      private void func_204754_a(TemplateManager p_204754_1_) {
         ...
         PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setMirror(Mirror.NONE).setCenterOffset(ShipwreckPieces.STRUCTURE_OFFSET).func_215222_a(BlockIgnoreStructureProcessor.field_215206_c);
