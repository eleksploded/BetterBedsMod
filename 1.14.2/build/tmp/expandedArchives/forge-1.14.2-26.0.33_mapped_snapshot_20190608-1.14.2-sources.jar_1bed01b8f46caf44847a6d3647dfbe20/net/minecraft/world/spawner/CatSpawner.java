...
public class CatSpawner {
   ...
   public int func_221124_a(ServerWorld p_221124_1_, boolean p_221124_2_, boolean p_221124_3_) {
      if (p_221124_3_ && p_221124_1_.getGameRules().getBoolean("doMobSpawning")) {
         --this.field_221125_a;
         if (this.field_221125_a > 0) {
            ...
            if (playerentity == null) {
               ...
               if (!p_221124_1_.isAreaLoaded(blockpos.getX() - 10, blockpos.getY() - 10, blockpos.getZ() - 10, blockpos.getX() + 10, blockpos.getY() + 10, blockpos.getZ() + 10)) {
                  ...
                  if (WorldEntitySpawner.canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, p_221124_1_, blockpos, EntityType.field_220360_g)) {
                     if (p_221124_1_.func_217471_a(blockpos, 2)) {
                        return this.func_221121_a(p_221124_1_, blockpos);
                     }

                     if (Feature.field_202334_l.isPositionInsideStructure(p_221124_1_, blockpos)) {
   ...
   private int func_221121_a(ServerWorld p_221121_1_, BlockPos p_221121_2_) {
      int i = 48;
      if (p_221121_1_.func_217443_B().func_219145_a(PointOfInterestType.field_221069_q.func_221045_c(), p_221121_2_, 48, PointOfInterestManager.Status.IS_OCCUPIED) > 4L) {
   ...
   private int func_221122_a(BlockPos p_221122_1_, World p_221122_2_) {
      CatEntity catentity = EntityType.field_220360_g.create(p_221122_2_);
      if (catentity == null) {
         return 0;
      } else {
         ...
         p_221122_2_.func_217376_c(catentity);
         return 1;
      }
   }
}