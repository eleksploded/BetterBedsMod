...
public class OverworldChunkGenerator extends NoiseChunkGenerator<OverworldGenSettings> {
   ...
   private double func_222574_c(int p_222574_1_, int p_222574_2_) {
      double d0 = this.field_185984_c.func_215462_a((double)(p_222574_1_ * 200), 10.0D, (double)(p_222574_2_ * 200), 1.0D, 0.0D, true) / 8000.0D;
      if (d0 < 0.0D) {
         d0 = -d0 * 0.3D;
      }
   ...
   public List<Biome.SpawnListEntry> getPossibleCreatures(EntityClassification creatureType, BlockPos pos) {
      if (Feature.field_202334_l.func_202383_b(this.world, pos)) {
         if (creatureType == EntityClassification.MONSTER) {
            return Feature.field_202334_l.getSpawnList();
         }

         if (creatureType == EntityClassification.CREATURE) {
            return Feature.field_202334_l.getCreatureSpawnList();
         }
      } else if (creatureType == EntityClassification.MONSTER) {
         if (Feature.field_214536_b.isPositionInStructure(this.world, pos)) {
            return Feature.field_214536_b.getSpawnList();
         }
   ...
   public void spawnMobs(ServerWorld worldIn, boolean spawnHostileMobs, boolean spawnPeacefulMobs) {
      this.field_203230_r.spawnMobs(worldIn, spawnHostileMobs, spawnPeacefulMobs);
      this.field_222578_l.func_222696_a(worldIn, spawnHostileMobs, spawnPeacefulMobs);
      this.field_222579_m.func_221124_a(worldIn, spawnHostileMobs, spawnPeacefulMobs);
   }
