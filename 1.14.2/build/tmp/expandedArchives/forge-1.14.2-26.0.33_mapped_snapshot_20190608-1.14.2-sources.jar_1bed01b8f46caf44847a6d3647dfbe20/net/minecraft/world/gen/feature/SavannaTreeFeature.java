...
public class SavannaTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState field_181643_a = Blocks.ACACIA_LOG.getDefaultState();
   private static final BlockState field_181644_b = Blocks.ACACIA_LEAVES.getDefaultState();
   ...
   private void func_208532_a(Set<BlockPos> p_208532_1_, IWorldWriter p_208532_2_, BlockPos p_208532_3_, MutableBoundingBox p_208532_4_) {
      this.setLogState(p_208532_1_, p_208532_2_, p_208532_3_, field_181643_a, p_208532_4_);
   }
   ...
   private void placeLeafAt(Set<BlockPos> worldIn, IWorldGenerationReader pos, BlockPos p_175924_3_, MutableBoundingBox p_175924_4_) {
      if (func_214572_g(pos, p_175924_3_)) {
         this.setLogState(worldIn, pos, p_175924_3_, field_181644_b, p_175924_4_);
      }
