...
public class VillageStructure extends Structure<VillageConfig> {
   ...
   public boolean hasStartAt(ChunkGenerator<?> chunkGen, Random rand, int chunkPosX, int chunkPosZ) {
      ...
      if (chunkPosX == chunkpos.x && chunkPosZ == chunkpos.z) {
         ...
         return chunkGen.hasStructure(biome, Feature.field_214550_p);
      } else {
         return false;
      }
   }
   ...
   public static class Start extends MarginedStructureStart {
      ...
      public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
         VillageConfig villageconfig = (VillageConfig)generator.getStructureConfig(biomeIn, Feature.field_214550_p);
