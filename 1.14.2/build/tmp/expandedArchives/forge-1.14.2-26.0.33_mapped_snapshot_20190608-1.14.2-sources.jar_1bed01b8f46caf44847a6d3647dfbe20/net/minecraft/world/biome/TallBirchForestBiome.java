...
public final class TallBirchForestBiome extends Biome {
   public TallBirchForestBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215396_G, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(0.2F).scale(0.4F).temperature(0.6F).downfall(0.6F).waterColor(4159204).waterFogColor(329011).parent("birch_forest"));
