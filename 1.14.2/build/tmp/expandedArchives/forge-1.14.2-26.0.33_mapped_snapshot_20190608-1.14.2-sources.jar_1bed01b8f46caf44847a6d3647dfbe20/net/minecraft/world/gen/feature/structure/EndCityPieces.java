...
public class EndCityPieces {
   private static final PlacementSettings OVERWRITE = (new PlacementSettings()).setIgnoreEntities(true).func_215222_a(BlockIgnoreStructureProcessor.field_215204_a);
   private static final PlacementSettings INSERT = (new PlacementSettings()).setIgnoreEntities(true).func_215222_a(BlockIgnoreStructureProcessor.field_215206_c);
   ...
   public static class CityTemplate extends TemplateStructurePiece {
      ...
      public CityTemplate(TemplateManager p_i47214_1_, String p_i47214_2_, BlockPos p_i47214_3_, Rotation p_i47214_4_, boolean overwriteIn) {
         super(IStructurePieceType.field_214779_Z, 0);
      ...
      public CityTemplate(TemplateManager p_i50598_1_, CompoundNBT p_i50598_2_) {
         super(IStructurePieceType.field_214779_Z, p_i50598_2_);
      ...
      protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
         if (function.startsWith("Chest")) {
            ...
            worldIn.func_217376_c(shulkerentity);
            ...
            worldIn.func_217376_c(itemframeentity);
         }
