...
public final class MountainsBiome extends Biome {
   protected MountainsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215397_H, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.RAIN).category(Biome.Category.EXTREME_HILLS).depth(1.0F).scale(0.5F).temperature(0.2F).downfall(0.3F).waterColor(4159204).waterFogColor(329011).parent((String)null));
