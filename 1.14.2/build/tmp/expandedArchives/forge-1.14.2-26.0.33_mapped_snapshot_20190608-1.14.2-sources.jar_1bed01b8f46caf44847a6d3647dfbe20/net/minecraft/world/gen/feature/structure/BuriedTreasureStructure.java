...
public class BuriedTreasureStructure extends Structure<BuriedTreasureConfig> {
   ...
   public boolean hasStartAt(ChunkGenerator<?> chunkGen, Random rand, int chunkPosX, int chunkPosZ) {
      ...
      if (chunkGen.hasStructure(biome, Feature.field_214549_o)) {
         ((SharedSeedRandom)rand).setLargeFeatureSeedWithSalt(chunkGen.getSeed(), chunkPosX, chunkPosZ, 10387320);
         BuriedTreasureConfig buriedtreasureconfig = (BuriedTreasureConfig)chunkGen.getStructureConfig(biome, Feature.field_214549_o);
