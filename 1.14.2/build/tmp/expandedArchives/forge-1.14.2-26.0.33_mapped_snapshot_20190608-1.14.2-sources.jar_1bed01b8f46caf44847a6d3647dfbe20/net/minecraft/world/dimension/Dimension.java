...
public abstract class Dimension implements net.minecraftforge.common.extensions.IForgeDimension {
   ...
   public Dimension(World p_i49936_1_, DimensionType p_i49936_2_) {
      this.world = p_i49936_1_;
      this.field_222669_f = p_i49936_2_;
   ...
   public boolean hasSkyLight() {
      return this.field_222669_f.func_218272_d();
   }
