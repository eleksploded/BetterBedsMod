...
public class WoodedBadlandsSurfaceBuilder extends BadlandsSurfaceBuilder {
   private static final BlockState field_215447_S = Blocks.WHITE_TERRACOTTA.getDefaultState();
   private static final BlockState field_215448_T = Blocks.ORANGE_TERRACOTTA.getDefaultState();
   private static final BlockState field_215449_U = Blocks.TERRACOTTA.getDefaultState();
   ...
   public void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, int seaLevel, long seed, SurfaceBuilderConfig config) {
      int i = x & 15;
      int j = z & 15;
      BlockState blockstate = field_215447_S;
               ...
               if (l == -1) {
                  ...
                  if (j1 >= seaLevel - 1) {
                     if (j1 > 86 + k * 2) {
                        ...
                        if (j1 >= 64 && j1 <= 127) {
                           if (flag) {
                              blockstate3 = field_215449_U;
                           } else {
                              blockstate3 = this.func_215431_a(x, j1, z);
                           }
                        } else {
                           blockstate3 = field_215448_T;
                        }
                     ...
                     if (blockstate1 == field_215447_S) {
                        chunkIn.setBlockState(blockpos$mutableblockpos, field_215448_T, false);
                     }
                  }
               } else if (l > 0) {
                  --l;
