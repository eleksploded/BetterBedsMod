...
public final class WorldEntitySpawner {
   ...
   public static void performNaturalSpawning(EntityClassification p_222263_0_, World p_222263_1_, Chunk p_222263_2_, BlockPos p_222263_3_) {
      ...
      int i = 0;
      BlockPos blockpos = func_222262_a(p_222263_1_, p_222263_2_);
      int j = blockpos.getX();
      int k = blockpos.getY();
      int l = blockpos.getZ();
      if (k >= 1) {
         BlockState blockstate = p_222263_2_.getBlockState(blockpos);
         if (!blockstate.func_215686_e(p_222263_2_, blockpos)) {
                  ...
                  label108: {
                     if (k2 < i2) {
                        label116: {
                           ...
                           if (playerentity == null || playerentity.getDistanceSq((double)f, (double)k, (double)f1) <= 576.0D || p_222263_3_.func_218137_a(new Vec3d((double)f, (double)k, (double)f1), 24.0D)) {
                              break label108;
                           }

                           ChunkPos chunkpos = new ChunkPos(blockpos$mutableblockpos);
                           if (!Objects.equals(chunkpos, p_222263_2_.getPos()) && !p_222263_1_.getChunkProvider().func_222865_a(chunkpos)) {
                              break label108;
                           }
                           ...
                           if (biome$spawnlistentry.entityType.getClassiciation() == EntityClassification.MISC) {
                              break label108;
                           }
                           ...
                           try {
                              ...
                              if (!(entity instanceof MobEntity)) {
                                 throw new IllegalStateException("Trying to spawn a non-mob: " + Registry.field_212629_r.getKey(entitytype));
                              }
                           ...
                           if (playerentity.getDistanceSq((double)f, (double)k, (double)f1) > 16384.0D && (canSpawn == 1 || (canSpawn == 0 && mobentity.func_213397_c(playerentity.getDistanceSq((double)f, (double)k, (double)f1)))) || !mobentity.canSpawn(p_222263_1_, SpawnReason.NATURAL) || !mobentity.isNotColliding(p_222263_1_)) {
                              break label108;
                           }
   ...
   public static boolean canSpawnAtBody(EntitySpawnPlacementRegistry.PlacementType placeType, IWorldReader worldIn, BlockPos pos, @Nullable EntityType<?> entityTypeIn) {
      {
         ...
         switch(placeType) {
         case IN_WATER:
            return ifluidstate.isTagged(FluidTags.WATER) && worldIn.getFluidState(blockpos1).isTagged(FluidTags.WATER) && !worldIn.getBlockState(blockpos).func_215686_e(worldIn, blockpos);
         case ON_GROUND:
         default:
            ...
            for(int l1 = 0; l1 < k; ++l1) {
               ...
               for(int i2 = 0; !flag && i2 < 4; ++i2) {
                  ...
                  if (biome$spawnlistentry.entityType.isSummonable() && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, worldIn, blockpos, biome$spawnlistentry.entityType)) {
                     float f = biome$spawnlistentry.entityType.func_220333_h();
