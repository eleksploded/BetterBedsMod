...
public class ExplorationMap extends LootFunction {
   ...
   public Set<LootParameter<?>> getRequiredParameters() {
      return ImmutableSet.of(LootParameters.field_216286_f);
   }
   ...
   public ItemStack doApply(ItemStack p_215859_1_, LootContext p_215859_2_) {
      if (p_215859_1_.getItem() != Items.MAP) {
         ...
         BlockPos blockpos = p_215859_2_.get(LootParameters.field_216286_f);
         if (blockpos != null) {
            ServerWorld serverworld = p_215859_2_.getWorld();
   ...
   public static class Builder extends LootFunction.Builder<ExplorationMap.Builder> {
      ...
      protected ExplorationMap.Builder func_212826_d_() {
         return this;
      }
   ...
   public static class Serializer extends LootFunction.Serializer<ExplorationMap> {
      ...
      public ExplorationMap deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn) {
         ...
         s = Feature.field_202300_at.containsKey(s.toLowerCase(Locale.ROOT)) ? s : "Buried_Treasure";
