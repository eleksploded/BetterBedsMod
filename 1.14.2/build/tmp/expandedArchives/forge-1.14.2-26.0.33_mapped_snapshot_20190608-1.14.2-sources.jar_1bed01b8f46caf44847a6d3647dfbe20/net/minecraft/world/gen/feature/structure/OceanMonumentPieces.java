...
public class OceanMonumentPieces {
   public static class DoubleXRoom extends OceanMonumentPieces.Piece {
      public DoubleXRoom(Direction p_i50661_1_, OceanMonumentPieces.RoomDefinition p_i50661_2_) {
         super(IStructurePieceType.field_214769_P, 1, p_i50661_1_, p_i50661_2_, 2, 1, 1);
      }

      public DoubleXRoom(TemplateManager p_i50662_1_, CompoundNBT p_i50662_2_) {
         super(IStructurePieceType.field_214769_P, p_i50662_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 4, 1, 7, 4, 6, field_175828_a);
         }

         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 8, 4, 1, 14, 4, 6, field_175828_a);
         }
   ...
   public static class DoubleXYRoom extends OceanMonumentPieces.Piece {
      public DoubleXYRoom(Direction p_i50659_1_, OceanMonumentPieces.RoomDefinition p_i50659_2_) {
         super(IStructurePieceType.field_214770_Q, 1, p_i50659_1_, p_i50659_2_, 2, 2, 1);
      }

      public DoubleXYRoom(TemplateManager p_i50660_1_, CompoundNBT p_i50660_2_) {
         super(IStructurePieceType.field_214770_Q, p_i50660_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (oceanmonumentpieces$roomdefinition2.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 8, 1, 7, 8, 6, field_175828_a);
         }

         if (oceanmonumentpieces$roomdefinition3.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 8, 8, 1, 14, 8, 6, field_175828_a);
         }
   ...
   public static class DoubleYRoom extends OceanMonumentPieces.Piece {
      public DoubleYRoom(Direction p_i50657_1_, OceanMonumentPieces.RoomDefinition p_i50657_2_) {
         super(IStructurePieceType.field_214771_R, 1, p_i50657_1_, p_i50657_2_, 1, 2, 1);
      }

      public DoubleYRoom(TemplateManager p_i50658_1_, CompoundNBT p_i50658_2_) {
         super(IStructurePieceType.field_214771_R, p_i50658_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 8, 1, 6, 8, 6, field_175828_a);
         }
   ...
   public static class DoubleYZRoom extends OceanMonumentPieces.Piece {
      public DoubleYZRoom(Direction p_i50655_1_, OceanMonumentPieces.RoomDefinition p_i50655_2_) {
         super(IStructurePieceType.field_214772_S, 1, p_i50655_1_, p_i50655_2_, 1, 2, 2);
      }

      public DoubleYZRoom(TemplateManager p_i50656_1_, CompoundNBT p_i50656_2_) {
         super(IStructurePieceType.field_214772_S, p_i50656_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (oceanmonumentpieces$roomdefinition3.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 8, 1, 6, 8, 7, field_175828_a);
         }

         if (oceanmonumentpieces$roomdefinition2.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 8, 8, 6, 8, 14, field_175828_a);
         }
         ...
         for(int j = 1; j <= 7; ++j) {
            BlockState blockstate1 = field_175827_c;
            if (j == 2 || j == 6) {
               blockstate1 = field_175825_e;
            }
   ...
   public static class DoubleZRoom extends OceanMonumentPieces.Piece {
      public DoubleZRoom(Direction p_i50653_1_, OceanMonumentPieces.RoomDefinition p_i50653_2_) {
         super(IStructurePieceType.field_214773_T, 1, p_i50653_1_, p_i50653_2_, 1, 1, 2);
      }

      public DoubleZRoom(TemplateManager p_i50654_1_, CompoundNBT p_i50654_2_) {
         super(IStructurePieceType.field_214773_T, p_i50654_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (oceanmonumentpieces$roomdefinition1.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 4, 1, 6, 4, 7, field_175828_a);
         }

         if (oceanmonumentpieces$roomdefinition.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 4, 8, 6, 4, 14, field_175828_a);
         }
   ...
   public static class EntryRoom extends OceanMonumentPieces.Piece {
      public EntryRoom(Direction p_i45592_1_, OceanMonumentPieces.RoomDefinition p_i45592_2_) {
         super(IStructurePieceType.field_214774_U, 1, p_i45592_1_, p_i45592_2_, 1, 1, 1);
      }

      public EntryRoom(TemplateManager p_i50652_1_, CompoundNBT p_i50652_2_) {
         super(IStructurePieceType.field_214774_U, p_i50652_2_);
      }
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.Piece {
      ...
      public MonumentBuilding(TemplateManager p_i50665_1_, CompoundNBT p_i50665_2_) {
         super(IStructurePieceType.field_214767_N, p_i50665_2_);
      }
   ...
   public static class MonumentCoreRoom extends OceanMonumentPieces.Piece {
      public MonumentCoreRoom(Direction p_i50663_1_, OceanMonumentPieces.RoomDefinition p_i50663_2_) {
         super(IStructurePieceType.field_214768_O, 1, p_i50663_1_, p_i50663_2_, 2, 2, 2);
      }

      public MonumentCoreRoom(TemplateManager p_i50664_1_, CompoundNBT p_i50664_2_) {
         super(IStructurePieceType.field_214768_O, p_i50664_2_);
      }
       ...
       */
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 8, 0, 14, 8, 14, field_175828_a);
         int i = 7;
         BlockState blockstate = field_175826_b;
   ...
   public static class Penthouse extends OceanMonumentPieces.Piece {
      public Penthouse(Direction p_i45591_1_, MutableBoundingBox p_i45591_2_) {
         super(IStructurePieceType.field_214775_V, p_i45591_1_, p_i45591_2_);
      }

      public Penthouse(TemplateManager p_i50651_1_, CompoundNBT p_i50651_2_) {
         super(IStructurePieceType.field_214775_V, p_i50651_2_);
      }
   ...
   public abstract static class Piece extends StructurePiece {
      protected static final BlockState field_175828_a = Blocks.PRISMARINE.getDefaultState();
      protected static final BlockState field_175826_b = Blocks.PRISMARINE_BRICKS.getDefaultState();
      protected static final BlockState field_175827_c = Blocks.DARK_PRISMARINE.getDefaultState();
      protected static final BlockState field_175824_d = field_175826_b;
      protected static final BlockState field_175825_e = Blocks.SEA_LANTERN.getDefaultState();
      protected static final BlockState field_175822_f = Blocks.WATER.getDefaultState();
      protected static final Set<Block> field_212180_g = ImmutableSet.<Block>builder().add(Blocks.ICE).add(Blocks.PACKED_ICE).add(Blocks.BLUE_ICE).add(field_175822_f.getBlock()).build();
            ...
            for(int j = x1; j <= x2; ++j) {
               for(int k = z1; k <= z2; ++k) {
                  ...
                  if (!field_212180_g.contains(blockstate.getBlock())) {
                     if (this.getYWithOffset(i) >= worldIn.getSeaLevel() && blockstate != field_175822_f) {
                        this.setBlockState(worldIn, Blocks.AIR.getDefaultState(), j, i, k, boundingBoxIn);
                     } else {
                        this.setBlockState(worldIn, field_175822_f, j, i, k, boundingBoxIn);
                     }
                  }
               }
            }
      ...
      protected void generateDefaultFloor(IWorld worldIn, MutableBoundingBox p_175821_2_, int x, int z, boolean hasOpeningDownwards) {
         if (hasOpeningDownwards) {
            this.fillWithBlocks(worldIn, p_175821_2_, x + 0, 0, z + 0, x + 2, 0, z + 8 - 1, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 5, 0, z + 0, x + 8 - 1, 0, z + 8 - 1, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 3, 0, z + 0, x + 4, 0, z + 2, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 3, 0, z + 5, x + 4, 0, z + 8 - 1, field_175828_a, field_175828_a, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 3, 0, z + 2, x + 4, 0, z + 2, field_175826_b, field_175826_b, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 3, 0, z + 5, x + 4, 0, z + 5, field_175826_b, field_175826_b, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 2, 0, z + 3, x + 2, 0, z + 4, field_175826_b, field_175826_b, false);
            this.fillWithBlocks(worldIn, p_175821_2_, x + 5, 0, z + 3, x + 5, 0, z + 4, field_175826_b, field_175826_b, false);
         } else {
            this.fillWithBlocks(worldIn, p_175821_2_, x + 0, 0, z + 0, x + 8 - 1, 0, z + 8 - 1, field_175828_a, field_175828_a, false);
         }
      ...
      protected boolean spawnElder(IWorld worldIn, MutableBoundingBox p_175817_2_, int p_175817_3_, int p_175817_4_, int p_175817_5_) {
         ...
         if (p_175817_2_.isVecInside(new BlockPos(i, j, k))) {
            ...
            worldIn.func_217376_c(elderguardianentity);
            return true;
         } else {
            return false;
         }
   ...
   public static class SimpleRoom extends OceanMonumentPieces.Piece {
      ...
      public SimpleRoom(Direction p_i45587_1_, OceanMonumentPieces.RoomDefinition p_i45587_2_, Random p_i45587_3_) {
         super(IStructurePieceType.field_214776_W, 1, p_i45587_1_, p_i45587_2_, 1, 1, 1);
         this.mainDesign = p_i45587_3_.nextInt(3);
      }

      public SimpleRoom(TemplateManager p_i50646_1_, CompoundNBT p_i50646_2_) {
         super(IStructurePieceType.field_214776_W, p_i50646_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (this.roomDefinition.connections[Direction.UP.getIndex()] == null) {
            this.generateBoxOnFillOnly(worldIn, structureBoundingBoxIn, 1, 4, 1, 6, 4, 6, field_175828_a);
         }
   ...
   public static class SimpleTopRoom extends OceanMonumentPieces.Piece {
      public SimpleTopRoom(Direction p_i50644_1_, OceanMonumentPieces.RoomDefinition p_i50644_2_) {
         super(IStructurePieceType.field_214777_X, 1, p_i50644_1_, p_i50644_2_, 1, 1, 1);
      }

      public SimpleTopRoom(TemplateManager p_i50645_1_, CompoundNBT p_i50645_2_) {
         super(IStructurePieceType.field_214777_X, p_i50645_2_);
      }
   ...
   public static class WingRoom extends OceanMonumentPieces.Piece {
      ...
      public WingRoom(Direction p_i45585_1_, MutableBoundingBox p_i45585_2_, int p_i45585_3_) {
         super(IStructurePieceType.field_214778_Y, p_i45585_1_, p_i45585_2_);
         this.mainDesign = p_i45585_3_ & 1;
      }

      public WingRoom(TemplateManager p_i50643_1_, CompoundNBT p_i50643_2_) {
         super(IStructurePieceType.field_214778_Y, p_i50643_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         if (this.mainDesign == 0) {
            ...
            for(int l = 0; l < 2; ++l) {
               this.setBlockState(worldIn, field_175826_b, j1, 6, 20, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175825_e, j1, 5, 20, structureBoundingBoxIn);
               this.setBlockState(worldIn, field_175826_b, j1, 4, 20, structureBoundingBoxIn);
               j1 = 13;
            }
