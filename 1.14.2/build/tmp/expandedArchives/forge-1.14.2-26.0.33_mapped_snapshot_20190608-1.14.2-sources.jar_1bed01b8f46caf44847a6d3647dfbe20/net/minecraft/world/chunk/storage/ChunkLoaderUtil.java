...
public class ChunkLoaderUtil {
   public static ChunkLoaderUtil.AnvilConverterData load(CompoundNBT nbt) {
      ...
      chunkloaderutil$anvilconverterdata.field_151564_i = nbt.getList("TileEntities", 10);
      chunkloaderutil$anvilconverterdata.field_151563_j = nbt.getList("TileTicks", 10);
   ...
   public static void convertToAnvilFormat(ChunkLoaderUtil.AnvilConverterData converterData, CompoundNBT compound, BiomeProvider provider) {
      ...
      for(int l2 = 0; l2 < 16; ++l2) {
         for(int i3 = 0; i3 < 16; ++i3) {
            ...
            abyte[i3 << 4 | l2] = (byte)(Registry.field_212624_m.getId(provider.getBiome(blockpos$mutableblockpos)) & 255);
         }
      }

      compound.putByteArray("Biomes", abyte);
      compound.put("Entities", converterData.field_76702_h);
      compound.put("TileEntities", converterData.field_151564_i);
      if (converterData.field_151563_j != null) {
         compound.put("TileTicks", converterData.field_151563_j);
      }
   ...
   public static class AnvilConverterData {
      ...
      public ListNBT field_151564_i;
      public ListNBT field_151563_j;
      public final int x;
      public final int z;
