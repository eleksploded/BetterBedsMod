...
public class StrongholdPieces {
   ...
   public static class ChestCorridor extends StrongholdPieces.Stronghold {
      ...
      public ChestCorridor(int p_i45582_1_, Random p_i45582_2_, MutableBoundingBox p_i45582_3_, Direction p_i45582_4_) {
         super(IStructurePieceType.field_214801_v, p_i45582_1_);
      ...
      public ChestCorridor(TemplateManager p_i50140_1_, CompoundNBT p_i50140_2_) {
         super(IStructurePieceType.field_214801_v, p_i50140_2_);
   ...
   public static class Corridor extends StrongholdPieces.Stronghold {
      ...
      public Corridor(int p_i50137_1_, MutableBoundingBox p_i50137_2_, Direction p_i50137_3_) {
         super(IStructurePieceType.field_214802_w, p_i50137_1_);
      ...
      public Corridor(TemplateManager p_i50138_1_, CompoundNBT p_i50138_2_) {
         super(IStructurePieceType.field_214802_w, p_i50138_2_);
   ...
   public static class Crossing extends StrongholdPieces.Stronghold {
      ...
      public Crossing(int p_i45580_1_, Random p_i45580_2_, MutableBoundingBox p_i45580_3_, Direction p_i45580_4_) {
         super(IStructurePieceType.field_214803_x, p_i45580_1_);
      ...
      public Crossing(TemplateManager p_i50136_1_, CompoundNBT p_i50136_2_) {
         super(IStructurePieceType.field_214803_x, p_i50136_2_);
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (this.leftLow) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 3, 1, 0, 5, 3, field_202556_l, field_202556_l, false);
         }

         if (this.rightLow) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 3, 1, 9, 5, 3, field_202556_l, field_202556_l, false);
         }

         if (this.leftHigh) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 5, 7, 0, 7, 9, field_202556_l, field_202556_l, false);
         }

         if (this.rightHigh) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 5, 7, 9, 7, 9, field_202556_l, field_202556_l, false);
         }

         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 1, 10, 7, 3, 10, field_202556_l, field_202556_l, false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 3, 4, 3, 3, 4, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 4, 6, 3, 4, 6, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         ...
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 1, 9, 7, 1, 9, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 2, 7, 7, 2, 7, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 5, 7, 4, 5, 9, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 8, 5, 7, 8, 5, 9, Blocks.field_222401_hJ.getDefaultState(), Blocks.field_222401_hJ.getDefaultState(), false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 5, 5, 7, 7, 5, 9, Blocks.field_222401_hJ.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), Blocks.field_222401_hJ.getDefaultState().with(SlabBlock.TYPE, SlabType.DOUBLE), false);
   ...
   public static class LeftTurn extends StrongholdPieces.Turn {
      public LeftTurn(int p_i45579_1_, Random p_i45579_2_, MutableBoundingBox p_i45579_3_, Direction p_i45579_4_) {
         super(IStructurePieceType.field_214804_y, p_i45579_1_);
      ...
      public LeftTurn(TemplateManager p_i50134_1_, CompoundNBT p_i50134_2_) {
         super(IStructurePieceType.field_214804_y, p_i50134_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         Direction direction = this.getCoordBaseMode();
         if (direction != Direction.NORTH && direction != Direction.EAST) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 1, 4, 3, 3, field_202556_l, field_202556_l, false);
         } else {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 1, 0, 3, 3, field_202556_l, field_202556_l, false);
         }
   ...
   public static class Library extends StrongholdPieces.Stronghold {
      ...
      public Library(int p_i45578_1_, Random p_i45578_2_, MutableBoundingBox p_i45578_3_, Direction p_i45578_4_) {
         super(IStructurePieceType.field_214805_z, p_i45578_1_);
      ...
      public Library(TemplateManager p_i50133_1_, CompoundNBT p_i50133_2_) {
         super(IStructurePieceType.field_214805_z, p_i50133_2_);
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (this.isLargeRoom) {
            this.setBlockState(worldIn, field_202556_l, 12, 9, 1, structureBoundingBoxIn);
   ...
   public static class PortalRoom extends StrongholdPieces.Stronghold {
      ...
      public PortalRoom(int p_i50131_1_, MutableBoundingBox p_i50131_2_, Direction p_i50131_3_) {
         super(IStructurePieceType.field_214754_A, p_i50131_1_);
      ...
      public PortalRoom(TemplateManager p_i50132_1_, CompoundNBT p_i50132_2_) {
         super(IStructurePieceType.field_214754_A, p_i50132_2_);
   ...
   public static class Prison extends StrongholdPieces.Stronghold {
      public Prison(int p_i45576_1_, Random p_i45576_2_, MutableBoundingBox p_i45576_3_, Direction p_i45576_4_) {
         super(IStructurePieceType.field_214755_B, p_i45576_1_);
      ...
      public Prison(TemplateManager p_i50130_1_, CompoundNBT p_i50130_2_) {
         super(IStructurePieceType.field_214755_B, p_i50130_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 1, 1, 0);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 1, 10, 3, 3, 10, field_202556_l, field_202556_l, false);
   ...
   public static class RightTurn extends StrongholdPieces.Turn {
      public RightTurn(int p_i50127_1_, Random p_i50127_2_, MutableBoundingBox p_i50127_3_, Direction p_i50127_4_) {
         super(IStructurePieceType.field_214756_C, p_i50127_1_);
      ...
      public RightTurn(TemplateManager p_i50128_1_, CompoundNBT p_i50128_2_) {
         super(IStructurePieceType.field_214756_C, p_i50128_2_);
      }
   ...
   public static class RoomCrossing extends StrongholdPieces.Stronghold {
      ...
      public RoomCrossing(int p_i45575_1_, Random p_i45575_2_, MutableBoundingBox p_i45575_3_, Direction p_i45575_4_) {
         super(IStructurePieceType.field_214757_D, p_i45575_1_);
      ...
      public RoomCrossing(TemplateManager p_i50125_1_, CompoundNBT p_i50125_2_) {
         super(IStructurePieceType.field_214757_D, p_i50125_2_);
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.placeDoor(worldIn, randomIn, structureBoundingBoxIn, this.entryDoor, 4, 1, 0);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 10, 6, 3, 10, field_202556_l, field_202556_l, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 4, 0, 3, 6, field_202556_l, field_202556_l, false);
         this.fillWithBlocks(worldIn, structureBoundingBoxIn, 10, 1, 4, 10, 3, 6, field_202556_l, field_202556_l, false);
         ...
         case 0:
            ...
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 4, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 4, 1, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 4, 1, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 6, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 6, 1, 5, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 6, 1, 6, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 5, 1, 4, structureBoundingBoxIn);
            this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 5, 1, 6, structureBoundingBoxIn);
            break;
         case 1:
   ...
   public static class Stairs extends StrongholdPieces.Stronghold {
      ...
      public Stairs(int p_i45574_1_, Random p_i45574_2_, MutableBoundingBox p_i45574_3_, Direction p_i45574_4_) {
         super(IStructurePieceType.field_214758_E, p_i45574_1_);
         this.source = false;
      ...
      public Stairs(TemplateManager p_i50122_1_, CompoundNBT p_i50122_2_) {
         this(IStructurePieceType.field_214758_E, p_i50122_2_);
      }
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 1, 6, 1, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 1, 5, 3, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 3, 4, 3, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 3, 3, 1, structureBoundingBoxIn);
         ...
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 1, 2, 1, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.STONE_BRICKS.getDefaultState(), 1, 1, 2, structureBoundingBoxIn);
         this.setBlockState(worldIn, Blocks.field_222401_hJ.getDefaultState(), 1, 1, 3, structureBoundingBoxIn);
         return true;
      }
   }
   ...
   public static class Stairs2 extends StrongholdPieces.Stairs {
      ...
      public Stairs2(Random p_i50117_1_, int p_i50117_2_, int p_i50117_3_) {
         super(IStructurePieceType.field_214759_F, 0, p_i50117_1_, p_i50117_2_, p_i50117_3_);
      }

      public Stairs2(TemplateManager p_i50118_1_, CompoundNBT p_i50118_2_) {
         super(IStructurePieceType.field_214759_F, p_i50118_2_);
      }
   }
   ...
   public static class StairsStraight extends StrongholdPieces.Stronghold {
      public StairsStraight(int p_i45572_1_, Random p_i45572_2_, MutableBoundingBox p_i45572_3_, Direction p_i45572_4_) {
         super(IStructurePieceType.field_214761_H, p_i45572_1_);
      ...
      public StairsStraight(TemplateManager p_i50113_1_, CompoundNBT p_i50113_2_) {
         super(IStructurePieceType.field_214761_H, p_i50113_2_);
      }
   ...
   static class Stones extends StructurePiece.BlockSelector {
      ...
      public void selectBlocks(Random rand, int x, int y, int z, boolean wall) {
         if (wall) {
            ...
            if (f < 0.2F) {
               this.field_151562_a = Blocks.CRACKED_STONE_BRICKS.getDefaultState();
            } else if (f < 0.5F) {
               this.field_151562_a = Blocks.MOSSY_STONE_BRICKS.getDefaultState();
            } else if (f < 0.55F) {
               this.field_151562_a = Blocks.INFESTED_STONE_BRICKS.getDefaultState();
            } else {
               this.field_151562_a = Blocks.STONE_BRICKS.getDefaultState();
            }
         } else {
            this.field_151562_a = Blocks.CAVE_AIR.getDefaultState();
         }
   ...
   public static class Straight extends StrongholdPieces.Stronghold {
      ...
      public Straight(int p_i45573_1_, Random p_i45573_2_, MutableBoundingBox p_i45573_3_, Direction p_i45573_4_) {
         super(IStructurePieceType.field_214760_G, p_i45573_1_);
      ...
      public Straight(TemplateManager p_i50115_1_, CompoundNBT p_i50115_2_) {
         super(IStructurePieceType.field_214760_G, p_i50115_2_);
      ...
      public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         ...
         if (this.expandsX) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 1, 2, 0, 3, 4, field_202556_l, field_202556_l, false);
         }

         if (this.expandsZ) {
            this.fillWithBlocks(worldIn, structureBoundingBoxIn, 4, 1, 2, 4, 3, 4, field_202556_l, field_202556_l, false);
         }
   ...
   abstract static class Stronghold extends StructurePiece {
      ...
      protected void placeDoor(IWorld worldIn, Random p_74990_2_, MutableBoundingBox p_74990_3_, StrongholdPieces.Stronghold.Door p_74990_4_, int p_74990_5_, int p_74990_6_, int p_74990_7_) {
         switch(p_74990_4_) {
         case OPENING:
            this.fillWithBlocks(worldIn, p_74990_3_, p_74990_5_, p_74990_6_, p_74990_7_, p_74990_5_ + 3 - 1, p_74990_6_ + 3 - 1, p_74990_7_, field_202556_l, field_202556_l, false);
            break;
         case WOOD_DOOR:
