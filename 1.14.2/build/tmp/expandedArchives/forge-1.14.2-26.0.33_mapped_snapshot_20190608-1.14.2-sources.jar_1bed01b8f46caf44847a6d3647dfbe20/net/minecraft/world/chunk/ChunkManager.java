...
public class ChunkManager extends ChunkLoader implements ChunkHolder.IPlayerProvider {
   ...
   public ChunkManager(ServerWorld p_i50715_1_, File p_i50715_2_, DataFixer p_i50715_3_, TemplateManager p_i50715_4_, Executor p_i50715_5_, ThreadTaskExecutor<Runnable> p_i50715_6_, IChunkLightProvider p_i50715_7_, ChunkGenerator<?> p_i50715_8_, IChunkStatusListener p_i50715_9_, Supplier<DimensionSavedDataManager> p_i50715_10_, int p_i50715_11_, int p_i50715_12_) {
      ...
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor = DelegatedTaskExecutor.func_213144_a(p_i50715_5_, "worldgen");
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor1 = DelegatedTaskExecutor.func_213144_a(p_i50715_6_, "main");
      this.field_219266_t = p_i50715_9_;
      DelegatedTaskExecutor<Runnable> delegatedtaskexecutor2 = DelegatedTaskExecutor.func_213144_a(p_i50715_5_, "light");
      ...
      this.field_219267_u = new ChunkManager.ProxyTicketManager(p_i50715_5_, p_i50715_6_);
   ...
   private static double func_219217_a(ChunkPos p_219217_0_, Entity p_219217_1_) {
      ...
      double d2 = d0 - p_219217_1_.posX;
      double d3 = d1 - p_219217_1_.posZ;
      return d2 * d2 + d3 * d3;
   }
   ...
   public String func_219170_a(ChunkPos p_219170_1_) {
      ...
      if (chunkholder == null) {
         ...
         if (ichunk != null) {
            s = s + "Ch: \u00a7" + ichunk.getStatus().func_222584_c() + ichunk.getStatus() + '\u00a7' + "r\n";
         }
      ...
      completablefuture.thenAcceptAsync((p_219185_5_) -> {
         ...
         if (completablefuture1 != completablefuture) {
            ...
            if (this.chunksToUnload.remove(p_219212_1_, p_219212_3_) && p_219185_5_ != null) {
               ...
               this.lightManager.func_215581_a(p_219185_5_.getPos());
         ...
         return completablefuture.thenComposeAsync((p_223180_4_) -> {
            ...
            if (!optional.isPresent()) {
               ...
               if (p_219244_2_ == ChunkStatus.LIGHT) {
                  this.field_219267_u.func_219356_a(TicketType.field_219492_e, chunkpos, 33 + ChunkStatus.func_222599_a(ChunkStatus.FEATURES), chunkpos);
               }
   ...
   protected void func_219209_c(ChunkPos p_219209_1_) {
      this.field_219257_k.enqueue(Util.namedRunnable(() -> {
         this.field_219267_u.func_219345_b(TicketType.field_219492_e, p_219209_1_, 33 + ChunkStatus.func_222599_a(ChunkStatus.FEATURES), p_219209_1_);
      }, () -> {
   ...
   private CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_219200_b(ChunkHolder p_219200_1_) {
      CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> completablefuture = p_219200_1_.func_219301_a(ChunkStatus.FULL.func_222593_e());
      return completablefuture.thenApplyAsync((p_219193_2_) -> {
         ...
         this.field_219265_s.enqueue(ChunkTaskPriorityQueueSorter.func_219069_a(p_219228_2_, p_219200_1_.func_219277_h().asLong(), p_219200_1_::func_219299_i));
      });
   }
   ...
   private boolean func_219229_a(IChunk chunkIn) {
      ...
      if (!chunkIn.isModified()) {
         ...
         try {
            ...
            field_219250_d.error("Failed to save chunk {},{}", chunkpos.x, chunkpos.z, exception);
            return false;
         }
      }
   }

   protected void setViewDistance(int p_219175_1_, int p_219175_2_) {
      ...
      if (k != this.field_219248_B) {
         ...
         this.field_219267_u.func_219351_a(this.field_219248_B);
      }
   ...
   private CompoundNBT func_219178_f(ChunkPos p_219178_1_) throws IOException {
      CompoundNBT compoundnbt = this.readChunk(p_219178_1_);
      return compoundnbt == null ? null : this.func_219166_a(this.world.getDimension().getType(), this.field_219259_m, compoundnbt);
   }

   boolean func_219243_d(ChunkPos p_219243_1_) {
      return this.field_219271_y.func_219444_a(p_219243_1_.asLong()).noneMatch((p_219201_1_) -> {
         return !p_219201_1_.isSpectator() && func_219217_a(p_219243_1_, p_219201_1_) < 16384.0D;
      });
   }

   private boolean func_219187_b(ServerPlayerEntity p_219187_1_) {
      return p_219187_1_.isSpectator() && !this.world.getGameRules().getBoolean("spectatorsGenerateChunks");
   }
   ...
   void func_219234_a(ServerPlayerEntity p_219234_1_, boolean p_219234_2_) {
      ...
      int i = MathHelper.floor(p_219234_1_.posX) >> 4;
      int j = MathHelper.floor(p_219234_1_.posZ) >> 4;
      if (p_219234_2_) {
         this.field_219271_y.func_219442_a(ChunkPos.asLong(i, j), p_219234_1_, flag);
         if (!flag) {
            this.field_219267_u.func_219341_a(SectionPos.from(p_219234_1_), p_219234_1_);
         }
      } else {
         SectionPos sectionpos = p_219234_1_.func_213842_M();
         this.field_219271_y.func_219443_a(sectionpos.asChunkPos().asLong(), p_219234_1_);
         if (!flag) {
      ...
      for(int l = i - this.field_219247_A; l <= i + this.field_219247_A; ++l) {
         for(int k = j - this.field_219247_A; k <= j + this.field_219247_A; ++k) {
            ...
            net.minecraftforge.event.ForgeEventFactory.fireChunkWatch(p_219234_2_, p_219234_1_, chunkpos, world);
   ...
   public void func_219183_a(ServerPlayerEntity p_219183_1_) {
      ...
      int l1 = MathHelper.floor(p_219183_1_.posX) >> 4;
      int i2 = MathHelper.floor(p_219183_1_.posZ) >> 4;
      SectionPos sectionpos = p_219183_1_.func_213842_M();
      SectionPos sectionpos1 = SectionPos.from(p_219183_1_);
      long i = sectionpos.asChunkPos().asLong();
      long j = sectionpos1.asChunkPos().asLong();
      boolean flag = this.field_219271_y.func_219448_c(p_219183_1_);
         ...
         if (Math.abs(k - l1) <= this.field_219247_A * 2 && Math.abs(l - i2) <= this.field_219247_A * 2) {
            ...
            for(int l3 = k2; l3 <= j3; ++l3) {
               for(int k1 = i3; k1 <= k3; ++k1) {
                  ...
                  boolean flag5 = !flag && func_219232_a(chunkpos1, k, l) <= this.field_219247_A;
                  boolean flag6 = !flag1 && func_219232_a(chunkpos1, l1, i2) <= this.field_219247_A;
            ...
            for(int i1 = k - this.field_219247_A; i1 <= k + this.field_219247_A; ++i1) {
               for(int j1 = l - this.field_219247_A; j1 <= l + this.field_219247_A; ++j1) {
                  ...
                  boolean flag3 = !flag;
                  boolean flag4 = false;
                  this.func_219199_a(p_219183_1_, chunkpos, new IPacket[2], flag3, false);
               }
            }
            ...
            for(int j2 = l1 - this.field_219247_A; j2 <= l1 + this.field_219247_A; ++j2) {
               for(int l2 = i2 - this.field_219247_A; l2 <= i2 + this.field_219247_A; ++l2) {
                  ...
                  boolean flag7 = false;
                  boolean flag8 = !flag1;
                  this.func_219199_a(p_219183_1_, chunkpos2, new IPacket[2], false, flag8);
               }
            }
         }
   ...
   public Stream<ServerPlayerEntity> func_219097_a(ChunkPos p_219097_1_, boolean p_219097_2_) {
      return this.field_219271_y.func_219444_a(p_219097_1_.asLong()).filter((p_219192_3_) -> {
   ...
   private void func_219180_a(ServerPlayerEntity p_219180_1_, IPacket<?>[] p_219180_2_, Chunk p_219180_3_) {
      ...
      if (!list.isEmpty()) {
         for(Entity entity1 : list) {
            p_219180_1_.connection.sendPacket(new SMountEntityPacket(entity1, ((MobEntity)entity1).getLeashHolder()));
         }
      }
   ...
   class EntityTracker {
      ...
      public EntityTracker(Entity p_i50468_2_, int p_i50468_3_, int p_i50468_4_, boolean p_i50468_5_) {
         this.field_219402_b = new TrackedEntity(ChunkManager.this.world, p_i50468_2_, p_i50468_4_, p_i50468_5_, this::func_219391_a);
      ...
      public void func_219400_b(ServerPlayerEntity p_219400_1_) {
         if (p_219400_1_ != this.field_219403_c) {
            ...
            int i = Math.min(this.field_219404_d, (ChunkManager.this.field_219247_A - 1) * 16);
