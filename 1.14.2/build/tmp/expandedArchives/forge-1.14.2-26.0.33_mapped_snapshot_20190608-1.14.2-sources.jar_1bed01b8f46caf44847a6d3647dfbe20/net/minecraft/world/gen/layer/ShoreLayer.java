...
public enum ShoreLayer implements ICastleTransformer {
   ...
   private static final int BEACH = Registry.field_212624_m.getId(Biomes.BEACH);
   private static final int SNOWY_BEACH = Registry.field_212624_m.getId(Biomes.SNOWY_BEACH);
   ...
   private static final int JUNGLE_EDGE = Registry.field_212624_m.getId(Biomes.JUNGLE_EDGE);
   ...
   private static final int BADLANDS_PLATEAU = Registry.field_212624_m.getId(Biomes.BADLANDS_PLATEAU);
   private static final int ERODED_BADLANDS = Registry.field_212624_m.getId(Biomes.ERODED_BADLANDS);
   private static final int MODIFIED_WOODED_BADLANDS_PLATEAU = Registry.field_212624_m.getId(Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU);
   private static final int MODIFIED_BADLANDS_PLATEAU = Registry.field_212624_m.getId(Biomes.MODIFIED_BADLANDS_PLATEAU);
   private static final int MUSHROOM_FIELDS = Registry.field_212624_m.getId(Biomes.MUSHROOM_FIELDS);
   private static final int MUSHROOM_FIELD_SHORE = Registry.field_212624_m.getId(Biomes.MUSHROOM_FIELD_SHORE);
   private static final int RIVER = Registry.field_212624_m.getId(Biomes.RIVER);
   private static final int MOUNTAIN_EDGE = Registry.field_212624_m.getId(Biomes.MOUNTAIN_EDGE);
   private static final int STONE_SHORE = Registry.field_212624_m.getId(Biomes.STONE_SHORE);
   private static final int SWAMP = Registry.field_212624_m.getId(Biomes.SWAMP);
   ...
   public int apply(INoiseRandom context, int p_202748_2_, int p_202748_3_, int p_202748_4_, int p_202748_5_, int p_202748_6_) {
      Biome biome = Registry.field_212624_m.getByValue(p_202748_6_);
   ...
   private static boolean isJungleCompatible(int p_151631_0_) {
      if (Registry.field_212624_m.getByValue(p_151631_0_) != null && Registry.field_212624_m.getByValue(p_151631_0_).getCategory() == Biome.Category.JUNGLE) {
         return true;
      } else {
