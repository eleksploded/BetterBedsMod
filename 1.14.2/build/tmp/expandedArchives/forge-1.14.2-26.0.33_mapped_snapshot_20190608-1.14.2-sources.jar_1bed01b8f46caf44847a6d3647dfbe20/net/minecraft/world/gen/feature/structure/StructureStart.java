...
public abstract class StructureStart {
   ...
   public CompoundNBT write(int chunkX, int chunkZ) {
      ...
      if (this.isValid()) {
         if (Registry.field_218361_B.getKey(this.getStructure()) == null) { // FORGE: This is just a more friendly error instead of the 'Null String' below
         ...
         compoundnbt.putString("id", Registry.field_218361_B.getKey(this.getStructure()).toString());
         compoundnbt.putString("biome", Registry.field_212624_m.getKey(this.biome).toString());
