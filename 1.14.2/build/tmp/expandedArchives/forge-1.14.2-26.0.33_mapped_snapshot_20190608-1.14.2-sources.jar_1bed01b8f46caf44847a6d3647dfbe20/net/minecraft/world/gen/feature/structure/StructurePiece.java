...
public abstract class StructurePiece {
   protected static final BlockState field_202556_l = Blocks.CAVE_AIR.getDefaultState();
   ...
   public final CompoundNBT write() {
      if (Registry.field_218362_C.getKey(this.func_214807_k()) == null) { // FORGE: Friendlier error then the Null String error below.
      ...
      compoundnbt.putString("id", Registry.field_218362_C.getKey(this.func_214807_k()).toString());
   ...
   protected void setBlockState(IWorld worldIn, BlockState blockstateIn, int x, int y, int z, MutableBoundingBox boundingboxIn) {
      ...
      if (boundingboxIn.isVecInside(blockpos)) {
         ...
         if (BLOCKS_NEEDING_POSTPROCESSING.contains(blockstateIn.getBlock())) {
            worldIn.func_217349_x(blockpos).markBlockForPostprocessing(blockpos);
         }
   ...
   public abstract static class BlockSelector {
      protected BlockState field_151562_a = Blocks.AIR.getDefaultState();
