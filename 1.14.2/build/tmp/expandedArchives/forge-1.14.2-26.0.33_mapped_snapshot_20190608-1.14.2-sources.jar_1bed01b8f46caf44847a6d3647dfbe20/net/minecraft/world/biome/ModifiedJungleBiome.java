...
public final class ModifiedJungleBiome extends Biome {
   public ModifiedJungleBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215396_G, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.RAIN).category(Biome.Category.JUNGLE).depth(0.2F).scale(0.4F).temperature(0.95F).downfall(0.9F).waterColor(4159204).waterFogColor(329011).parent("jungle"));
