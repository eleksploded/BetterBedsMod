...
public class BigTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
   private static final BlockState field_208530_a = Blocks.OAK_LOG.getDefaultState();
   private static final BlockState field_208531_b = Blocks.OAK_LEAVES.getDefaultState();
         ...
         for(int k = -i; k <= i; ++k) {
            if (Math.pow((double)Math.abs(j) + 0.5D, 2.0D) + Math.pow((double)Math.abs(k) + 0.5D, 2.0D) <= (double)(p_208529_3_ * p_208529_3_)) {
               ...
               if (func_214572_g(p_208529_1_, blockpos)) {
                  this.setLogState(p_208529_5_, p_208529_1_, blockpos, field_208531_b, p_208529_4_);
               }
            }
         }
      }
   ...
   private int makeLimb(Set<BlockPos> p_208523_1_, IWorldGenerationReader p_208523_2_, BlockPos p_208523_3_, BlockPos p_208523_4_, boolean p_208523_5_, MutableBoundingBox p_208523_6_) {
      if (!p_208523_5_ && Objects.equals(p_208523_3_, p_208523_4_)) {
         ...
         for(int j = 0; j <= i; ++j) {
            ...
            if (p_208523_5_) {
               this.setLogState(p_208523_1_, p_208523_2_, blockpos1, field_208530_a.with(LogBlock.AXIS, this.getLoxAxis(p_208523_3_, blockpos1)), p_208523_6_);
