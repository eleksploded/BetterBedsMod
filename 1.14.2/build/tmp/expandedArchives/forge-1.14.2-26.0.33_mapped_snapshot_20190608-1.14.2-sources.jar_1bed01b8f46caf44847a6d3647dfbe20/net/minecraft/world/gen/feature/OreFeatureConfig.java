...
public class OreFeatureConfig implements IFeatureConfig {
   public final OreFeatureConfig.FillerBlockType field_202442_b;
   ...
   public OreFeatureConfig(OreFeatureConfig.FillerBlockType p_i51473_1_, BlockState p_i51473_2_, int p_i51473_3_) {
      ...
      this.field_202444_d = p_i51473_2_;
      this.field_202442_b = p_i51473_1_;
   }

   public <T> Dynamic<T> func_214634_a(DynamicOps<T> p_214634_1_) {
      return new Dynamic<>(p_214634_1_, p_214634_1_.createMap(ImmutableMap.of(p_214634_1_.createString("size"), p_214634_1_.createInt(this.size), p_214634_1_.createString("target"), p_214634_1_.createString(this.field_202442_b.func_214737_a()), p_214634_1_.createString("state"), BlockState.func_215689_a(p_214634_1_, this.field_202444_d).getValue())));
   }
   ...
   public static OreFeatureConfig func_214641_a(Dynamic<?> p_214641_0_) {
      ...
      BlockState blockstate = p_214641_0_.get("state").map(BlockState::func_215698_a).orElse(Blocks.AIR.getDefaultState());
