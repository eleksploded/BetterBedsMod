...
public class BiomeProviderType<C extends IBiomeProviderSettings, T extends BiomeProvider> extends net.minecraftforge.registries.ForgeRegistryEntry<BiomeProviderType<?, ?>> {
   ...
   private static <C extends IBiomeProviderSettings, T extends BiomeProvider> BiomeProviderType<C, T> register(String p_212581_0_, Function<C, T> p_212581_1_, Supplier<C> p_212581_2_) {
      return Registry.register(Registry.field_212625_n, p_212581_0_, new BiomeProviderType<>(p_212581_1_, p_212581_2_));
   }
