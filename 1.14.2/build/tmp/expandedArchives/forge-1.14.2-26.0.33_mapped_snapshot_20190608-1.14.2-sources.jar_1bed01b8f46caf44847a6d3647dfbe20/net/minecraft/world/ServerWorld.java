...
public class ServerWorld extends World implements net.minecraftforge.common.extensions.IForgeWorldServer {
   ...
   }, Registry.field_212618_g::getKey, Registry.field_212618_g::getOrDefault, this::tickBlock);
   ...
   }, Registry.field_212619_h::getKey, Registry.field_212619_h::getOrDefault, this::tickFluid);
   ...
   public ServerWorld(MinecraftServer p_i50703_1_, Executor p_i50703_2_, SaveHandler p_i50703_3_, WorldInfo p_i50703_4_, DimensionType p_i50703_5_, IProfiler p_i50703_6_, IChunkStatusListener p_i50703_7_) {
      super(p_i50703_4_, p_i50703_5_, (p_217442_4_, p_217442_5_) -> {
         return new ServerChunkProvider((ServerWorld)p_217442_4_, p_i50703_3_.getWorldDirectory(), p_i50703_3_.getFixer(), p_i50703_3_.getStructureTemplateManager(), p_i50703_2_, p_217442_4_.getWorldType().createChunkGenerator(p_217442_4_), p_i50703_1_.getPlayerList().getViewDistance(), p_i50703_1_.getPlayerList().getViewDistance() - 2, p_i50703_7_, () -> {
            return p_i50703_1_.getWorld(DimensionType.OVERWORLD).func_217481_x();
         });
      }, p_i50703_6_, false);
      ...
      this.field_217496_L = this.dimension.getType() == DimensionType.OVERWORLD ? new WanderingTraderSpawner(this) : null;
   ...
   public void tick(BooleanSupplier hasTimeLeft) {
      ...
      if (this.allPlayersSleeping && this.players.stream().noneMatch((p_217449_0_) -> {
         ...
         this.players.stream().filter(LivingEntity::isPlayerSleeping).forEach((p_217444_0_) -> {
      ...
      boolean flag3 = !this.players.isEmpty() || !this.func_217469_z().isEmpty();
      if (flag3) {
   ...
   public void func_217441_a(Chunk p_217441_1_, int p_217441_2_) {
      ...
      if (this.dimension.canDoLightning(p_217441_1_) && flag && this.isThundering() && this.rand.nextInt(100000) == 0) {
         ...
         if (this.isRainingAt(blockpos)) {
            ...
            this.func_217468_a(new LightningBoltEntity(this, (double)blockpos.getX() + 0.5D, (double)blockpos.getY(), (double)blockpos.getZ() + 0.5D, flag1));
         }
      }
   ...
   protected BlockPos adjustPosToNearbyEntity(BlockPos pos) {
      ...
      AxisAlignedBB axisalignedbb = (new AxisAlignedBB(blockpos, new BlockPos(blockpos.getX(), this.func_217301_I(), blockpos.getZ()))).grow(3.0D);
      ...
      if (!this.players.isEmpty()) {
         ...
         for(ServerPlayerEntity serverplayerentity : this.players) {
            if (serverplayerentity.isSpectator()) {
               ++i;
            } else if (serverplayerentity.isPlayerSleeping()) {
               ++j;
            }
         }
   ...
   public void updateEntity(Entity p_217479_1_) {
      if (p_217479_1_ instanceof PlayerEntity || this.getChunkProvider().func_217204_a(p_217479_1_)) {
         p_217479_1_.lastTickPosX = p_217479_1_.posX;
         p_217479_1_.lastTickPosY = p_217479_1_.posY;
         p_217479_1_.lastTickPosZ = p_217479_1_.posZ;
   ...
   public void func_217459_a(Entity p_217459_1_, Entity p_217459_2_) {
      if (!p_217459_2_.removed && p_217459_2_.getRidingEntity() == p_217459_1_) {
         if (p_217459_2_ instanceof PlayerEntity || this.getChunkProvider().func_217204_a(p_217459_2_)) {
   ...
   public void chunkCheck(Entity p_217464_1_) {
      ...
      int i = MathHelper.floor(p_217464_1_.posX / 16.0D);
      int j = MathHelper.floor(p_217464_1_.posY / 16.0D);
      int k = MathHelper.floor(p_217464_1_.posZ / 16.0D);
   ...
   public void createSpawnPosition(WorldSettings settings) {
      if (!this.dimension.canRespawnHere()) {
         this.worldInfo.setSpawn(BlockPos.ZERO.up(this.field_73020_y.getChunkGenerator().getGroundHeight()));
         ...
         BiomeProvider biomeprovider = this.field_73020_y.getChunkGenerator().getBiomeProvider();
         ...
         this.worldInfo.setSpawn(chunkpos.asBlockPos().add(8, this.field_73020_y.getChunkGenerator().getGroundHeight(), 8));
         int i1 = 0;
         int j1 = 0;
         int i = 0;
         int j = -1;
   ...
   protected void createBonusChest() {
      ...
      for(int i = 0; i < 10; ++i) {
         ...
         if (bonuschestfeature.place(this, this.field_73020_y.getChunkGenerator(), this.rand, blockpos, IFeatureConfig.NO_FEATURE_CONFIG)) {
            break;
         }
      }
   ...
   public void func_217445_a(@Nullable IProgressUpdate p_217445_1_, boolean p_217445_2_, boolean p_217445_3_) throws SessionLockException {
      ...
      if (!p_217445_3_) {
         if (p_217445_1_ != null) {
            p_217445_1_.displaySavingString(new TranslationTextComponent("menu.savingLevel"));
         }

         this.saveLevel();
         if (p_217445_1_ != null) {
            p_217445_1_.displayLoadingString(new TranslationTextComponent("menu.savingChunks"));
         }
   ...
   protected void saveLevel() throws SessionLockException {
      ...
      this.getChunkProvider().func_217227_h().save();
   }
   ...
   public Object2IntMap<EntityClassification> countEntities() {
      ...
      for(Entity entity : this.entitiesById.values()) {
         if (!(entity instanceof MobEntity) || !((MobEntity)entity).isNoDespawnRequired()) {
            ...
            if (entityclassification != EntityClassification.MISC && this.getChunkProvider().func_217204_a(entity)) {
   ...
   public boolean func_217376_c(Entity p_217376_1_) {
      return this.spawnEntity(p_217376_1_);
   }

   public boolean summonEntity(Entity p_217470_1_) {
      return this.spawnEntity(p_217470_1_);
   }
   ...
   private void func_217448_f(ServerPlayerEntity p_217448_1_) {
      Entity entity = this.entitiesByUuid.get(p_217448_1_.getUniqueID());
      if (entity != null) {
         LOGGER.warn("Force-added player with duplicate UUID {}", (Object)p_217448_1_.getUniqueID().toString());
      ...
      IChunk ichunk = this.getChunk(MathHelper.floor(p_217448_1_.posX / 16.0D), MathHelper.floor(p_217448_1_.posZ / 16.0D), ChunkStatus.FULL, true);
      if (ichunk instanceof Chunk) {
         ichunk.addEntity(p_217448_1_);
      }

      this.addEntity(p_217448_1_);
   }

   /**
    * Called when an entity is spawned in the world. This includes players.
    */
   private boolean spawnEntity(Entity entityIn) {
      if (entityIn.removed) {
   ...
   public boolean addEntityIfNotDuplicate(Entity p_217440_1_) {
      if (this.hasDuplicateEntity(p_217440_1_)) {
         ...
         this.addEntity(p_217440_1_);
         return true;
      }
   }

   private boolean hasDuplicateEntity(Entity p_217478_1_) {
      Entity entity = this.entitiesByUuid.get(p_217478_1_.getUniqueID());
      if (entity == null) {
         return false;
      } else {
         LOGGER.warn("Keeping entity {} that already exists with UUID {}", EntityType.getId(entity.getType()), p_217478_1_.getUniqueID().toString());
         return true;
      }
   }
   ...
   public void removeEntityComplete(Entity p_217484_1_, boolean keepData) {
      ...
      this.entitiesByUuid.remove(p_217484_1_.getUniqueID());
      this.getChunkProvider().func_217226_b(p_217484_1_);
      ...
      this.getScoreboard().removeEntity(p_217484_1_);
      if (p_217484_1_ instanceof MobEntity) {
         this.field_217495_I.remove(((MobEntity)p_217484_1_).getNavigator());
      }

      p_217484_1_.onRemovedFromWorld();
   }

   private void addEntity(Entity p_217465_1_) {
      if (this.tickingEntities) {
         ...
         this.getChunkProvider().func_217230_c(p_217465_1_);
         if (p_217465_1_ instanceof MobEntity) {
            this.field_217495_I.add(((MobEntity)p_217465_1_).getNavigator());
         }
      }
   ...
   public void removeEntity(Entity p_217467_1_, boolean keepData) {
      if (this.tickingEntities) {
         ...
         this.entitiesById.remove(p_217467_1_.getEntityId());
   ...
   public void removePlayer(ServerPlayerEntity p_217434_1_, boolean keepData) {
      ...
      this.removeEntity(p_217434_1_);
      this.updateAllPlayersSleepingFlag();
   }

   public void func_217468_a(LightningBoltEntity p_217468_1_) {
      this.weatherEffects.add(p_217468_1_);
      this.server.getPlayerList().sendToAllNearExcept((PlayerEntity)null, p_217468_1_.posX, p_217468_1_.posY, p_217468_1_.posZ, 512.0D, this.dimension.getType(), new SSpawnGlobalEntityPacket(p_217468_1_));
   }
   ...
   public void notifyBlockUpdate(BlockPos pos, BlockState oldState, BlockState newState, int flags) {
      this.getChunkProvider().func_217217_a(pos);
   ...
   public void setEntityState(Entity entityIn, byte state) {
      this.getChunkProvider().func_217216_a(entityIn, new SEntityStatusPacket(entityIn, state));
   }
   ...
   public TemplateManager getStructureTemplateManager() {
      return this.field_217493_C.getStructureTemplateManager();
   }
   ...
   private boolean sendPacketWithinDistance(ServerPlayerEntity p_195601_1_, boolean p_195601_2_, double p_195601_3_, double p_195601_5_, double p_195601_7_, IPacket<?> p_195601_9_) {
      if (p_195601_1_.getServerWorld() != this) {
         ...
         if (blockpos.func_218137_a(new Vec3d(p_195601_3_, p_195601_5_, p_195601_7_), p_195601_2_ ? 512.0D : 32.0D)) {
   ...
   public void setGameTime(long worldTime) {
      ...
      this.worldInfo.func_215763_z().func_216331_a(this.server, worldTime);
   }
   ...
   public void checkSessionLock() throws SessionLockException {
      this.field_217493_C.checkSessionLock();
   }
   ...
   public DimensionSavedDataManager func_217481_x() {
      return this.getChunkProvider().func_217227_h();
   }

   @Nullable
   public MapData func_217406_a(String p_217406_1_) {
      return this.getServer().getWorld(DimensionType.OVERWORLD).func_217481_x().func_215753_b(() -> {
         return new MapData(p_217406_1_);
      }, p_217406_1_);
   }

   public void func_217399_a(MapData p_217399_1_) {
      this.getServer().getWorld(DimensionType.OVERWORLD).func_217481_x().func_215757_a(p_217399_1_);
   }

   public int func_217395_y() {
      return this.getServer().getWorld(DimensionType.OVERWORLD).func_217481_x().func_215752_a(MapIdTracker::new, "idcounts").func_215162_a();
   }
   ...
   public void setSpawnPoint(BlockPos pos) {
      ...
      this.getChunkProvider().func_217222_b(TicketType.field_219488_a, chunkpos, 11, Unit.INSTANCE);
      this.getChunkProvider().func_217228_a(TicketType.field_219488_a, new ChunkPos(pos), 11, Unit.INSTANCE);
   }
   ...
   public Raid findRaid(BlockPos p_217475_1_) {
      Raid raid = this.field_217494_c.findRaid(p_217475_1_, 9216);
      return this.func_217483_b_(p_217475_1_) ? raid : null;
   }
