...
public class SetLore extends LootFunction {
   ...
   public SetLore(ILootCondition[] p_i51220_1_, boolean p_i51220_2_, List<ITextComponent> p_i51220_3_, @Nullable LootContext.EntityTarget p_i51220_4_) {
      super(p_i51220_1_);
      this.field_215945_a = p_i51220_2_;
      this.field_215946_c = ImmutableList.copyOf(p_i51220_3_);
   ...
   public ItemStack doApply(ItemStack p_215859_1_, LootContext p_215859_2_) {
      ListNBT listnbt = this.func_215942_a(p_215859_1_, !this.field_215946_c.isEmpty());
      if (listnbt != null) {
         if (this.field_215945_a) {
            listnbt.clear();
         }

         UnaryOperator<ITextComponent> unaryoperator = SetName.func_215936_a(p_215859_2_, this.field_215947_d);
         this.field_215946_c.stream().map(unaryoperator).map(ITextComponent.Serializer::toJson).map(StringNBT::new).forEach(listnbt::add);
      }
   ...
   public static class Serializer extends LootFunction.Serializer<SetLore> {
      ...
      public void serialize(JsonObject object, SetLore functionClazz, JsonSerializationContext serializationContext) {
         ...
         object.addProperty("replace", functionClazz.field_215945_a);
         JsonArray jsonarray = new JsonArray();

         for(ITextComponent itextcomponent : functionClazz.field_215946_c) {
