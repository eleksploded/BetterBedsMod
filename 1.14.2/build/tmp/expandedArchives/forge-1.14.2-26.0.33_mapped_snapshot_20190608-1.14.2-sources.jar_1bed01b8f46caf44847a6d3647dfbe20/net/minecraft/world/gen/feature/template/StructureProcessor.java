...
public abstract class StructureProcessor {
   ...
   protected abstract <T> Dynamic<T> doSerialize(DynamicOps<T> p_215193_1_);

   public <T> Dynamic<T> serialize(DynamicOps<T> p_215191_1_) {
      return new Dynamic<>(p_215191_1_, p_215191_1_.mergeInto(this.doSerialize(p_215191_1_).getValue(), p_215191_1_.createString("processor_type"), p_215191_1_.createString(Registry.field_218364_E.getKey(this.getType()).toString())));
   }
}