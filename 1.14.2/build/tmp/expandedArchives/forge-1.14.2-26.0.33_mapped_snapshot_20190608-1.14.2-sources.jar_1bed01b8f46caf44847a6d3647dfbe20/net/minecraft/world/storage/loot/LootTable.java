...
public class LootTable {
   ...
   public static final LootTable EMPTY_LOOT_TABLE = new LootTable(LootParameterSets.field_216260_a, new LootPool[0], new ILootFunction[0]);
   ...
   private LootTable(LootParameterSet p_i51265_1_, LootPool[] p_i51265_2_, ILootFunction[] p_i51265_3_) {
      ...
      this.field_216129_g = LootFunctionManager.combine(p_i51265_3_);
   }
   ...
   public void func_216114_a(LootContext p_216114_1_, Consumer<ItemStack> p_216114_2_) {
      if (p_216114_1_.addLootTable(this)) {
         Consumer<ItemStack> consumer = ILootFunction.func_215858_a(this.field_216129_g, p_216114_2_, p_216114_1_);
   ...
   public void func_216117_a(ValidationResults p_216117_1_, Function<ResourceLocation, LootTable> p_216117_2_, Set<ResourceLocation> p_216117_3_, LootParameterSet p_216117_4_) {
      for(int i = 0; i < this.pools.size(); ++i) {
         this.pools.get(i).func_216099_a(p_216117_1_.func_216108_b(".pools[" + i + "]"), p_216117_2_, p_216117_3_, p_216117_4_);
      }
   ...
   public static LootTable.Builder func_216119_b() {
   ...
   public static class Builder implements ILootFunctionConsumer<LootTable.Builder> {
      ...
      public LootTable.Builder func_216040_a(LootPool.Builder p_216040_1_) {
         this.field_216041_a.add(p_216040_1_.func_216044_b());
         return this;
      }
      ...
      public LootTable.Builder func_212841_b_(ILootFunction.IBuilder p_212841_1_) {
         this.field_216042_b.add(p_212841_1_.build());
         return this;
      }
   ...
   public static class Serializer implements JsonDeserializer<LootTable>, JsonSerializer<LootTable> {
      ...
      public JsonElement serialize(LootTable p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_) {
         ...
         if (p_serialize_1_.field_216127_d != LootTable.field_216126_b) {
            ...
            if (resourcelocation != null) {
               ...
               LootTable.LOGGER.warn("Failed to find id for param set " + p_serialize_1_.field_216127_d);
            }
         }
         ...
         if (!ArrayUtils.isEmpty((Object[])p_serialize_1_.field_216128_f)) {
            jsonobject.add("functions", p_serialize_3_.serialize(p_serialize_1_.field_216128_f));
         }
