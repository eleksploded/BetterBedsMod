      ...
      if (!this.func_203427_a(worldIn, position, i)) {
         ...
         for(int j = position.getY() + i - 2 - rand.nextInt(4); j > position.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
            ...
            for(int i1 = 0; i1 < 5; ++i1) {
               ...
               this.setLogState(changedBlocks, worldIn, new BlockPos(k, j - 3 + i1 / 2, l), this.field_76520_b, p_208519_5_);
            }
         ...
         for(int i2 = 0; i2 < i; ++i2) {
            ...
            if (func_214587_a(worldIn, blockpos)) {
               this.setLogState(changedBlocks, worldIn, blockpos, this.field_76520_b, p_208519_5_);
               if (i2 > 0) {
            ...
            if (i2 < i - 1) {
               ...
               if (func_214587_a(worldIn, blockpos1)) {
                  this.setLogState(changedBlocks, worldIn, blockpos1, this.field_76520_b, p_208519_5_);
                  if (i2 > 0) {
               ...
               if (func_214587_a(worldIn, blockpos2)) {
                  this.setLogState(changedBlocks, worldIn, blockpos2, this.field_76520_b, p_208519_5_);
                  if (i2 > 0) {
               ...
               if (func_214587_a(worldIn, blockpos3)) {
                  this.setLogState(changedBlocks, worldIn, blockpos3, this.field_76520_b, p_208519_5_);
                  if (i2 > 0) {
