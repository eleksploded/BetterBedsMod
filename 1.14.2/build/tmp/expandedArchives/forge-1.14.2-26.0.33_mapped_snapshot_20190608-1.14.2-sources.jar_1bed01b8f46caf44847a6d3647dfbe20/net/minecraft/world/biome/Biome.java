...
public abstract class Biome extends net.minecraftforge.registries.ForgeRegistryEntry<Biome> {
   ...
   public static Biome getMutationForBiome(Biome biome) {
      return MUTATION_TO_BASE_ID_MAP.getByValue(Registry.field_212624_m.getId(biome));
   }

   public static <C extends ICarverConfig> ConfiguredCarver<C> createWorldCarverWrapper(WorldCarver<C> carver, C config) {
      return new ConfiguredCarver<>(carver, config);
   }

   public static <F extends IFeatureConfig, D extends IPlacementConfig> ConfiguredFeature<?> func_222280_a(Feature<F> p_222280_0_, F p_222280_1_, Placement<D> p_222280_2_, D p_222280_3_) {
      Feature<DecoratedFeatureConfig> feature = p_222280_0_ instanceof FlowersFeature ? Feature.field_214484_aL : Feature.field_214483_aK;
      return new ConfiguredFeature<>(feature, new DecoratedFeatureConfig(p_222280_0_, p_222280_1_, p_222280_2_, p_222280_3_));
   }

   protected Biome(Biome.Builder biomeBuilder) {
      if (biomeBuilder.field_205422_a != null && biomeBuilder.precipitation != null && biomeBuilder.category != null && biomeBuilder.depth != null && biomeBuilder.scale != null && biomeBuilder.temperature != null && biomeBuilder.downfall != null && biomeBuilder.waterColor != null && biomeBuilder.waterFogColor != null) {
   ...
   public float getTemperature(BlockPos pos) {
      if (pos.getY() > 64) {
         float f = (float)(field_150605_ac.getValue((double)((float)pos.getX() / 8.0F), (double)((float)pos.getZ() / 8.0F)) * 4.0D);
   ...
   public boolean doesWaterFreeze(IWorldReader p_201848_1_, BlockPos pos) {
   ...
   public void addFeature(GenerationStage.Decoration decorationStage, ConfiguredFeature<?> featureIn) {
      if (featureIn.feature == Feature.field_214484_aL) {
   ...
   public void decorate(GenerationStage.Decoration stage, ChunkGenerator<? extends GenerationSettings> chunkGenerator, IWorld worldIn, long p_203608_4_, SharedSeedRandom random, BlockPos pos) {
      int i = 0;
   ...
   public String getTranslationKey() {
      if (this.translationKey == null) {
         this.translationKey = Util.makeTranslationKey("biome", Registry.field_212624_m.getKey(this));
      }
   ...
   public static enum Category {
      ...
      private static final Map<String, Biome.Category> field_222354_r = Arrays.stream(values()).collect(Collectors.toMap(Biome.Category::func_222352_a, (p_222353_0_) -> {
         return p_222353_0_;
      }));
      private final String field_222355_s;

      private Category(String p_i50595_3_) {
         this.field_222355_s = p_i50595_3_;
      }
   ...
   public static enum RainType {
      ...
      private static final Map<String, Biome.RainType> field_222362_d = Arrays.stream(values()).collect(Collectors.toMap(Biome.RainType::func_222361_a, (p_222360_0_) -> {
         return p_222360_0_;
      }));
      private final String field_222363_e;

      private RainType(String p_i50593_3_) {
         this.field_222363_e = p_i50593_3_;
      }
