...
public final class ShatteredSavannaPlateauBiome extends Biome {
   public ShatteredSavannaPlateauBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215398_I, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.NONE).category(Biome.Category.SAVANNA).depth(1.05F).scale(1.2125001F).temperature(1.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("savanna_plateau"));
