...
public class SmallEndIslandsBiome extends Biome {
   public SmallEndIslandsBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.RAW_GENERATION, func_222280_a(Feature.END_ISLAND, IFeatureConfig.NO_FEATURE_CONFIG, Placement.field_215011_J, IPlacementConfig.NO_PLACEMENT_CONFIG));
