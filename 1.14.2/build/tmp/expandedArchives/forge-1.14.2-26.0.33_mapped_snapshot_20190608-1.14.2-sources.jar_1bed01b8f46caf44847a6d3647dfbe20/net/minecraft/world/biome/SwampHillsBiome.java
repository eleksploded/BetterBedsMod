...
public final class SwampHillsBiome extends Biome {
   protected SwampHillsBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215401_L, SurfaceBuilder.field_215425_v).precipitation(Biome.RainType.RAIN).category(Biome.Category.SWAMP).depth(-0.1F).scale(0.3F).temperature(0.8F).downfall(0.9F).waterColor(6388580).waterFogColor(2302743).parent("swamp"));
   ...
   public int getGrassColor(BlockPos pos) {
      double d0 = field_180281_af.getValue((double)pos.getX() * 0.0225D, (double)pos.getZ() * 0.0225D);
