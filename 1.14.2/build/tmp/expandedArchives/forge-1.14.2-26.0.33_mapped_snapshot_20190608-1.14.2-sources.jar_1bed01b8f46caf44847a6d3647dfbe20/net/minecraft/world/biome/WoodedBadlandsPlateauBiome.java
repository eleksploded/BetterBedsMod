...
public final class WoodedBadlandsPlateauBiome extends Biome {
   public WoodedBadlandsPlateauBiome() {
      super((new Biome.Builder()).func_222351_a(SurfaceBuilder.field_215403_N, SurfaceBuilder.field_215392_C).precipitation(Biome.RainType.NONE).category(Biome.Category.MESA).depth(1.5F).scale(0.025F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
