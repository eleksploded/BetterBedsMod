...
public class FlatChunkGenerator extends ChunkGenerator<FlatGenerationSettings> {
   ...
   private Biome func_202099_e() {
      ...
      for(int i = 0; i < ablockstate.length; ++i) {
         ...
         if (blockstate != null && !Heightmap.Type.MOTION_BLOCKING.func_222684_d().test(blockstate)) {
            ...
            flatchunkgenerator$wrapperbiome.addFeature(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, Biome.func_222280_a(Feature.field_214486_aN, new FillLayerConfig(i, blockstate), Placement.field_215022_h, IPlacementConfig.NO_PLACEMENT_CONFIG));
         }
      }
   ...
   public void spawnMobs(ServerWorld worldIn, boolean spawnHostileMobs, boolean spawnPeacefulMobs) {
      this.field_203229_i.spawnMobs(worldIn, spawnHostileMobs, spawnPeacefulMobs);
