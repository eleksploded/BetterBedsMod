...
public class MapData extends WorldSavedData {
   ...
   public void updateVisiblePlayers(PlayerEntity player, ItemStack mapStack) {
      ...
      for(int i = 0; i < this.playersArrayList.size(); ++i) {
         ...
         String s = mapdata$mapinfo1.field_76211_a.getName().getString();
         if (!mapdata$mapinfo1.field_76211_a.removed && (mapdata$mapinfo1.field_76211_a.inventory.hasItemStack(mapStack) || mapStack.isOnItemFrame())) {
            if (!mapStack.isOnItemFrame() && mapdata$mapinfo1.field_76211_a.dimension == this.dimension && this.trackingPosition) {
               this.updateDecorations(MapDecoration.Type.PLAYER, mapdata$mapinfo1.field_76211_a.world, s, mapdata$mapinfo1.field_76211_a.posX, mapdata$mapinfo1.field_76211_a.posZ, (double)mapdata$mapinfo1.field_76211_a.rotationYaw, (ITextComponent)null);
            }
         } else {
            this.playersHashMap.remove(mapdata$mapinfo1.field_76211_a);
      ...
      if (mapStack.isOnItemFrame() && this.trackingPosition) {
         ...
         MapFrame mapframe = new MapFrame(blockpos, itemframeentity.field_174860_b.getHorizontalIndex() * 90, itemframeentity.getEntityId());
         this.updateDecorations(MapDecoration.Type.FRAME, player.world, "frame-" + itemframeentity.getEntityId(), (double)blockpos.getX(), (double)blockpos.getZ(), (double)(itemframeentity.field_174860_b.getHorizontalIndex() * 90), (ITextComponent)null);
         this.frames.put(mapframe.func_212767_e(), mapframe);
      }
