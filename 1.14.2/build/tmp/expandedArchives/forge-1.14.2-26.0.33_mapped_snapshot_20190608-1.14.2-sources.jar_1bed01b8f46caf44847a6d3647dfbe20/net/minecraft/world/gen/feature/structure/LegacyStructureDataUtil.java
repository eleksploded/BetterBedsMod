   ...
   private void func_212184_a(@Nullable DimensionSavedDataManager p_212184_1_) {
      if (p_212184_1_ != null) {
         for(String s : this.field_215132_f) {
            ...
            try {
               compoundnbt = p_212184_1_.func_215755_a(s, 1493).getCompound("data").getCompound("Features");
            ...
            String s5 = s + "_index";
            StructureIndexesSavedData structureindexessaveddata = p_212184_1_.func_215752_a(() -> {
