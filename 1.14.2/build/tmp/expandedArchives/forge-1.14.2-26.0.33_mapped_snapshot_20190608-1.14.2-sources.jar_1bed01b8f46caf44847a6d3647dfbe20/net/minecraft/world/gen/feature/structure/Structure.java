...
public abstract class Structure<C extends IFeatureConfig> extends Feature<C> {
            ...
            for(int l = -k; l <= k; ++l) {
               ...
               for(int i1 = -k; i1 <= k; ++i1) {
                  ...
                  if (flag || flag1) {
                     ...
                     StructureStart structurestart = worldIn.func_217348_a(chunkpos.x, chunkpos.z, ChunkStatus.STRUCTURE_STARTS).getStructureStart(this.getStructureName());
   ...
   private List<StructureStart> getStarts(IWorld worldIn, int x, int z) {
      ...
      IChunk ichunk = worldIn.func_217348_a(x, z, ChunkStatus.STRUCTURE_REFERENCES);
      LongIterator longiterator = ichunk.getStructureReferences(this.getStructureName()).iterator();

      while(longiterator.hasNext()) {
         long i = longiterator.nextLong();
         IStructureReader istructurereader = worldIn.func_217348_a(ChunkPos.getX(i), ChunkPos.getZ(i), ChunkStatus.STRUCTURE_STARTS);
