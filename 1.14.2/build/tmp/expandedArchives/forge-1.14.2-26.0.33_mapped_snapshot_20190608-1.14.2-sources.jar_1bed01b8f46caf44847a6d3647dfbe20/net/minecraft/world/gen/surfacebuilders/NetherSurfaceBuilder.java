...
public class NetherSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
   private static final BlockState field_205554_c = Blocks.CAVE_AIR.getDefaultState();
   private static final BlockState field_205555_d = Blocks.NETHERRACK.getDefaultState();
   private static final BlockState field_205556_e = Blocks.GRAVEL.getDefaultState();
   private static final BlockState field_205557_f = Blocks.SOUL_SAND.getDefaultState();
      ...
      for(int j1 = 127; j1 >= 0; --j1) {
         ...
         if (blockstate2.getBlock() != null && !blockstate2.isAir()) {
            if (blockstate2.getBlock() == defaultBlock.getBlock()) {
               if (i1 == -1) {
                  if (l <= 0) {
                     blockstate = field_205554_c;
                     blockstate1 = field_205555_d;
                  } else if (j1 >= i - 4 && j1 <= i + 1) {
                     blockstate = field_205555_d;
                     blockstate1 = field_205555_d;
                     if (flag1) {
                        blockstate = field_205556_e;
                        blockstate1 = field_205555_d;
                     }

                     if (flag) {
                        blockstate = field_205557_f;
                        blockstate1 = field_205557_f;
                     }
                  }
