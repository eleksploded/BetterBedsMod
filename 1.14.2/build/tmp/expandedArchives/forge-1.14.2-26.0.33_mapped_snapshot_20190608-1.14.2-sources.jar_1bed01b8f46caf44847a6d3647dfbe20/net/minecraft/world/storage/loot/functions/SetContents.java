...
public class SetContents extends LootFunction {
      ...
      if (p_215859_1_.isEmpty()) {
         ...
         this.field_215924_a.forEach((p_215921_2_) -> {
            p_215921_2_.expand(p_215859_2_, (p_215922_2_) -> {
               p_215922_2_.func_216188_a(LootTable.func_216124_a(nonnulllist::add), p_215859_2_);
            });
         });
   ...
   public void func_215856_a(ValidationResults p_215856_1_, Function<ResourceLocation, LootTable> p_215856_2_, Set<ResourceLocation> p_215856_3_, LootParameterSet p_215856_4_) {
      ...
      for(int i = 0; i < this.field_215924_a.size(); ++i) {
         this.field_215924_a.get(i).func_216142_a(p_215856_1_.func_216108_b(".entry[" + i + "]"), p_215856_2_, p_215856_3_, p_215856_4_);
      }
   ...
   public static class Builder extends LootFunction.Builder<SetContents.Builder> {
      ...
      protected SetContents.Builder func_212826_d_() {
         return this;
      }
      ...
      public ILootFunction build() {
         return new SetContents(this.func_216053_g(), this.field_216076_a);
      }
   }
