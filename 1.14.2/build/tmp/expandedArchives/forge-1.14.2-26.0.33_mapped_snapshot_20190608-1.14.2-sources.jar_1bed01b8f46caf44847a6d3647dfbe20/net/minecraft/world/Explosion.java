...
public class Explosion {
   ...
   private final Explosion.Mode field_222260_b;
         ...
         for(float f = 0.0F; f <= 1.0F; f = (float)((double)f + d0)) {
            for(float f1 = 0.0F; f1 <= 1.0F; f1 = (float)((double)f1 + d1)) {
               for(float f2 = 0.0F; f2 <= 1.0F; f2 = (float)((double)f2 + d2)) {
                  double d5 = MathHelper.func_219803_d((double)f, axisalignedbb.minX, axisalignedbb.maxX);
                  double d6 = MathHelper.func_219803_d((double)f1, axisalignedbb.minY, axisalignedbb.maxY);
                  double d7 = MathHelper.func_219803_d((double)f2, axisalignedbb.minZ, axisalignedbb.maxZ);
                  Vec3d vec3d = new Vec3d(d5 + d3, d6, d7 + d4);
                  if (p_222259_1_.world.func_217299_a(new RayTraceContext(vec3d, p_222259_0_, RayTraceContext.BlockMode.OUTLINE, RayTraceContext.FluidMode.NONE, p_222259_1_)).getType() == RayTraceResult.Type.MISS) {
                     ++i;
                  }
            ...
            if (d12 <= 1.0D) {
               ...
               if (d13 != 0.0D) {
                  ...
                  if (entity instanceof PlayerEntity) {
                     ...
                     if (!playerentity.isSpectator() && (!playerentity.isCreative() || !playerentity.playerAbilities.isFlying)) {
   ...
   public void doExplosionB(boolean spawnParticles) {
      ...
      boolean flag = this.field_222260_b != Explosion.Mode.NONE;
         ...
         for(BlockPos blockpos : this.affectedBlockPositions) {
            ...
            if (!blockstate.isAir(this.world, blockpos)) {
               if (this.world instanceof ServerWorld && blockstate.canDropFromExplosion(this.world, blockpos, this)) {
                  ...
                  LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withRandom(this.world.rand).withParameter(LootParameters.field_216286_f, blockpos).withParameter(LootParameters.field_216289_i, ItemStack.EMPTY).withNullableParameter(LootParameters.field_216288_h, tileentity);
                  if (this.field_222260_b == Explosion.Mode.DESTROY) {
                     lootcontext$builder.withParameter(LootParameters.field_216290_j, this.size);
                  }
