...
public class IglooPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public Piece(TemplateManager p_i50566_1_, CompoundNBT p_i50566_2_) {
         super(IStructurePieceType.field_214764_K, p_i50566_2_);
      ...
      private void func_207614_a(TemplateManager p_207614_1_) {
         ...
         PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.field_207616_e).setMirror(Mirror.NONE).setCenterOffset(IglooPieces.field_207621_d.get(this.field_207615_d)).func_215222_a(BlockIgnoreStructureProcessor.field_215204_a);
