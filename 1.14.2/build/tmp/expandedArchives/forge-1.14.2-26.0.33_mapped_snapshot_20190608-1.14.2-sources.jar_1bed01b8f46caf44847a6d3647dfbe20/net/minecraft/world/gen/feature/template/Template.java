...
public class Template {
   ...
   public List<Template.BlockInfo> func_215386_a(BlockPos p_215386_1_, PlacementSettings p_215386_2_, Block p_215386_3_, boolean p_215386_4_) {
      ...
      for(Template.BlockInfo template$blockinfo : p_215386_2_.func_204764_a(this.blocks, p_215386_1_)) {
         ...
         if (mutableboundingbox == null || mutableboundingbox.isVecInside(blockpos)) {
            BlockState blockstate = template$blockinfo.blockState;
            if (blockstate.getBlock() == p_215386_3_) {
               list.add(new Template.BlockInfo(blockpos, blockstate.rotate(p_215386_2_.getRotation()), template$blockinfo.tileentityData));
            }
         }
      }
         ...
         if ((!list.isEmpty() || !placementIn.getIgnoreEntities() && !this.entities.isEmpty()) && this.size.getX() >= 1 && this.size.getY() >= 1 && this.size.getZ() >= 1) {
            ...
            for(Template.BlockInfo template$blockinfo : func_215387_a(worldIn, pos, placementIn, list)) {
               ...
               if (mutableboundingbox == null || mutableboundingbox.isVecInside(blockpos)) {
                  ...
                  BlockState blockstate = template$blockinfo.blockState.mirror(placementIn.getMirror()).rotate(placementIn.getRotation());
                  ...
                  if (worldIn.setBlockState(blockpos, blockstate, flags)) {
                     ...
                     if (template$blockinfo.tileentityData != null) {
                        ...
                        if (tileentity1 != null) {
                           template$blockinfo.tileentityData.putInt("x", blockpos.getX());
                           template$blockinfo.tileentityData.putInt("y", blockpos.getY());
                           template$blockinfo.tileentityData.putInt("z", blockpos.getZ());
                           tileentity1.read(template$blockinfo.tileentityData);
   ...
   public static List<Template.BlockInfo> func_215387_a(IWorld p_215387_0_, BlockPos p_215387_1_, PlacementSettings p_215387_2_, List<Template.BlockInfo> p_215387_3_) {
      ...
      for(Template.BlockInfo template$blockinfo : p_215387_3_) {
         ...
         Template.BlockInfo template$blockinfo1 = new Template.BlockInfo(blockpos, template$blockinfo.blockState, template$blockinfo.tileentityData);

         for(Iterator<StructureProcessor> iterator = p_215387_2_.func_215221_j().iterator(); template$blockinfo1 != null && iterator.hasNext(); template$blockinfo1 = iterator.next().process(p_215387_0_, p_215387_1_, template$blockinfo, template$blockinfo1, p_215387_2_)) {
            ;
         }
      ...
      for(Template.EntityInfo template$entityinfo : this.entities) {
         ...
         if (p_207668_6_ == null || p_207668_6_.isVecInside(blockpos)) {
            ...
            func_215382_a(p_207668_1_, compoundnbt).ifPresent((p_215383_4_) -> {
               ...
               p_207668_1_.func_217376_c(p_215383_4_);
            });
         }
      }
   ...
   private static Optional<Entity> func_215382_a(IWorld p_215382_0_, CompoundNBT p_215382_1_) {
      try {
         return EntityType.func_220330_a(p_215382_1_, p_215382_0_.getWorld());
   ...
   public CompoundNBT writeToNBT(CompoundNBT nbt) {
      if (this.blocks.isEmpty()) {
         ...
         for(int j = 0; j < list1.size(); ++j) {
            ...
            if (template$blockinfo.tileentityData != null) {
               compoundnbt.put("nbt", template$blockinfo.tileentityData);
            }
            ...
            for(int l = 1; l < this.blocks.size(); ++l) {
               ...
               template$basicpalette1.addMapping((this.blocks.get(l).get(j)).blockState, k);
            }
         }
      ...
      for(Template.EntityInfo template$entityinfo : this.entities) {
         ...
         if (template$entityinfo.entityData != null) {
            compoundnbt1.put("nbt", template$entityinfo.entityData);
         }
   ...
   static class BasicPalette implements Iterable<BlockState> {
      public static final BlockState field_189957_a = Blocks.AIR.getDefaultState();
   ...
   public static class BlockInfo {
      ...
      public String toString() {
         return String.format("<StructureBlockInfo | %s | %s | %s>", this.pos, this.blockState, this.tileentityData);
      }
   }
   ...
   public static class EntityInfo {
      ...
      public EntityInfo(Vec3d vecIn, BlockPos posIn, CompoundNBT compoundIn) {
         this.pos = vecIn;
         this.blockPos = posIn;
