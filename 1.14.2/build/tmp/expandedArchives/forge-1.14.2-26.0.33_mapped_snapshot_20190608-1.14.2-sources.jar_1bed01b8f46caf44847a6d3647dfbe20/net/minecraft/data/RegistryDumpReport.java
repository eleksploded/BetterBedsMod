...
public class RegistryDumpReport implements IDataProvider {
   ...
   public void act(DirectoryCache cache) throws IOException {
      ...
      Registry.field_212617_f.keySet().forEach((p_218431_1_) -> {
         jsonobject.add(p_218431_1_.toString(), func_218432_a(Registry.field_212617_f.getOrDefault(p_218431_1_)));
      });
      Path path = this.field_218434_c.getOutputFolder().resolve("reports/registries.json");
      IDataProvider.func_218426_a(field_218433_b, cache, jsonobject, path);
   }
   ...
   private static <T> JsonElement func_218432_a(MutableRegistry<T> p_218432_0_) {
      ...
      int j = Registry.field_212617_f.getId(p_218432_0_);
