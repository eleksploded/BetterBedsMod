...
public class ItemTagsProvider extends TagsProvider<Item> {
   ...
   public ItemTagsProvider(DataGenerator generatorIn) {
      super(generatorIn, Registry.field_212630_s);
   }
   ...
   protected void registerTags() {
      ...
      this.copy(BlockTags.field_219756_j, ItemTags.field_219777_j);
      ...
      this.copy(BlockTags.field_219757_z, ItemTags.field_219778_z);
      ...
      this.copy(BlockTags.field_219746_E, ItemTags.field_219770_E);
      this.copy(BlockTags.field_219747_F, ItemTags.field_219771_F);
      this.copy(BlockTags.field_219748_G, ItemTags.field_219772_G);
      ...
      this.copy(BlockTags.field_219751_T, ItemTags.field_219773_J);
      this.getBuilder(ItemTags.field_219774_K).add(Items.MUSIC_DISC_13, Items.MUSIC_DISC_CAT, Items.MUSIC_DISC_BLOCKS, Items.MUSIC_DISC_CHIRP, Items.MUSIC_DISC_FAR, Items.MUSIC_DISC_MALL, Items.MUSIC_DISC_MELLOHI, Items.MUSIC_DISC_STAL, Items.MUSIC_DISC_STRAD, Items.MUSIC_DISC_WARD, Items.MUSIC_DISC_11, Items.MUSIC_DISC_WAIT);
      this.getBuilder(ItemTags.field_219775_L).add(Items.COAL, Items.CHARCOAL);
      this.getBuilder(ItemTags.field_219776_M).add(Items.ARROW, Items.TIPPED_ARROW, Items.SPECTRAL_ARROW);
   }
   ...
   private Tag.ITagEntry<Item> copyEntry(Tag.ITagEntry<Block> entry) {
      if (entry instanceof Tag.TagEntry) {
         ...
         for(Block block : ((Tag.ListEntry<Block>)entry).getTaggedItems()) {
            ...
            if (item == Items.AIR) {
               LOGGER.warn("Itemless block copied to item tag: {}", (Object)Registry.field_212618_g.getKey(block));
            } else {
               list.add(item);
            }
         }
