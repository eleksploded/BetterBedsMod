...
public class AdventureAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement advancement12 = Advancement.Builder.builder().withParent(advancement).withDisplay(Items.field_222114_py, new TranslationTextComponent("advancements.adventure.ol_betsy.title"), new TranslationTextComponent("advancements.adventure.ol_betsy.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).withCriterion("shot_crossbow", ShotCrossbowTrigger.Instance.func_215122_a(Items.field_222114_py)).register(p_accept_1_, "adventure/ol_betsy");
      Advancement advancement13 = Advancement.Builder.builder().withParent(advancement12).withDisplay(Items.field_222114_py, new TranslationTextComponent("advancements.adventure.whos_the_pillager_now.title"), new TranslationTextComponent("advancements.adventure.whos_the_pillager_now.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).withCriterion("kill_pillager", KilledByCrossbowTrigger.Instance.func_215116_a(EntityPredicate.Builder.create().type(EntityType.field_220350_aJ))).register(p_accept_1_, "adventure/whos_the_pillager_now");
      Advancement advancement14 = Advancement.Builder.builder().withParent(advancement12).withDisplay(Items.field_222114_py, new TranslationTextComponent("advancements.adventure.two_birds_one_arrow.title"), new TranslationTextComponent("advancements.adventure.two_birds_one_arrow.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, false).withRewards(AdvancementRewards.Builder.experience(65)).withCriterion("two_birds", KilledByCrossbowTrigger.Instance.func_215116_a(EntityPredicate.Builder.create().type(EntityType.PHANTOM), EntityPredicate.Builder.create().type(EntityType.PHANTOM))).register(p_accept_1_, "adventure/two_birds_one_arrow");
      Advancement advancement15 = Advancement.Builder.builder().withParent(advancement12).withDisplay(Items.field_222114_py, new TranslationTextComponent("advancements.adventure.arbalistic.title"), new TranslationTextComponent("advancements.adventure.arbalistic.description"), (ResourceLocation)null, FrameType.CHALLENGE, true, true, true).withRewards(AdvancementRewards.Builder.experience(85)).withCriterion("arbalistic", KilledByCrossbowTrigger.Instance.func_215117_a(MinMaxBounds.IntBound.exactly(5))).register(p_accept_1_, "adventure/arbalistic");
      Advancement advancement16 = Advancement.Builder.builder().withParent(advancement).func_215092_a(Raid.ILLAGER_BANNER, new TranslationTextComponent("advancements.adventure.voluntary_exile.title"), new TranslationTextComponent("advancements.adventure.voluntary_exile.description"), (ResourceLocation)null, FrameType.TASK, true, true, true).withCriterion("voluntary_exile", KilledTrigger.Instance.playerKilledEntity(EntityPredicate.Builder.create().func_217989_a(EntityTypeTags.field_219765_b).func_217985_a(EntityEquipmentPredicate.field_217959_b))).register(p_accept_1_, "adventure/voluntary_exile");
   ...
   private Advancement.Builder makeMobAdvancement(Advancement.Builder builder) {
      for(EntityType<?> entitytype : field_218459_b) {
         builder.withCriterion(Registry.field_212629_r.getKey(entitytype).toString(), KilledTrigger.Instance.playerKilledEntity(EntityPredicate.Builder.create().type(entitytype)));
      }
   ...
   private Advancement.Builder makeBiomeAdvancement(Advancement.Builder builder) {
      for(Biome biome : EXPLORATION_BIOMES) {
         builder.withCriterion(Registry.field_212624_m.getKey(biome).toString(), PositionTrigger.Instance.forLocation(LocationPredicate.forBiome(biome)));
      }
