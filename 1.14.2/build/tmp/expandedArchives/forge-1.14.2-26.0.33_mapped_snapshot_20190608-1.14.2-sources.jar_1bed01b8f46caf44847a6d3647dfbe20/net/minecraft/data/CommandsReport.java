...
public class CommandsReport implements IDataProvider {
   ...
   public void act(DirectoryCache cache) throws IOException {
      ...
      MinecraftServer minecraftserver = new DedicatedServer(file1, serverpropertiesprovider, DataFixesManager.getDataFixer(), yggdrasilauthenticationservice, minecraftsessionservice, gameprofilerepository, playerprofilecache, LoggingChunkStatusListener::new, serverpropertiesprovider.func_219034_a().field_219021_o);
      ...
      IDataProvider.func_218426_a(field_218430_b, cache, ArgumentTypes.serialize(commanddispatcher, commanddispatcher.getRoot()), path);
   }
