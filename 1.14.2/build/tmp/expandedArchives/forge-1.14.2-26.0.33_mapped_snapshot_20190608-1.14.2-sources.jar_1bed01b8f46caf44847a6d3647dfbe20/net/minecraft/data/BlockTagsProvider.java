...
public class BlockTagsProvider extends TagsProvider<Block> {
   public BlockTagsProvider(DataGenerator generatorIn) {
      super(generatorIn, Registry.field_212618_g);
   }
   ...
   protected void registerTags() {
      ...
      this.getBuilder(BlockTags.field_219756_j).add(Blocks.OAK_FENCE, Blocks.ACACIA_FENCE, Blocks.DARK_OAK_FENCE, Blocks.SPRUCE_FENCE, Blocks.BIRCH_FENCE, Blocks.JUNGLE_FENCE);
      ...
      this.getBuilder(BlockTags.STAIRS).add(Blocks.OAK_STAIRS, Blocks.COBBLESTONE_STAIRS, Blocks.SPRUCE_STAIRS, Blocks.SANDSTONE_STAIRS, Blocks.ACACIA_STAIRS, Blocks.JUNGLE_STAIRS, Blocks.BIRCH_STAIRS, Blocks.DARK_OAK_STAIRS, Blocks.NETHER_BRICK_STAIRS, Blocks.STONE_BRICK_STAIRS, Blocks.BRICK_STAIRS, Blocks.PURPUR_STAIRS, Blocks.QUARTZ_STAIRS, Blocks.RED_SANDSTONE_STAIRS, Blocks.PRISMARINE_BRICK_STAIRS, Blocks.PRISMARINE_STAIRS, Blocks.DARK_PRISMARINE_STAIRS, Blocks.field_222407_kV, Blocks.field_222408_kW, Blocks.field_222409_kX, Blocks.field_222410_kY, Blocks.field_222411_kZ, Blocks.field_222437_la, Blocks.field_222438_lb, Blocks.field_222439_lc, Blocks.field_222440_ld, Blocks.field_222441_le, Blocks.field_222442_lf, Blocks.field_222443_lg, Blocks.field_222444_lh, Blocks.field_222445_li);
      this.getBuilder(BlockTags.SLABS).add(Blocks.STONE_SLAB, Blocks.field_222401_hJ, Blocks.STONE_BRICK_SLAB, Blocks.SANDSTONE_SLAB, Blocks.ACACIA_SLAB, Blocks.BIRCH_SLAB, Blocks.DARK_OAK_SLAB, Blocks.JUNGLE_SLAB, Blocks.OAK_SLAB, Blocks.SPRUCE_SLAB, Blocks.PURPUR_SLAB, Blocks.QUARTZ_SLAB, Blocks.RED_SANDSTONE_SLAB, Blocks.BRICK_SLAB, Blocks.COBBLESTONE_SLAB, Blocks.NETHER_BRICK_SLAB, Blocks.PETRIFIED_OAK_SLAB, Blocks.PRISMARINE_SLAB, Blocks.PRISMARINE_BRICK_SLAB, Blocks.DARK_PRISMARINE_SLAB, Blocks.field_222446_lj, Blocks.field_222447_lk, Blocks.field_222448_ll, Blocks.field_222449_lm, Blocks.field_222450_ln, Blocks.field_222451_lo, Blocks.field_222452_lp, Blocks.field_222453_lq, Blocks.field_222454_lr, Blocks.field_222455_ls, Blocks.field_222456_lt, Blocks.field_222457_lu, Blocks.field_222458_lv, Blocks.field_222402_hL, Blocks.field_222403_hT);
      this.getBuilder(BlockTags.field_219757_z).add(Blocks.COBBLESTONE_WALL, Blocks.MOSSY_COBBLESTONE_WALL, Blocks.field_222459_lw, Blocks.field_222460_lx, Blocks.field_222461_ly, Blocks.field_222462_lz, Blocks.field_222412_lA, Blocks.field_222413_lB, Blocks.field_222414_lC, Blocks.field_222415_lD, Blocks.field_222416_lE, Blocks.field_222417_lF, Blocks.field_222418_lG, Blocks.field_222419_lH);
      ...
      this.getBuilder(BlockTags.field_219750_S).add(Blocks.DIRT).add(Blocks.GRASS_BLOCK).add(Blocks.PODZOL).add(Blocks.COARSE_DIRT).add(Blocks.MYCELIUM);
      this.getBuilder(BlockTags.field_219749_R).add(Blocks.field_222405_kQ).add(Blocks.field_222404_kP).add(Blocks.GRAVEL).add(BlockTags.SAND).add(BlockTags.field_219750_S);
      this.getBuilder(BlockTags.field_219751_T).add(Blocks.field_222384_bX, Blocks.field_222385_bY, Blocks.field_222386_bZ, Blocks.field_222389_ca, Blocks.field_222390_cb, Blocks.field_222391_cc);
      this.getBuilder(BlockTags.field_219752_U).add(Blocks.field_222392_ch, Blocks.field_222393_ci, Blocks.field_222394_cj, Blocks.field_222395_ck, Blocks.field_222396_cl, Blocks.field_222397_cm);
      this.getBuilder(BlockTags.field_219753_V).add(BlockTags.field_219751_T).add(BlockTags.field_219752_U);
      this.getBuilder(BlockTags.field_219747_F).add(Blocks.RED_BED, Blocks.BLACK_BED, Blocks.BLUE_BED, Blocks.BROWN_BED, Blocks.CYAN_BED, Blocks.GRAY_BED, Blocks.GREEN_BED, Blocks.LIGHT_BLUE_BED, Blocks.LIGHT_GRAY_BED, Blocks.LIME_BED, Blocks.MAGENTA_BED, Blocks.ORANGE_BED, Blocks.PINK_BED, Blocks.PURPLE_BED, Blocks.WHITE_BED, Blocks.YELLOW_BED);
      this.getBuilder(BlockTags.field_219748_G).add(BlockTags.field_219756_j).add(Blocks.NETHER_BRICK_FENCE);
      this.getBuilder(BlockTags.field_219754_W).add(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.field_222435_lY, Blocks.MOVING_PISTON, Blocks.OBSIDIAN, Blocks.END_STONE, Blocks.IRON_BARS);
      this.getBuilder(BlockTags.field_219755_X).add(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.field_222435_lY, Blocks.MOVING_PISTON);
   }
