...
public class ShapedRecipeBuilder {
   ...
   public void build(Consumer<IFinishedRecipe> consumerIn) {
      this.build(consumerIn, Registry.field_212630_s.getKey(this.result));
   }
   ...
   public void build(Consumer<IFinishedRecipe> consumerIn, String save) {
      ResourceLocation resourcelocation = Registry.field_212630_s.getKey(this.result);
   ...
   class Result implements IFinishedRecipe {
      ...
      public void func_218610_a(JsonObject p_218610_1_) {
         ...
         jsonobject1.addProperty("item", Registry.field_212630_s.getKey(this.result).toString());
         if (this.count > 1) {
