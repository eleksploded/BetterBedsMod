   ...
   static void func_218401_c() {
      ...
      DefaultDispenseItemBehavior defaultdispenseitembehavior = new DefaultDispenseItemBehavior() {
         ...
         public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            entitytype.func_220331_a(source.getWorld(), stack, (PlayerEntity)null, source.getBlockPos().offset(direction), SpawnReason.DISPENSER, direction != Direction.UP, false);
            stack.shrink(1);
            return stack;
         }
      };
      ...
      DispenserBlock.registerDispenseBehavior(Items.FIREWORK_ROCKET, new DefaultDispenseItemBehavior() {
         ...
         public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            source.getWorld().func_217376_c(new FireworkRocketEntity(source.getWorld(), d0, d1, d2, stack));
            stack.shrink(1);
            return stack;
         }
      ...
      DispenserBlock.registerDispenseBehavior(Items.FIRE_CHARGE, new DefaultDispenseItemBehavior() {
         ...
         public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            world.func_217376_c(Util.make(new SmallFireballEntity(world, d0, d1, d2, d3, d4, d5), (p_218404_1_) -> {
      ...
      DispenserBlock.registerDispenseBehavior(Items.FLINT_AND_STEEL, new OptionalDispenseBehavior() {
         ...
         protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            if (this.field_218407_b && stack.attemptDamageItem(1, world.rand, (ServerPlayerEntity)null)) {
               stack.setCount(0);
            }
      ...
      IDispenseItemBehavior idispenseitembehavior1 = new OptionalDispenseBehavior() {
          ...
          */
         protected ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            this.field_218407_b = !ArmorItem.dispenseArmor(source, stack).isEmpty();
            return stack;
         }
      };
