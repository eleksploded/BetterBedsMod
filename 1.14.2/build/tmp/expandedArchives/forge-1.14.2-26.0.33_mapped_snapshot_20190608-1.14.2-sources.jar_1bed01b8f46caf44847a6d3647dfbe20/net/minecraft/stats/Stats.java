...
public class Stats {
   public static final StatType<Block> BLOCK_MINED = registerType("mined", Registry.field_212618_g);
   public static final StatType<Item> ITEM_CRAFTED = registerType("crafted", Registry.field_212630_s);
   public static final StatType<Item> ITEM_USED = registerType("used", Registry.field_212630_s);
   public static final StatType<Item> ITEM_BROKEN = registerType("broken", Registry.field_212630_s);
   public static final StatType<Item> ITEM_PICKED_UP = registerType("picked_up", Registry.field_212630_s);
   public static final StatType<Item> ITEM_DROPPED = registerType("dropped", Registry.field_212630_s);
   public static final StatType<EntityType<?>> ENTITY_KILLED = registerType("killed", Registry.field_212629_r);
   public static final StatType<EntityType<?>> ENTITY_KILLED_BY = registerType("killed_by", Registry.field_212629_r);
   public static final StatType<ResourceLocation> CUSTOM = registerType("custom", Registry.field_212623_l);
   ...
   public static final ResourceLocation BEACON_INTERACTION = registerCustom("interact_with_beacon", IStatFormatter.DEFAULT);
   ...
   public static final ResourceLocation field_219732_ap = registerCustom("open_barrel", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219733_aq = registerCustom("interact_with_blast_furnace", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219734_ar = registerCustom("interact_with_smoker", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219735_as = registerCustom("interact_with_lectern", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219736_at = registerCustom("interact_with_campfire", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219737_au = registerCustom("interact_with_cartography_table", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219738_av = registerCustom("interact_with_loom", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219739_aw = registerCustom("interact_with_stonecutter", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219740_ax = registerCustom("bell_ring", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219741_ay = registerCustom("raid_trigger", IStatFormatter.DEFAULT);
   public static final ResourceLocation field_219742_az = registerCustom("raid_win", IStatFormatter.DEFAULT);

   private static ResourceLocation registerCustom(String id, IStatFormatter formatter) {
      ResourceLocation resourcelocation = new ResourceLocation(id);
      Registry.register(Registry.field_212623_l, id, resourcelocation);
      CUSTOM.get(resourcelocation, formatter);
      return resourcelocation;
   }

   private static <T> StatType<T> registerType(String id, Registry<T> registry) {
      return Registry.register(Registry.field_212634_w, id, new StatType<>(registry));
   }
}