...
public class DemoPlayerInteractionManager extends PlayerInteractionManager {
   ...
   public void tick() {
      super.tick();
      ++this.gameModeTicks;
      long i = this.field_73092_a.getGameTime();
      long j = i / 24000L + 1L;
      if (!this.displayedIntro && this.gameModeTicks > 20) {
         this.displayedIntro = true;
         this.field_73090_b.connection.sendPacket(new SChangeGameStatePacket(5, 0.0F));
      }
      ...
      if (i % 24000L == 500L) {
         if (j <= 6L) {
            if (j == 6L) {
               this.field_73090_b.connection.sendPacket(new SChangeGameStatePacket(5, 104.0F));
            } else {
               this.field_73090_b.sendMessage(new TranslationTextComponent("demo.day." + j));
            }
         }
      } else if (j == 1L) {
         if (i == 100L) {
            this.field_73090_b.connection.sendPacket(new SChangeGameStatePacket(5, 101.0F));
         } else if (i == 175L) {
            this.field_73090_b.connection.sendPacket(new SChangeGameStatePacket(5, 102.0F));
         } else if (i == 250L) {
            this.field_73090_b.connection.sendPacket(new SChangeGameStatePacket(5, 103.0F));
         }
      } else if (j == 5L && i % 24000L == 22000L) {
         this.field_73090_b.sendMessage(new TranslationTextComponent("demo.day.warning"));
      }
   ...
   private void sendDemoReminder() {
      if (this.demoEndedReminder > 100) {
         this.field_73090_b.sendMessage(new TranslationTextComponent("demo.reminder"));
