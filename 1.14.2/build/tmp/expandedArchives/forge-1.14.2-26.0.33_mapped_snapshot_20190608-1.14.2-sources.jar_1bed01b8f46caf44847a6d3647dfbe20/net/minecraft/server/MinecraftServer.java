...
public abstract class MinecraftServer extends RecursiveEventLoop<TickDelayedTask> implements ISnooperInfo, ICommandSource, AutoCloseable, Runnable {
   ...
   public static final WorldSettings field_213219_c = (new WorldSettings((long)"North Carolina".hashCode(), GameType.SURVIVAL, true, false, WorldType.DEFAULT)).enableBonusChest();
   ...
   private final DebugProfiler field_71304_b = new DebugProfiler(this::getTickCounter);
   ...
   public MinecraftServer(File p_i50590_1_, Proxy p_i50590_2_, DataFixer p_i50590_3_, Commands p_i50590_4_, YggdrasilAuthenticationService p_i50590_5_, MinecraftSessionService p_i50590_6_, GameProfileRepository p_i50590_7_, PlayerProfileCache p_i50590_8_, IChunkStatusListenerFactory p_i50590_9_, String p_i50590_10_) {
      ...
      this.resourceManager.func_219534_a(this.networkTagManager);
      this.resourceManager.func_219534_a(this.recipeManager);
      this.resourceManager.func_219534_a(this.lootTableManager);
      this.resourceManager.func_219534_a(this.functionManager);
      this.resourceManager.func_219534_a(this.advancementManager);
   ...
   protected void convertMapIfNeeded(String worldNameIn) {
      ...
      if (this.forceWorldUpgrade) {
         ...
         if (worldinfo != null) {
            WorldOptimizer worldoptimizer = new WorldOptimizer(this.getFolderName(), this.getActiveAnvilConverter(), worldinfo, this.field_213216_as);
   ...
   protected void func_213194_a(SaveHandler p_213194_1_, WorldInfo p_213194_2_, WorldSettings p_213194_3_, IChunkStatusListener p_213194_4_) {
      if (this.isDemo()) {
         p_213194_2_.populateFromWorldSettings(field_213219_c);
      }

      ServerWorld serverworld = new ServerWorld(this, this.field_213217_au, p_213194_1_, p_213194_2_, DimensionType.OVERWORLD, this.field_71304_b, p_213194_4_);
      this.worlds.put(DimensionType.OVERWORLD, serverworld);
      this.func_213204_a(serverworld.func_217481_x());
      ...
      for(DimensionType dimensiontype : DimensionType.getAll()) {
         if (dimensiontype != DimensionType.OVERWORLD) {
            this.worlds.put(dimensiontype, new ServerMultiWorld(serverworld1, this, this.field_213217_au, p_213194_1_, dimensiontype, this.field_71304_b, p_213194_4_));
         }
   ...
   private void func_213188_a(WorldInfo p_213188_1_) {
      ...
      p_213188_1_.getGameRulesInstance().setOrCreateGameRule("doDaylightCycle", "false", this);
   }
   ...
   protected void func_213186_a(IChunkStatusListener p_213186_1_) {
      ...
      for(DimensionType dimensiontype : DimensionType.getAll()) {
         ForcedChunksSaveData forcedchunkssavedata = this.getWorld(dimensiontype).func_217481_x().func_215753_b(ForcedChunksSaveData::new, "chunks");
   ...
   public boolean func_213211_a(boolean p_213211_1_, boolean p_213211_2_, boolean p_213211_3_) {
      ...
      for(ServerWorld serverworld : this.getWorlds()) {
         ...
         try {
            serverworld.func_217445_a((IProgressUpdate)null, p_213211_2_, serverworld.disableLevelSaving && !p_213211_3_);
      ...
      serverworld1.func_217485_w().saveWorldInfoWithPlayer(worldinfo, this.getPlayerList().getHostPlayerData());
      return flag;
   }
      ...
      try {
         if (this.init()) {
            ...
            while(this.serverRunning) {
               ...
               this.field_71304_b.endStartSection("nextTickWait");
               this.field_213214_ac = true;
               this.field_213213_ab = Math.max(Util.milliTime() + 50L, this.serverTime);
               this.func_213202_o();
   ...
   private boolean isAheadOfTime() {
      return this.func_213182_bg() || Util.milliTime() < (this.field_213214_ac ? this.field_213213_ab : this.serverTime);
   }
   ...
   protected void tick(BooleanSupplier hasTimeLeft) {
      ...
      this.field_213215_ap.addFrame(i1 - i);
      this.field_71304_b.endSection();
   ...
   protected void updateTimeLightAndEntities(BooleanSupplier hasTimeLeft) {
      this.field_71304_b.startSection("commandFunctions");
      ...
      for(ServerWorld serverworld : this.getWorlds()) {
         ...
         if (serverworld.dimension.getType() == DimensionType.OVERWORLD || this.getAllowNether()) {
            this.field_71304_b.startSection(() -> {
               return serverworld.getWorldInfo().getWorldName() + " " + Registry.field_212622_k.getKey(serverworld.dimension.getType());
            });
      ...
      this.field_71304_b.endStartSection("dim_unloading");
      ...
      this.field_71304_b.endStartSection("server gui refresh");
   ...
   public void setDifficultyForAllWorlds(Difficulty difficulty, boolean p_147139_2_) {
      ...
      this.getPlayerList().getPlayers().forEach(this::func_213189_a);
   }
   ...
   public void fillSnooper(Snooper snooper) {
      ...
      if (this.playerList != null) {
         ...
         snooper.addClientStat("players_seen", this.getWorld(DimensionType.OVERWORLD).func_217485_w().func_215771_d().length);
      }
   ...
   private void loadDataPacks(WorldInfo worldInfoIn) {
      ...
      CompletableFuture<Unit> completablefuture = this.resourceManager.func_219536_a(this.field_213217_au, this, list1, CompletableFuture.completedFuture(Unit.INSTANCE));
