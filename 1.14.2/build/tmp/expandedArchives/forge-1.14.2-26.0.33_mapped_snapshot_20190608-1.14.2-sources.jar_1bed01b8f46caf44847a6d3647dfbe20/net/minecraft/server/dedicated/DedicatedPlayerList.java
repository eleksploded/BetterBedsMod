...
public class DedicatedPlayerList extends PlayerList {
   ...
   public DedicatedPlayerList(DedicatedServer server) {
      super(server, server.func_213221_d_().field_219000_M);
      ServerProperties serverproperties = server.func_213221_d_();
      this.func_217884_a(serverproperties.field_218999_L, serverproperties.field_218999_L - 2);
      super.setWhiteListEnabled(serverproperties.field_219006_S.get());
