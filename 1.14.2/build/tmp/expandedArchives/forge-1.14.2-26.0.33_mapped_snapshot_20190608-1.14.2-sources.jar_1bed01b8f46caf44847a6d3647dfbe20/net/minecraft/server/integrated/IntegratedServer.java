...
public class IntegratedServer extends MinecraftServer {
   ...
   public IntegratedServer(Minecraft p_i50895_1_, String p_i50895_2_, String p_i50895_3_, WorldSettings p_i50895_4_, YggdrasilAuthenticationService p_i50895_5_, MinecraftSessionService p_i50895_6_, GameProfileRepository p_i50895_7_, PlayerProfileCache p_i50895_8_, IChunkStatusListenerFactory p_i50895_9_) {
      ...
      this.mc = p_i50895_1_;
      this.worldSettings = this.isDemo() ? MinecraftServer.field_213219_c : p_i50895_4_;
   }
   ...
   public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, JsonElement generatorOptions) {
      ...
      if (this.getWorld(DimensionType.OVERWORLD).getWorldInfo().getDifficulty() == null) {
         this.setDifficultyForAllWorlds(this.mc.gameSettings.field_74318_M, true);
      }
   ...
   public void tick(BooleanSupplier hasTimeLeft) {
      ...
      if (!this.isGamePaused) {
         ...
         if (i != this.getPlayerList().getViewDistance()) {
            ...
            this.getPlayerList().func_217884_a(i, i - 2);
         }
   ...
   public Difficulty getDifficulty() {
      if (this.mc.world == null) return this.mc.gameSettings.field_74318_M; // Fix NPE just in case.
   ...
   public boolean shareToLAN(GameType gameMode, boolean cheats, int port) {
      try {
         ...
         this.field_71345_q = new LanServerPingThread(this.getMOTD(), port + "");
