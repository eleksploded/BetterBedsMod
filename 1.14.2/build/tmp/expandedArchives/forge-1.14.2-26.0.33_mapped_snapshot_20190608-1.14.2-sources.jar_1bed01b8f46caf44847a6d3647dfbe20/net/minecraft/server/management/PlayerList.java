...
public abstract class PlayerList {
   ...
   private final BanList field_72401_g = new BanList(FILE_PLAYERBANS);
   private final IPBanList field_72413_h = new IPBanList(FILE_IPBANS);
   private final OpList field_72414_i = new OpList(FILE_OPS);
   private final WhiteList field_72411_j = new WhiteList(FILE_WHITELIST);
   ...
   public void initializeConnectionToPlayer(NetworkManager netManager, ServerPlayerEntity playerIn) {
      ...
      serverplaynethandler.sendPacket(new SPlayerAbilitiesPacket(playerIn.playerAbilities));
   ...
   public void func_212504_a(ServerWorld p_212504_1_) {
      this.playerDataManager = p_212504_1_.func_217485_w();
   ...
   public ITextComponent canPlayerLogin(SocketAddress p_206258_1_, GameProfile p_206258_2_) {
      if (this.field_72401_g.isBanned(p_206258_2_)) {
         ProfileBanEntry profilebanentry = this.field_72401_g.getEntry(p_206258_2_);
      ...
      } else if (this.field_72413_h.isBanned(p_206258_1_)) {
         IPBanEntry ipbanentry = this.field_72413_h.getBanEntry(p_206258_1_);
   ...
   public void addOp(GameProfile profile) {
      this.field_72414_i.addEntry(new OpEntry(profile, this.server.getOpPermissionLevel(), this.field_72414_i.bypassesPlayerLimit(profile)));
   ...
   public void removeOp(GameProfile profile) {
      this.field_72414_i.removeEntry(profile);
      ServerPlayerEntity serverplayerentity = this.getPlayerByUUID(profile.getId());
      if (serverplayerentity != null) {
         this.updatePermissionLevel(serverplayerentity);
      }
   ...
   public boolean canJoin(GameProfile profile) {
      return !this.whiteListEnforced || this.field_72414_i.hasEntry(profile) || this.field_72411_j.hasEntry(profile);
   }

   public boolean canSendCommands(GameProfile profile) {
      return this.field_72414_i.hasEntry(profile) || this.server.func_213199_b(profile) && this.server.getWorld(DimensionType.OVERWORLD).getWorldInfo().areCommandsAllowed() || this.commandsAllowedForAll;
   }
   ...
   public String[] getWhitelistedPlayerNames() {
      return this.field_72411_j.getKeys();
   }
   ...
   public String[] getOppedPlayerNames() {
      return this.field_72414_i.getKeys();
   }
   ...
   public ServerStatisticsManager getPlayerStats(PlayerEntity playerIn) {
      ...
      if (serverstatisticsmanager == null) {
         File file1 = new File(this.server.getWorld(DimensionType.OVERWORLD).func_217485_w().getWorldDirectory(), "stats");
   ...
   public PlayerAdvancements getPlayerAdvancements(ServerPlayerEntity p_192054_1_) {
      ...
      if (playeradvancements == null) {
         File file1 = new File(this.server.getWorld(DimensionType.OVERWORLD).func_217485_w().getWorldDirectory(), "advancements");
         File file2 = new File(file1, uuid + ".json");
   ...
   public void func_217884_a(int p_217884_1_, int p_217884_2_) {
      this.viewDistance = p_217884_1_;
      this.sendPacketToAllPlayers(new SUpdateViewDistancePacket(p_217884_1_));

      for(ServerWorld serverworld : this.server.getWorlds()) {
         if (serverworld != null) {
            serverworld.getChunkProvider().func_217219_c(p_217884_1_, p_217884_2_);
         }
      }
