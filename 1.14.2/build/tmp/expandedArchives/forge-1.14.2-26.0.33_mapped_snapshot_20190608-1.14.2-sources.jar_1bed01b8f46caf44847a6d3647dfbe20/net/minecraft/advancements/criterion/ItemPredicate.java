...
public class ItemPredicate {
   ...
   public boolean test(ItemStack item) {
      if (this == ANY) {
         ...
         if (this.field_192500_f != null && this.field_192500_f != potion) {
            return false;
         } else {
            return true;
         }
      ...
      if (element != null && !element.isJsonNull()) {
         ...
         if (jsonobject.has("data")) {
            ...
            if (jsonobject.has("item")) {
               ...
               item = Registry.field_212630_s.func_218349_b(resourcelocation).orElseThrow(() -> {
            ...
            if (jsonobject.has("potion")) {
               ...
               potion = Registry.field_212621_j.func_218349_b(resourcelocation2).orElseThrow(() -> {
   ...
   public JsonElement serialize() {
      if (this == ANY) {
         ...
         if (this.item != null) {
            jsonobject.addProperty("item", Registry.field_212630_s.getKey(this.item).toString());
         }
         ...
         if (this.field_192500_f != null) {
            jsonobject.addProperty("potion", Registry.field_212621_j.getKey(this.field_192500_f).toString());
         }
   ...
   public static class Builder {
      ...
      public ItemPredicate.Builder func_218002_a(CompoundNBT p_218002_1_) {
         this.nbt = new NBTPredicate(p_218002_1_);
         return this;
      }

      public ItemPredicate.Builder func_218003_a(EnchantmentPredicate p_218003_1_) {
         this.enchantments.add(p_218003_1_);
         return this;
      }

      public ItemPredicate build() {
         return new ItemPredicate(this.tag, this.item, this.count, this.durability, this.enchantments.toArray(new EnchantmentPredicate[0]), this.field_200317_f, this.nbt);
      }
   }
}