...
public class NBTPredicate {
   ...
   public boolean test(@Nullable INBT nbt) {
      if (nbt == null) {
         ...
         return this.field_193480_b == null || NBTUtil.areNBTEquals(this.field_193480_b, nbt, true);
      }
   }

   public JsonElement serialize() {
      return (JsonElement)(this != ANY && this.field_193480_b != null ? new JsonPrimitive(this.field_193480_b.toString()) : JsonNull.INSTANCE);
   }
