...
public class CriteriaTriggers {
   ...
   public static final ShotCrossbowTrigger field_215099_F = register(new ShotCrossbowTrigger());
   public static final KilledByCrossbowTrigger field_215100_G = register(new KilledByCrossbowTrigger());
   public static final PositionTrigger field_215101_H = register(new PositionTrigger(new ResourceLocation("hero_of_the_village")));
   public static final PositionTrigger field_215102_I = register(new PositionTrigger(new ResourceLocation("voluntary_exile")));
