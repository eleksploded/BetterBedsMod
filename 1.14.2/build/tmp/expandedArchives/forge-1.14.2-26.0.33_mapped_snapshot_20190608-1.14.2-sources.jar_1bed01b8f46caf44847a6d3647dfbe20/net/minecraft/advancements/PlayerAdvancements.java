...
public class PlayerAdvancements {
   ...
   private void checkForAutomaticTriggers() {
      for(Advancement advancement : this.server.getAdvancementManager().getAllAdvancements()) {
         if (advancement.getCriteria().isEmpty()) {
            ...
            advancement.getRewards().apply(this.field_192762_j);
         }
      }
   ...
   public boolean grantCriterion(Advancement p_192750_1_, String p_192750_2_) {
      ...
      if (advancementprogress.grantCriterion(p_192750_2_)) {
         ...
         if (!flag1 && advancementprogress.isDone()) {
            p_192750_1_.getRewards().apply(this.field_192762_j);
            if (p_192750_1_.getDisplay() != null && p_192750_1_.getDisplay().shouldAnnounceToChat() && this.field_192762_j.world.getGameRules().getBoolean("announceAdvancements")) {
               this.server.getPlayerList().sendMessage(new TranslationTextComponent("chat.type.advancement." + p_192750_1_.getDisplay().getFrame().getName(), this.field_192762_j.getDisplayName(), p_192750_1_.getDisplayText()));
            }
   ...
   public void setSelectedTab(@Nullable Advancement p_194220_1_) {
      ...
      if (advancement != this.lastSelectedTab) {
         this.field_192762_j.connection.sendPacket(new SSelectAdvancementsTabPacket(this.lastSelectedTab == null ? null : this.lastSelectedTab.getId()));
      }
