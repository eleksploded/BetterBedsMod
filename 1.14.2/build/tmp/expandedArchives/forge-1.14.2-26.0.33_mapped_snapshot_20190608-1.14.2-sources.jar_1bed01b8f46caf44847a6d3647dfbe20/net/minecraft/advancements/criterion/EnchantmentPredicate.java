...
public class EnchantmentPredicate {
   ...
   public JsonElement serialize() {
      if (this == ANY) {
         ...
         if (this.enchantment != null) {
            jsonobject.addProperty("enchantment", Registry.field_212628_q.getKey(this.enchantment).toString());
         }
   ...
   public static EnchantmentPredicate deserialize(@Nullable JsonElement element) {
      if (element != null && !element.isJsonNull()) {
         ...
         if (jsonobject.has("enchantment")) {
            ...
            enchantment = Registry.field_212628_q.func_218349_b(resourcelocation).orElseThrow(() -> {
