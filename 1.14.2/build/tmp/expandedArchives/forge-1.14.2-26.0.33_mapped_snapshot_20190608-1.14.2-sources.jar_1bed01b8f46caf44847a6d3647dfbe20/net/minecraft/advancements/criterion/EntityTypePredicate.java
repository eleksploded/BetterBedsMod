...
public abstract class EntityTypePredicate {
   ...
   public static EntityTypePredicate deserialize(@Nullable JsonElement p_209370_0_) {
      if (p_209370_0_ != null && !p_209370_0_.isJsonNull()) {
         ...
         if (s.startsWith("#")) {
            ...
            Tag<EntityType<?>> tag = EntityTypeTags.func_219762_a().getOrCreate(resourcelocation1);
            return new EntityTypePredicate.TagPredicate(tag);
         } else {
            ResourceLocation resourcelocation = new ResourceLocation(s);
            EntityType<?> entitytype = Registry.field_212629_r.func_218349_b(resourcelocation).orElseThrow(() -> {
               return new JsonSyntaxException("Unknown entity type '" + resourcelocation + "', valid types are: " + field_209372_b.join(Registry.field_212629_r.keySet()));
            });
   ...
   static class TypePredicate extends EntityTypePredicate {
      ...
      public JsonElement serialize() {
         return new JsonPrimitive(Registry.field_212629_r.getKey(this.field_218000_b).toString());
      }
   }
}