...
public class AdvancementList {
   ...
   private AdvancementList.IListener field_192095_e;
   ...
   private void remove(Advancement advancementIn) {
      ...
      if (advancementIn.getParent() == null) {
         ...
         if (this.field_192095_e != null) {
            this.field_192095_e.rootAdvancementRemoved(advancementIn);
         }
      } else {
         this.nonRoots.remove(advancementIn);
         if (this.field_192095_e != null) {
            this.field_192095_e.nonRootAdvancementRemoved(advancementIn);
         }
      }
         ...
         while(iterator.hasNext()) {
            ...
            if (advancement$builder.resolveParent(function)) {
               ...
               if (advancement.getParent() == null) {
                  ...
                  if (this.field_192095_e != null) {
                     this.field_192095_e.rootAdvancementAdded(advancement);
                  }
               } else {
                  this.nonRoots.add(advancement);
                  if (this.field_192095_e != null) {
                     this.field_192095_e.nonRootAdvancementAdded(advancement);
                  }
               }
            }
         }
   ...
   public void clear() {
      ...
      this.nonRoots.clear();
      if (this.field_192095_e != null) {
         this.field_192095_e.advancementsCleared();
      }
