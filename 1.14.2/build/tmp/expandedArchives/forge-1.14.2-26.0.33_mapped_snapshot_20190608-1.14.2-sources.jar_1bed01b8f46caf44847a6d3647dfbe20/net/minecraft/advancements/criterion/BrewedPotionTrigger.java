...
public class BrewedPotionTrigger implements ICriterionTrigger<BrewedPotionTrigger.Instance> {
   ...
   public BrewedPotionTrigger.Instance deserializeInstance(JsonObject json, JsonDeserializationContext context) {
      ...
      if (json.has("potion")) {
         ...
         potion = Registry.field_212621_j.func_218349_b(resourcelocation).orElseThrow(() -> {
   ...
   public static class Instance extends CriterionInstance {
      ...
      public JsonElement serialize() {
         ...
         if (this.field_192251_a != null) {
            jsonobject.addProperty("potion", Registry.field_212621_j.getKey(this.field_192251_a).toString());
         }
