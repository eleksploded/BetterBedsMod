...
public enum NoteBlockInstrument implements IStringSerializable {
   ...
   IRON_XYLOPHONE("iron_xylophone", SoundEvents.field_219653_gZ),
   COW_BELL("cow_bell", SoundEvents.field_219662_ha),
   DIDGERIDOO("didgeridoo", SoundEvents.field_219663_hb),
   BIT("bit", SoundEvents.field_219664_hc),
   BANJO("banjo", SoundEvents.field_219665_hd),
