...
public class LecternTileEntity extends TileEntity implements IClearable, INamedContainerProvider {
   private final IInventory field_214048_a = new IInventory() {
      ...
      public boolean isEmpty() {
         return LecternTileEntity.this.field_214050_c.isEmpty();
      }
      ...
      public ItemStack getStackInSlot(int index) {
         return index == 0 ? LecternTileEntity.this.field_214050_c : ItemStack.EMPTY;
      }
      ...
      public ItemStack decrStackSize(int index, int count) {
         if (index == 0) {
            ItemStack itemstack = LecternTileEntity.this.field_214050_c.split(count);
            if (LecternTileEntity.this.field_214050_c.isEmpty()) {
      ...
      public ItemStack removeStackFromSlot(int index) {
         if (index == 0) {
            ...
            LecternTileEntity.this.field_214050_c = ItemStack.EMPTY;
            LecternTileEntity.this.func_214042_s();
            return itemstack;
         } else {
            return ItemStack.EMPTY;
   ...
   private ItemStack field_214050_c = ItemStack.EMPTY;
   ...
   public boolean func_214046_f() {
      Item item = this.field_214050_c.getItem();
   ...
   public void func_214040_a(ItemStack p_214040_1_, @Nullable PlayerEntity p_214040_2_) {
      this.field_214050_c = this.func_214047_b(p_214040_1_, p_214040_2_);
      this.field_214051_g = 0;
   ...
   private void func_214035_a(int p_214035_1_) {
      int i = MathHelper.clamp(p_214035_1_, 0, this.field_214052_h - 1);
   ...
   public int func_214034_r() {
      float f = this.field_214052_h > 1 ? (float)this.func_214041_g() / ((float)this.field_214052_h - 1.0F) : 1.0F;
   ...
   public void read(CompoundNBT compound) {
      ...
      if (compound.contains("Book", 10)) {
         this.field_214050_c = this.func_214047_b(ItemStack.read(compound.getCompound("Book")), (PlayerEntity)null);
      } else {
         this.field_214050_c = ItemStack.EMPTY;
      }

      this.field_214052_h = WrittenBookItem.func_220049_j(this.field_214050_c);
      this.field_214051_g = MathHelper.clamp(compound.getInt("Page"), 0, this.field_214052_h - 1);
   }
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      if (!this.func_214033_c().isEmpty()) {
         ...
         compound.putInt("Page", this.field_214051_g);
      }
