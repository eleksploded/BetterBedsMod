...
public abstract class LockableLootTileEntity extends LockableTileEntity {
   ...
   public void fillWithLoot(@Nullable PlayerEntity player) {
      if (this.lootTable != null && this.world.getServer() != null) {
         ...
         this.lootTable = null;
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.world)).withParameter(LootParameters.field_216286_f, new BlockPos(this.pos)).withSeed(this.lootTableSeed);
         if (player != null) {
