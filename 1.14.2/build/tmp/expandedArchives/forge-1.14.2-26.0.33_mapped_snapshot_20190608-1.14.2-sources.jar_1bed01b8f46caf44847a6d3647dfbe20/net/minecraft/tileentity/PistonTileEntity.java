...
public class PistonTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public float getProgress(float ticks) {
      ...
      return MathHelper.func_219799_g(ticks, this.lastProgress, this.progress);
   }

   @OnlyIn(Dist.CLIENT)
   public float getOffsetX(float ticks) {
      return (float)this.field_174931_f.getXOffset() * this.getExtendedProgress(this.getProgress(ticks));
   }

   @OnlyIn(Dist.CLIENT)
   public float getOffsetY(float ticks) {
      return (float)this.field_174931_f.getYOffset() * this.getExtendedProgress(this.getProgress(ticks));
   }

   @OnlyIn(Dist.CLIENT)
   public float getOffsetZ(float ticks) {
      return (float)this.field_174931_f.getZOffset() * this.getExtendedProgress(this.getProgress(ticks));
   }
   ...
   private BlockState getCollisionRelatedBlockState() {
      return !this.isExtending() && this.shouldPistonHeadBeRendered() && this.field_200231_a.getBlock() instanceof PistonBlock ? Blocks.PISTON_HEAD.getDefaultState().with(PistonHeadBlock.TYPE, this.field_200231_a.getBlock() == Blocks.STICKY_PISTON ? PistonType.STICKY : PistonType.DEFAULT).with(PistonHeadBlock.FACING, this.field_200231_a.get(PistonBlock.FACING)) : this.field_200231_a;
   }
   ...
   private void moveCollidedEntities(float p_184322_1_) {
      ...
      if (!voxelshape.isEmpty()) {
         ...
         if (!list1.isEmpty()) {
            boolean flag = this.field_200231_a.getBlock().isStickyBlock(this.field_200231_a);
   ...
   public Direction getMotionDirection() {
      return this.extending ? this.field_174931_f : this.field_174931_f.getOpposite();
   }
   ...
   private AxisAlignedBB moveByPositionAndProgress(AxisAlignedBB p_190607_1_) {
      ...
      return p_190607_1_.offset((double)this.pos.getX() + d0 * (double)this.field_174931_f.getXOffset(), (double)this.pos.getY() + d0 * (double)this.field_174931_f.getYOffset(), (double)this.pos.getZ() + d0 * (double)this.field_174931_f.getZOffset());
   }
      ...
      if (this.lastProgress < 1.0F && this.world != null) {
         ...
         if (this.world.getBlockState(this.pos).getBlock() == Blocks.MOVING_PISTON) {
            ...
            if (this.shouldHeadBeRendered) {
               ...
               blockstate = Block.getValidBlockForPosition(this.field_200231_a, this.world, this.pos);
            }
   ...
   public void tick() {
      ...
      if (this.lastProgress >= 1.0F) {
         this.world.removeTileEntity(this.pos);
         this.remove();
         if (this.field_200231_a != null && this.world.getBlockState(this.pos).getBlock() == Blocks.MOVING_PISTON) {
            BlockState blockstate = Block.getValidBlockForPosition(this.field_200231_a, this.world, this.pos);
            if (blockstate.isAir()) {
               this.world.setBlockState(this.pos, this.field_200231_a, 84);
               Block.replaceBlock(this.field_200231_a, blockstate, this.world, this.pos, 3);
            } else {
   ...
   public void read(CompoundNBT compound) {
      super.read(compound);
      this.field_200231_a = NBTUtil.readBlockState(compound.getCompound("blockState"));
      this.field_174931_f = Direction.byIndex(compound.getInt("facing"));
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      compound.put("blockState", NBTUtil.writeBlockState(this.field_200231_a));
      compound.putInt("facing", this.field_174931_f.getIndex());
   ...
   public VoxelShape getCollisionShape(IBlockReader p_195508_1_, BlockPos p_195508_2_) {
      ...
      if (!this.extending && this.shouldHeadBeRendered) {
         voxelshape = this.field_200231_a.with(PistonBlock.EXTENDED, Boolean.valueOf(true)).getCollisionShape(p_195508_1_, p_195508_2_);
      } else {
      ...
      if ((double)this.progress < 1.0D && direction == this.getMotionDirection()) {
         ...
         if (this.shouldPistonHeadBeRendered()) {
            blockstate = Blocks.PISTON_HEAD.getDefaultState().with(PistonHeadBlock.FACING, this.field_174931_f).with(PistonHeadBlock.SHORT, Boolean.valueOf(this.extending != 1.0F - this.progress < 4.0F));
         } else {
            blockstate = this.field_200231_a;
         }

         float f = this.getExtendedProgress(this.progress);
         double d0 = (double)((float)this.field_174931_f.getXOffset() * f);
         double d1 = (double)((float)this.field_174931_f.getYOffset() * f);
         double d2 = (double)((float)this.field_174931_f.getZOffset() * f);
