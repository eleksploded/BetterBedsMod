...
public class ShulkerBoxTileEntity extends LockableLootTileEntity implements ISidedInventory, ITickableTileEntity {
   ...
   private ShulkerBoxTileEntity.AnimationStatus field_190599_i = ShulkerBoxTileEntity.AnimationStatus.CLOSED;
   ...
   public void tick() {
      ...
      if (this.field_190599_i == ShulkerBoxTileEntity.AnimationStatus.OPENING || this.field_190599_i == ShulkerBoxTileEntity.AnimationStatus.CLOSING) {
   ...
   protected void updateAnimation() {
      ...
      case OPENING:
         ...
         if (this.progress >= 1.0F) {
            this.moveCollidedEntities();
            this.field_190599_i = ShulkerBoxTileEntity.AnimationStatus.OPENED;
            this.progress = 1.0F;
            this.func_213975_v();
         }
         break;
      case CLOSING:
         ...
         if (this.progress <= 0.0F) {
            this.field_190599_i = ShulkerBoxTileEntity.AnimationStatus.CLOSED;
            this.progress = 0.0F;
            this.func_213975_v();
         }
         break;
   ...
   public boolean receiveClientEvent(int id, int type) {
      if (id == 1) {
         this.openCount = type;
         if (type == 0) {
            this.field_190599_i = ShulkerBoxTileEntity.AnimationStatus.CLOSING;
            this.func_213975_v();
         }

         if (type == 1) {
            this.field_190599_i = ShulkerBoxTileEntity.AnimationStatus.OPENING;
            this.func_213975_v();
         }
   ...
   public DyeColor getColor() {
      if (this.needsColorFromWorld) {
         this.field_190602_l = ShulkerBoxBlock.getColorFromBlock(this.getBlockState().getBlock());
