...
public class BannerTileEntity extends TileEntity implements INameable {
   ...
   public BannerTileEntity(DyeColor p_i47731_1_) {
      this();
      this.field_175120_a = p_i47731_1_;
   }
   ...
   public void loadFromItemStack(ItemStack p_195534_1_, DyeColor p_195534_2_) {
      ...
      if (compoundnbt != null && compoundnbt.contains("Patterns", 9)) {
         this.field_175118_f = compoundnbt.getList("Patterns", 10).copy();
      }

      this.field_175120_a = p_195534_2_;
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      if (this.field_175118_f != null) {
         compound.put("Patterns", this.field_175118_f);
      }
   ...
   public void read(CompoundNBT compound) {
      ...
      if (this.hasWorld()) {
         this.field_175120_a = ((AbstractBannerBlock)this.getBlockState().getBlock()).getColor();
      } else {
      ...
      if (this.patternList == null || this.colorList == null || this.patternResourceLocation == null) {
         if (!this.patternDataSet) {
            ...
            if (dyecolor == null) {
               ...
               if (this.field_175118_f != null) {
                  for(int i = 0; i < this.field_175118_f.size(); ++i) {
                     CompoundNBT compoundnbt = this.field_175118_f.getCompound(i);
   ...
   public ItemStack getItem(BlockState p_190615_1_) {
      ...
      if (this.field_175118_f != null && !this.field_175118_f.isEmpty()) {
         itemstack.getOrCreateChildTag("BlockEntityTag").put("Patterns", this.field_175118_f.copy());
      }
   ...
   public DyeColor getBaseColor(Supplier<BlockState> p_195533_1_) {
      if (this.field_175120_a == null) {
         this.field_175120_a = ((AbstractBannerBlock)p_195533_1_.get().getBlock()).getColor();
      }
