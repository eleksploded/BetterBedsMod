...
public class ConduitTileEntity extends TileEntity implements ITickableTileEntity {
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      if (this.field_205047_j != null) {
         compound.put("target_uuid", NBTUtil.writeUniqueId(this.field_205047_j.getUniqueID()));
      }
   ...
   private void addEffectsToPlayers() {
      ...
      AxisAlignedBB axisalignedbb = (new AxisAlignedBB((double)k, (double)l, (double)i1, (double)(k + 1), (double)(l + 1), (double)(i1 + 1))).grow((double)j).expand(0.0D, (double)this.world.func_217301_I(), 0.0D);
      List<PlayerEntity> list = this.world.getEntitiesWithinAABB(PlayerEntity.class, axisalignedbb);
      if (!list.isEmpty()) {
         for(PlayerEntity playerentity : list) {
            if (this.pos.func_218141_a(new BlockPos(playerentity), (double)j) && playerentity.isWet()) {
               playerentity.addPotionEffect(new EffectInstance(Effects.field_205136_C, 260, 0, true, true));
            }
         }
   ...
   private void attackMobs() {
      ...
      if (i < 42) {
      ...
      } else if (this.field_205047_j == null && this.targetUuid != null) {
         this.field_205047_j = this.findExistingTarget();
         this.targetUuid = null;
         ...
         if (!list.isEmpty()) {
            this.field_205047_j = list.get(this.world.rand.nextInt(list.size()));
         }
      } else if (!this.field_205047_j.isAlive() || !this.pos.func_218141_a(new BlockPos(this.field_205047_j), 8.0D)) {
         this.field_205047_j = null;
      }

      if (this.field_205047_j != null) {
         this.world.playSound((PlayerEntity)null, this.field_205047_j.posX, this.field_205047_j.posY, this.field_205047_j.posZ, SoundEvents.BLOCK_CONDUIT_ATTACK_TARGET, SoundCategory.BLOCKS, 1.0F, 1.0F);
         this.field_205047_j.attackEntityFrom(DamageSource.MAGIC, 4.0F);
      }
   ...
   private void updateClientTarget() {
      if (this.targetUuid == null) {
         this.field_205047_j = null;
      } else if (this.field_205047_j == null || !this.field_205047_j.getUniqueID().equals(this.targetUuid)) {
         this.field_205047_j = this.findExistingTarget();
         if (this.field_205047_j == null) {
            this.targetUuid = null;
         }
   ...
   private void spawnParticles() {
      ...
      if (this.field_205047_j != null) {
         Vec3d vec3d2 = new Vec3d(this.field_205047_j.posX, this.field_205047_j.posY + (double)this.field_205047_j.getEyeHeight(), this.field_205047_j.posZ);
         float f4 = (-0.5F + random.nextFloat()) * (3.0F + this.field_205047_j.getWidth());
         float f5 = -1.0F + random.nextFloat() * this.field_205047_j.getHeight();
         float f6 = (-0.5F + random.nextFloat()) * (3.0F + this.field_205047_j.getWidth());
