...
public class MobSpawnerTileEntity extends TileEntity implements ITickableTileEntity {
   private final AbstractSpawner field_145882_a = new AbstractSpawner() {
   ...
   public void read(CompoundNBT compound) {
      super.read(compound);
      this.field_145882_a.read(compound);
   }

   public CompoundNBT write(CompoundNBT compound) {
      super.write(compound);
      this.field_145882_a.write(compound);
      return compound;
   }

   public void tick() {
      this.field_145882_a.tick();
   }
