...
public abstract class TileEntity extends net.minecraftforge.common.capabilities.CapabilityProvider<TileEntity> implements net.minecraftforge.common.extensions.IForgeTileEntity {
   ...
   public static TileEntity create(CompoundNBT tag) {
      ...
      return Registry.field_212626_o.func_218349_b(new ResourceLocation(s)).map((p_213134_1_) -> {
         try {
   ...
   public void markDirty() {
      if (this.world != null) {
         this.field_195045_e = this.world.getBlockState(this.pos);
         this.world.markChunkDirty(this.pos, this);
         if (!this.field_195045_e.isAir(world, this.pos)) {
            this.world.updateComparatorOutputLevel(this.pos, this.field_195045_e.getBlock());
         }
      }
   ...
   public void addInfoToCrashReport(CrashReportCategory reportCategory) {
      reportCategory.addDetail("Name", () -> {
         return Registry.field_212626_o.getKey(this.getType()) + " // " + this.getClass().getCanonicalName();
      });
      if (this.world != null) {
   ...
   public void warnInvalidBlock() {
      if (!this.warnedInvalidBlock) {
         ...
         LOGGER.warn("Block entity invalid: {} @ {}", () -> {
            return Registry.field_212626_o.getKey(this.getType());
         }, this::getPos);
      }
   }
}