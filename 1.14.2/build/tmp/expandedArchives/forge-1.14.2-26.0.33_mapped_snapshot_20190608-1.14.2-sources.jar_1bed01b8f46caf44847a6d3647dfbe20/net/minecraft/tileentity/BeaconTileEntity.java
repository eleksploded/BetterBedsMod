...
public class BeaconTileEntity extends TileEntity implements INamedContainerProvider, ITickableTileEntity {
   ...
   private final IIntArray field_213937_n = new IIntArray() {
      public int func_221476_a(int p_221476_1_) {
         ...
         case 1:
            return Effect.getIdFromPotion(BeaconTileEntity.this.primaryEffect);
         case 2:
            return Effect.getIdFromPotion(BeaconTileEntity.this.secondaryEffect);
         default:
            return 0;
         }
      }
   ...
   private void addEffectsToPlayers() {
      if (!this.world.isRemote && this.primaryEffect != null) {
         ...
         AxisAlignedBB axisalignedbb = (new AxisAlignedBB(this.pos)).grow(d0).expand(0.0D, (double)this.world.func_217301_I(), 0.0D);
   ...
   private static Effect isBeaconEffect(int p_184279_0_) {
      Effect effect = Effect.getPotionById(p_184279_0_);
   ...
   public CompoundNBT write(CompoundNBT compound) {
      ...
      compound.putInt("Primary", Effect.getIdFromPotion(this.primaryEffect));
      compound.putInt("Secondary", Effect.getIdFromPotion(this.secondaryEffect));
