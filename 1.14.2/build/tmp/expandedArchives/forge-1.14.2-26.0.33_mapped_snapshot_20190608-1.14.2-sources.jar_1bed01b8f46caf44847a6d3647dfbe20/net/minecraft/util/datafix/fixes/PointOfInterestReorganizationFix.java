...
public class PointOfInterestReorganizationFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      Type<Pair<String, Dynamic<?>>> type = DSL.named(TypeReferences.field_219869_j.typeName(), DSL.remainderType());
      if (!Objects.equals(type, this.getInputSchema().getType(TypeReferences.field_219869_j))) {
