...
public class CachedBlockInfo {
   ...
   public BlockState getBlockState() {
      if (this.field_177514_c == null && (this.forceLoad || this.field_177515_a.isBlockLoaded(this.pos))) {
         this.field_177514_c = this.field_177515_a.getBlockState(this.pos);
      }
   ...
   public TileEntity getTileEntity() {
      if (this.tileEntity == null && !this.tileEntityInitialized) {
         this.tileEntity = this.field_177515_a.getTileEntity(this.pos);
