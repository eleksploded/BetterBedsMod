...
public class BlockPos extends Vec3i implements IDynamicSerializable {
   ...
   public static Stream<BlockPos> func_218281_b(BlockPos p_218281_0_, BlockPos p_218281_1_) {
      return func_218287_a(Math.min(p_218281_0_.getX(), p_218281_1_.getX()), Math.min(p_218281_0_.getY(), p_218281_1_.getY()), Math.min(p_218281_0_.getZ(), p_218281_1_.getZ()), Math.max(p_218281_0_.getX(), p_218281_1_.getX()), Math.max(p_218281_0_.getY(), p_218281_1_.getY()), Math.max(p_218281_0_.getZ(), p_218281_1_.getZ()));
   }

   public static Stream<BlockPos> func_218287_a(final int p_218287_0_, final int p_218287_1_, final int p_218287_2_, final int p_218287_3_, final int p_218287_4_, final int p_218287_5_) {
      return StreamSupport.stream(new AbstractSpliterator<BlockPos>((long)((p_218287_3_ - p_218287_0_ + 1) * (p_218287_4_ - p_218287_1_ + 1) * (p_218287_5_ - p_218287_2_ + 1)), 64) {
         ...
         final BlockPos.MutableBlockPos field_218297_b = new BlockPos.MutableBlockPos();

         public boolean tryAdvance(Consumer<? super BlockPos> p_tryAdvance_1_) {
            if (this.field_218296_a.func_218301_a()) {
               p_tryAdvance_1_.accept(this.field_218297_b.setPos(this.field_218296_a.func_218304_b(), this.field_218296_a.func_218302_c(), this.field_218296_a.func_218303_d()));
               return true;
            } else {
               return false;
            }
      ...
      return () -> {
         return new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               return (BlockPos)(this.field_218298_a.func_218301_a() ? this.field_218299_b.setPos(this.field_218298_a.func_218304_b(), this.field_218298_a.func_218302_c(), this.field_218298_a.func_218303_d()) : this.endOfData());
            }
         };
      };
   }
   ...
   public static class MutableBlockPos extends BlockPos {
      ...
      public BlockPos.MutableBlockPos func_218294_g(long p_218294_1_) {
