...
public final class VoxelShapes {
   ...
   public static final VoxelShape field_216389_a = create(Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY);
   ...
   public static double func_216383_a(Direction.Axis p_216383_0_, AxisAlignedBB p_216383_1_, IWorldReader p_216383_2_, double p_216383_3_, ISelectionContext p_216383_5_, Stream<VoxelShape> p_216383_6_) {
      return func_216386_a(p_216383_1_, p_216383_2_, p_216383_3_, p_216383_5_, AxisRotation.from(p_216383_0_, Direction.Axis.Z), p_216383_6_);
   }
   ...
   private static double func_216386_a(AxisAlignedBB p_216386_0_, IWorldReader p_216386_1_, double p_216386_2_, ISelectionContext p_216386_4_, AxisRotation p_216386_5_, Stream<VoxelShape> p_216386_6_) {
      if (!(p_216386_0_.func_216364_b() < 1.0E-6D) && !(p_216386_0_.func_216360_c() < 1.0E-6D) && !(p_216386_0_.func_216362_d() < 1.0E-6D)) {
         if (Math.abs(p_216386_2_) < 1.0E-7D) {
            return 0.0D;
         } else {
            AxisRotation axisrotation = p_216386_5_.reverse();
            ...
            int i = MathHelper.floor(p_216386_0_.getMin(direction$axis) - 1.0E-7D) - 1;
            int j = MathHelper.floor(p_216386_0_.getMax(direction$axis) + 1.0E-7D) + 1;
            int k = MathHelper.floor(p_216386_0_.getMin(direction$axis1) - 1.0E-7D) - 1;
            int l = MathHelper.floor(p_216386_0_.getMax(direction$axis1) + 1.0E-7D) + 1;
            double d0 = p_216386_0_.getMin(direction$axis2) - 1.0E-7D;
            double d1 = p_216386_0_.getMax(direction$axis2) + 1.0E-7D;
            boolean flag = p_216386_2_ > 0.0D;
            int i1 = flag ? MathHelper.floor(p_216386_0_.getMax(direction$axis2) - 1.0E-7D) - 1 : MathHelper.floor(p_216386_0_.getMin(direction$axis2) + 1.0E-7D) + 1;
            int j1 = func_216385_a(p_216386_2_, d0, d1);
            int k1 = flag ? 1 : -1;
            int l1 = i1;
               ...
               for(int i2 = i; i2 <= j; ++i2) {
                  for(int j2 = k; j2 <= l; ++j2) {
                     ...
                     if (k2 < 3) {
                        ...
                        BlockState blockstate = p_216386_1_.getBlockState(blockpos$mutableblockpos);
                        if ((k2 != 1 || blockstate.func_215704_f()) && (k2 != 2 || blockstate.getBlock() == Blocks.MOVING_PISTON)) {
                           p_216386_2_ = blockstate.getCollisionShape(p_216386_1_, blockpos$mutableblockpos, p_216386_4_).getAllowedOffset(direction$axis2, p_216386_0_.offset((double)(-blockpos$mutableblockpos.getX()), (double)(-blockpos$mutableblockpos.getY()), (double)(-blockpos$mutableblockpos.getZ())), p_216386_2_);
                           if (Math.abs(p_216386_2_) < 1.0E-7D) {
                              return 0.0D;
                           }

                           j1 = func_216385_a(p_216386_2_, d0, d1);
                        }
                     }
                  }
               }
            ...
            p_216386_6_.forEach((p_216388_3_) -> {
               adouble[0] = p_216388_3_.getAllowedOffset(direction$axis2, p_216386_0_, adouble[0]);
            });
            return adouble[0];
         }
      } else {
