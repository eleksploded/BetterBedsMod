...
public class Bootstrap {
   ...
   public static void register() {
      if (!alreadyRegistered) {
         ...
         if (Registry.field_212617_f.isEmpty()) {
   ...
   public static Set<String> func_218816_b() {
      ...
      func_218819_a(Registry.field_212629_r, EntityType::getTranslationKey, set);
      func_218819_a(Registry.field_212631_t, Effect::getName, set);
      func_218819_a(Registry.field_212630_s, Item::getTranslationKey, set);
      func_218819_a(Registry.field_212628_q, Enchantment::getName, set);
      func_218819_a(Registry.field_212624_m, Biome::getTranslationKey, set);
      func_218819_a(Registry.field_212618_g, Block::getTranslationKey, set);
      func_218819_a(Registry.field_212623_l, (p_218820_0_) -> {
