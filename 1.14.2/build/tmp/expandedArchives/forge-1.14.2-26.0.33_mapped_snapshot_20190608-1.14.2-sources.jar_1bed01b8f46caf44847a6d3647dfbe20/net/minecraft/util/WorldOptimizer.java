...
public class WorldOptimizer {
   ...
   public WorldOptimizer(String p_i50400_1_, SaveFormat p_i50400_2_, WorldInfo p_i50400_3_, boolean p_i50400_4_) {
      ...
      this.field_212221_c = p_i50400_2_.getSaveLoader(p_i50400_1_, (MinecraftServer)null);
      this.field_212221_c.saveWorldInfo(p_i50400_3_);
      this.field_219960_q = new DimensionSavedDataManager(new File(DimensionType.OVERWORLD.getDirectory(this.field_212221_c.getWorldDirectory()), "data"), this.field_212221_c.getFixer());
      this.field_219958_g = this.field_212221_c.getWorldDirectory();
   ...
   private void optimize() {
      File file1 = this.field_212221_c.getWorldDirectory();
      this.totalChunks = 0;
      ...
      if (this.totalChunks == 0) {
         ...
         for(DimensionType dimensiontype1 : DimensionType.getAll()) {
            ...
            builder1.put(dimensiontype1, new ChunkLoader(new File(file2, "region"), this.field_212221_c.getFixer()));
         }
         ...
         while(this.active) {
            ...
            for(DimensionType dimensiontype2 : DimensionType.getAll()) {
               ...
               this.field_212544_m.put(dimensiontype2, f2);
               f += f2;
            }
   ...
   private List<ChunkPos> func_219953_b(DimensionType p_219953_1_) {
      File file1 = p_219953_1_.getDirectory(this.field_219958_g);
