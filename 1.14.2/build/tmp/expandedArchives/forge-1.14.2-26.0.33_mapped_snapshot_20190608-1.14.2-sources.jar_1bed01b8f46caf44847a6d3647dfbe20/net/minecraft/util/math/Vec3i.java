...
public class Vec3i implements Comparable<Vec3i> {
   ...
   public boolean func_218141_a(Vec3i p_218141_1_, double p_218141_2_) {
      return this.func_218140_a((double)p_218141_1_.x, (double)p_218141_1_.y, (double)p_218141_1_.z, false) < p_218141_2_ * p_218141_2_;
   }

   public boolean func_218137_a(IPosition p_218137_1_, double p_218137_2_) {
      return this.func_218140_a(p_218137_1_.getX(), p_218137_1_.getY(), p_218137_1_.getZ(), true) < p_218137_2_ * p_218137_2_;
   }
   ...
   public double distanceSq(Vec3i to) {
      return this.func_218140_a((double)to.getX(), (double)to.getY(), (double)to.getZ(), true);
   }

   public double func_218138_a(IPosition p_218138_1_, boolean p_218138_2_) {
      return this.func_218140_a(p_218138_1_.getX(), p_218138_1_.getY(), p_218138_1_.getZ(), p_218138_2_);
   }
