...
public enum Direction implements IStringSerializable {
   ...
   private final Direction.Axis field_176758_k;
   private final Direction.AxisDirection field_176755_l;
   private final Vec3i directionVec;
   private static final Direction[] field_199792_n = values();
   private static final Map<String, Direction> NAME_LOOKUP = Arrays.stream(field_199792_n).collect(Collectors.toMap(Direction::getName2, (p_199787_0_) -> {
      return p_199787_0_;
   }));
   private static final Direction[] field_82609_l = Arrays.stream(field_199792_n).sorted(Comparator.comparingInt((p_199790_0_) -> {
      return p_199790_0_.index;
   })).toArray((p_199788_0_) -> {
      return new Direction[p_199788_0_];
   });
   private static final Direction[] field_176754_o = Arrays.stream(field_199792_n).filter((p_199786_0_) -> {
   ...
   private static final Long2ObjectMap<Direction> field_218387_r = Arrays.stream(field_199792_n).collect(Collectors.toMap((p_218385_0_) -> {
   ...
   public int getXOffset() {
      return this.field_176758_k == Direction.Axis.X ? this.field_176755_l.getOffset() : 0;
   }
   ...
   public int getYOffset() {
      return this.field_176758_k == Direction.Axis.Y ? this.field_176755_l.getOffset() : 0;
   }
   ...
   public int getZOffset() {
      return this.field_176758_k == Direction.Axis.Z ? this.field_176755_l.getOffset() : 0;
   }
   ...
   public static Direction byIndex(int index) {
      return field_82609_l[MathHelper.abs(index % field_82609_l.length)];
   }
   ...
   public static Direction byHorizontalIndex(int horizontalIndexIn) {
      return field_176754_o[MathHelper.abs(horizontalIndexIn % field_176754_o.length)];
   }
   ...
   public static enum Plane implements Iterable<Direction>, Predicate<Direction> {
      ...
      private final Direction.Axis[] field_209388_d;
