...
public class EntitySelectionContext implements ISelectionContext {
   ...
   protected EntitySelectionContext(Entity p_i51182_1_) {
      this(p_i51182_1_.isSneaking(), p_i51182_1_.getBoundingBox().minY, p_i51182_1_ instanceof LivingEntity ? ((LivingEntity)p_i51182_1_).getHeldItemMainhand().getItem() : Items.AIR);
   }
