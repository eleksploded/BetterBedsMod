...
public class ProtectionEnchantment extends Enchantment {
   public final ProtectionEnchantment.Type field_77356_a;
   ...
   public ProtectionEnchantment(Enchantment.Rarity rarityIn, ProtectionEnchantment.Type protectionTypeIn, EquipmentSlotType... slots) {
      ...
      this.field_77356_a = protectionTypeIn;
   ...
   public int getMinEnchantability(int enchantmentLevel) {
      return this.field_77356_a.getMinimalEnchantability() + (enchantmentLevel - 1) * this.field_77356_a.getEnchantIncreasePerLevel();
   }
   ...
   public int calcModifierDamage(int level, DamageSource source) {
      if (source.canHarmInCreative()) {
         return 0;
      } else if (this.field_77356_a == ProtectionEnchantment.Type.ALL) {
         return level;
      } else if (this.field_77356_a == ProtectionEnchantment.Type.FIRE && source.isFireDamage()) {
         return level * 2;
      } else if (this.field_77356_a == ProtectionEnchantment.Type.FALL && source == DamageSource.FALL) {
         return level * 3;
      } else if (this.field_77356_a == ProtectionEnchantment.Type.EXPLOSION && source.isExplosion()) {
         return level * 2;
      } else {
         return this.field_77356_a == ProtectionEnchantment.Type.PROJECTILE && source.isProjectile() ? level * 2 : 0;
      }
   }
   ...
   public boolean canApplyTogether(Enchantment ench) {
      if (ench instanceof ProtectionEnchantment) {
         ...
         return this.field_77356_a != protectionenchantment.field_77356_a;
      } else {
