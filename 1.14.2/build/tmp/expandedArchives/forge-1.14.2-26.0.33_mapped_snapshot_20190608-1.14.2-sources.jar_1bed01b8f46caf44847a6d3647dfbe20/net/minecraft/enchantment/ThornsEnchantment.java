...
public class ThornsEnchantment extends Enchantment {
   ...
   public void onUserHurt(LivingEntity user, Entity attacker, int level) {
      ...
      if (shouldHit(level, random)) {
         ...
         if (entry != null) {
            entry.getValue().func_222118_a(3, user, (p_222183_1_) -> {
               p_222183_1_.func_213361_c(entry.getKey());
            });
         }
      } else if (entry != null) {
         entry.getValue().func_222118_a(1, user, (p_222182_1_) -> {
            p_222182_1_.func_213361_c(entry.getKey());
         });
      }
