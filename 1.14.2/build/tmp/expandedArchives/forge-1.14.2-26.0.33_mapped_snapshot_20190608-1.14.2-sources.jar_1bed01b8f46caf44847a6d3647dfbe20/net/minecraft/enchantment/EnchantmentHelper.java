...
public class EnchantmentHelper {
   ...
   public static int getEnchantmentLevel(Enchantment enchID, ItemStack stack) {
      if (stack.isEmpty()) {
         ...
         ResourceLocation resourcelocation = Registry.field_212628_q.getKey(enchID);
   ...
   public static Map<Enchantment, Integer> getEnchantments(ItemStack stack) {
      ...
      for(int i = 0; i < listnbt.size(); ++i) {
         CompoundNBT compoundnbt = listnbt.getCompound(i);
         Registry.field_212628_q.func_218349_b(ResourceLocation.tryCreate(compoundnbt.getString("id"))).ifPresent((p_222185_2_) -> {
   ...
   public static void setEnchantments(Map<Enchantment, Integer> enchMap, ItemStack stack) {
      ...
      for(Entry<Enchantment, Integer> entry : enchMap.entrySet()) {
         ...
         if (enchantment != null) {
            ...
            compoundnbt.putString("id", String.valueOf((Object)Registry.field_212628_q.getKey(enchantment)));
   ...
   private static void applyEnchantmentModifier(EnchantmentHelper.IEnchantmentVisitor modifier, ItemStack stack) {
      if (!stack.isEmpty()) {
         ...
         for(int i = 0; i < listnbt.size(); ++i) {
            ...
            Registry.field_212628_q.func_218349_b(ResourceLocation.tryCreate(s)).ifPresent((p_222184_2_) -> {
   ...
   public static int getMaxEnchantmentLevel(Enchantment enchantmentIn, LivingEntity entityIn) {
      Iterable<ItemStack> iterable = enchantmentIn.func_222181_a(entityIn).values();
      if (iterable == null) {
         return 0;
      } else {
         int i = 0;
