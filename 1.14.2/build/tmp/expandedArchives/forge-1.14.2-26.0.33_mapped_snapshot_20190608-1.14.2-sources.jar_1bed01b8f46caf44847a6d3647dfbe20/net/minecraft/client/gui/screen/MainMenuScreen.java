...
public class MainMenuScreen extends Screen {
   ...
   private boolean areRealmsNotificationsEnabled() {
      return this.minecraft.gameSettings.realmsNotifications && this.field_183503_M != null;
   }
   ...
   public static CompletableFuture<Void> func_213097_a(TextureManager p_213097_0_, Executor p_213097_1_) {
      return CompletableFuture.allOf(p_213097_0_.func_215268_a(MINECRAFT_TITLE_TEXTURES, p_213097_1_), p_213097_0_.func_215268_a(MINECRAFT_TITLE_EDITION, p_213097_1_), p_213097_0_.func_215268_a(field_213099_c, p_213097_1_), field_213098_a.func_217617_a(p_213097_0_, p_213097_1_));
   }
   ...
   protected void init() {
      ...
      this.addButton(new ImageButton(this.width / 2 + 104, j + 72 + 12, 20, 20, 0, 0, 20, field_213100_d, 32, 64, (p_213088_1_) -> {
   ...
   private void addDemoButtons(int yIn, int rowHeightIn) {
      this.addButton(new Button(this.width / 2 - 100, yIn, 200, 20, I18n.format("menu.playdemo"), (p_213092_1_) -> {
         this.minecraft.launchIntegratedServer("Demo_World", "Demo_World", MinecraftServer.field_213219_c);
      }));
      this.field_73973_d = this.addButton(new Button(this.width / 2 - 100, yIn + rowHeightIn * 1, 200, 20, I18n.format("menu.resetdemo"), (p_213091_1_) -> {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      int k = 30;
      this.minecraft.getTextureManager().bindTexture(field_213099_c);
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
         ...
         if (this.areRealmsNotificationsEnabled() && this.field_183503_M.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
            return true;
         } else {
