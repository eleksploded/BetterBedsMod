...
public class CreativeScreen extends DisplayEffectsScreen<CreativeScreen.CreativeContainer> {
   ...
   protected void handleMouseClick(@Nullable Slot slotIn, int slotId, int mouseButton, ClickType type) {
      if (this.hasTmpInventory(slotIn)) {
         this.field_147062_A.setCursorPositionEnd();
         this.field_147062_A.setSelectionPos(0);
      }
      ...
      if (slotIn == null && selectedTabIndex != ItemGroup.INVENTORY.getIndex() && type != ClickType.QUICK_CRAFT) {
         ...
         if (!playerinventory1.getItemStack().isEmpty() && this.field_199506_G) {
            if (mouseButton == 0) {
               ...
               this.minecraft.field_71442_b.sendPacketDropItem(playerinventory1.getItemStack());
            ...
            if (mouseButton == 1) {
               ...
               this.minecraft.field_71442_b.sendPacketDropItem(itemstack6);
            }
         }
      } else {
         ...
         if (slotIn == this.field_147064_C && flag) {
            for(int j = 0; j < this.minecraft.player.container.getInventory().size(); ++j) {
               this.minecraft.field_71442_b.sendSlotPacket(ItemStack.EMPTY, j);
            }
            ...
            if (slotIn == this.field_147064_C) {
               ...
               this.minecraft.field_71442_b.sendPacketDropItem(itemstack);
               this.minecraft.field_71442_b.sendSlotPacket(itemstack1, ((CreativeScreen.CreativeSlot)slotIn).field_148332_b.slotNumber);
               ...
               this.minecraft.field_71442_b.sendPacketDropItem(this.minecraft.player.inventory.getItemStack());
               this.minecraft.player.inventory.setItemStack(ItemStack.EMPTY);
            } else {
               this.minecraft.player.container.slotClick(slotIn == null ? slotId : ((CreativeScreen.CreativeSlot)slotIn).field_148332_b.slotNumber, mouseButton, type, this.minecraft.player);
            ...
            if (type == ClickType.THROW) {
               if (!itemstack7.isEmpty()) {
                  ...
                  this.minecraft.field_71442_b.sendPacketDropItem(itemstack8);
               }
            ...
            ItemStack itemstack3 = slotIn == null ? ItemStack.EMPTY : this.field_147002_h.getSlot(slotIn.slotNumber).getStack();
            this.field_147002_h.slotClick(slotIn == null ? slotId : slotIn.slotNumber, mouseButton, type, this.minecraft.player);
            if (Container.getDragEvent(mouseButton) == 2) {
               for(int k = 0; k < 9; ++k) {
                  this.minecraft.field_71442_b.sendSlotPacket(this.field_147002_h.getSlot(45 + k).getStack(), 36 + k);
               }
            } else if (slotIn != null) {
               ItemStack itemstack4 = this.field_147002_h.getSlot(slotIn.slotNumber).getStack();
               this.minecraft.field_71442_b.sendSlotPacket(itemstack4, slotIn.slotNumber - (this.field_147002_h).inventorySlots.size() + 9 + 36);
               int i = 45 + mouseButton;
               if (type == ClickType.SWAP) {
                  this.minecraft.field_71442_b.sendSlotPacket(itemstack3, i - (this.field_147002_h).inventorySlots.size() + 9 + 36);
                  ...
                  this.minecraft.field_71442_b.sendPacketDropItem(itemstack2);
               }
   ...
   protected void updateActivePotionEffects() {
      ...
      if (this.field_147062_A != null && this.guiLeft != i) {
         this.field_147062_A.func_212952_l(this.guiLeft + 82);
      }
   ...
   protected void init() {
      if (this.minecraft.field_71442_b.isInCreativeMode()) {
         ...
         this.field_147062_A = new TextFieldWidget(this.font, this.guiLeft + 82, this.guiTop + 6, 80, 9, I18n.format("itemGroup.search"));
         this.field_147062_A.setMaxStringLength(50);
         ...
         this.minecraft.player.container.removeListener(this.field_147059_E);
         this.field_147059_E = new CreativeCraftingListener(this.minecraft);
         this.minecraft.player.container.addListener(this.field_147059_E);
      } else {
         this.minecraft.displayGuiScreen(new InventoryScreen(this.minecraft.player));
      }
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String s = this.field_147062_A.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.field_147062_A.setText(s);
      if (!this.field_147062_A.getText().isEmpty()) {
   ...
   public boolean charTyped(char p_charTyped_1_, int p_charTyped_2_) {
      if (this.field_195377_F) {
         ...
         if (this.field_147062_A.charTyped(p_charTyped_1_, p_charTyped_2_)) {
            if (!Objects.equals(s, this.field_147062_A.getText())) {
               this.updateCreativeSearch();
            }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      ...
      if (!ItemGroup.GROUPS[selectedTabIndex].hasSearchBar()) {
         ...
         boolean flag = !this.hasTmpInventory(this.field_147006_u) || this.field_147006_u != null && this.field_147006_u.getHasStack();
         if (flag && this.func_195363_d(p_keyPressed_1_, p_keyPressed_2_)) {
            ...
            if (this.field_147062_A.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
               ...
               return this.field_147062_A.isFocused() && this.field_147062_A.getVisible() && p_keyPressed_1_ != 256 ? true : super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_);
            }
         }
      }
   }
   ...
   private void updateCreativeSearch() {
      (this.field_147002_h).itemList.clear();
      this.field_214085_w.clear();

      ItemGroup tab = ItemGroup.GROUPS[selectedTabIndex];
      if (tab.hasSearchBar() && tab != ItemGroup.SEARCH) {
         tab.fill(field_147002_h.itemList);
         if (!this.field_147062_A.getText().isEmpty()) {
            //TODO: Make this a SearchTree not a manual search
            String search = this.field_147062_A.getText().toLowerCase(Locale.ROOT);
            java.util.Iterator<ItemStack> itr = field_147002_h.itemList.iterator();
            while (itr.hasNext()) {
      ...
      if (s.isEmpty()) {
         for(Item item : Registry.field_212630_s) {
            item.fillItemGroup(ItemGroup.SEARCH, (this.field_147002_h).itemList);
         }
      } else {
         ...
         (this.field_147002_h).itemList.addAll(isearchtree.search(s.toLowerCase(Locale.ROOT)));
      }
   ...
   private boolean needsScrollBars() {
      ...
      return selectedTabIndex != ItemGroup.INVENTORY.getIndex() && ItemGroup.GROUPS[selectedTabIndex].hasScrollbar() && this.field_147002_h.canScroll();
   }
   ...
   private void setCurrentCreativeTab(ItemGroup tab) {
            ...
            if (hotbarsnapshot.isEmpty()) {
               for(int k = 0; k < 9; ++k) {
                  if (k == j) {
                     ...
                     (this.field_147002_h).itemList.add(itemstack);
                  } else {
                     (this.field_147002_h).itemList.add(ItemStack.EMPTY);
                  }
               }
            } else {
               (this.field_147002_h).itemList.addAll(hotbarsnapshot);
            }
         }
      } else if (tab != ItemGroup.SEARCH) {
         tab.fill((this.field_147002_h).itemList);
      }

      if (tab == ItemGroup.INVENTORY) {
         Container container = this.minecraft.player.container;
         if (this.originalSlots == null) {
            this.originalSlots = ImmutableList.copyOf((this.field_147002_h).inventorySlots);
         }

         (this.field_147002_h).inventorySlots.clear();

         for(int l = 0; l < container.inventorySlots.size(); ++l) {
            Slot slot = new CreativeScreen.CreativeSlot(container.inventorySlots.get(l), l);
            (this.field_147002_h).inventorySlots.add(slot);
            if (l >= 5 && l < 9) {
               int j1 = l - 5;
               int l1 = j1 / 2;
               int j2 = j1 % 2;
         ...
         (this.field_147002_h).inventorySlots.add(this.field_147064_C);
      } else if (i == ItemGroup.INVENTORY.getIndex()) {
         (this.field_147002_h).inventorySlots.clear();
         (this.field_147002_h).inventorySlots.addAll(this.originalSlots);
      ...
      if (this.field_147062_A != null) {
         if (tab.hasSearchBar()) {
            ...
            this.field_147062_A.setFocused2(true);
            if (i != tab.getIndex()) {
               this.field_147062_A.setText("");
            }
            this.field_147062_A.setWidth(tab.getSearchbarWidth());
            this.field_147062_A.x = this.guiLeft + (82 /*default left*/ + 89 /*default width*/) - this.field_147062_A.getWidth();

            this.updateCreativeSearch();
         } else {
            this.field_147062_A.setVisible(false);
            this.field_147062_A.setCanLoseFocus(true);
            this.field_147062_A.setFocused2(false);
            this.field_147062_A.setText("");
         }
      }
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      if (!this.needsScrollBars()) {
         ...
         int i = ((this.field_147002_h).itemList.size() + 9 - 1) / 9 - 5;
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (this.field_147064_C != null && selectedTabIndex == ItemGroup.INVENTORY.getIndex() && this.isPointInRegion(this.field_147064_C.xPos, this.field_147064_C.yPos, 16, 16, (double)p_render_1_, (double)p_render_2_)) {
      ...
      if (selectedTabIndex == ItemGroup.SEARCH.getIndex()) {
         ...
         if (itemgroup1 == null && item == Items.ENCHANTED_BOOK) {
            ...
            if (map.size() == 1) {
               ...
               for(ItemGroup itemgroup : ItemGroup.GROUPS) {
                  if (itemgroup.hasRelevantEnchantmentType(enchantment.field_77351_y)) {
   ...
   public static void handleHotbarSnapshots(Minecraft client, int index, boolean load, boolean save) {
      ...
      if (load) {
         for(int i = 0; i < PlayerInventory.getHotbarSize(); ++i) {
            ...
            client.field_71442_b.sendSlotPacket(itemstack, 36 + i);
         }
         ...
         client.field_71456_v.setOverlayMessage(new TranslationTextComponent("inventory.hotbarSaved", s1, s), false);
   ...
   public static class CreativeContainer extends Container {
      ...
      public CreativeContainer(PlayerEntity player) {
         ...
         for(int i = 0; i < 5; ++i) {
            for(int j = 0; j < 9; ++j) {
               this.addSlot(new CreativeScreen.LockedSlot(CreativeScreen.field_195378_x, i * 9 + j, 9 + j * 18, 18 + i * 18));
            }
         }
         ...
         for(int k = 0; k < 5; ++k) {
            for(int l = 0; l < 9; ++l) {
               ...
               if (i1 >= 0 && i1 < this.itemList.size()) {
                  CreativeScreen.field_195378_x.setInventorySlotContents(l + k * 9, this.itemList.get(i1));
               } else {
                  CreativeScreen.field_195378_x.setInventorySlotContents(l + k * 9, ItemStack.EMPTY);
               }
            }
         }
      ...
      public boolean canMergeSlot(ItemStack stack, Slot slotIn) {
         return slotIn.inventory != CreativeScreen.field_195378_x;
      }
   ...
   class CreativeSlot extends Slot {
      ...
      public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
         this.field_148332_b.onTake(thePlayer, stack);
         return stack;
      }
      ...
      public int getItemStackLimit(ItemStack stack) {
         return this.field_148332_b.getItemStackLimit(stack);
      }

      @Nullable
      public String getSlotTexture() {
         return this.field_148332_b.getSlotTexture();
      }
      ...
      public boolean isEnabled() {
         return this.field_148332_b.isEnabled();
      }
      ...
      public boolean canTakeStack(PlayerEntity playerIn) {
         return this.field_148332_b.canTakeStack(playerIn);
      }
