...
public class TurtleModel<T extends TurtleEntity> extends QuadrupedModel<T> {
   ...
   public TurtleModel(float p_i48834_1_) {
      ...
      this.field_78150_a.addBox(-3.0F, -1.0F, -3.0F, 6, 5, 6, 0.0F);
      this.field_78150_a.setRotationPoint(0.0F, 19.0F, -10.0F);
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      ...
      this.field_78149_c.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F * 0.6F) * 0.5F * p_212844_3_;
      this.field_78146_d.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F * 0.6F + (float)Math.PI) * 0.5F * p_212844_3_;
      this.field_78147_e.rotateAngleZ = MathHelper.cos(p_212844_2_ * 0.6662F * 0.6F + (float)Math.PI) * 0.5F * p_212844_3_;
      this.field_78144_f.rotateAngleZ = MathHelper.cos(p_212844_2_ * 0.6662F * 0.6F) * 0.5F * p_212844_3_;
      ...
      if (!p_212844_1_.isInWater() && p_212844_1_.onGround) {
         float f = p_212844_1_.isDigging() ? 4.0F : 1.0F;
         float f1 = p_212844_1_.isDigging() ? 2.0F : 1.0F;
         float f2 = 5.0F;
         this.field_78147_e.rotateAngleY = MathHelper.cos(f * p_212844_2_ * 5.0F + (float)Math.PI) * 8.0F * p_212844_3_ * f1;
         this.field_78147_e.rotateAngleZ = 0.0F;
         this.field_78144_f.rotateAngleY = MathHelper.cos(f * p_212844_2_ * 5.0F) * 8.0F * p_212844_3_ * f1;
         this.field_78144_f.rotateAngleZ = 0.0F;
         this.field_78149_c.rotateAngleY = MathHelper.cos(p_212844_2_ * 5.0F + (float)Math.PI) * 3.0F * p_212844_3_;
         this.field_78149_c.rotateAngleX = 0.0F;
         this.field_78146_d.rotateAngleY = MathHelper.cos(p_212844_2_ * 5.0F) * 3.0F * p_212844_3_;
