...
public class ALUtils {
   private static final Logger field_216484_a = LogManager.getLogger();
   ...
   static boolean func_216483_a(String p_216483_0_) {
      ...
      if (i != 0) {
         field_216484_a.error("{}: {}", p_216483_0_, func_216482_a(i));
         return true;
      } else {
         return false;
      }
   ...
   private static String func_216480_b(int p_216480_0_) {
      switch(p_216480_0_) {
      case 40961:
   ...
   static boolean func_216481_a(long p_216481_0_, String p_216481_2_) {
      ...
      if (i != 0) {
         field_216484_a.error("{}{}: {}", p_216481_2_, p_216481_0_, func_216480_b(i));
         return true;
      } else {
         return false;
      }
