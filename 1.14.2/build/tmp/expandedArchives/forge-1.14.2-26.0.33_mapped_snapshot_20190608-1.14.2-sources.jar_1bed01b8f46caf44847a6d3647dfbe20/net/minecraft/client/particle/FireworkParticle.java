   ...
   public static class Starter extends MetaParticle {
      ...
      public Starter(World p_i46464_1_, double p_i46464_2_, double p_i46464_4_, double p_i46464_6_, double p_i46464_8_, double p_i46464_10_, double p_i46464_12_, ParticleManager p_i46464_14_, @Nullable CompoundNBT p_i46464_15_) {
         ...
         if (p_i46464_15_ != null) {
            this.field_92039_az = p_i46464_15_.getList("Explosions", 10);
            if (this.field_92039_az.isEmpty()) {
               this.field_92039_az = null;
            } else {
               this.maxAge = this.field_92039_az.size() * 2 - 1;

               for(int i = 0; i < this.field_92039_az.size(); ++i) {
                  CompoundNBT compoundnbt = this.field_92039_az.getCompound(i);
      ...
      public void tick() {
         if (this.fireworkAge == 0 && this.field_92039_az != null) {
         ...
         if (this.fireworkAge % 2 == 0 && this.field_92039_az != null && this.fireworkAge / 2 < this.field_92039_az.size()) {
            int k = this.fireworkAge / 2;
            CompoundNBT compoundnbt1 = this.field_92039_az.getCompound(k);
            ...
            Particle particle = this.manager.addParticle(ParticleTypes.field_218419_B, this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
         ...
         for(int i = 0; i < 3; ++i) {
            ...
            for(int j = 1; j < shape.length; ++j) {
               ...
               for(double d8 = 0.25D; d8 <= 1.0D; d8 += 0.25D) {
                  double d9 = MathHelper.func_219803_d(d8, d4, d6) * speed;
                  double d10 = MathHelper.func_219803_d(d8, d5, d7) * speed;
