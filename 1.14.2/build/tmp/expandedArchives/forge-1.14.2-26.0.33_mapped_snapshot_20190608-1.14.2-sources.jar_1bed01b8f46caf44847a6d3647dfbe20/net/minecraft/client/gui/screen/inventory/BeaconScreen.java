...
public class BeaconScreen extends ContainerScreen<BeaconContainer> {
   ...
   private BeaconScreen.ConfirmButton field_147028_x;
   ...
   protected void init() {
      super.init();
      this.field_147028_x = this.addButton(new BeaconScreen.ConfirmButton(this.guiLeft + 164, this.guiTop + 107));
   ...
   public void tick() {
      super.tick();
      int i = this.field_147002_h.func_216969_e();
      ...
      this.field_147028_x.active = this.field_147002_h.func_216970_h() && this.field_214105_n != null;
   }
   ...
   class CancelButton extends BeaconScreen.SpriteButton {
      ...
      public void onPress() {
         BeaconScreen.this.minecraft.player.field_71174_a.sendPacket(new CCloseWindowPacket(BeaconScreen.this.minecraft.player.openContainer.windowId));
   ...
   class ConfirmButton extends BeaconScreen.SpriteButton {
      ...
      public void onPress() {
         BeaconScreen.this.minecraft.getConnection().sendPacket(new CUpdateBeaconPacket(Effect.getIdFromPotion(BeaconScreen.this.field_214105_n), Effect.getIdFromPotion(BeaconScreen.this.field_214106_o)));
         BeaconScreen.this.minecraft.player.field_71174_a.sendPacket(new CCloseWindowPacket(BeaconScreen.this.minecraft.player.openContainer.windowId));
         BeaconScreen.this.minecraft.displayGuiScreen((Screen)null);
      }
   ...
   class PowerButton extends BeaconScreen.Button {
      ...
      public PowerButton(int p_i50827_2_, int p_i50827_3_, Effect p_i50827_4_, boolean p_i50827_5_) {
         ...
         this.field_184066_p = p_i50827_4_;
         this.field_212946_c = Minecraft.getInstance().func_213248_ap().func_215288_a(p_i50827_4_);
      ...
      public void renderToolTip(int p_renderToolTip_1_, int p_renderToolTip_2_) {
         String s = I18n.format(this.field_184066_p.getName());
