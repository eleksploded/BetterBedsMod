...
public class CowModel<T extends Entity> extends QuadrupedModel<T> {
   public CowModel() {
      ...
      this.field_78150_a.addBox(-4.0F, -4.0F, -6.0F, 8, 8, 6, 0.0F);
      this.field_78150_a.setRotationPoint(0.0F, 4.0F, -8.0F);
      this.field_78150_a.setTextureOffset(22, 0).addBox(-5.0F, -5.0F, -4.0F, 1, 3, 1, 0.0F);
      this.field_78150_a.setTextureOffset(22, 0).addBox(4.0F, -5.0F, -4.0F, 1, 3, 1, 0.0F);
