   ...
   public boolean render(IEnviromentBlockReader reader, BlockPos pos, BufferBuilder bufferBuilderIn, IFluidState fluidStateIn) {
      ...
      if (!flag1 && !flag2 && !flag6 && !flag5 && !flag3 && !flag4) {
         ...
         if (flag1 && !func_209556_a(reader, pos, Direction.UP, Math.min(Math.min(f7, f8), Math.min(f9, f10)))) {
            ...
            f12 = MathHelper.func_219799_g(f44, f12, f39);
            f13 = MathHelper.func_219799_g(f44, f13, f39);
            f14 = MathHelper.func_219799_g(f44, f14, f39);
            f15 = MathHelper.func_219799_g(f44, f15, f39);
            f16 = MathHelper.func_219799_g(f44, f16, f41);
            f17 = MathHelper.func_219799_g(f44, f17, f41);
            f18 = MathHelper.func_219799_g(f44, f18, f41);
            f19 = MathHelper.func_219799_g(f44, f19, f41);
