...
public abstract class TexturedParticle extends Particle {
   ...
   public void renderParticle(BufferBuilder buffer, ActiveRenderInfo entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
      ...
      float f5 = (float)(MathHelper.func_219803_d((double)partialTicks, this.prevPosX, this.posX) - interpPosX);
      float f6 = (float)(MathHelper.func_219803_d((double)partialTicks, this.prevPosY, this.posY) - interpPosY);
      float f7 = (float)(MathHelper.func_219803_d((double)partialTicks, this.prevPosZ, this.posZ) - interpPosZ);
      ...
      if (this.particleAngle != 0.0F) {
         float f8 = MathHelper.func_219799_g(partialTicks, this.prevParticleAngle, this.particleAngle);
