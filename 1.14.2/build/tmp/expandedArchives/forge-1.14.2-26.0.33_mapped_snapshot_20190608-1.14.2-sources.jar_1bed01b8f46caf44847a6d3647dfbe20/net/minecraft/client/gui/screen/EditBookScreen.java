...
public class EditBookScreen extends Screen {
   ...
   public EditBookScreen(PlayerEntity p_i51100_1_, ItemStack p_i51100_2_, Hand p_i51100_3_) {
      ...
      this.field_214232_a = p_i51100_1_;
      this.field_214233_b = p_i51100_2_;
      this.field_214250_s = p_i51100_3_;
   ...
   private void func_214198_a(boolean p_214198_1_) {
      if (this.field_214234_c) {
         ...
         if (!this.field_214238_g.isEmpty()) {
            this.field_214233_b.setTagInfo("pages", listnbt);
         }
         ...
         this.minecraft.getConnection().sendPacket(new CEditBookPacket(this.field_214233_b, p_214198_1_, this.field_214250_s));
      }
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (this.field_214235_d) {
         ...
         String s2 = I18n.format("book.byAuthor", this.field_214232_a.getName().getString());
