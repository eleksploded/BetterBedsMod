...
public class GameRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   public void tick() {
      ...
      if (this.mc.field_71456_v.getBossOverlay().shouldDarkenSky()) {
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null) {
         if (this.mc.world != null) {
            ...
            double d0 = (double)this.mc.field_71442_b.getBlockReachDistance();
            ...
            float f = 1.0F;
            AxisAlignedBB axisalignedbb = entity.getBoundingBox().func_216361_a(vec3d1.scale(d0)).grow(1.0D, 1.0D, 1.0D);
   ...
   private double func_215311_a(ActiveRenderInfo p_215311_1_, float p_215311_2_, boolean p_215311_3_) {
      if (this.debugView) {
         ...
         if (p_215311_3_) {
            ...
            d0 = d0 * (double)MathHelper.func_219799_g(p_215311_2_, this.fovModifierHandPrev, this.fovModifierHand);
         }
   ...
   private void applyBobbing(float partialTicks) {
      if (this.mc.getRenderViewEntity() instanceof PlayerEntity) {
         ...
         float f2 = MathHelper.func_219799_g(partialTicks, playerentity.prevCameraYaw, playerentity.cameraYaw);
   ...
   private void setupCameraTransform(float partialTicks) {
      ...
      float f = MathHelper.func_219799_g(partialTicks, this.mc.player.prevTimeInPortal, this.mc.player.timeInPortal);
      if (f > 0.0F) {
         int i = 20;
         if (this.mc.player.isPotionActive(Effects.field_76431_k)) {
            i = 7;
         }
   ...
   private void func_215308_a(ActiveRenderInfo p_215308_1_, float p_215308_2_) {
      if (!this.debugView) {
         ...
         boolean flag = this.mc.getRenderViewEntity() instanceof LivingEntity && ((LivingEntity)this.mc.getRenderViewEntity()).isPlayerSleeping();
         if (!net.minecraftforge.client.ForgeHooksClient.renderFirstPersonHand(mc.worldRenderer, p_215308_2_))
         if (this.mc.gameSettings.thirdPersonView == 0 && !flag && !this.mc.gameSettings.hideGUI && this.mc.field_71442_b.getCurrentGameType() != GameType.SPECTATOR) {
            this.enableLightmap();
   ...
   public float getNightVisionBrightness(LivingEntity entitylivingbaseIn, float partialTicks) {
      int i = entitylivingbaseIn.getActivePotionEffect(Effects.field_76439_r).getDuration();
   ...
   public void updateCameraAndRender(float partialTicks, long nanoTime, boolean renderWorldIn) {
      ...
      if (!this.mc.skipRenderWorld) {
         ...
         if (renderWorldIn && this.mc.world != null) {
            ...
            if (!this.mc.gameSettings.hideGUI || this.mc.field_71462_r != null) {
               ...
               this.mc.field_71456_v.renderGameOverlay(partialTicks);
            }
         ...
         if (this.mc.field_213279_p != null) {
            ...
            try {
               this.mc.field_213279_p.render(i, j, this.mc.getTickLength());
               ...
               crashreportcategory.addDetail("Overlay name", () -> {
                  return this.mc.field_213279_p.getClass().getCanonicalName();
               });
            ...
            try {
               net.minecraftforge.client.ForgeHooksClient.drawScreen(this.mc.field_71462_r, i, j, this.mc.getTickLength());
               ...
               crashreportcategory1.addDetail("Screen name", () -> {
                  return this.mc.field_71462_r.getClass().getCanonicalName();
               });
   ...
   private boolean isDrawBlockOutline() {
      if (!this.drawBlockOutline) {
         ...
         if (flag && !((PlayerEntity)entity).playerAbilities.allowEdit) {
   ...
   private void updateCameraAndRender(float partialTicks, long nanoTime) {
      ...
      if (activerenderinfo.func_216785_c().y < 128.0D) {
      ...
      if (flag && this.mc.objectMouseOver != null) {
         ...
         worldrenderer.func_215325_a(activerenderinfo, this.mc.objectMouseOver, 0);
         GlStateManager.enableAlphaTest();
      }
   ...
   private void func_215313_a(ActiveRenderInfo p_215313_1_, WorldRenderer p_215313_2_, float p_215313_3_, double p_215313_4_, double p_215313_6_, double p_215313_8_) {
      if (this.mc.gameSettings.func_216842_e() != CloudOption.OFF) {
   ...
   private void addRainParticles() {
      ...
      if (f != 0.0F) {
         ...
         if (this.mc.gameSettings.field_74362_aa == ParticleStatus.DECREASED) {
            k >>= 1;
         } else if (this.mc.gameSettings.field_74362_aa == ParticleStatus.MINIMAL) {
            k = 0;
         }
         ...
         for(int l = 0; l < k; ++l) {
            ...
            if (blockpos1.getY() <= blockpos.getY() + 10 && blockpos1.getY() >= blockpos.getY() - 10 && biome.getPrecipitation() == Biome.RainType.RAIN && biome.getTemperature(blockpos1) >= 0.15F) {
               ...
               if (d5 > -Double.MAX_VALUE) {
                  if (!ifluidstate.isTagged(FluidTags.LAVA) && blockstate.getBlock() != Blocks.MAGMA_BLOCK && (blockstate.getBlock() != Blocks.field_222433_lV || !blockstate.get(CampfireBlock.LIT))) {
                     ++j;
   ...
   protected void renderRainSnow(float partialTicks) {
      ...
      if (!(f <= 0.0F)) {
         ...
         int i = MathHelper.floor(this.field_215317_L.func_216785_c().x);
         int j = MathHelper.floor(this.field_215317_L.func_216785_c().y);
         int k = MathHelper.floor(this.field_215317_L.func_216785_c().z);
         ...
         GlStateManager.blendFuncSeparate(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA, GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
         GlStateManager.alphaFunc(516, 0.1F);
         double d0 = this.field_215317_L.func_216785_c().x;
         double d1 = this.field_215317_L.func_216785_c().y;
         double d2 = this.field_215317_L.func_216785_c().z;
               ...
               if (biome.getPrecipitation() != Biome.RainType.NONE) {
                  ...
                  if (k2 != l2) {
                     ...
                     if (f2 >= 0.15F) {
                        ...
                        double d6 = (double)((float)l1 + 0.5F) - this.field_215317_L.func_216785_c().x;
                        double d7 = (double)((float)k1 + 0.5F) - this.field_215317_L.func_216785_c().z;
                        ...
                        double d11 = (double)((float)l1 + 0.5F) - this.field_215317_L.func_216785_c().x;
                        double d12 = (double)((float)k1 + 0.5F) - this.field_215317_L.func_216785_c().z;
   ...
   public static void func_215307_a(FontRenderer p_215307_0_, String p_215307_1_, float p_215307_2_, float p_215307_3_, float p_215307_4_, int p_215307_5_, float p_215307_6_, float p_215307_7_, boolean p_215307_8_) {
      GlStateManager.pushMatrix();
   ...
   public float getBossColorModifier(float partialTicks) {
      return MathHelper.func_219799_g(partialTicks, this.bossColorModifierPrev, this.bossColorModifier);
   }
