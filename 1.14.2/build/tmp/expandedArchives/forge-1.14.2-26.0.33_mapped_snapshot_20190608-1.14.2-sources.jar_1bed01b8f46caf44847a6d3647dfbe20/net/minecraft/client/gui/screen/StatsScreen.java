...
public class StatsScreen extends Screen implements IProgressMeter {
   ...
   private StatsScreen.CustomStatsList field_146550_h;
   private StatsScreen.StatsList field_146551_i;
   private StatsScreen.MobStatsList field_146547_s;
   ...
   public void initLists() {
      this.field_146550_h = new StatsScreen.CustomStatsList(this.minecraft);
      this.field_146551_i = new StatsScreen.StatsList(this.minecraft);
      this.field_146547_s = new StatsScreen.MobStatsList(this.minecraft);
   }
   ...
   public void func_213110_a(@Nullable ExtendedList<?> p_213110_1_) {
      ...
      if (p_213110_1_ != null) {
         ...
         this.field_146545_u = p_213110_1_;
      }
   ...
   class MobStatsList extends ExtendedList<StatsScreen.MobStatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.MobStatsList.Entry> {
         ...
         public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
            String s = I18n.format(Util.makeTranslationKey("entity", EntityType.getId(this.field_214411_b)));
   ...
   class StatsList extends ExtendedList<StatsScreen.StatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.StatsList.Entry> {
         ...
         public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
            Item item = StatsScreen.this.field_146551_i.field_195116_y.get(p_render_1_);
            StatsScreen.this.drawStatsScreen(p_render_3_ + 40, p_render_2_, item);

            for(int i = 0; i < StatsScreen.this.field_146551_i.field_195113_v.size(); ++i) {
               Stat<Block> stat;
               if (item instanceof BlockItem) {
                  stat = StatsScreen.this.field_146551_i.field_195113_v.get(i).get(((BlockItem)item).getBlock());
               } else {
                  stat = null;
               }
            ...
            for(int j = 0; j < StatsScreen.this.field_146551_i.field_195114_w.size(); ++j) {
               this.func_214406_a(StatsScreen.this.field_146551_i.field_195114_w.get(j).get(item), p_render_3_ + StatsScreen.this.func_195224_b(j + StatsScreen.this.field_146551_i.field_195113_v.size()), p_render_2_, p_render_1_ % 2 == 0);
            }
