...
public class CreeperModel<T extends Entity> extends EntityModel<T> {
   ...
   private final RendererModel field_78133_b;
   ...
   public CreeperModel(float p_i46366_1_) {
      ...
      this.field_78133_b.setRotationPoint(0.0F, 6.0F, 0.0F);
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      this.field_78135_a.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      this.field_78135_a.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
      this.field_78131_d.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F) * 1.4F * p_212844_3_;
      this.field_78132_e.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212844_3_;
      this.field_78129_f.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212844_3_;
      this.field_78130_g.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F) * 1.4F * p_212844_3_;
   }
}