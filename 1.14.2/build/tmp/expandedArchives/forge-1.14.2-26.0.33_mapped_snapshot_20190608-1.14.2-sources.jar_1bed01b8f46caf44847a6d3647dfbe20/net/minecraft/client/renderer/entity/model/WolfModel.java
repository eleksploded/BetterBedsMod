...
public class WolfModel<T extends WolfEntity> extends EntityModel<T> {
   ...
   public void func_212843_a_(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      if (p_212843_1_.isAngry()) {
         ...
         this.field_78180_g.rotateAngleY = MathHelper.cos(p_212843_2_ * 0.6662F) * 1.4F * p_212843_3_;
      }
      ...
      if (p_212843_1_.isSitting()) {
         ...
         this.field_78182_e.setRotationPoint(-2.5F, 16.0F, -4.0F);
         this.field_78179_f.setRotationPoint(0.5F, 16.0F, -4.0F);
         this.field_78184_c.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F) * 1.4F * p_212843_3_;
         this.field_78181_d.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
         this.field_78182_e.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
         this.field_78179_f.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F) * 1.4F * p_212843_3_;
      }

      this.field_78185_a.rotateAngleZ = p_212843_1_.getInterestedAngle(p_212843_4_) + p_212843_1_.getShakeAngle(p_212843_4_, 0.0F);
      this.field_78186_h.rotateAngleZ = p_212843_1_.getShakeAngle(p_212843_4_, -0.08F);
      this.field_78183_b.rotateAngleZ = p_212843_1_.getShakeAngle(p_212843_4_, -0.16F);
      this.field_78180_g.rotateAngleZ = p_212843_1_.getShakeAngle(p_212843_4_, -0.2F);
   }
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      ...
      this.field_78185_a.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
      this.field_78185_a.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      this.field_78180_g.rotateAngleX = p_212844_4_;
   }
}