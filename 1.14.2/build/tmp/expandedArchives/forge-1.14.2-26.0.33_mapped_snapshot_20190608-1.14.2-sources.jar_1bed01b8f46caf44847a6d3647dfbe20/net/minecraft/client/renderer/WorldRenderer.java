...
public class WorldRenderer implements AutoCloseable, IResourceManagerReloadListener {
   ...
   public void setWorldAndLoadRenderers(@Nullable ClientWorld worldClientIn) {
      ...
      this.field_175010_j.setWorld(worldClientIn);
   ...
   public void func_215326_a(ActiveRenderInfo p_215326_1_, ICamera p_215326_2_, float p_215326_3_) {
      if (this.renderEntitiesStartupCounter > 0) {
         ...
         double d0 = p_215326_1_.func_216785_c().x;
         double d1 = p_215326_1_.func_216785_c().y;
         double d2 = p_215326_1_.func_216785_c().z;
         ...
         this.field_175010_j.func_217781_a(this.world, this.mc.fontRenderer, p_215326_1_, this.mc.pointedEntity, this.mc.gameSettings);
         this.countEntitiesRendered = 0;
         this.countEntitiesHidden = 0;
         double d3 = p_215326_1_.func_216785_c().x;
         double d4 = p_215326_1_.func_216785_c().y;
         double d5 = p_215326_1_.func_216785_c().z;
         ...
         for(Entity entity : this.world.func_217416_b()) {
            if ((this.field_175010_j.shouldRender(entity, p_215326_2_, d0, d1, d2) || entity.isRidingOrBeingRiddenBy(this.mc.player)) && (entity != p_215326_1_.func_216773_g() || p_215326_1_.func_216770_i() || p_215326_1_.func_216773_g() instanceof LivingEntity && ((LivingEntity)p_215326_1_.func_216773_g()).isPlayerSleeping())) {
               ++this.countEntitiesRendered;
               this.field_175010_j.renderEntityStatic(entity, p_215326_3_, false);
               ...
               if (this.field_175010_j.isRenderMultipass(entity)) {
                  list1.add(entity);
               }
            }
         }
         ...
         if (!list1.isEmpty()) {
            for(Entity entity1 : list1) {
               this.field_175010_j.renderMultipass(entity1, p_215326_3_);
            }
         }
         ...
         if (this.isRenderEntityOutlines() && (!list.isEmpty() || this.entityOutlinesRendered)) {
            ...
            if (!list.isEmpty()) {
               ...
               for(int i = 0; i < list.size(); ++i) {
                  this.field_175010_j.renderEntityStatic(list.get(i), p_215326_3_, false);
               }
         ...
         for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
            List<TileEntity> list2 = worldrenderer$localrenderinformationcontainer.field_178036_a.getCompiledChunk().getTileEntities();
            if (!list2.isEmpty()) {
   ...
   protected int getRenderedChunks() {
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
         CompiledChunk compiledchunk = worldrenderer$localrenderinformationcontainer.field_178036_a.compiledChunk;
   ...
   public void func_215320_a(ActiveRenderInfo p_215320_1_, ICamera p_215320_2_, int p_215320_3_, boolean p_215320_4_) {
      ...
      this.field_174996_N.initialize(p_215320_1_.func_216785_c().x, p_215320_1_.func_216785_c().y, p_215320_1_.func_216785_c().z);
      this.renderDispatcher.func_217669_a(p_215320_1_.func_216785_c());
      ...
      BlockPos blockpos = new BlockPos(MathHelper.floor(p_215320_1_.func_216785_c().x / 16.0D) * 16, MathHelper.floor(p_215320_1_.func_216785_c().y / 16.0D) * 16, MathHelper.floor(p_215320_1_.func_216785_c().z / 16.0D) * 16);
      float f = p_215320_1_.func_216777_e();
      float f1 = p_215320_1_.func_216778_f();
      this.displayListEntitiesDirty = this.displayListEntitiesDirty || !this.chunksToUpdate.isEmpty() || p_215320_1_.func_216785_c().x != this.lastViewEntityX || p_215320_1_.func_216785_c().y != this.lastViewEntityY || p_215320_1_.func_216785_c().z != this.lastViewEntityZ || (double)f != this.lastViewEntityPitch || (double)f1 != this.lastViewEntityYaw;
      this.lastViewEntityX = p_215320_1_.func_216785_c().x;
      this.lastViewEntityY = p_215320_1_.func_216785_c().y;
      this.lastViewEntityZ = p_215320_1_.func_216785_c().z;
      ...
      if (!flag && this.displayListEntitiesDirty) {
         ...
         while(!queue.isEmpty()) {
            ...
            ChunkRender chunkrender3 = worldrenderer$localrenderinformationcontainer1.field_178036_a;
            Direction direction2 = worldrenderer$localrenderinformationcontainer1.field_178034_b;
      ...
      if (this.debugFixTerrainFrustum) {
         this.fixTerrainFrustum(p_215320_1_.func_216785_c().x, p_215320_1_.func_216785_c().y, p_215320_1_.func_216785_c().z);
      ...
      for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer2 : this.renderInfos) {
         ChunkRender chunkrender4 = worldrenderer$localrenderinformationcontainer2.field_178036_a;
   ...
   public int func_215323_a(BlockRenderLayer p_215323_1_, ActiveRenderInfo p_215323_2_) {
      RenderHelper.disableStandardItemLighting();
      if (p_215323_1_ == BlockRenderLayer.TRANSLUCENT) {
         this.mc.getProfiler().startSection("translucent_sort");
         double d0 = p_215323_2_.func_216785_c().x - this.prevRenderSortX;
         double d1 = p_215323_2_.func_216785_c().y - this.prevRenderSortY;
         double d2 = p_215323_2_.func_216785_c().z - this.prevRenderSortZ;
         if (d0 * d0 + d1 * d1 + d2 * d2 > 1.0D) {
            this.prevRenderSortX = p_215323_2_.func_216785_c().x;
            this.prevRenderSortY = p_215323_2_.func_216785_c().y;
            this.prevRenderSortZ = p_215323_2_.func_216785_c().z;
            int k = 0;

            for(WorldRenderer.LocalRenderInformationContainer worldrenderer$localrenderinformationcontainer : this.renderInfos) {
               if (worldrenderer$localrenderinformationcontainer.field_178036_a.compiledChunk.isLayerStarted(p_215323_1_) && k++ < 15) {
                  this.renderDispatcher.updateTransparencyLater(worldrenderer$localrenderinformationcontainer.field_178036_a);
               }
            }
         }
      ...
      for(int j = i1; j != i; j += j1) {
         ChunkRender chunkrender = (this.renderInfos.get(j)).field_178036_a;
         if (!chunkrender.getCompiledChunk().isLayerEmpty(p_215323_1_)) {
            ++l;
            this.field_174996_N.addRenderChunk(chunkrender, p_215323_1_);
         }
      }
   ...
   private void renderBlockLayer(BlockRenderLayer blockLayerIn) {
      ...
      this.field_174996_N.renderChunkLayer(blockLayerIn);
      if (GLX.useVbo()) {
   ...
   public void renderSky(float partialTicks) {
      ...
      if (this.mc.world.dimension.getType() == DimensionType.THE_END) {
         ...
         Vec3d vec3d = this.world.func_217382_a(this.mc.gameRenderer.func_215316_n().func_216780_d(), partialTicks);
...
//      if (net.minecraftforge.client.CloudRenderer.renderClouds(this.ticks, partialTicks, this.world, mc)) return;
      if (this.mc.world.dimension.isSurfaceWorld()) {
         ...
         if (i != this.cloudsCheckX || j != this.cloudsCheckY || k != this.cloudsCheckZ || this.mc.gameSettings.func_216842_e() != this.field_204800_W || this.cloudsCheckColor.squareDistanceTo(vec3d) > 2.0E-4D) {
            this.cloudsCheckX = i;
            this.cloudsCheckY = j;
            this.cloudsCheckZ = k;
            this.cloudsCheckColor = vec3d;
            this.field_204800_W = this.mc.gameSettings.func_216842_e();
            this.cloudsNeedUpdate = true;
         }
         ...
         if (this.vboEnabled && this.cloudsVBO != null) {
            ...
            int i1 = this.field_204800_W == CloudOption.FANCY ? 0 : 1;
            ...
            int l = this.field_204800_W == CloudOption.FANCY ? 0 : 1;
   ...
   public void func_215322_a(ActiveRenderInfo p_215322_1_, float p_215322_2_) {
      ...
      if (!(p_215322_1_.func_216785_c().x < worldborder.maxX() - d0) || !(p_215322_1_.func_216785_c().x > worldborder.minX() + d0) || !(p_215322_1_.func_216785_c().z < worldborder.maxZ() - d0) || !(p_215322_1_.func_216785_c().z > worldborder.minZ() + d0)) {
         double d1 = 1.0D - worldborder.getClosestDistance(p_215322_1_.func_216785_c().x, p_215322_1_.func_216785_c().z) / d0;
         d1 = Math.pow(d1, 4.0D);
         double d2 = p_215322_1_.func_216785_c().x;
         double d3 = p_215322_1_.func_216785_c().y;
         double d4 = p_215322_1_.func_216785_c().z;
         GlStateManager.enableBlend();
         GlStateManager.blendFuncSeparate(GlStateManager.SourceFactor.SRC_ALPHA, GlStateManager.DestFactor.ONE, GlStateManager.SourceFactor.ONE, GlStateManager.DestFactor.ZERO);
         this.textureManager.bindTexture(FORCEFIELD_TEXTURES);
         GlStateManager.depthMask(false);
   ...
   public void func_215318_a(Tessellator p_215318_1_, BufferBuilder p_215318_2_, ActiveRenderInfo p_215318_3_) {
      double d0 = p_215318_3_.func_216785_c().x;
      double d1 = p_215318_3_.func_216785_c().y;
      double d2 = p_215318_3_.func_216785_c().z;
   ...
   public void func_215325_a(ActiveRenderInfo p_215325_1_, RayTraceResult p_215325_2_, int p_215325_3_) {
      if (p_215325_3_ == 0 && p_215325_2_.getType() == RayTraceResult.Type.BLOCK) {
         ...
         if (!blockstate.isAir(this.world, blockpos) && this.world.getWorldBorder().contains(blockpos)) {
            ...
            double d0 = p_215325_1_.func_216785_c().x;
            double d1 = p_215325_1_.func_216785_c().y;
            double d2 = p_215325_1_.func_216785_c().z;
      ...
      for(int i = p_215324_1_.getZ() - 1; i <= p_215324_1_.getZ() + 1; ++i) {
         for(int j = p_215324_1_.getX() - 1; j <= p_215324_1_.getX() + 1; ++j) {
            for(int k = p_215324_1_.getY() - 1; k <= p_215324_1_.getY() + 1; ++k) {
               this.func_215319_a(j >> 4, k >> 4, i >> 4, p_215324_2_);
            }
         }
      }
   ...
   public void func_215321_a(int p_215321_1_, int p_215321_2_, int p_215321_3_) {
   ...
   public void func_215328_b(int p_215328_1_, int p_215328_2_, int p_215328_3_) {
      this.func_215319_a(p_215328_1_, p_215328_2_, p_215328_3_, false);
   }

   private void func_215319_a(int p_215319_1_, int p_215319_2_, int p_215319_3_, boolean p_215319_4_) {
   ...
   public void playRecord(@Nullable SoundEvent soundIn, BlockPos pos) {
      ...
      if (soundIn != null) {
         ...
         if (musicdiscitem != null) {
            this.mc.field_71456_v.setRecordPlayingMessage(musicdiscitem.getRecordDescription().getFormattedText());
         }
   ...
   public void addParticle(IParticleData particleData, boolean ignoreRange, boolean minimizeLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      try {
         ...
         crashreportcategory.addDetail("ID", Registry.field_212632_u.getKey(particleData.getType()));
   ...
   private Particle addParticleUnchecked(IParticleData particleData, boolean alwaysRender, boolean minimizeLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      ActiveRenderInfo activerenderinfo = this.mc.gameRenderer.func_215316_n();
      if (this.mc != null && activerenderinfo.func_216786_h() && this.mc.particles != null) {
         ...
         } else if (activerenderinfo.func_216785_c().squareDistanceTo(x, y, z) > 1024.0D) {
            return null;
         } else {
   ...
   private ParticleStatus func_215327_a(boolean p_215327_1_) {
      ParticleStatus particlestatus = this.mc.gameSettings.field_74362_aa;
   ...
   public void broadcastSound(int soundID, BlockPos pos, int data) {
      ...
      case 1038:
         ...
         if (activerenderinfo.func_216786_h()) {
            double d0 = (double)pos.getX() - activerenderinfo.func_216785_c().x;
            double d1 = (double)pos.getY() - activerenderinfo.func_216785_c().y;
            double d2 = (double)pos.getZ() - activerenderinfo.func_216785_c().z;
            double d3 = Math.sqrt(d0 * d0 + d1 * d1 + d2 * d2);
            double d4 = activerenderinfo.func_216785_c().x;
            double d5 = activerenderinfo.func_216785_c().y;
            double d6 = activerenderinfo.func_216785_c().z;
            if (d3 > 0.0D) {
               d4 += d0 / d3 * 2.0D;
               d5 += d1 / d3 * 2.0D;
               d6 += d2 / d3 * 2.0D;
   ...
   public void playEvent(PlayerEntity player, int type, BlockPos blockPosIn, int data) {
      ...
      case 1041:
         ...
         break;
      case 1042:
         this.world.playSound(blockPosIn, SoundEvents.field_219642_eu, SoundCategory.BLOCKS, 1.0F, this.world.rand.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1043:
         this.world.playSound(blockPosIn, SoundEvents.field_219617_ah, SoundCategory.BLOCKS, 1.0F, this.world.rand.nextFloat() * 0.1F + 0.9F, false);
         break;
      case 1500:
