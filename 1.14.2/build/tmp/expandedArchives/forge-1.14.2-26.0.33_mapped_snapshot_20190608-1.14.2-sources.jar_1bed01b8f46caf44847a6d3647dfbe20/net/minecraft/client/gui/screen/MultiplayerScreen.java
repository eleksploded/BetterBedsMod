...
public class MultiplayerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_146809_s = this.addButton(new Button(this.width / 2 - 154, this.height - 52, 100, 20, I18n.format("selectServer.select"), (p_214293_1_) -> {
      ...
      this.field_146810_r = this.addButton(new Button(this.width / 2 - 154, this.height - 28, 70, 20, I18n.format("selectServer.edit"), (p_214283_1_) -> {
      ...
      this.field_146808_t = this.addButton(new Button(this.width / 2 - 74, this.height - 28, 70, 20, I18n.format("selectServer.delete"), (p_214294_1_) -> {
         ServerSelectionList.Entry serverselectionlist$entry = this.field_146803_h.getSelected();
         if (serverselectionlist$entry instanceof ServerSelectionList.NormalEntry) {
   ...
   public void tick() {
      ...
      if (this.lanServerList.getWasUpdated()) {
         ...
         this.field_146803_h.updateNetworkServers(list);
      }
   ...
   private void refreshServerList() {
      this.minecraft.displayGuiScreen(new MultiplayerScreen(this.field_146798_g));
   }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         ...
         this.refreshServerList();
         return true;
      } else if (this.field_146803_h.getSelected() == null || p_keyPressed_1_ != 257 && p_keyPressed_1_ != 335) {
         return false;
      } else {
         this.connectToSelected();
         return true;
