...
public class MinecartRenderer<T extends AbstractMinecartEntity> extends EntityRenderer<T> {
   ...
   public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      double d0 = MathHelper.func_219803_d((double)partialTicks, entity.lastTickPosX, entity.posX);
      double d1 = MathHelper.func_219803_d((double)partialTicks, entity.lastTickPosY, entity.posY);
      double d2 = MathHelper.func_219803_d((double)partialTicks, entity.lastTickPosZ, entity.posZ);
      double d3 = (double)0.3F;
      Vec3d vec3d = entity.getPos(d0, d1, d2);
      float f3 = MathHelper.func_219799_g(partialTicks, entity.prevRotationPitch, entity.rotationPitch);
      if (vec3d != null) {
