...
public class ShareToLanScreen extends Screen {
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("lanServer.start"), (p_213082_1_) -> {
         ...
         this.minecraft.field_71456_v.getChatGUI().printChatMessage(itextcomponent);
      }));
      this.addButton(new Button(this.width / 2 + 5, this.height - 28, 150, 20, I18n.format("gui.cancel"), (p_213085_1_) -> {
         this.minecraft.displayGuiScreen(this.field_146598_a);
      }));
      this.field_146597_g = this.addButton(new Button(this.width / 2 - 155, 100, 150, 20, I18n.format("selectWorld.gameMode"), (p_213084_1_) -> {
      ...
      this.field_146596_f = this.addButton(new Button(this.width / 2 + 5, 100, 150, 20, I18n.format("selectWorld.allowCommands"), (p_213083_1_) -> {
   ...
   private void updateDisplayNames() {
      this.field_146597_g.setMessage(I18n.format("selectWorld.gameMode") + ": " + I18n.format("selectWorld.gameMode." + this.gameMode));
      this.field_146596_f.setMessage(I18n.format("selectWorld.allowCommands") + ' ' + I18n.format(this.allowCheats ? "options.on" : "options.off"));
   }
