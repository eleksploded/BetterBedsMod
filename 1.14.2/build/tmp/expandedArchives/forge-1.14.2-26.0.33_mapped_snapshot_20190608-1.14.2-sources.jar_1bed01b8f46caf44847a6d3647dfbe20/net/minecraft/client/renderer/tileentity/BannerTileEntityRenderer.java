...
public class BannerTileEntityRenderer extends TileEntityRenderer<BannerTileEntity> {
   private final BannerModel field_178465_e = new BannerModel();
   ...
   public void render(BannerTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      RendererModel renderermodel = this.field_178465_e.func_205057_b();
      long i;
      if (flag) {
         i = 0L;
      ...
      this.field_178465_e.func_205056_c().rotateAngleX = (-0.0125F + 0.01F * MathHelper.cos(f1 * (float)Math.PI * 0.02F)) * (float)Math.PI;
      ...
      if (resourcelocation != null) {
         ...
         this.field_178465_e.renderBanner();
