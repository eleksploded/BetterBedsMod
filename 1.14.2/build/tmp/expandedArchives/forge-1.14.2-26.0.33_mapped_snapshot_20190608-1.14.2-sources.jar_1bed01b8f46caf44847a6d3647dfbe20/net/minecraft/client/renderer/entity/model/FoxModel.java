...
public class FoxModel<T extends FoxEntity> extends EntityModel<T> {
   ...
   public void func_212843_a_(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      this.field_217121_j.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
      this.field_217122_k.rotateAngleX = MathHelper.cos(p_212843_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_212843_3_;
      ...
      this.field_217120_i.setRotationPoint(-5.0F, 17.5F, 7.0F);
      this.field_217121_j.setRotationPoint(-1.0F, 17.5F, 7.0F);
      if (p_212843_1_.func_213453_ef()) {
         this.field_217119_h.rotateAngleX = 1.6755161F;
         float f = p_212843_1_.func_213503_w(p_212843_4_);
         ...
         this.field_217115_a.rotateAngleY = 0.0F;
      } else if (p_212843_1_.isPlayerSleeping()) {
      ...
      } else if (p_212843_1_.func_213455_dW()) {
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      ...
      if (!p_212844_1_.isPlayerSleeping() && !p_212844_1_.func_213472_dX() && !p_212844_1_.func_213453_ef()) {
         this.field_217115_a.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
         this.field_217115_a.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      }

      if (p_212844_1_.isPlayerSleeping()) {
         this.field_217115_a.rotateAngleX = 0.0F;
         this.field_217115_a.rotateAngleY = -2.0943952F;
         this.field_217115_a.rotateAngleZ = MathHelper.cos(p_212844_4_ * 0.027F) / 22.0F;
      }

      if (p_212844_1_.func_213453_ef()) {
         float f = MathHelper.cos(p_212844_4_) * 0.01F;
