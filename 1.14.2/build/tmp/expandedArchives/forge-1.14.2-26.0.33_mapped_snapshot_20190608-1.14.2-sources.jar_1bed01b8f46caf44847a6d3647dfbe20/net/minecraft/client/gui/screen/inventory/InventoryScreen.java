...
public class InventoryScreen extends DisplayEffectsScreen<PlayerContainer> implements IRecipeShownListener {
   ...
   private final RecipeBookGui field_192045_A = new RecipeBookGui();
   ...
   protected void init() {
      if (this.minecraft.field_71442_b.isInCreativeMode()) {
         ...
         this.field_192045_A.func_201520_a(this.width, this.height, this.minecraft, this.widthTooNarrow, this.field_147002_h);
         this.field_212353_B = true;
         this.guiLeft = this.field_192045_A.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
         this.children.add(this.field_192045_A);
         this.func_212928_a(this.field_192045_A);
         this.addButton(new ImageButton(this.guiLeft + 104, this.height / 2 - 22, 20, 18, 0, 0, 19, RECIPE_BUTTON_TEXTURE, (p_214086_1_) -> {
            this.field_192045_A.func_201518_a(this.widthTooNarrow);
            this.field_192045_A.toggleVisibility();
            this.guiLeft = this.field_192045_A.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.hasActivePotionEffects = !this.field_192045_A.isVisible();
      if (this.field_192045_A.isVisible() && this.widthTooNarrow) {
         this.drawGuiContainerBackgroundLayer(p_render_3_, p_render_1_, p_render_2_);
         this.field_192045_A.render(p_render_1_, p_render_2_, p_render_3_);
      } else {
         this.field_192045_A.render(p_render_1_, p_render_2_, p_render_3_);
         super.render(p_render_1_, p_render_2_, p_render_3_);
         this.field_192045_A.renderGhostRecipe(this.guiLeft, this.guiTop, false, p_render_3_);
      }

      this.renderHoveredToolTip(p_render_1_, p_render_2_);
      this.field_192045_A.renderTooltip(this.guiLeft, this.guiTop, p_render_1_, p_render_2_);
      this.oldMouseX = (float)p_render_1_;
      this.oldMouseY = (float)p_render_2_;
      this.func_212932_b(this.field_192045_A);
   }
   ...
   protected boolean isPointInRegion(int p_195359_1_, int p_195359_2_, int p_195359_3_, int p_195359_4_, double p_195359_5_, double p_195359_7_) {
      return (!this.widthTooNarrow || !this.field_192045_A.isVisible()) && super.isPointInRegion(p_195359_1_, p_195359_2_, p_195359_3_, p_195359_4_, p_195359_5_, p_195359_7_);
   }
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (this.field_192045_A.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
         ...
         return this.widthTooNarrow && this.field_192045_A.isVisible() ? false : super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
      }
   }
   ...
   protected boolean hasClickedOutside(double p_195361_1_, double p_195361_3_, int p_195361_5_, int p_195361_6_, int p_195361_7_) {
      ...
      return this.field_192045_A.func_195604_a(p_195361_1_, p_195361_3_, this.guiLeft, this.guiTop, this.xSize, this.ySize, p_195361_7_) && flag;
   }
   ...
   protected void handleMouseClick(Slot slotIn, int slotId, int mouseButton, ClickType type) {
      ...
      this.field_192045_A.slotClicked(slotIn);
   }

   public void recipesUpdated() {
      this.field_192045_A.recipesUpdated();
   }

   public void removed() {
      if (this.field_212353_B) {
         this.field_192045_A.removed();
      }
