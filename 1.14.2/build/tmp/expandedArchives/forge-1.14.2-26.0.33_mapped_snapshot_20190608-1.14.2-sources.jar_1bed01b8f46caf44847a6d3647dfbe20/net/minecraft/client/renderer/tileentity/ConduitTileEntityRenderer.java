...
public class ConduitTileEntityRenderer extends TileEntityRenderer<ConduitTileEntity> {
   ...
   private final ConduitTileEntityRenderer.ShellModel field_205122_g = new ConduitTileEntityRenderer.ShellModel();
   private final ConduitTileEntityRenderer.CageModel field_205123_h = new ConduitTileEntityRenderer.CageModel();
   private final ConduitTileEntityRenderer.WindModel field_205124_i = new ConduitTileEntityRenderer.WindModel();
   private final ConduitTileEntityRenderer.EyeModel field_207748_l = new ConduitTileEntityRenderer.EyeModel();
   ...
   public void render(ConduitTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      if (!tileEntityIn.isActive()) {
         ...
         ActiveRenderInfo activerenderinfo = this.rendererDispatcher.field_217666_g;
