...
public final class MainWindow implements AutoCloseable {
   ...
   private final IWindowEventListener field_198116_c;
   ...
   public MainWindow(IWindowEventListener p_i51170_1_, MonitorHandler p_i51170_2_, ScreenSize p_i51170_3_, String p_i51170_4_, String p_i51170_5_) {
      ...
      this.field_198116_c = p_i51170_1_;
      Optional<VideoMode> optional = VideoMode.parseFromSettings(p_i51170_4_);
      if (optional.isPresent()) {
         this.videoMode = optional;
      } else if (p_i51170_3_.field_216496_c.isPresent() && p_i51170_3_.field_216497_d.isPresent()) {
         this.videoMode = Optional.of(new VideoMode(p_i51170_3_.field_216496_c.get(), p_i51170_3_.field_216497_d.get(), 8, 8, 8, 60));
      } else {
         this.videoMode = Optional.empty();
      }

      this.lastFullscreen = this.fullscreen = p_i51170_3_.field_216498_e;
      ...
      this.prevWindowWidth = this.width = p_i51170_3_.field_216494_a > 0 ? p_i51170_3_.field_216494_a : 1;
      this.prevWindowHeight = this.height = p_i51170_3_.field_216495_b > 0 ? p_i51170_3_.field_216495_b : 1;
   ...
   public void func_216523_b(boolean p_216523_1_) {
      this.field_216530_A = p_216523_1_;
   ...
   private void setMonitorFromVirtualScreen() {
      ...
      this.monitor = this.field_216531_d.func_216515_a(this);
      AbstractOption.field_216702_i.func_216728_a((float)this.monitor.getVideoModeCount());
   }
      ...
      if (windowPointer == this.handle) {
         ...
         if (framebufferWidth != 0 && framebufferHeight != 0) {
            ...
            if (this.getFramebufferWidth() != i || this.getFramebufferHeight() != j) {
               this.field_198116_c.func_213226_a();
            }
   ...
   private void onWindowFocusUpdate(long windowPointer, boolean hasFocus) {
      if (windowPointer == this.handle) {
         this.field_198116_c.func_213228_a(hasFocus);
      }
   ...
   private void func_216527_d(boolean p_216527_1_) {
      try {
         this.updateVideoMode();
         this.field_198116_c.func_213226_a();
         this.func_216523_b(p_216527_1_);
         this.field_198116_c.func_213227_b(false);
