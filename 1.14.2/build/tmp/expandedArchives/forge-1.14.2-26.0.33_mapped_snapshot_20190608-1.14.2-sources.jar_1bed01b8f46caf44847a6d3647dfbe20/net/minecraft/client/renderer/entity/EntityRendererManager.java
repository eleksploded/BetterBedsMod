...
public class EntityRendererManager {
   ...
   private <T extends Entity> void func_217782_a(Class<T> p_217782_1_, EntityRenderer<? super T> p_217782_2_) {
   ...
   public <T extends Entity, U extends EntityRenderer<T>> U getEntityRenderObject(T entityIn) {
      if (entityIn instanceof AbstractClientPlayerEntity) {
         ...
         return (U)(playerrenderer != null ? playerrenderer : this.field_178637_m);
      } else {
   ...
   public void func_217781_a(World p_217781_1_, FontRenderer p_217781_2_, ActiveRenderInfo p_217781_3_, Entity p_217781_4_, GameSettings p_217781_5_) {
      ...
      this.field_217783_c = p_217781_3_;
      this.pointedEntity = p_217781_4_;
      this.textRenderer = p_217781_2_;
      if (p_217781_3_.func_216773_g() instanceof LivingEntity && ((LivingEntity)p_217781_3_.func_216773_g()).isPlayerSleeping()) {
         ...
         this.playerViewY = p_217781_3_.func_216778_f();
         this.playerViewX = p_217781_3_.func_216777_e();
      }
   ...
   public void renderEntityStatic(Entity entityIn, float partialTicks, boolean p_188388_3_) {
      ...
      double d0 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosX, entityIn.posX);
      double d1 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosY, entityIn.posY);
      double d2 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosZ, entityIn.posZ);
      float f = MathHelper.func_219799_g(partialTicks, entityIn.prevRotationYaw, entityIn.rotationYaw);
   ...
   public double getDistanceToCamera(double x, double y, double z) {
      return this.field_217783_c.func_216785_c().squareDistanceTo(x, y, z);
   }
