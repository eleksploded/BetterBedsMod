...
public class LanguageScreen extends Screen {
   protected final Screen field_146453_a;
   ...
   protected void init() {
      this.field_146450_f = new LanguageScreen.List(this.minecraft);
      this.children.add(this.field_146450_f);
      this.field_211832_i = this.addButton(new OptionButton(this.width / 2 - 155, this.height - 38, 150, 20, AbstractOption.field_216684_H, AbstractOption.field_216684_H.func_216743_c(this.game_settings_3), (p_213037_1_) -> {
         AbstractOption.field_216684_H.func_216740_a(this.game_settings_3);
         this.game_settings_3.saveOptions();
         p_213037_1_.setMessage(AbstractOption.field_216684_H.func_216743_c(this.game_settings_3));
         this.minecraft.func_213226_a();
      }));
      this.field_146452_r = this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 38, 150, 20, I18n.format("gui.done"), (p_213036_1_) -> {
         LanguageScreen.List.LanguageEntry languagescreen$list$languageentry = this.field_146450_f.getSelected();
         if (languagescreen$list$languageentry != null && !languagescreen$list$languageentry.field_214398_b.getCode().equals(this.languageManager.getCurrentLanguage().getCode())) {
            ...
            this.field_146452_r.setMessage(I18n.format("gui.done"));
            this.field_211832_i.setMessage(AbstractOption.field_216684_H.func_216743_c(this.game_settings_3));
            this.game_settings_3.saveOptions();
         }

         this.minecraft.displayGuiScreen(this.field_146453_a);
      }));
      super.init();
   }
