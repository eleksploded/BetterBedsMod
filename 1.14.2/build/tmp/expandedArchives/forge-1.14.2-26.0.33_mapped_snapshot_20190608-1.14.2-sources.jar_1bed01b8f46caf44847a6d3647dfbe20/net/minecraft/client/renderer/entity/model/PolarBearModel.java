...
public class PolarBearModel<T extends PolarBearEntity> extends QuadrupedModel<T> {
   public PolarBearModel() {
      ...
      this.field_78150_a.addBox(-3.5F, -3.0F, -3.0F, 7, 7, 7, 0.0F);
      this.field_78150_a.setRotationPoint(0.0F, 10.0F, -16.0F);
      this.field_78150_a.setTextureOffset(0, 44).addBox(-2.5F, 1.0F, -6.0F, 5, 3, 3, 0.0F);
      this.field_78150_a.setTextureOffset(26, 0).addBox(-4.5F, -4.0F, -1.0F, 2, 2, 1, 0.0F);
      RendererModel renderermodel = this.field_78150_a.setTextureOffset(26, 0);
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      ...
      float f1 = p_212844_1_.getStandingAnimationScale(f);
      f1 = f1 * f1;
      float f2 = 1.0F - f1;
      ...
      if (this.field_217114_e) {
         this.field_78150_a.rotationPointY = 10.0F * f2 - 9.0F * f1;
         this.field_78150_a.rotationPointZ = -16.0F * f2 - 7.0F * f1;
      } else {
         this.field_78150_a.rotationPointY = 10.0F * f2 - 14.0F * f1;
         this.field_78150_a.rotationPointZ = -16.0F * f2 - 3.0F * f1;
      }

      this.field_78150_a.rotateAngleX += f1 * (float)Math.PI * 0.15F;
   }
}