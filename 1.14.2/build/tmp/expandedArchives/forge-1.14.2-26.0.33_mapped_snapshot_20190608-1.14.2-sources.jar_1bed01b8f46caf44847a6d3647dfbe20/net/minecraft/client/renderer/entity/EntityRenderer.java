...
public abstract class EntityRenderer<T extends Entity> {
   ...
   public void bindTexture(ResourceLocation location) {
      this.field_76990_c.textureManager.bindTexture(location);
   }
   ...
   private void renderShadow(Entity entityIn, double x, double y, double z, float shadowAlpha, float partialTicks) {
      ...
      this.field_76990_c.textureManager.bindTexture(SHADOW_TEXTURES);
      ...
      double d5 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosX, entityIn.posX);
      double d0 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosY, entityIn.posY);
      double d1 = MathHelper.func_219803_d((double)partialTicks, entityIn.lastTickPosZ, entityIn.posZ);
   ...
   private IWorldReader getWorldFromRenderManager() {
      return this.field_76990_c.world;
   }
   ...
   public void doRenderShadowAndFire(Entity entityIn, double x, double y, double z, float yaw, float partialTicks) {
      if (this.field_76990_c.options != null) {
         if (this.field_76990_c.options.entityShadows && this.shadowSize > 0.0F && !entityIn.isInvisible() && this.field_76990_c.isRenderShadow()) {
            double d0 = this.field_76990_c.getDistanceToCamera(entityIn.posX, entityIn.posY, entityIn.posZ);
   ...
   public FontRenderer getFontRendererFromRenderManager() {
      return this.field_76990_c.getFontRenderer();
   }
   ...
   protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance) {
      double d0 = entityIn.getDistanceSq(this.field_76990_c.field_217783_c.func_216785_c());
      if (!(d0 > (double)(maxDistance * maxDistance))) {
         ...
         GameRenderer.func_215307_a(this.getFontRendererFromRenderManager(), str, (float)x, (float)y + f2, (float)z, i, f, f1, flag);
      }
   }
