...
public class ItemRenderer extends EntityRenderer<ItemEntity> {
   ...
   private int transformModelCount(ItemEntity itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
      ...
      if (item == null) {
         ...
         if (flag || this.field_76990_c.options != null) {
   ...
   public void doRender(ItemEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (this.bindEntityTexture(entity)) {
         this.field_76990_c.textureManager.getTexture(this.getEntityTexture(entity)).setBlurMipmap(false, false);
         flag = true;
      }
      ...
      if (flag) {
         this.field_76990_c.textureManager.getTexture(this.getEntityTexture(entity)).restoreLastBlurMipmap();
      }
