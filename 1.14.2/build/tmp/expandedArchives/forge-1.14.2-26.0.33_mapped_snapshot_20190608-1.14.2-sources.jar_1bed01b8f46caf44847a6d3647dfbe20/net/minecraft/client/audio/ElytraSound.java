...
public class ElytraSound extends TickableSound {
   ...
   public void tick() {
      ++this.time;
      if (!this.field_189405_m.removed && (this.time <= 20 || this.field_189405_m.isElytraFlying())) {
         this.x = (float)this.field_189405_m.posX;
         this.y = (float)this.field_189405_m.posY;
         this.z = (float)this.field_189405_m.posZ;
         float f = (float)this.field_189405_m.getMotion().lengthSquared();
         if ((double)f >= 1.0E-7D) {
