...
public class VertexFormatElement {
   ...
   private final VertexFormatElement.Type field_177379_b;
   private final VertexFormatElement.Usage field_177380_c;
   ...
   public VertexFormatElement(int indexIn, VertexFormatElement.Type typeIn, VertexFormatElement.Usage usageIn, int count) {
      if (this.isFirstOrUV(indexIn, usageIn)) {
         ...
         this.field_177380_c = VertexFormatElement.Usage.UV;
      }
   ...
   public String toString() {
      return this.elementCount + "," + this.field_177380_c.getDisplayName() + "," + this.field_177379_b.getDisplayName();
   }

   public final int getSize() {
      return this.field_177379_b.getSize() * this.elementCount;
   }

   public final boolean isPositionElement() {
      return this.field_177380_c == VertexFormatElement.Usage.POSITION;
   }
