...
public class EntityAIDebugRenderer implements DebugRenderer.IDebugRenderer {
   private final Minecraft field_217684_a;
   ...
   public EntityAIDebugRenderer(Minecraft p_i50977_1_) {
      this.field_217684_a = p_i50977_1_;
   }

   public void func_217676_a(long p_217676_1_) {
      ActiveRenderInfo activerenderinfo = this.field_217684_a.gameRenderer.func_215316_n();
      ...
      this.field_217685_b.forEach((p_217683_1_, p_217683_2_) -> {
         for(int i = 0; i < p_217683_2_.size(); ++i) {
            ...
            if (blockpos.func_218141_a(entityaidebugrenderer$entry.field_217723_a, 160.0D)) {
