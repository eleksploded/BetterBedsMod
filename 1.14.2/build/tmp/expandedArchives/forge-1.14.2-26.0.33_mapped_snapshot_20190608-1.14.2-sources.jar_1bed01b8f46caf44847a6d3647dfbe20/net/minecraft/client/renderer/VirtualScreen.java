...
public final class VirtualScreen implements AutoCloseable {
   ...
   public VirtualScreen(Minecraft mcIn) {
      this.mc = mcIn;
      this.field_217627_b = new MonitorHandler(this::func_217625_a);
   }

   public Monitor func_217625_a(long p_217625_1_) {
      Monitor monitor = new Monitor(this.field_217627_b, p_217625_1_);
      AbstractOption.field_216702_i.func_216728_a((float)monitor.getVideoModeCount());
      return monitor;
   }

   public MainWindow func_217626_a(ScreenSize p_217626_1_, String p_217626_2_, String p_217626_3_) {
