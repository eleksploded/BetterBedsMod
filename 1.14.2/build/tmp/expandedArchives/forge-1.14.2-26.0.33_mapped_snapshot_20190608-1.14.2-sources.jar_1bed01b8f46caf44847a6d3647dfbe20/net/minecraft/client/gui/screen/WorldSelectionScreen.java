...
public class WorldSelectionScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_184866_u = new WorldSelectionList(this, this.minecraft, this.width, this.height, 48, this.height - 64, 36, () -> {
         return this.field_212352_g.getText();
      }, this.field_184866_u);
      this.children.add(this.field_212352_g);
      this.children.add(this.field_184866_u);
      this.field_146641_z = this.addButton(new Button(this.width / 2 - 154, this.height - 52, 150, 20, I18n.format("selectWorld.select"), (p_214325_1_) -> {
         this.field_184866_u.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214438_a);
      }));
      ...
      this.field_146630_A = this.addButton(new Button(this.width / 2 - 154, this.height - 28, 72, 20, I18n.format("selectWorld.edit"), (p_214323_1_) -> {
         this.field_184866_u.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214444_c);
      }));
      this.field_146642_y = this.addButton(new Button(this.width / 2 - 76, this.height - 28, 72, 20, I18n.format("selectWorld.delete"), (p_214330_1_) -> {
         this.field_184866_u.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214442_b);
      }));
      this.field_184865_t = this.addButton(new Button(this.width / 2 + 4, this.height - 28, 72, 20, I18n.format("selectWorld.recreate"), (p_214328_1_) -> {
         this.field_184866_u.func_214376_a().ifPresent(WorldSelectionList.Entry::func_214445_d);
      }));
      this.addButton(new Button(this.width / 2 + 82, this.height - 28, 72, 20, I18n.format("gui.cancel"), (p_214327_1_) -> {
         this.minecraft.displayGuiScreen(this.field_184864_a);
      }));
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_184866_u.render(p_render_1_, p_render_2_, p_render_3_);
   ...
   public void func_214324_a(boolean p_214324_1_) {
      this.field_146641_z.active = p_214324_1_;
      this.field_146642_y.active = p_214324_1_;
      this.field_146630_A.active = p_214324_1_;
      this.field_184865_t.active = p_214324_1_;
   }

   public void removed() {
      if (this.field_184866_u != null) {
         this.field_184866_u.children().forEach(WorldSelectionList.Entry::close);
      }
