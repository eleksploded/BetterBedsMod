...
public class ParrotRenderer extends MobRenderer<ParrotEntity, ParrotModel> {
   ...
   public float handleRotationFloat(ParrotEntity livingBase, float partialTicks) {
      float f = MathHelper.func_219799_g(partialTicks, livingBase.oFlap, livingBase.flap);
      float f1 = MathHelper.func_219799_g(partialTicks, livingBase.oFlapSpeed, livingBase.flapSpeed);
