...
public class SpinAttackEffectLayer<T extends LivingEntity> extends LayerRenderer<T, PlayerModel<T>> {
   ...
   private final SpinAttackEffectLayer.Model field_204838_c = new SpinAttackEffectLayer.Model();
   ...
   public void func_212842_a_(T p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      if (p_212842_1_.isSpinAttacking()) {
         GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
         this.func_215333_a(field_204836_a);
         ...
         for(int i = 0; i < 3; ++i) {
            ...
            this.field_204838_c.func_217110_a(p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
