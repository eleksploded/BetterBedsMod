...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public PointOfInterestDebugRenderer(Minecraft p_i50976_1_) {
      this.field_217712_b = p_i50976_1_;
   }
   ...
   public void func_217706_a(BlockPos p_217706_1_, int p_217706_2_) {
      ...
      if (pointofinterestdebugrenderer$poiinfo == null) {
         field_217711_a.warn("Strange, setFreeTicketCount was called for an unknown POI: " + p_217706_1_);
      } else {
   ...
   public void func_217676_a(long p_217676_1_) {
      ...
      if (!this.field_217712_b.player.isSpectator()) {
         this.func_217710_d();
      }
   ...
   private void func_217708_b() {
      ...
      this.field_217714_d.forEach((p_222924_1_) -> {
         if (blockpos.func_218141_a(p_222924_1_.getCenter(), 60.0D)) {
   ...
   private ActiveRenderInfo func_217709_c() {
      return this.field_217712_b.gameRenderer.func_215316_n();
   }
   ...
   private boolean func_217694_d(PointOfInterestDebugRenderer.BrainInfo p_217694_1_) {
      PlayerEntity playerentity = this.field_217712_b.player;
      ...
      return blockpos.func_218141_a(blockpos1, 30.0D);
   }
   ...
   private void func_217710_d() {
      DebugRenderer.func_217728_a(this.field_217712_b.getRenderViewEntity(), 8).ifPresent((p_217707_1_) -> {
