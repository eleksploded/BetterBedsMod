...
public class ClientChunkProvider extends AbstractChunkProvider {
   ...
   public Chunk func_217250_a(World p_217250_1_, int p_217250_2_, int p_217250_3_, PacketBuffer p_217250_4_, CompoundNBT p_217250_5_, int p_217250_6_, boolean p_217250_7_) {
      if (!this.array.inView(p_217250_2_, p_217250_3_)) {
         ...
         for(int j = 0; j < achunksection.length; ++j) {
            ...
            worldlightmanager.func_215566_a(SectionPos.of(p_217250_2_, j, p_217250_3_), ChunkSection.isEmpty(chunksection));
         }
   ...
   public void func_217201_a(LightType p_217201_1_, SectionPos p_217201_2_) {
      Minecraft.getInstance().worldRenderer.func_215328_b(p_217201_2_.func_218149_a(), p_217201_2_.func_218163_b(), p_217201_2_.func_218148_c());
   }
   ...
   public boolean func_217204_a(Entity p_217204_1_) {
      return this.chunkExists(MathHelper.floor(p_217204_1_.posX) >> 4, MathHelper.floor(p_217204_1_.posZ) >> 4);
   }
