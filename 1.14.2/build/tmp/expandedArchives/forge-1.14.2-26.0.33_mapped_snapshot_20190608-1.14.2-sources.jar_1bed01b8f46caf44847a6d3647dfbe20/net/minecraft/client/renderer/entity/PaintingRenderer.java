...
public class PaintingRenderer extends EntityRenderer<PaintingEntity> {
   ...
   public void doRender(PaintingEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      PaintingSpriteUploader paintingspriteuploader = Minecraft.getInstance().func_213263_ao();
      this.func_217762_a(entity, paintingtype.getWidth(), paintingtype.getHeight(), paintingspriteuploader.func_215285_a(paintingtype), paintingspriteuploader.func_215286_b());
      if (this.renderOutlines) {
   ...
   private void setLightmap(PaintingEntity painting, float p_77008_2_, float p_77008_3_) {
      ...
      Direction direction = painting.field_174860_b;
      ...
      int l = this.field_76990_c.world.getCombinedLight(new BlockPos(i, j, k), 0);
      int i1 = l % 65536;
      int j1 = l / 65536;
