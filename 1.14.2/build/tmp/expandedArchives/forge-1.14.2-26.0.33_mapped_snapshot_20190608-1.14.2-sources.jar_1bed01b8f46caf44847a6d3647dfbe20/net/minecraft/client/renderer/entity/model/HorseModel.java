...
public class HorseModel<T extends AbstractHorseEntity> extends EntityModel<T> {
   ...
   public void render(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      float f = entityIn.func_213355_cm();
   ...
   public void func_212843_a_(T p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      ...
      float f = this.func_217126_a(p_212843_1_.prevRenderYawOffset, p_212843_1_.renderYawOffset, p_212843_4_);
      float f1 = this.func_217126_a(p_212843_1_.prevRotationYawHead, p_212843_1_.rotationYawHead, p_212843_4_);
      float f2 = MathHelper.func_219799_g(p_212843_4_, p_212843_1_.prevRotationPitch, p_212843_1_.rotationPitch);
      float f3 = f1 - f;
      ...
      float f9 = (float)p_212843_1_.ticksExisted + p_212843_4_;
      ...
      this.field_217129_f.rotateAngleX = f14 - f11 * 0.5F * p_212843_3_ * f7;
      this.field_217130_g.rotateAngleX = f14 + f11 * 0.5F * p_212843_3_ * f7;
      this.field_217131_h.rotateAngleX = f16;
      this.field_217132_i.rotateAngleX = f17;
      this.field_217133_j.rotateAngleX = ((float)Math.PI / 6F) + p_212843_3_ * 0.75F;
