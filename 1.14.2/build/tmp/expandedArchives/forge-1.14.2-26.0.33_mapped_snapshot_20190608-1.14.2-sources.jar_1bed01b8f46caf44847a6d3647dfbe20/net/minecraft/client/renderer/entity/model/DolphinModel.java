...
public class DolphinModel<T extends Entity> extends EntityModel<T> {
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      this.field_205082_b.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
      this.field_205082_b.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      if (Entity.func_213296_b(p_212844_1_.getMotion()) > 1.0E-7D) {
         this.field_205082_b.rotateAngleX += -0.05F + -0.05F * MathHelper.cos(p_212844_4_ * 0.3F);
         this.field_205083_c.rotateAngleX = -0.1F * MathHelper.cos(p_212844_4_ * 0.3F);
         this.field_205084_d.rotateAngleX = -0.2F * MathHelper.cos(p_212844_4_ * 0.3F);
      }
