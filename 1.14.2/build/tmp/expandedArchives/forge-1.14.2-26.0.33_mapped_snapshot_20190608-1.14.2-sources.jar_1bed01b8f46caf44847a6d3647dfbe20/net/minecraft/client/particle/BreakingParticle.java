...
public class BreakingParticle extends SpriteTexturedParticle {
   ...
   protected BreakingParticle(World p_i47645_1_, double p_i47645_2_, double p_i47645_4_, double p_i47645_6_, ItemStack p_i47645_8_) {
      ...
      this.func_217567_a(Minecraft.getInstance().getItemRenderer().getModelWithOverrides(p_i47645_8_, p_i47645_1_, (LivingEntity)null).getParticleTexture());
   ...
   protected float func_217563_c() {
      return this.field_217569_E.getInterpolatedU((double)((this.field_217571_C + 1.0F) / 4.0F * 16.0F));
   }

   protected float func_217564_d() {
      return this.field_217569_E.getInterpolatedU((double)(this.field_217571_C / 4.0F * 16.0F));
   }

   protected float func_217562_e() {
      return this.field_217569_E.getInterpolatedV((double)(this.field_217572_F / 4.0F * 16.0F));
   }

   protected float func_217560_f() {
      return this.field_217569_E.getInterpolatedV((double)((this.field_217572_F + 1.0F) / 4.0F * 16.0F));
   }
