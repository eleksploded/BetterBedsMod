...
public class DebugRenderer {
   public final PathfindingDebugRenderer field_188286_a;
   ...
   public DebugRenderer(Minecraft clientIn) {
      this.field_188286_a = new PathfindingDebugRenderer(clientIn);
      ...
      this.field_201747_g = new CaveDebugRenderer(clientIn);
      this.field_201748_h = new StructureDebugRenderer(clientIn);
   ...
   public void renderDebug(long partialTicks) {
      if (this.pathfindingEnabled) {
         this.field_188286_a.func_217676_a(partialTicks);
      }

      if (this.chunkBorderEnabled && !Minecraft.getInstance().isReducedDebug()) {
         this.chunkBorder.func_217676_a(partialTicks);
      }

      if (this.waterEnabled) {
         this.water.func_217676_a(partialTicks);
      }

      if (this.heightMapEnabled) {
         this.heightMap.func_217676_a(partialTicks);
      }

      if (this.collisionBoxEnabled) {
         this.collisionBox.func_217676_a(partialTicks);
      }

      if (this.neighborsUpdateEnabled) {
         this.neighborsUpdate.func_217676_a(partialTicks);
      }

      if (this.caveEnabled) {
         this.field_201747_g.func_217676_a(partialTicks);
      }

      if (this.structureEnabled) {
         this.field_201748_h.func_217676_a(partialTicks);
      }

      if (this.lightEnabled) {
         this.light.func_217676_a(partialTicks);
      }

      if (this.worldGenAttemptsEnabled) {
         this.worldGenAttempts.func_217676_a(partialTicks);
      }

      if (this.solidFaceEnabled) {
         this.solidFace.func_217676_a(partialTicks);
      }

      if (this.field_217739_A) {
         this.field_217742_n.func_217676_a(partialTicks);
      }
   ...
   public static Optional<Entity> func_217728_a(@Nullable Entity p_217728_0_, int p_217728_1_) {
      if (p_217728_0_ == null) {
         ...
         AxisAlignedBB axisalignedbb = p_217728_0_.getBoundingBox().func_216361_a(vec3d1).grow(1.0D);
   ...
   public static void func_217735_a(BlockPos p_217735_0_, BlockPos p_217735_1_, float p_217735_2_, float p_217735_3_, float p_217735_4_, float p_217735_5_) {
      ...
      if (activerenderinfo.func_216786_h()) {
         Vec3d vec3d = activerenderinfo.func_216785_c().func_216371_e();
   ...
   public static void func_217734_a(String p_217734_0_, double p_217734_1_, double p_217734_3_, double p_217734_5_, int p_217734_7_, float p_217734_8_, boolean p_217734_9_, float p_217734_10_, boolean p_217734_11_) {
      ...
      ActiveRenderInfo activerenderinfo = minecraft.gameRenderer.func_215316_n();
   ...
   public interface IDebugRenderer {
      void func_217676_a(long p_217676_1_);
