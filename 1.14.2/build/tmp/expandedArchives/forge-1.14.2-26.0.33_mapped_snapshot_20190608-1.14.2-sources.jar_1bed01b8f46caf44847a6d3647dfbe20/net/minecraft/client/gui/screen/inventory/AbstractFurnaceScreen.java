...
public abstract class AbstractFurnaceScreen<T extends AbstractFurnaceContainer> extends ContainerScreen<T> implements IRecipeShownListener {
   ...
   public void init() {
      ...
      this.field_214088_k.func_201520_a(this.width, this.height, this.minecraft, this.field_214090_m, this.field_147002_h);
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      if (((AbstractFurnaceContainer)this.field_147002_h).func_217061_l()) {
         int k = ((AbstractFurnaceContainer)this.field_147002_h).func_217059_k();
         this.blit(i + 56, j + 36 + 12 - k, 176, 12 - k, 14, k + 1);
      }

      int l = ((AbstractFurnaceContainer)this.field_147002_h).func_217060_j();
