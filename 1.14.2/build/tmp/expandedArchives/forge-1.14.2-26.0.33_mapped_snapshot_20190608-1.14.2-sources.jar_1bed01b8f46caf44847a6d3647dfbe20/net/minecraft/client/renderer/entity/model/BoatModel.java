...
public class BoatModel extends EntityModel<BoatEntity> {
   ...
   private final RendererModel[] field_187057_b = new RendererModel[2];
   private final RendererModel field_187058_c;
   ...
   public BoatModel() {
      ...
      this.field_187057_b[0] = this.makePaddle(true);
      this.field_187057_b[0].setRotationPoint(3.0F, -5.0F, 9.0F);
      this.field_187057_b[1] = this.makePaddle(false);
      this.field_187057_b[1].setRotationPoint(3.0F, -5.0F, -9.0F);
      this.field_187057_b[1].rotateAngleY = (float)Math.PI;
      this.field_187057_b[0].rotateAngleZ = 0.19634955F;
      this.field_187057_b[1].rotateAngleZ = 0.19634955F;
      this.field_187058_c = (new RendererModel(this, 0, 0)).setTextureSize(128, 64);
      this.field_187058_c.addBox(-14.0F, -9.0F, -3.0F, 28, 16, 3, 0.0F);
      this.field_187058_c.setRotationPoint(0.0F, -3.0F, 1.0F);
   ...
   public void renderMultipass(Entity entityIn, float partialTicks, float p_187054_3_, float p_187054_4_, float p_187054_5_, float p_187054_6_, float scale) {
      ...
      this.field_187058_c.render(scale);
   ...
   protected void renderPaddle(BoatEntity boat, int paddle, float scale, float limbSwing) {
      ...
      RendererModel renderermodel = this.field_187057_b[paddle];
