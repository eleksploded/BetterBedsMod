...
public class ChatScreen extends Screen {
   ...
   private ChatScreen.SuggestionsList field_195139_w;
   ...
   protected void init() {
      ...
      this.sentHistoryCursor = this.minecraft.field_71456_v.getChatGUI().getSentMessages().size();
      this.field_146415_a = new TextFieldWidget(this.font, 4, this.height - 12, this.width - 4, 12, I18n.format("chat.editBox"));
      this.field_146415_a.setMaxStringLength(256);
      this.field_146415_a.setEnableBackgroundDrawing(false);
      this.field_146415_a.setText(this.defaultInputFieldText);
      this.field_146415_a.setTextFormatter(this::formatMessage);
   ...
   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String s = this.field_146415_a.getText();
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (this.field_195139_w != null && this.field_195139_w.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         return true;
      } else {
         ...
         if (super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
            ...
            if (p_keyPressed_1_ == 265) {
               ...
               this.minecraft.field_71456_v.getChatGUI().func_194813_a((double)(this.minecraft.field_71456_v.getChatGUI().getLineCount() - 1));
               return true;
   ...
   public void showSuggestions() {
      if (this.pendingSuggestions != null && this.pendingSuggestions.isDone()) {
         ...
         if (!suggestions.getList().isEmpty()) {
            ...
            int j = MathHelper.clamp(this.field_146415_a.func_195611_j(suggestions.getRange().getStart()), 0, this.width - i);
            this.field_195139_w = new ChatScreen.SuggestionsList(j, this.height - 12, i, suggestions);
         }
      }
   ...
   private void updateSuggestion() {
      ...
      if (!this.field_212338_z) {
         this.field_146415_a.setSuggestion((String)null);
      ...
      if (stringreader.canRead() && stringreader.peek() == '/') {
         stringreader.skip();
         CommandDispatcher<ISuggestionProvider> commanddispatcher = this.minecraft.player.field_71174_a.func_195515_i();
         if (this.currentParse == null) {
            this.currentParse = commanddispatcher.parse(stringreader, this.minecraft.player.field_71174_a.getSuggestionProvider());
         }

         int j = this.field_146415_a.getCursorPosition();
         if (j >= 1 && (this.field_195139_w == null || !this.field_212338_z)) {
         ...
         Collection<String> collection = this.minecraft.player.field_71174_a.getSuggestionProvider().getPlayerNames();
   ...
   private void updateUsageInfo() {
      if (this.pendingSuggestions.join().isEmpty() && !this.currentParse.getExceptions().isEmpty() && this.field_146415_a.getCursorPosition() == this.field_146415_a.getText().length()) {
         int i = 0;
      ...
      this.field_195139_w = null;
      if (this.hasEdits && this.minecraft.gameSettings.autoSuggestions) {
         this.showSuggestions();
      }
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      ...
      if (this.field_195139_w != null && this.field_195139_w.mouseScrolled(p_mouseScrolled_5_)) {
         return true;
      } else {
         if (!hasShiftDown()) {
         ...
         this.minecraft.field_71456_v.getChatGUI().func_194813_a(p_mouseScrolled_5_);
         return true;
      }
   }

   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (this.field_195139_w != null && this.field_195139_w.mouseClicked((int)p_mouseClicked_1_, (int)p_mouseClicked_3_, p_mouseClicked_5_)) {
         return true;
      } else {
         if (p_mouseClicked_5_ == 0) {
            ITextComponent itextcomponent = this.minecraft.field_71456_v.getChatGUI().getTextComponent(p_mouseClicked_1_, p_mouseClicked_3_);
            if (itextcomponent != null && this.handleComponentClicked(itextcomponent)) {
               return true;
            }
         }

         return this.field_146415_a.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_) ? true : super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
      }
   }

   protected void insertText(String p_insertText_1_, boolean p_insertText_2_) {
      if (p_insertText_2_) {
         this.field_146415_a.setText(p_insertText_1_);
      } else {
         this.field_146415_a.writeText(p_insertText_1_);
      }
   ...
   public void getSentHistory(int msgPos) {
      ...
      int j = this.minecraft.field_71456_v.getChatGUI().getSentMessages().size();
      i = MathHelper.clamp(i, 0, j);
      if (i != this.sentHistoryCursor) {
         if (i == j) {
            this.sentHistoryCursor = j;
            this.field_146415_a.setText(this.historyBuffer);
         } else {
            if (this.sentHistoryCursor == j) {
               this.historyBuffer = this.field_146415_a.getText();
            }

            this.field_146415_a.setText(this.minecraft.field_71456_v.getChatGUI().getSentMessages().get(i));
            this.field_195139_w = null;
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_146415_a.setFocused2(true);
      ...
      if (this.field_195139_w != null) {
         this.field_195139_w.render(p_render_1_, p_render_2_);
      } else {
         int i = 0;
      ...
      ITextComponent itextcomponent = this.minecraft.field_71456_v.getChatGUI().getTextComponent((double)p_render_1_, (double)p_render_2_);
   ...
   private void fillNodeUsage(TextFormatting p_195132_1_) {
      ...
      SuggestionContext<ISuggestionProvider> suggestioncontext = commandcontextbuilder.findSuggestionContext(this.field_146415_a.getCursorPosition());
      Map<CommandNode<ISuggestionProvider>, String> map = this.minecraft.player.field_71174_a.func_195515_i().getSmartUsage(suggestioncontext.parent, this.minecraft.player.field_71174_a.getSuggestionProvider());
      ...
      if (!list.isEmpty()) {
         ...
         this.commandUsagePosition = MathHelper.clamp(this.field_146415_a.func_195611_j(suggestioncontext.startPos), 0, this.width - i);
   ...
   private void setChatLine(String p_208604_1_) {
      this.field_146415_a.setText(p_208604_1_);
   }
   ...
   class SuggestionsList {
      ...
      private SuggestionsList(int p_i47700_2_, int p_i47700_3_, int p_i47700_4_, Suggestions p_i47700_5_) {
         ...
         this.field_212466_d = ChatScreen.this.field_146415_a.getText();
         this.select(0);
      }
      ...
      public void select(int p_199675_1_) {
         ...
         ChatScreen.this.field_146415_a.setSuggestion(ChatScreen.calculateSuggestionSuffix(ChatScreen.this.field_146415_a.getText(), suggestion.apply(this.field_212466_d)));
      }
      ...
      public void useSuggestion() {
         ...
         ChatScreen.this.field_146415_a.func_212422_f(i);
         ChatScreen.this.field_146415_a.setSelectionPos(i);
