...
public class KeyBindingList extends AbstractOptionList<KeyBindingList.Entry> {
   ...
   public class CategoryEntry extends KeyBindingList.Entry {
      ...
      public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
         KeyBindingList.this.minecraft.fontRenderer.drawString(this.labelText, (float)(KeyBindingList.this.minecraft.field_71462_r.width / 2 - this.labelWidth / 2), (float)(p_render_2_ + p_render_5_ - 9 - 1), 16777215);
      }
   ...
   public class KeyEntry extends KeyBindingList.Entry {
      ...
      private KeyEntry(final KeyBinding name) {
         ...
         this.field_148280_d = new Button(0, 0, 75 + 20 /*Forge: add space*/, 20, this.keyDesc, (p_214386_2_) -> {
            KeyBindingList.this.field_148191_k.buttonId = name;
         }) {
         ...
         this.field_148281_e = new Button(0, 0, 50, 20, I18n.format("controls.reset"), (p_214387_2_) -> {
      ...
      public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
         boolean flag = KeyBindingList.this.field_148191_k.buttonId == this.keybinding;
         ...
         this.field_148281_e.active = !this.keybinding.isDefault();
         ...
         this.field_148280_d.setMessage(this.keybinding.getLocalizedName());
         boolean flag1 = false;
