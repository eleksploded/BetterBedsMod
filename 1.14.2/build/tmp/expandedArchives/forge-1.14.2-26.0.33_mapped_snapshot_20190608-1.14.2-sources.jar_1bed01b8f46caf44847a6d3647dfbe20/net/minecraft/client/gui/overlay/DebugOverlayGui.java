...
public class DebugOverlayGui extends AbstractGui {
   ...
   protected List<String> call() {
      ...
      if (this.mc.isReducedDebug()) {
         ...
         LongSet longset = (LongSet)(world instanceof ServerWorld ? ((ServerWorld)world).func_217469_z() : LongSets.EMPTY_SET);
            ...
            if (this.mc.world.isBlockLoaded(blockpos)) {
               ...
               if (chunk.isEmpty()) {
                  ...
                  if (blockpos.getY() >= 0 && blockpos.getY() < 256) {
                     list.add("Biome: " + Registry.field_212624_m.getKey(chunk.getBiome(blockpos)));
                     long i = 0L;
                     float f2 = 0.0F;
                     if (chunk1 != null) {
         ...
         list.add(this.mc.getSoundHandler().func_215293_f());
         return list;
      }
   }
   ...
   protected List<String> getDebugInfoRight() {
      ...
      if (this.mc.isReducedDebug()) {
         ...
         if (this.rayTraceBlock.getType() == RayTraceResult.Type.BLOCK) {
            ...
            list.add(String.valueOf((Object)Registry.field_212618_g.getKey(blockstate.getBlock())));
         ...
         if (this.rayTraceFluid.getType() == RayTraceResult.Type.BLOCK) {
            ...
            list.add(String.valueOf((Object)Registry.field_212619_h.getKey(ifluidstate.getFluid())));
         ...
         if (entity != null) {
            ...
            list.add(String.valueOf((Object)Registry.field_212629_r.getKey(entity.getType())));
   ...
   private void func_212920_a(FrameTimer p_212920_1_, int p_212920_2_, int p_212920_3_, boolean p_212920_4_) {
      ...
      if (p_212920_4_ && this.mc.gameSettings.limitFramerate > 0 && this.mc.gameSettings.limitFramerate <= 250) {
         this.hLine(p_212920_2_, p_212920_2_ + j1 - 1, j3 - 1 - (int)(1800.0D / (double)this.mc.gameSettings.limitFramerate), -16711681);
      }
   ...
   private int blendColors(int col1, int col2, float factor) {
      ...
      int k1 = col2 >> 8 & 255;
      int l1 = col2 & 255;
      int i2 = MathHelper.clamp((int)MathHelper.func_219799_g(factor, (float)i, (float)i1), 0, 255);
      int j2 = MathHelper.clamp((int)MathHelper.func_219799_g(factor, (float)j, (float)j1), 0, 255);
      int k2 = MathHelper.clamp((int)MathHelper.func_219799_g(factor, (float)k, (float)k1), 0, 255);
      int l2 = MathHelper.clamp((int)MathHelper.func_219799_g(factor, (float)l, (float)l1), 0, 255);
