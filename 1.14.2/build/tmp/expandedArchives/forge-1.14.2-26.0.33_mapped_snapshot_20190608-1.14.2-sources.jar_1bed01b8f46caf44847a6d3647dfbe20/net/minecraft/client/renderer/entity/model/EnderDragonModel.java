...
public class EnderDragonModel extends EntityModel<EnderDragonEntity> {
   ...
   private final RendererModel field_78219_b;
   ...
   public EnderDragonModel(float p_i46360_1_) {
      ...
      this.field_78219_b = new RendererModel(this, "neck");
      this.field_78219_b.func_217178_a("box", -5.0F, -5.0F, -5.0F, 10, 10, 10, p_i46360_1_, 192, 104);
      this.field_78219_b.func_217178_a("scale", -1.0F, -9.0F, -3.0F, 2, 4, 6, p_i46360_1_, 48, 0);
   ...
   public void func_212843_a_(EnderDragonEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
   ...
   public void render(EnderDragonEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      ...
      float f = MathHelper.func_219799_g(this.partialTicks, entityIn.prevAnimTime, entityIn.animTime);
      ...
      for(int i = 0; i < 5; ++i) {
         ...
         this.field_78219_b.rotateAngleY = this.updateRotations(adouble1[0] - adouble[0]) * ((float)Math.PI / 180F) * 1.5F;
         this.field_78219_b.rotateAngleX = f9 + entityIn.getHeadPartYOffset(i, adouble, adouble1) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
         this.field_78219_b.rotateAngleZ = -this.updateRotations(adouble1[0] - (double)f7) * ((float)Math.PI / 180F) * 1.5F;
         this.field_78219_b.rotationPointY = f3;
         this.field_78219_b.rotationPointZ = f4;
         this.field_78219_b.rotationPointX = f2;
         f3 = (float)((double)f3 + Math.sin((double)this.field_78219_b.rotateAngleX) * 10.0D);
         f4 = (float)((double)f4 - Math.cos((double)this.field_78219_b.rotateAngleY) * Math.cos((double)this.field_78219_b.rotateAngleX) * 10.0D);
         f2 = (float)((double)f2 - Math.sin((double)this.field_78219_b.rotateAngleY) * Math.cos((double)this.field_78219_b.rotateAngleX) * 10.0D);
         this.field_78219_b.render(scale);
      }
      ...
      for(int k = 0; k < 12; ++k) {
         ...
         this.field_78219_b.rotateAngleY = (this.updateRotations(adouble2[0] - adouble[0]) * 1.5F + 180.0F) * ((float)Math.PI / 180F);
         this.field_78219_b.rotateAngleX = f10 + (float)(adouble2[1] - adouble[1]) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
         this.field_78219_b.rotateAngleZ = this.updateRotations(adouble2[0] - (double)f7) * ((float)Math.PI / 180F) * 1.5F;
         this.field_78219_b.rotationPointY = f3;
         this.field_78219_b.rotationPointZ = f4;
         this.field_78219_b.rotationPointX = f2;
         f3 = (float)((double)f3 + Math.sin((double)this.field_78219_b.rotateAngleX) * 10.0D);
