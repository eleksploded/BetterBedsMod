...
public class FaceBakery {
   ...
   public BakedQuad makeBakedQuad(Vector3f p_217648_1_, Vector3f p_217648_2_, BlockPartFace p_217648_3_, TextureAtlasSprite p_217648_4_, Direction p_217648_5_, ISprite p_217648_6_, @Nullable BlockPartRotation p_217648_7_, boolean p_217648_8_) {
      ...
      blockfaceuv.uvs[0] = MathHelper.func_219799_g(f2, blockfaceuv.uvs[0], f3);
      blockfaceuv.uvs[2] = MathHelper.func_219799_g(f2, blockfaceuv.uvs[2], f3);
      blockfaceuv.uvs[1] = MathHelper.func_219799_g(f2, blockfaceuv.uvs[1], f4);
      blockfaceuv.uvs[3] = MathHelper.func_219799_g(f2, blockfaceuv.uvs[3], f4);
