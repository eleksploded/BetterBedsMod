...
public class IngameGui extends AbstractGui {
   ...
   public IngameGui(Minecraft mcIn) {
      ...
      this.field_175198_t = new DebugOverlayGui(mcIn);
      this.field_175197_u = new SpectatorGui(mcIn);
      this.field_73840_e = new NewChatGui(mcIn);
      this.field_175196_v = new PlayerTabOverlayGui(mcIn, this);
      this.field_184050_w = new BossOverlayGui(mcIn);
      this.field_184049_t = new SubtitleOverlayGui(mcIn);
   ...
   public void renderGameOverlay(float partialTicks) {
      ...
      if (!this.mc.gameSettings.hideGUI) {
         ...
         GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
         this.mc.getTextureManager().bindTexture(GUI_ICONS_LOCATION);
         if (this.mc.field_71442_b.shouldDrawHUD()) {
         ...
         } else if (this.mc.field_71442_b.gameIsSurvivalOrAdventure()) {
            this.renderExpBar(l);
         }
      ...
      if (!this.mc.gameSettings.hideGUI) {
         ...
         this.field_73840_e.render(this.ticks);
         this.mc.getProfiler().endSection();
         GlStateManager.popMatrix();
         scoreobjective1 = scoreboard.getObjectiveInDisplaySlot(0);
         if (!this.mc.gameSettings.keyBindPlayerList.isKeyDown() || this.mc.isIntegratedServerRunning() && this.mc.player.field_71174_a.getPlayerInfoMap().size() <= 1 && scoreobjective1 == null) {
            this.field_175196_v.setVisible(false);
         } else {
            this.field_175196_v.setVisible(true);
            this.field_175196_v.render(this.scaledWidth, scoreboard, scoreobjective1);
         }
      }
   ...
   protected void renderAttackIndicator() {
      ...
      if (gamesettings.thirdPersonView == 0) {
         if (this.mc.field_71442_b.getCurrentGameType() != GameType.SPECTATOR || this.func_212913_a(this.mc.objectMouseOver)) {
            if (gamesettings.showDebugInfo && !gamesettings.hideGUI && !this.mc.player.hasReducedDebug() && !gamesettings.reducedDebugInfo) {
               ...
               if (this.mc.gameSettings.field_186716_M == AttackIndicatorStatus.CROSSHAIR) {
   ...
   protected void renderPotionEffects() {
      ...
      if (!collection.isEmpty()) {
         ...
         this.mc.getTextureManager().bindTexture(AtlasTexture.field_215264_i);
   ...
   protected void renderHotbar(float partialTicks) {
      ...
      if (playerentity != null) {
         ...
         if (this.mc.gameSettings.field_186716_M == AttackIndicatorStatus.HOTBAR) {
            float f = this.mc.player.getCooledAttackStrength(0.0F);
            if (f < 1.0F) {
   ...
   private void renderPlayerStats() {
      ...
      if (playerentity != null) {
         ...
         int k3 = -1;
         if (playerentity.isPotionActive(Effects.field_76428_l)) {
         ...
         for(int l5 = MathHelper.ceil((f + (float)l1) / 2.0F) - 1; l5 >= 0; --l5) {
            int i6 = 16;
            if (playerentity.isPotionActive(Effects.field_76436_u)) {
               i6 += 36;
            } else if (playerentity.isPotionActive(Effects.field_82731_v)) {
               i6 += 72;
            }
         ...
         if (j6 == 0) {
            ...
            for(int k6 = 0; k6 < 10; ++k6) {
               ...
               int k7 = 16;
               int i8 = 0;
               if (playerentity.isPotionActive(Effects.field_76438_s)) {
                  k7 += 36;
                  i8 = 13;
               }
   ...
   public void resetPlayersOverlayFooterHeader() {
      this.field_175196_v.resetFooterHeader();
      this.field_184050_w.clearBossInfos();
