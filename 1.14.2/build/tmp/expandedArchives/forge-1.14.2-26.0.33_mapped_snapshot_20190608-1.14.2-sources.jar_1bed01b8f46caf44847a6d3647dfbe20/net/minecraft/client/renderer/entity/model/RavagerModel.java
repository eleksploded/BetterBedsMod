...
public class RavagerModel extends EntityModel<RavagerEntity> {
   ...
   public void func_212844_a_(RavagerEntity p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      this.field_217168_a.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
      this.field_217168_a.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      this.field_217170_f.rotateAngleX = ((float)Math.PI / 2F);
      float f = 0.4F * p_212844_3_;
      this.field_217171_g.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F) * f;
      this.field_217172_h.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F + (float)Math.PI) * f;
      this.field_217173_i.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F + (float)Math.PI) * f;
      this.field_217174_j.rotateAngleX = MathHelper.cos(p_212844_2_ * 0.6662F) * f;
   }

   public void func_212843_a_(RavagerEntity p_212843_1_, float p_212843_2_, float p_212843_3_, float p_212843_4_) {
      super.func_212843_a_(p_212843_1_, p_212843_2_, p_212843_3_, p_212843_4_);
      int i = p_212843_1_.func_213684_dX();
      int j = p_212843_1_.func_213687_eg();
      int k = 20;
      int l = p_212843_1_.func_213683_l();
      int i1 = 10;
      if (l > 0) {
         ...
         if (l > 5) {
            this.field_217169_b.rotateAngleX = MathHelper.sin(((float)(-4 + l) - p_212843_4_) / 4.0F) * (float)Math.PI * 0.4F;
         } else {
            this.field_217169_b.rotateAngleX = 0.15707964F * MathHelper.sin((float)Math.PI * ((float)l - p_212843_4_) / 10.0F);
         }
      } else {
         float f5 = -1.0F;
