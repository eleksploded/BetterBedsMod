...
public class PlayerRenderer extends LivingRenderer<AbstractClientPlayerEntity, PlayerModel<AbstractClientPlayerEntity>> {
   ...
   public void doRender(AbstractClientPlayerEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      if (!entity.isUser() || this.field_76990_c.field_217783_c.func_216773_g() == entity) {
         double d0 = y;
   ...
   private void setModelVisibilities(AbstractClientPlayerEntity clientPlayer) {
      PlayerModel<AbstractClientPlayerEntity> playermodel = this.func_217764_d();
      if (clientPlayer.isSpectator()) {
         playermodel.setVisible(false);
         playermodel.field_78116_c.showModel = true;
         playermodel.field_178720_f.showModel = true;
      } else {
         ItemStack itemstack = clientPlayer.getHeldItemMainhand();
         ItemStack itemstack1 = clientPlayer.getHeldItemOffhand();
         playermodel.setVisible(true);
         playermodel.field_178720_f.showModel = clientPlayer.isWearing(PlayerModelPart.HAT);
         playermodel.field_178730_v.showModel = clientPlayer.isWearing(PlayerModelPart.JACKET);
         playermodel.field_178733_c.showModel = clientPlayer.isWearing(PlayerModelPart.LEFT_PANTS_LEG);
         playermodel.field_178731_d.showModel = clientPlayer.isWearing(PlayerModelPart.RIGHT_PANTS_LEG);
         playermodel.field_178734_a.showModel = clientPlayer.isWearing(PlayerModelPart.LEFT_SLEEVE);
         playermodel.field_178732_b.showModel = clientPlayer.isWearing(PlayerModelPart.RIGHT_SLEEVE);
   ...
   private BipedModel.ArmPose func_217766_a(AbstractClientPlayerEntity p_217766_1_, ItemStack p_217766_2_, ItemStack p_217766_3_, Hand p_217766_4_) {
      ...
      if (!itemstack.isEmpty()) {
         ...
         if (p_217766_1_.getItemInUseCount() > 0) {
            ...
            boolean flag3 = p_217766_2_.getItem() == Items.field_222114_py;
            boolean flag = CrossbowItem.func_220012_d(p_217766_2_);
            boolean flag1 = p_217766_3_.getItem() == Items.field_222114_py;
            boolean flag2 = CrossbowItem.func_220012_d(p_217766_3_);
            if (flag3 && flag) {
   ...
   public void renderRightArm(AbstractClientPlayerEntity clientPlayer) {
      ...
      playermodel.func_212844_a_(clientPlayer, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
      playermodel.field_178723_h.rotateAngleX = 0.0F;
      playermodel.field_178723_h.render(0.0625F);
      playermodel.field_178732_b.rotateAngleX = 0.0F;
      playermodel.field_178732_b.render(0.0625F);
   ...
   public void renderLeftArm(AbstractClientPlayerEntity clientPlayer) {
      ...
      playermodel.field_205061_a = 0.0F;
      playermodel.func_212844_a_(clientPlayer, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
      playermodel.field_178724_i.rotateAngleX = 0.0F;
      playermodel.field_178724_i.render(0.0625F);
      playermodel.field_178734_a.rotateAngleX = 0.0F;
      playermodel.field_178734_a.render(0.0625F);
      GlStateManager.disableBlend();
   }
