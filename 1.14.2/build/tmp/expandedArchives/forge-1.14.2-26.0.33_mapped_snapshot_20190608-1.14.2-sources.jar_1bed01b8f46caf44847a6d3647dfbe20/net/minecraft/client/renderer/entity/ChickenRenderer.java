...
public class ChickenRenderer extends MobRenderer<ChickenEntity, ChickenModel<ChickenEntity>> {
   ...
   protected float handleRotationFloat(ChickenEntity livingBase, float partialTicks) {
      float f = MathHelper.func_219799_g(partialTicks, livingBase.oFlap, livingBase.wingRotation);
      float f1 = MathHelper.func_219799_g(partialTicks, livingBase.oFlapSpeed, livingBase.destPos);
