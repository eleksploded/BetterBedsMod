...
public class CreateBuffetWorldScreen extends Screen {
   private static final List<ResourceLocation> BUFFET_GENERATORS = Registry.field_212627_p.keySet().stream().filter((p_205307_0_) -> {
      return Registry.field_212627_p.getOrDefault(p_205307_0_).isOptionForBuffetWorld();
   }).collect(Collectors.toList());
   private final CreateWorldScreen field_205314_f;
   private final CompoundNBT field_213017_c;
   private CreateBuffetWorldScreen.BiomeList field_205311_s;
   ...
   protected void init() {
      ...
      this.field_205311_s = new CreateBuffetWorldScreen.BiomeList();
      ...
      this.field_205313_u = this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done"), (p_213014_1_) -> {
         this.field_205314_f.field_146334_a = this.serialize();
         this.minecraft.displayGuiScreen(this.field_205314_f);
      }));
   ...
   private void deserialize() {
      ...
      if (this.field_213017_c.contains("biome_source", 10) && this.field_213017_c.getCompound("biome_source").contains("biomes", 9)) {
         ...
         for(int j = 0; j < listnbt.size(); ++j) {
            ...
            this.field_205311_s.setSelected(this.field_205311_s.children().stream().filter((p_213013_1_) -> {
   ...
   private CompoundNBT serialize() {
      ...
      compoundnbt1.putString("type", Registry.field_212625_n.getKey(BiomeProviderType.FIXED).toString());
      CompoundNBT compoundnbt2 = new CompoundNBT();
      ListNBT listnbt = new ListNBT();
      listnbt.add(new StringNBT((this.field_205311_s.getSelected()).field_214394_b.toString()));
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_205311_s.render(p_render_1_, p_render_2_, p_render_3_);
   ...
   class BiomeList extends ExtendedList<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
      private BiomeList() {
         ...
         Registry.field_212624_m.keySet().stream().sorted(Comparator.comparing((p_214347_0_) -> {
            return Registry.field_212624_m.getOrDefault(p_214347_0_).getDisplayName().getString();
         })).forEach((p_214348_1_) -> {
      ...
      public void setSelected(@Nullable CreateBuffetWorldScreen.BiomeList.BiomeEntry p_setSelected_1_) {
         ...
         if (p_setSelected_1_ != null) {
            NarratorChatListener.INSTANCE.func_216864_a((new TranslationTextComponent("narrator.select", Registry.field_212624_m.getOrDefault(p_setSelected_1_.field_214394_b).getDisplayName().getString())).getString());
         }
      ...
      class BiomeEntry extends ExtendedList.AbstractListEntry<CreateBuffetWorldScreen.BiomeList.BiomeEntry> {
         ...
         public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
            BiomeList.this.drawString(CreateBuffetWorldScreen.this.font, Registry.field_212624_m.getOrDefault(this.field_214394_b).getDisplayName().getString(), p_render_3_ + 5, p_render_2_ + 2, 16777215);
         }
