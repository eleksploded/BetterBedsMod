...
public class NewChatGui extends AbstractGui {
   ...
   public void render(int updateCounter) {
      if (this.mc.gameSettings.field_74343_n != ChatVisibility.HIDDEN) {
         ...
         if (j > 0) {
            ...
            double d2 = this.mc.gameSettings.field_216845_l;
            int l = 0;
   ...
   public void printChatMessageWithOptionalDeletion(ITextComponent chatComponent, int chatLineId) {
      this.setChatLine(chatComponent, chatLineId, this.mc.field_71456_v.getTicks(), false);
