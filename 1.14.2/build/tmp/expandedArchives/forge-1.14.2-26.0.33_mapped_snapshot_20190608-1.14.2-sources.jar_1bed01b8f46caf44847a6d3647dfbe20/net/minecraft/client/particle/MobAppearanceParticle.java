...
public class MobAppearanceParticle extends Particle {
   ...
   public void tick() {
      ...
      if (this.field_174844_a == null) {
         ...
         this.field_174844_a = elderguardianentity;
      }
   ...
   public void renderParticle(BufferBuilder buffer, ActiveRenderInfo entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ) {
      if (this.field_174844_a != null) {
         ...
         GlStateManager.rotatef(180.0F - entityIn.func_216778_f(), 0.0F, 1.0F, 0.0F);
         GlStateManager.rotatef(60.0F - 150.0F * f1 - entityIn.func_216777_e(), 1.0F, 0.0F, 0.0F);
         ...
         entityrenderermanager.renderEntity(this.field_174844_a, 0.0D, 0.0D, 0.0D, 0.0F, partialTicks, false);
