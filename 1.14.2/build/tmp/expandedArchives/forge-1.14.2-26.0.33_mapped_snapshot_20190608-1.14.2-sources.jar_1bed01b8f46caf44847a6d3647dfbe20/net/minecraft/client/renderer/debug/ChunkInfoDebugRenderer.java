...
public class ChunkInfoDebugRenderer implements DebugRenderer.IDebugRenderer {
   ...
   public ChunkInfoDebugRenderer(Minecraft p_i50978_1_) {
      this.field_217678_a = p_i50978_1_;
   }
   ...
   public void func_217676_a(long p_217676_1_) {
      ...
      if (d0 - this.field_217679_b > 3.0E9D) {
         ...
         IntegratedServer integratedserver = this.field_217678_a.getIntegratedServer();
      ...
      if (this.field_217681_d != null) {
         ...
         double d1 = this.field_217678_a.gameRenderer.func_215316_n().func_216785_c().y * 0.85D;
   ...
   final class Entry {
      ...
      private Entry(IntegratedServer p_i49965_2_) {
         ClientWorld clientworld = ChunkInfoDebugRenderer.this.field_217678_a.world;
         DimensionType dimensiontype = ChunkInfoDebugRenderer.this.field_217678_a.world.dimension.getType();
         ...
         ActiveRenderInfo activerenderinfo = ChunkInfoDebugRenderer.this.field_217678_a.gameRenderer.func_215316_n();
         int i = (int)activerenderinfo.func_216785_c().x >> 4;
         int j = (int)activerenderinfo.func_216785_c().z >> 4;
