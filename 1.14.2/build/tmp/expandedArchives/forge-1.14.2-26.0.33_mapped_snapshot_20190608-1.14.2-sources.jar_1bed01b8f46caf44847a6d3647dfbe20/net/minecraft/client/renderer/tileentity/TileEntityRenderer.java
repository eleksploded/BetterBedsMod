...
public abstract class TileEntityRenderer<T extends TileEntity> {
   ...
   protected void drawNameplate(T te, String str, double x, double y, double z, int maxDistance) {
      ...
      double d0 = te.getDistanceSq(activerenderinfo.func_216785_c().x, activerenderinfo.func_216785_c().y, activerenderinfo.func_216785_c().z);
      if (!(d0 > (double)(maxDistance * maxDistance))) {
         float f = activerenderinfo.func_216778_f();
         float f1 = activerenderinfo.func_216777_e();
         GameRenderer.func_215307_a(this.getFontRenderer(), str, (float)x + 0.5F, (float)y + 1.5F, (float)z + 0.5F, 0, f, f1, false);
      }
   }
}