...
public class BlockModel implements IUnbakedModel {
   ...
   public List<BlockPart> getElements() {
      return this.elements.isEmpty() && this.field_178315_d != null ? this.field_178315_d.getElements() : this.elements;
   }
   ...
   public boolean isAmbientOcclusion() {
      return this.field_178315_d != null ? this.field_178315_d.isAmbientOcclusion() : this.ambientOcclusion;
   }
   ...
   public Collection<ResourceLocation> getTextures(Function<ResourceLocation, IUnbakedModel> modelGetter, Set<String> missingTextureErrors) {
      ...
      for(BlockModel blockmodel = this; blockmodel.parentLocation != null && blockmodel.field_178315_d == null; blockmodel = blockmodel.field_178315_d) {
         set.add(blockmodel);
         ...
         blockmodel.field_178315_d = (BlockModel)iunbakedmodel;
      }
      ...
      if (this.getRootModel() == ModelBakery.field_177606_o) {
   ...
   public IBakedModel bake(ModelBakery p_217644_1_, BlockModel p_217644_2_, Function<ResourceLocation, TextureAtlasSprite> p_217644_3_, ISprite p_217644_4_, net.minecraft.client.renderer.vertex.VertexFormat format) {
      ...
      if (this.getRootModel() == ModelBakery.field_177616_r) {
         ...
         for(BlockPart blockpart : this.getElements()) {
            for(Direction direction : blockpart.mapFaces.keySet()) {
               ...
               if (blockpartface.field_178244_b == null) {
                  ...
                  simplebakedmodel$builder.addFaceQuad(p_217644_4_.getState().apply(java.util.Optional.empty()).map(trsr -> trsr.rotate(direction)).orElse(direction), makeBakedQuad(blockpart, blockpartface, textureatlassprite1, direction, p_217644_4_));
               }
            }
         }
      ...
      if (this.startsWithHash(textureName)) {
         if (this == p_178302_2_.field_178323_b) {
            ...
            if (s == null && this.field_178315_d != null) {
               s = this.field_178315_d.resolveTextureName(textureName, p_178302_2_);
            }

            p_178302_2_.field_178323_b = this;
            if (s != null && this.startsWithHash(s)) {
               s = p_178302_2_.field_178324_a.resolveTextureName(s, p_178302_2_);
            }
   ...
   public BlockModel getRootModel() {
      return this.field_178315_d == null ? this : this.field_178315_d.getRootModel();
   }
   ...
   private ItemTransformVec3f getTransform(ItemCameraTransforms.TransformType type) {
      return this.field_178315_d != null && !this.cameraTransforms.hasCustomTransform(type) ? this.field_178315_d.getTransform(type) : this.cameraTransforms.getTransform(type);
   }
