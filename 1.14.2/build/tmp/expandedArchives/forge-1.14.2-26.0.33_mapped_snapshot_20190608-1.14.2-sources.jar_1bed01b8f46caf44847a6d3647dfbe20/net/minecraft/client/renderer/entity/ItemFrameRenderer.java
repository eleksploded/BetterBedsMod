...
public class ItemFrameRenderer extends EntityRenderer<ItemFrameEntity> {
   ...
   public void doRender(ItemFrameEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      this.field_76990_c.textureManager.bindTexture(AtlasTexture.LOCATION_BLOCKS_TEXTURE);
      ...
      GlStateManager.enableLighting();
      GlStateManager.popMatrix();
      this.renderName(entity, x + (double)((float)entity.field_174860_b.getXOffset() * 0.3F), y - 0.25D, z + (double)((float)entity.field_174860_b.getZOffset() * 0.3F));
   }
   ...
   private void renderItem(ItemFrameEntity itemFrame) {
      ...
      if (!itemstack.isEmpty()) {
         ...
         if (mapdata != null) {
            ...
            this.field_76990_c.textureManager.bindTexture(MAP_BACKGROUND_TEXTURES);
   ...
   protected void renderName(ItemFrameEntity entity, double x, double y, double z) {
      if (Minecraft.isGuiEnabled() && !entity.getDisplayedItem().isEmpty() && entity.getDisplayedItem().hasDisplayName() && this.field_76990_c.pointedEntity == entity) {
