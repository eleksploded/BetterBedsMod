...
public class AdvancementEntryGui extends AbstractGui {
   ...
   private AdvancementEntryGui getFirstVisibleParent(Advancement advancementIn) {
      ...
      if (advancementIn != null && advancementIn.getDisplay() != null) {
         return this.field_191828_f.getAdvancementGui(advancementIn);
      } else {
         return null;
      }
   }
   ...
   public void drawConnectivity(int p_191819_1_, int p_191819_2_, boolean p_191819_3_) {
      if (this.field_191834_l != null) {
         int i = p_191819_1_ + this.field_191834_l.x + 13;
         int j = p_191819_1_ + this.field_191834_l.x + 26 + 4;
         int k = p_191819_2_ + this.field_191834_l.y + 13;
   ...
   public void drawHover(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
      boolean flag = p_191821_4_ + p_191821_1_ + this.x + this.width + 26 >= this.field_191828_f.getScreen().width;
   ...
   public void attachToParent() {
      if (this.field_191834_l == null && this.advancement.getParent() != null) {
         this.field_191834_l = this.getFirstVisibleParent(this.advancement);
         if (this.field_191834_l != null) {
            this.field_191834_l.addGuiAdvancement(this);
         }
      }
