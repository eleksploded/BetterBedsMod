...
public class ToastGui extends AbstractGui {
   ...
   private final ToastGui.ToastInstance<?>[] field_191791_g = new ToastGui.ToastInstance[5];
   ...
   public void render() {
      if (!this.mc.gameSettings.hideGUI) {
         ...
         for(int i = 0; i < this.field_191791_g.length; ++i) {
            ...
            if (this.field_191791_g[i] == null && !this.toastsQueue.isEmpty()) {
               this.field_191791_g[i] = new ToastGui.ToastInstance(this.toastsQueue.removeFirst());
            }
         }
   ...
   public <T extends IToast> T getToast(Class<? extends T> p_192990_1_, Object p_192990_2_) {
      for(ToastGui.ToastInstance<?> toastinstance : this.field_191791_g) {
