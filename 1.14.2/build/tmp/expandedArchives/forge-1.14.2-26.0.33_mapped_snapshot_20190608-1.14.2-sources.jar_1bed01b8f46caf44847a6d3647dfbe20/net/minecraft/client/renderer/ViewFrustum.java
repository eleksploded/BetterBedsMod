...
public class ViewFrustum {
      ...
      for(int j = 0; j < this.countChunksX; ++j) {
         for(int k = 0; k < this.countChunksY; ++k) {
            for(int l = 0; l < this.countChunksZ; ++l) {
               ...
               this.field_178164_f[i1] = renderChunkFactory.create(this.world, this.renderGlobal);
               this.field_178164_f[i1].setPosition(j * 16, k * 16, l * 16);
            }
         }
      }
      ...
      for(int l = 0; l < this.countChunksX; ++l) {
         ...
         for(int j1 = 0; j1 < this.countChunksZ; ++j1) {
            ...
            for(int l1 = 0; l1 < this.countChunksY; ++l1) {
               int i2 = l1 * 16;
               ChunkRender chunkrender = this.field_178164_f[this.getIndex(l, l1, j1)];
   ...
   public void func_217628_a(int p_217628_1_, int p_217628_2_, int p_217628_3_, boolean p_217628_4_) {
      ...
      ChunkRender chunkrender = this.field_178164_f[this.getIndex(i, j, k)];
      chunkrender.setNeedsUpdate(p_217628_4_);
   }
   ...
   protected ChunkRender getRenderChunk(BlockPos pos) {
      ...
      if (j >= 0 && j < this.countChunksY) {
         ...
         return this.field_178164_f[this.getIndex(i, j, k)];
      } else {
         return null;
      }
   }
