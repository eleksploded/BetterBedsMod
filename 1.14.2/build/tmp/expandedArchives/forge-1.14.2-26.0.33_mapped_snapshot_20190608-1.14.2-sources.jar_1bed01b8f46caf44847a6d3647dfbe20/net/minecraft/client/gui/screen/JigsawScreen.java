...
public class JigsawScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_214261_c.setText(this.field_214259_a.func_214056_d().toString());
      ...
      this.field_214260_b.setText(this.field_214259_a.func_214053_c().toString());
      ...
      this.field_214262_d.setText(this.field_214259_a.func_214054_f());
