...
public class OptionsScreen extends Screen {
   private static final AbstractOption[] field_146440_f = new AbstractOption[]{AbstractOption.field_216700_g};
   ...
   protected void init() {
      ...
      for(AbstractOption abstractoption : field_146440_f) {
         ...
         this.addButton(abstractoption.func_216586_a(this.minecraft.gameSettings, j, k, 150));
         ++i;
      }

      if (this.minecraft.world != null) {
         this.field_213062_f = this.minecraft.world.getDifficulty();
         this.field_175357_i = this.addButton(new Button(this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, this.getDifficultyText(this.field_213062_f), (p_213051_1_) -> {
            ...
            this.field_175357_i.setMessage(this.getDifficultyText(this.field_213062_f));
         }));
         if (this.minecraft.isSingleplayer() && !this.minecraft.world.getWorldInfo().isHardcore()) {
            ...
            this.field_175356_r = this.addButton(new LockIconButton(this.field_175357_i.x + this.field_175357_i.getWidth(), this.field_175357_i.y, (p_213054_1_) -> {
            ...
            this.field_175356_r.setLocked(this.minecraft.world.getWorldInfo().isDifficultyLocked());
            this.field_175356_r.active = !this.field_175356_r.isLocked();
            this.field_175357_i.active = !this.field_175356_r.isLocked();
         } else {
            this.field_175357_i.active = false;
         }
      } else {
         this.addButton(new OptionButton(this.width / 2 - 155 + i % 2 * 160, this.height / 6 - 12 + 24 * (i >> 1), 150, 20, AbstractOption.field_216686_J, AbstractOption.field_216686_J.func_216743_c(this.settings), (p_213057_1_) -> {
            AbstractOption.field_216686_J.func_216740_a(this.settings);
            this.settings.saveOptions();
            p_213057_1_.setMessage(AbstractOption.field_216686_J.func_216743_c(this.settings));
         }));
      }
      ...
      this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, I18n.format("gui.done"), (p_213056_1_) -> {
         this.minecraft.displayGuiScreen(this.field_146441_g);
      }));
   }
   ...
   private void func_213050_a(boolean p_213050_1_) {
      ...
      if (p_213050_1_ && this.minecraft.world != null) {
         ...
         this.field_175356_r.setLocked(true);
