...
public abstract class Screen extends FocusableGui implements IRenderable {
   ...
   public void sendMessage(String p_sendMessage_1_, boolean p_sendMessage_2_) {
      ...
      if (p_sendMessage_2_) {
         this.minecraft.field_71456_v.getChatGUI().addToSentMessages(p_sendMessage_1_);
      }
   ...
   public static boolean hasControlDown() {
      if (Minecraft.IS_RUNNING_ON_MAC) {
         return InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 343) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 347);
      } else {
         return InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 341) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 345);
      }
   }

   public static boolean hasShiftDown() {
      return InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 340) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 344);
   }

   public static boolean hasAltDown() {
      return InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 342) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 346);
   }
