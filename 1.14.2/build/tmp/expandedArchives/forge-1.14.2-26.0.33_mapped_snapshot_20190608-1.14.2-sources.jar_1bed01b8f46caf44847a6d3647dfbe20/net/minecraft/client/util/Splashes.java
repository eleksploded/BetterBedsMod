...
public class Splashes extends ReloadListener<List<String>> {
   ...
   private static final Random field_215279_b = new Random();
   ...
   protected List<String> func_212854_a_(IResourceManager p_212854_1_, IProfiler p_212854_2_) {
      try (
   ...
   protected void func_212853_a_(List<String> p_212853_1_, IResourceManager p_212853_2_, IProfiler p_212853_3_) {
   ...
   public String func_215276_a() {
      ...
      if (calendar.get(2) + 1 == 12 && calendar.get(5) == 24) {
         ...
         return this.field_215281_d != null && field_215279_b.nextInt(this.field_215280_c.size()) == 42 ? this.field_215281_d.getUsername().toUpperCase(Locale.ROOT) + " IS YOU" : this.field_215280_c.get(field_215279_b.nextInt(this.field_215280_c.size()));
      }
   }
}