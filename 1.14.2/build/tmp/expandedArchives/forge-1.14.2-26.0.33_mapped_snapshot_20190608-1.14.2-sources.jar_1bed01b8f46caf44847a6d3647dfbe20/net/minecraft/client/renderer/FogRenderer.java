...
public class FogRenderer {
   ...
   public void func_217619_a(ActiveRenderInfo p_217619_1_, float p_217619_2_) {
      ...
      double d0 = p_217619_1_.func_216785_c().y * world.dimension.getVoidFogYFactor();
      if (p_217619_1_.func_216773_g() instanceof LivingEntity && ((LivingEntity)p_217619_1_.func_216773_g()).isPotionActive(Effects.field_76440_q)) {
         int i = ((LivingEntity)p_217619_1_.func_216773_g()).getActivePotionEffect(Effects.field_76440_q).getDuration();
         if (i < 20) {
      ...
      } else if (p_217619_1_.func_216773_g() instanceof LivingEntity && ((LivingEntity)p_217619_1_.func_216773_g()).isPotionActive(Effects.field_76439_r)) {
   ...
   private void func_217621_a(ActiveRenderInfo p_217621_1_, IWorldReader p_217621_2_) {
      ...
      int j = p_217621_2_.getBiome(new BlockPos(p_217621_1_.func_216785_c())).getWaterFogColor();
      ...
      float f1 = MathHelper.func_219799_g(f, (float)j1, (float)k);
      float f2 = MathHelper.func_219799_g(f, (float)k1, (float)l);
      float f3 = MathHelper.func_219799_g(f, (float)l1, (float)i1);
      this.red = f1 / 255.0F;
   ...
   public void setupFog(ActiveRenderInfo p_217618_1_, int p_217618_2_, float partialTicks) {
      ...
      if (p_217618_1_.func_216773_g() instanceof LivingEntity && ((LivingEntity)p_217618_1_.func_216773_g()).isPotionActive(Effects.field_76440_q)) {
         float f2 = 5.0F;
         int i = ((LivingEntity)p_217618_1_.func_216773_g()).getActivePotionEffect(Effects.field_76440_q).getDuration();
         if (i < 20) {
            f2 = MathHelper.func_219799_g(1.0F - (float)i / 20.0F, 5.0F, this.entityRenderer.getFarPlaneDistance());
         }
         ...
         GLX.setupNvFogDistance();
         if (this.mc.world.dimension.doesXZShowFog(MathHelper.floor(p_217618_1_.func_216785_c().x), MathHelper.floor(p_217618_1_.func_216785_c().z)) || this.mc.field_71456_v.getBossOverlay().shouldCreateFog()) {
