...
public class CustomizeSkinScreen extends Screen {
   ...
   protected void init() {
      ...
      this.addButton(new OptionButton(this.width / 2 - 155 + i % 2 * 160, this.height / 6 + 24 * (i >> 1), 150, 20, AbstractOption.field_216714_u, AbstractOption.field_216714_u.func_216720_c(this.minecraft.gameSettings), (p_213081_1_) -> {
         AbstractOption.field_216714_u.func_216722_a(this.minecraft.gameSettings, 1);
         this.minecraft.gameSettings.saveOptions();
         p_213081_1_.setMessage(AbstractOption.field_216714_u.func_216720_c(this.minecraft.gameSettings));
      ...
      this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), 200, 20, I18n.format("gui.done"), (p_213079_1_) -> {
         this.minecraft.displayGuiScreen(this.field_175361_a);
      }));
   }
