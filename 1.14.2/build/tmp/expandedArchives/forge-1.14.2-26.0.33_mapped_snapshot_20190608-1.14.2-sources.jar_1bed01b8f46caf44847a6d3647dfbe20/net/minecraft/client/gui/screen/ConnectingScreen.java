...
public class ConnectingScreen extends Screen {
      ...
      Thread thread = new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectingScreen.this.networkManager.setNetHandler(new ClientLoginNetHandler(ConnectingScreen.this.networkManager, ConnectingScreen.this.minecraft, ConnectingScreen.this.field_146374_i, (p_209549_1_) -> {
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.field_146374_i, "connect.failed", new TranslationTextComponent("disconnect.genericReason", "Unknown host")));
               });
               ...
               ConnectingScreen.this.minecraft.execute(() -> {
                  ConnectingScreen.this.minecraft.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.field_146374_i, "connect.failed", new TranslationTextComponent("disconnect.genericReason", s)));
               });
            }
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, I18n.format("gui.cancel"), (p_212999_1_) -> {
         ...
         this.minecraft.displayGuiScreen(this.field_146374_i);
      }));
   }
