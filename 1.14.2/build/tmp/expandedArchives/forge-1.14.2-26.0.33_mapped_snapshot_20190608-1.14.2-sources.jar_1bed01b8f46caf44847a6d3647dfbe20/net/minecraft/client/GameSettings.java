...
public class GameSettings {
   ...
   public double field_216845_l = 0.5D;
   @Nullable
   ...
   public int func_216839_a(int p_216839_1_) {
      return this.field_216844_T ? p_216839_1_ : (int)(this.field_216845_l * 255.0D) << 24 & -16777216;
   }
         ...
         for(String s1 : compoundnbt.keySet()) {
            ...
            try {
               if ("autoJump".equals(s1)) {
                  AbstractOption.field_216719_z.func_216742_a(this, s2);
               }

               if ("autoSuggestions".equals(s1)) {
                  AbstractOption.field_216677_A.func_216742_a(this, s2);
               }

               if ("chatColors".equals(s1)) {
                  AbstractOption.field_216678_B.func_216742_a(this, s2);
               }

               if ("chatLinks".equals(s1)) {
                  AbstractOption.field_216679_C.func_216742_a(this, s2);
               }

               if ("chatLinksPrompt".equals(s1)) {
                  AbstractOption.field_216680_D.func_216742_a(this, s2);
               }

               if ("enableVsync".equals(s1)) {
                  AbstractOption.field_216682_F.func_216742_a(this, s2);
               }

               if ("entityShadows".equals(s1)) {
                  AbstractOption.field_216683_G.func_216742_a(this, s2);
               }

               if ("forceUnicodeFont".equals(s1)) {
                  AbstractOption.field_216684_H.func_216742_a(this, s2);
               }

               if ("discrete_mouse_scroll".equals(s1)) {
                  AbstractOption.field_216681_E.func_216742_a(this, s2);
               }

               if ("invertYMouse".equals(s1)) {
                  AbstractOption.field_216685_I.func_216742_a(this, s2);
               }

               if ("realmsNotifications".equals(s1)) {
                  AbstractOption.field_216686_J.func_216742_a(this, s2);
               }

               if ("reducedDebugInfo".equals(s1)) {
                  AbstractOption.field_216687_K.func_216742_a(this, s2);
               }

               if ("showSubtitles".equals(s1)) {
                  AbstractOption.field_216688_L.func_216742_a(this, s2);
               }

               if ("snooperEnabled".equals(s1)) {
                  AbstractOption.field_216689_M.func_216742_a(this, s2);
               }

               if ("touchscreen".equals(s1)) {
                  AbstractOption.field_216690_N.func_216742_a(this, s2);
               }

               if ("fullscreen".equals(s1)) {
                  AbstractOption.field_216691_O.func_216742_a(this, s2);
               }

               if ("bobView".equals(s1)) {
                  AbstractOption.field_216692_P.func_216742_a(this, s2);
               }
               ...
               if ("fov".equals(s1)) {
                  this.fovSetting = (double)(parseFloat(s2) * 40.0F + 70.0F);
               }

               if ("gamma".equals(s1)) {
                  this.gammaSetting = (double)parseFloat(s2);
               }
               ...
               if ("particles".equals(s1)) {
                  this.field_74362_aa = ParticleStatus.func_216833_a(Integer.parseInt(s2));
               }

               if ("maxFps".equals(s1)) {
                  this.limitFramerate = Integer.parseInt(s2);
                  if (this.mc.mainWindow != null) {
                     this.mc.mainWindow.func_216526_a(this.limitFramerate);
                  }
               }

               if ("difficulty".equals(s1)) {
                  this.field_74318_M = Difficulty.byId(Integer.parseInt(s2));
               }
               ...
               if ("attackIndicator".equals(s1)) {
                  this.field_186716_M = AttackIndicatorStatus.func_216749_a(Integer.parseInt(s2));
               }
               ...
               if ("chatVisibility".equals(s1)) {
                  this.field_74343_n = ChatVisibility.func_221252_a(Integer.parseInt(s2));
               }
               ...
               if ("textBackgroundOpacity".equals(s1)) {
                  this.field_216845_l = (double)parseFloat(s2);
               }

               if ("backgroundForChatOnly".equals(s1)) {
                  this.field_216844_T = "true".equals(s2);
               }
               ...
               if ("mainHand".equals(s1)) {
                  this.field_186715_A = "left".equals(s2) ? HandSide.LEFT : HandSide.RIGHT;
               }

               if ("narrator".equals(s1)) {
                  this.field_192571_R = NarratorStatus.func_216825_a(Integer.parseInt(s2));
               }
   ...
   public void saveOptions() {
      ...
      try (PrintWriter printwriter = new PrintWriter(new OutputStreamWriter(new FileOutputStream(this.optionsFile), StandardCharsets.UTF_8))) {
         ...
         printwriter.println("difficulty:" + this.field_74318_M.getId());
   ...
   public void sendSettingsToServer() {
      if (this.mc.player != null) {
         ...
         this.mc.player.field_71174_a.sendPacket(new CClientSettingsPacket(this.language, this.renderDistanceChunks, this.field_74343_n, this.chatColours, i, this.field_186715_A));
      }
   ...
   public CloudOption func_216842_e() {
      return this.renderDistanceChunks >= 4 ? this.field_74345_l : CloudOption.OFF;
   }
