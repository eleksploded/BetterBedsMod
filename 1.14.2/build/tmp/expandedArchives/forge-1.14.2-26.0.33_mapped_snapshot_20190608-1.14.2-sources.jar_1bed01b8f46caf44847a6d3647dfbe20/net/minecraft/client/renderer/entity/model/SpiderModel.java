...
public class SpiderModel<T extends Entity> extends EntityModel<T> {
   ...
   public void func_212844_a_(T p_212844_1_, float p_212844_2_, float p_212844_3_, float p_212844_4_, float p_212844_5_, float p_212844_6_, float p_212844_7_) {
      this.field_78209_a.rotateAngleY = p_212844_5_ * ((float)Math.PI / 180F);
      this.field_78209_a.rotateAngleX = p_212844_6_ * ((float)Math.PI / 180F);
      ...
      float f3 = -(MathHelper.cos(p_212844_2_ * 0.6662F * 2.0F + 0.0F) * 0.4F) * p_212844_3_;
      float f4 = -(MathHelper.cos(p_212844_2_ * 0.6662F * 2.0F + (float)Math.PI) * 0.4F) * p_212844_3_;
      float f5 = -(MathHelper.cos(p_212844_2_ * 0.6662F * 2.0F + ((float)Math.PI / 2F)) * 0.4F) * p_212844_3_;
      float f6 = -(MathHelper.cos(p_212844_2_ * 0.6662F * 2.0F + ((float)Math.PI * 1.5F)) * 0.4F) * p_212844_3_;
      float f7 = Math.abs(MathHelper.sin(p_212844_2_ * 0.6662F + 0.0F) * 0.4F) * p_212844_3_;
      float f8 = Math.abs(MathHelper.sin(p_212844_2_ * 0.6662F + (float)Math.PI) * 0.4F) * p_212844_3_;
      float f9 = Math.abs(MathHelper.sin(p_212844_2_ * 0.6662F + ((float)Math.PI / 2F)) * 0.4F) * p_212844_3_;
      float f10 = Math.abs(MathHelper.sin(p_212844_2_ * 0.6662F + ((float)Math.PI * 1.5F)) * 0.4F) * p_212844_3_;
