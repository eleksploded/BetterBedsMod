...
public class ActiveRenderInfo {
   ...
   public void func_216772_a(IBlockReader p_216772_1_, Entity p_216772_2_, boolean p_216772_3_, boolean p_216772_4_, float p_216772_5_) {
      ...
      this.func_216775_b(MathHelper.func_219803_d((double)p_216772_5_, p_216772_2_.prevPosX, p_216772_2_.posX), MathHelper.func_219803_d((double)p_216772_5_, p_216772_2_.prevPosY, p_216772_2_.posY) + (double)MathHelper.func_219799_g(p_216772_5_, this.field_216802_n, this.field_216801_m), MathHelper.func_219803_d((double)p_216772_5_, p_216772_2_.prevPosZ, p_216772_2_.posZ));
      if (p_216772_3_) {
         if (p_216772_4_) {
            this.field_216798_j += 180.0F;
            this.field_216797_i += -this.field_216797_i * 2.0F;
            this.func_216784_b();
         }

         this.func_216782_a(-this.func_216779_a(4.0D), 0.0D, 0.0D);
      } else if (p_216772_2_ instanceof LivingEntity && ((LivingEntity)p_216772_2_).isPlayerSleeping()) {
   ...
   private double func_216779_a(double p_216779_1_) {
      for(int i = 0; i < 8; ++i) {
         ...
         RayTraceResult raytraceresult = this.field_216790_b.func_217299_a(new RayTraceContext(vec3d, vec3d1, RayTraceContext.BlockMode.COLLIDER, RayTraceContext.FluidMode.NONE, this.field_216791_c));
   ...
   protected void func_216784_b() {
      float f = MathHelper.cos((this.field_216798_j + 90.0F) * ((float)Math.PI / 180F));
      float f1 = MathHelper.sin((this.field_216798_j + 90.0F) * ((float)Math.PI / 180F));
      float f2 = MathHelper.cos(-this.field_216797_i * ((float)Math.PI / 180F));
      float f3 = MathHelper.sin(-this.field_216797_i * ((float)Math.PI / 180F));
      float f4 = MathHelper.cos((-this.field_216797_i + 90.0F) * ((float)Math.PI / 180F));
      float f5 = MathHelper.sin((-this.field_216797_i + 90.0F) * ((float)Math.PI / 180F));
   ...
   protected void func_216776_a(float p_216776_1_, float p_216776_2_) {
      this.field_216797_i = p_216776_2_;
      this.field_216798_j = p_216776_1_;
      this.func_216784_b();
   }
