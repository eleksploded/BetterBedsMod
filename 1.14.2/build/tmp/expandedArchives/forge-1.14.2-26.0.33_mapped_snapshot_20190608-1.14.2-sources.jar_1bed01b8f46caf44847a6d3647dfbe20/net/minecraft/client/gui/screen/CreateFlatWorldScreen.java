...
public class CreateFlatWorldScreen extends Screen {
   private final CreateWorldScreen field_146385_f;
   private FlatGenerationSettings field_146387_g = FlatGenerationSettings.getDefaultFlatGenerator();
   private String materialText;
   private String heightText;
   private CreateFlatWorldScreen.DetailsList field_146390_s;
   ...
   public CompoundNBT getGeneratorOptions() {
      return (CompoundNBT)this.field_146387_g.func_210834_a(NBTDynamicOps.INSTANCE).getValue();
   }
   ...
   public void setPreset(String preset) {
      this.field_146387_g = FlatGenerationSettings.createFlatGeneratorFromString(preset);
   }
   ...
   public void setGeneratorOptions(CompoundNBT nbt) {
      this.field_146387_g = FlatGenerationSettings.createFlatGenerator(new Dynamic<>(NBTDynamicOps.INSTANCE, nbt));
   }
   ...
   protected void init() {
      ...
      this.field_146390_s = new CreateFlatWorldScreen.DetailsList();
      this.children.add(this.field_146390_s);
      this.field_146386_v = this.addButton(new Button(this.width / 2 - 155, this.height - 52, 150, 20, I18n.format("createWorld.customize.flat.removeLayer"), (p_213007_1_) -> {
         if (this.hasSelectedLayer()) {
            List<FlatLayerInfo> list = this.field_146387_g.getFlatLayers();
            int i = this.field_146390_s.children().indexOf(this.field_146390_s.getSelected());
            int j = list.size() - i - 1;
            list.remove(j);
            this.field_146390_s.setSelected(list.isEmpty() ? null : this.field_146390_s.children().get(Math.min(i, list.size() - 1)));
            this.field_146387_g.updateLayers();
      ...
      this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("gui.done"), (p_213010_1_) -> {
         this.field_146385_f.field_146334_a = this.getGeneratorOptions();
         this.minecraft.displayGuiScreen(this.field_146385_f);
         this.field_146387_g.updateLayers();
         this.onLayersChanged();
      }));
   ...
   public void onLayersChanged() {
      this.field_146386_v.active = this.hasSelectedLayer();
   ...
   private boolean hasSelectedLayer() {
      return this.field_146390_s.getSelected() != null;
   }

   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      this.renderBackground();
      this.field_146390_s.render(p_render_1_, p_render_2_, p_render_3_);
   ...
   class DetailsList extends ExtendedList<CreateFlatWorldScreen.DetailsList.LayerEntry> {
      public DetailsList() {
         ...
         for(int i = 0; i < CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().size(); ++i) {
      ...
      public void setSelected(@Nullable CreateFlatWorldScreen.DetailsList.LayerEntry p_setSelected_1_) {
         ...
         if (p_setSelected_1_ != null) {
            FlatLayerInfo flatlayerinfo = CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().get(CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().size() - this.children().indexOf(p_setSelected_1_) - 1);
      ...
      public void func_214345_a() {
         ...
         for(int j = 0; j < CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().size(); ++j) {
            this.addEntry(new CreateFlatWorldScreen.DetailsList.LayerEntry());
         }
      ...
      class LayerEntry extends ExtendedList.AbstractListEntry<CreateFlatWorldScreen.DetailsList.LayerEntry> {
         ...
         public void render(int p_render_1_, int p_render_2_, int p_render_3_, int p_render_4_, int p_render_5_, int p_render_6_, int p_render_7_, boolean p_render_8_, float p_render_9_) {
            FlatLayerInfo flatlayerinfo = CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().get(CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().size() - p_render_1_ - 1);
            ...
            } else if (p_render_1_ == CreateFlatWorldScreen.this.field_146387_g.getFlatLayers().size() - 1) {
