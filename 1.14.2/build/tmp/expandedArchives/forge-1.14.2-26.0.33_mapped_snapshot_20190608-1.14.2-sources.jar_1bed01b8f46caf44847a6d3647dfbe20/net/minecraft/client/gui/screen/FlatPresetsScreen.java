...
public class FlatPresetsScreen extends Screen {
   ...
   private FlatPresetsScreen.SlotList field_146435_s;
   ...
   protected void init() {
      ...
      this.field_146433_u = new TextFieldWidget(this.font, 50, 40, this.width - 100, 20, this.presetsShare);
      this.field_146433_u.setMaxStringLength(1230);
      this.field_146433_u.setText(this.field_146432_g.getPreset());
      this.children.add(this.field_146433_u);
      this.field_146435_s = new FlatPresetsScreen.SlotList();
      this.children.add(this.field_146435_s);
      this.field_146434_t = this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, I18n.format("createWorld.customize.presets.select"), (p_213077_1_) -> {
         this.field_146432_g.setPreset(this.field_146433_u.getText());
         this.minecraft.displayGuiScreen(this.field_146432_g);
      }));
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      return this.field_146435_s.mouseScrolled(p_mouseScrolled_1_, p_mouseScrolled_3_, p_mouseScrolled_5_);
   }

   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String s = this.field_146433_u.getText();
      this.init(p_resize_1_, p_resize_2_, p_resize_3_);
      this.field_146433_u.setText(s);
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_146435_s.render(p_render_1_, p_render_2_, p_render_3_);
      ...
      this.field_146433_u.render(p_render_1_, p_render_2_, p_render_3_);
      super.render(p_render_1_, p_render_2_, p_render_3_);
   }

   public void tick() {
      this.field_146433_u.tick();
      super.tick();
   }

   public void func_213074_a(boolean p_213074_1_) {
      this.field_146434_t.active = p_213074_1_ || this.field_146433_u.getText().length() > 1;
   }
   ...
   class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry> {
      ...
      public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry> {
         ...
         private void func_214399_a() {
            ...
            FlatPresetsScreen.this.func_213074_a(true);
            FlatPresetsScreen.this.field_146433_u.setText((FlatPresetsScreen.FLAT_WORLD_PRESETS.get(SlotList.this.children().indexOf(this))).generatorInfo);
            FlatPresetsScreen.this.field_146433_u.setCursorPositionZero();
         }
