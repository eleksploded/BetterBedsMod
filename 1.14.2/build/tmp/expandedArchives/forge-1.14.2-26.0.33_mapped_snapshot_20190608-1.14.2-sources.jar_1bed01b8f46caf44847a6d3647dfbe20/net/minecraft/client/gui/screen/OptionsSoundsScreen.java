...
public class OptionsSoundsScreen extends Screen {
   ...
   protected void init() {
      ...
      ++i;
      this.addButton(new OptionButton(j, k + 24 * (i >> 1), 150, 20, AbstractOption.field_216688_L, AbstractOption.field_216688_L.func_216743_c(this.game_settings_4), (p_213105_1_) -> {
         AbstractOption.field_216688_L.func_216740_a(this.minecraft.gameSettings);
         p_213105_1_.setMessage(AbstractOption.field_216688_L.func_216743_c(this.minecraft.gameSettings));
         this.minecraft.gameSettings.saveOptions();
      }));
      this.addButton(new Button(this.width / 2 - 100, this.height / 6 + 168, 200, 20, I18n.format("gui.done"), (p_213104_1_) -> {
         this.minecraft.displayGuiScreen(this.field_146505_f);
      }));
   }
