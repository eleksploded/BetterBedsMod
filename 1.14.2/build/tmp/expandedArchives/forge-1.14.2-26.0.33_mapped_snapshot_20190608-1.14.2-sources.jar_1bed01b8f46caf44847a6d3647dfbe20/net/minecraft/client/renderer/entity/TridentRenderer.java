...
public class TridentRenderer extends EntityRenderer<TridentEntity> {
   ...
   public void doRender(TridentEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      GlStateManager.rotatef(MathHelper.func_219799_g(partialTicks, entity.prevRotationPitch, entity.rotationPitch) + 90.0F, 0.0F, 0.0F, 1.0F);
   ...
   protected void func_203085_b(TridentEntity p_203085_1_, double p_203085_2_, double p_203085_4_, double p_203085_6_, float p_203085_8_, float p_203085_9_) {
      ...
      if (entity != null && p_203085_1_.func_203047_q()) {
         ...
         double d0 = (double)(MathHelper.func_219799_g(p_203085_9_ * 0.5F, entity.rotationYaw, entity.prevRotationYaw) * ((float)Math.PI / 180F));
         double d1 = Math.cos(d0);
         double d2 = Math.sin(d0);
         double d3 = MathHelper.func_219803_d((double)p_203085_9_, entity.prevPosX, entity.posX);
         double d4 = MathHelper.func_219803_d((double)p_203085_9_, entity.prevPosY + (double)entity.getEyeHeight() * 0.8D, entity.posY + (double)entity.getEyeHeight() * 0.8D);
         double d5 = MathHelper.func_219803_d((double)p_203085_9_, entity.prevPosZ, entity.posZ);
         double d6 = d1 - d2;
         double d7 = d2 + d1;
         double d8 = MathHelper.func_219803_d((double)p_203085_9_, p_203085_1_.prevPosX, p_203085_1_.posX);
         double d9 = MathHelper.func_219803_d((double)p_203085_9_, p_203085_1_.prevPosY, p_203085_1_.posY);
         double d10 = MathHelper.func_219803_d((double)p_203085_9_, p_203085_1_.prevPosZ, p_203085_1_.posZ);
