...
public class MerchantScreen extends ContainerScreen<MerchantContainer> {
   ...
   private void func_195391_j() {
      this.field_147002_h.setCurrentRecipeIndex(this.selectedMerchantRecipe);
      this.field_147002_h.func_217046_g(this.selectedMerchantRecipe);
   ...
   protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
      int i = this.field_147002_h.func_217049_g();
      int j = this.ySize - 94;
      if (i > 0 && i <= 5 && this.field_147002_h.func_217042_i()) {
         ...
         this.font.drawString(this.field_213127_e.getDisplayName().getFormattedText(), 107.0F, (float)j, 4210752);
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      MerchantOffers merchantoffers = this.field_147002_h.func_217051_h();
   ...
   private void func_214130_a(int p_214130_1_, int p_214130_2_, MerchantOffer p_214130_3_) {
      this.minecraft.getTextureManager().bindTexture(MERCHANT_GUI_TEXTURE);
      int i = this.field_147002_h.func_217049_g();
      int j = this.field_147002_h.func_217048_e();
      if (i < 5) {
         ...
         if (j >= k && VillagerData.func_221128_d(i)) {
            ...
            int j1 = this.field_147002_h.func_217047_f();
            if (j1 > 0) {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      if (!merchantoffers.isEmpty()) {
         ...
         GlStateManager.disableLighting();
         if (this.field_147002_h.func_217042_i()) {
         ...
         for(MerchantScreen.TradeButton merchantscreen$tradebutton : this.field_214138_m) {
            ...
            merchantscreen$tradebutton.visible = merchantscreen$tradebutton.field_212938_a < this.field_147002_h.func_217051_h().size();
         }
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      int i = this.field_147002_h.func_217051_h().size();
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      ...
      int i = (this.width - this.xSize) / 2;
      int j = (this.height - this.ySize) / 2;
      if (this.func_214135_a(this.field_147002_h.func_217051_h().size()) && p_mouseClicked_1_ > (double)(i + 94) && p_mouseClicked_1_ < (double)(i + 94 + 6) && p_mouseClicked_3_ > (double)(j + 18) && p_mouseClicked_3_ <= (double)(j + 18 + 139 + 1)) {
   ...
   class TradeButton extends Button {
      ...
      public void renderToolTip(int p_renderToolTip_1_, int p_renderToolTip_2_) {
         if (this.isHovered && MerchantScreen.this.field_147002_h.func_217051_h().size() > this.field_212938_a + MerchantScreen.this.field_214139_n) {
            if (p_renderToolTip_1_ < this.x + 20) {
               ItemStack itemstack = MerchantScreen.this.field_147002_h.func_217051_h().get(this.field_212938_a + MerchantScreen.this.field_214139_n).func_222205_b();
               ...
               ItemStack itemstack2 = MerchantScreen.this.field_147002_h.func_217051_h().get(this.field_212938_a + MerchantScreen.this.field_214139_n).func_222202_c();
               if (!itemstack2.isEmpty()) {
                  MerchantScreen.this.renderTooltip(itemstack2, p_renderToolTip_1_, p_renderToolTip_2_);
               }
            } else if (p_renderToolTip_1_ > this.x + 65) {
               ItemStack itemstack1 = MerchantScreen.this.field_147002_h.func_217051_h().get(this.field_212938_a + MerchantScreen.this.field_214139_n).func_222200_d();
