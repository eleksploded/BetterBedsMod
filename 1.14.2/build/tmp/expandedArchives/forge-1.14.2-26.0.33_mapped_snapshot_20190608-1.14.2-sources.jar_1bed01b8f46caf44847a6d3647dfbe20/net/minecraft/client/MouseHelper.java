...
public class MouseHelper {
   ...
   private void mouseButtonCallback(long handle, int button, int action, int mods) {
      if (handle == this.minecraft.mainWindow.getHandle()) {
         ...
         if (this.minecraft.field_213279_p == null) {
            if (this.minecraft.field_71462_r == null) {
               ...
               if (flag) {
                  Screen.wrapScreenError(() -> {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseClickedPre(this.minecraft.field_71462_r, d0, d1, p_198023_3_f);
                     if (!aboolean[0]) aboolean[0] = this.minecraft.field_71462_r.mouseClicked(d0, d1, p_198023_3_f);
                     if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseClickedPost(this.minecraft.field_71462_r, d0, d1, p_198023_3_f);
                  }, "mouseClicked event handler", this.minecraft.field_71462_r.getClass().getCanonicalName());
               } else {
                  Screen.wrapScreenError(() -> {
                     aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseReleasedPre(this.minecraft.field_71462_r, d0, d1, p_198023_3_f);
                     if (!aboolean[0]) aboolean[0] = this.minecraft.field_71462_r.mouseReleased(d0, d1, p_198023_3_f);
                     if (!aboolean[0]) aboolean[0] = net.minecraftforge.client.ForgeHooksClient.onGuiMouseReleasedPost(this.minecraft.field_71462_r, d0, d1, p_198023_3_f);
                  }, "mouseReleased event handler", this.minecraft.field_71462_r.getClass().getCanonicalName());
               }
            }
         }

         if (!aboolean[0] && (this.minecraft.field_71462_r == null || this.minecraft.field_71462_r.passEvents) && this.minecraft.field_213279_p == null) {
            if (button == 0) {
               this.leftDown = flag;
            } else if (button == 2) {
            ...
            if (flag) {
               if (this.minecraft.player.isSpectator() && button == 2) {
                  this.minecraft.field_71456_v.getSpectatorGui().onMiddleClick();
               } else {
   ...
   private void scrollCallback(long handle, double xoffset, double yoffset) {
      if (handle == Minecraft.getInstance().mainWindow.getHandle()) {
         double d0 = (this.minecraft.gameSettings.field_216843_O ? Math.signum(yoffset) : yoffset) * this.minecraft.gameSettings.mouseWheelSensitivity;
         if (this.minecraft.field_213279_p == null) {
            if (this.minecraft.field_71462_r != null) {
               ...
               if (net.minecraftforge.client.ForgeHooksClient.onGuiMouseScrollPre(this, this.minecraft.field_71462_r, d0)) return;
               if (this.minecraft.field_71462_r.mouseScrolled(d1, d2, d0)) return;
               net.minecraftforge.client.ForgeHooksClient.onGuiMouseScrollPost(this, this.minecraft.field_71462_r, d0);
               ...
               if (this.minecraft.player.isSpectator()) {
                  if (this.minecraft.field_71456_v.getSpectatorGui().isMenuActive()) {
                     this.minecraft.field_71456_v.getSpectatorGui().onMouseScroll((double)(-f1));
                  } else {
                     float f = MathHelper.clamp(this.minecraft.player.playerAbilities.getFlySpeed() + f1 * 0.005F, 0.0F, 0.2F);
                     this.minecraft.player.playerAbilities.setFlySpeed(f);
                  }
               } else {
   ...
   private void cursorPosCallback(long handle, double xpos, double ypos) {
      if (handle == Minecraft.getInstance().mainWindow.getHandle()) {
         ...
         IGuiEventListener iguieventlistener = this.minecraft.field_71462_r;
         if (iguieventlistener != null && this.minecraft.field_213279_p == null) {
            ...
            Screen.wrapScreenError(() -> {
               iguieventlistener.func_212927_b(d0, d1);
            ...
            if (this.activeButton != -1 && this.eventTime > 0.0D) {
               ...
               Screen.wrapScreenError(() -> {
               if (net.minecraftforge.client.ForgeHooksClient.onGuiMouseDragPre(this.minecraft.field_71462_r, d0, d1, this.activeButton, d2, d3)) return;
               if (iguieventlistener.mouseDragged(d0, d1, this.activeButton, d2, d3)) return;
               net.minecraftforge.client.ForgeHooksClient.onGuiMouseDragPost(this.minecraft.field_71462_r, d0, d1, this.activeButton, d2, d3);
