...
public class ShulkerColorLayer extends LayerRenderer<ShulkerEntity, ShulkerModel<ShulkerEntity>> {
   ...
   public void func_212842_a_(ShulkerEntity p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      GlStateManager.pushMatrix();
      switch(p_212842_1_.getAttachmentFacing()) {
      case DOWN:
      default:
         break;
      case EAST:
      ...
      RendererModel renderermodel = this.func_215332_c().getHead();
      ...
      if (dyecolor == null) {
         this.func_215333_a(ShulkerRenderer.field_204402_a);
      } else {
         this.func_215333_a(ShulkerRenderer.SHULKER_ENDERGOLEM_TEXTURE[dyecolor.getId()]);
      }
