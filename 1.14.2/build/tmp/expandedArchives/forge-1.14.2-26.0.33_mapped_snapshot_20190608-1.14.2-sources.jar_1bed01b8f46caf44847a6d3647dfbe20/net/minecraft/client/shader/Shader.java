...
public class Shader implements AutoCloseable {
   ...
   public Shader(IResourceManager resourceManager, String programName, Framebuffer framebufferInIn, Framebuffer framebufferOutIn) throws IOException {
      this.field_148051_c = new ShaderInstance(resourceManager, programName);
   ...
   public void render(float partialTicks) {
      ...
      this.field_148051_c.func_216537_a("DiffuseSampler", this.framebufferIn);

      for(int i = 0; i < this.listAuxFramebuffers.size(); ++i) {
         this.field_148051_c.func_216537_a(this.listAuxNames.get(i), this.listAuxFramebuffers.get(i));
         this.field_148051_c.func_216538_b("AuxSize" + i).set((float)this.listAuxWidths.get(i), (float)this.listAuxHeights.get(i));
      }

      this.field_148051_c.func_216538_b("ProjMat").set(this.projectionMatrix);
      this.field_148051_c.func_216538_b("InSize").set((float)this.framebufferIn.framebufferTextureWidth, (float)this.framebufferIn.framebufferTextureHeight);
      this.field_148051_c.func_216538_b("OutSize").set(f, f1);
      this.field_148051_c.func_216538_b("Time").set(partialTicks);
      Minecraft minecraft = Minecraft.getInstance();
      this.field_148051_c.func_216538_b("ScreenSize").set((float)minecraft.mainWindow.getFramebufferWidth(), (float)minecraft.mainWindow.getFramebufferHeight());
