...
public class ClientSuggestionProvider implements ISuggestionProvider {
   ...
   public Collection<String> getPlayerNames() {
      ...
      for(NetworkPlayerInfo networkplayerinfo : this.field_197016_a.getPlayerInfoMap()) {
   ...
   public Collection<String> getTeamNames() {
      return this.field_197016_a.getWorld().getScoreboard().getTeamNames();
   }
   ...
   public Stream<ResourceLocation> getRecipeResourceLocations() {
      return this.field_197016_a.getRecipeManager().func_215378_c();
   }
   ...
   public CompletableFuture<Suggestions> getSuggestionsFromServer(CommandContext<ISuggestionProvider> context, SuggestionsBuilder suggestionsBuilder) {
      ...
      this.field_197016_a.sendPacket(new CTabCompletePacket(i, context.getInput()));
      return this.future;
   }
