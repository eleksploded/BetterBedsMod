...
public class HeadLayer<T extends LivingEntity, M extends EntityModel<T> & IHasHead> extends LayerRenderer<T, M> {
   ...
   public void func_212842_a_(T p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      ItemStack itemstack = p_212842_1_.getItemStackFromSlot(EquipmentSlotType.HEAD);
      if (!itemstack.isEmpty()) {
         ...
         boolean flag = p_212842_1_ instanceof VillagerEntity || p_212842_1_ instanceof ZombieVillagerEntity;
         if (p_212842_1_.isChild() && !(p_212842_1_ instanceof VillagerEntity)) {
            float f = 2.0F;
            float f1 = 1.4F;
         ...
         ((IHasHead)this.func_215332_c()).func_217142_c(0.0625F);
         ...
         if (item instanceof BlockItem && ((BlockItem)item).getBlock() instanceof AbstractSkullBlock) {
            ...
            SkullTileEntityRenderer.field_147536_b.render(-0.5F, 0.0F, -0.5F, (Direction)null, 180.0F, ((AbstractSkullBlock)((BlockItem)item).getBlock()).getSkullType(), gameprofile, -1, p_212842_2_);
            ...
            Minecraft.getInstance().getFirstPersonRenderer().renderItem(p_212842_1_, itemstack, ItemCameraTransforms.TransformType.HEAD);
         }
