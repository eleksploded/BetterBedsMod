...
public class VillagerLevelPendantLayer<T extends LivingEntity & IVillagerDataHolder, M extends EntityModel<T> & IHeadToggle> extends LayerRenderer<T, M> implements IResourceManagerReloadListener {
   ...
   public VillagerLevelPendantLayer(IEntityRenderer<T, M> p_i50955_1_, IReloadableResourceManager p_i50955_2_, String p_i50955_3_) {
      ...
      p_i50955_2_.func_219534_a(this);
   }
   ...
   public void func_212842_a_(T p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      if (!p_212842_1_.isInvisible()) {
         VillagerData villagerdata = ((IVillagerDataHolder)p_212842_1_).func_213700_eh();
         IVillagerType ivillagertype = villagerdata.getType();
         VillagerProfession villagerprofession = villagerdata.getProfession();
         VillagerMetadataSection.HatType villagermetadatasection$hattype = this.func_215350_a(this.field_215353_b, "type", Registry.field_218369_K, ivillagertype);
         ...
         M m = this.func_215332_c();
         this.func_215333_a(this.func_215351_a("type", Registry.field_218369_K.getKey(ivillagertype)));
         ...
         m.render(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
         ((IHeadToggle)m).func_217146_a(true);
         if (villagerprofession != VillagerProfession.field_221151_a && !p_212842_1_.isChild()) {
            this.func_215333_a(this.func_215351_a("profession", Registry.field_218370_L.getKey(villagerprofession)));
            m.render(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
            this.func_215333_a(this.func_215351_a("profession_level", field_215352_a.get(MathHelper.clamp(villagerdata.getLevel(), 1, field_215352_a.size()))));
            m.render(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_);
         }
