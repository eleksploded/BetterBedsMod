...
public class EditMinecartCommandBlockScreen extends AbstractCommandBlockScreen {
   ...
   protected void init() {
      ...
      this.field_195237_a.setText(this.getLogic().getCommand());
   }
   ...
   protected void func_195235_a(CommandBlockLogic p_195235_1_) {
      if (p_195235_1_ instanceof MinecartCommandBlockEntity.MinecartCommandLogic) {
         ...
         this.minecraft.getConnection().sendPacket(new CUpdateMinecartCommandBlockPacket(minecartcommandblockentity$minecartcommandlogic.getMinecart().getEntityId(), this.field_195237_a.getText(), p_195235_1_.shouldTrackOutput()));
      }
