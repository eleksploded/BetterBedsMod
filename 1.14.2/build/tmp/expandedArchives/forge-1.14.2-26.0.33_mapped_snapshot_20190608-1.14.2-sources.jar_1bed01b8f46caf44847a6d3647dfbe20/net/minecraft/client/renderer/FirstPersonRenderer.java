...
public class FirstPersonRenderer {
   ...
   private void rotateArm(float partialTicks) {
      ...
      float f = MathHelper.func_219799_g(partialTicks, clientplayerentity.prevRenderArmPitch, clientplayerentity.renderArmPitch);
      float f1 = MathHelper.func_219799_g(partialTicks, clientplayerentity.prevRenderArmYaw, clientplayerentity.renderArmYaw);
   ...
   private void renderArm(HandSide side) {
      ...
      EntityRenderer<AbstractClientPlayerEntity> entityrenderer = this.field_178111_g.getEntityRenderObject(this.mc.player);
   ...
   private void renderArmFirstPerson(float equippedProgress, float swingProgress, HandSide side) {
      ...
      PlayerRenderer playerrenderer = this.field_178111_g.getEntityRenderObject(abstractclientplayerentity);
      GlStateManager.disableCull();
      if (flag) {
   ...
   public void renderItemInFirstPerson(float partialTicks) {
      ...
      Hand hand = MoreObjects.firstNonNull(abstractclientplayerentity.field_184622_au, Hand.MAIN_HAND);
      float f1 = MathHelper.func_219799_g(partialTicks, abstractclientplayerentity.prevRotationPitch, abstractclientplayerentity.rotationPitch);
      float f2 = MathHelper.func_219799_g(partialTicks, abstractclientplayerentity.prevRotationYaw, abstractclientplayerentity.rotationYaw);
      boolean flag = true;
      boolean flag1 = true;
      if (abstractclientplayerentity.isHandActive()) {
         ...
         if (hand1 == Hand.MAIN_HAND) {
            ...
            if (itemstack1.getItem() instanceof net.minecraft.item.CrossbowItem && CrossbowItem.func_220012_d(itemstack1)) {
               flag1 = false;
            }
         }
      } else {
         ...
         if (itemstack2.getItem() instanceof net.minecraft.item.CrossbowItem && CrossbowItem.func_220012_d(itemstack2)) {
            flag1 = !flag;
         }

         if (itemstack3.getItem() instanceof net.minecraft.item.CrossbowItem && CrossbowItem.func_220012_d(itemstack3)) {
      ...
      if (flag) {
         ...
         float f5 = 1.0F - MathHelper.func_219799_g(partialTicks, this.prevEquippedProgressMainHand, this.equippedProgressMainHand);
      ...
      if (flag1) {
         ...
         float f6 = 1.0F - MathHelper.func_219799_g(partialTicks, this.prevEquippedProgressOffHand, this.equippedProgressOffHand);
   ...
   public void renderItemInFirstPerson(AbstractClientPlayerEntity player, float partialTicks, float pitch, Hand hand, float swingProgress, ItemStack stack, float equippedProgress) {
      ...
      } else if (stack.getItem() == Items.field_222114_py) {
         boolean flag1 = CrossbowItem.func_220012_d(stack);
