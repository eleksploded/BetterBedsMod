...
public abstract class ContainerScreen<T extends Container> extends Screen implements IHasContainer<T> {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      for(int i1 = 0; i1 < this.field_147002_h.inventorySlots.size(); ++i1) {
         Slot slot = this.field_147002_h.inventorySlots.get(i1);
         if (slot.isEnabled()) {
            this.drawSlot(slot);
         }
      ...
      if (!this.returningStack.isEmpty()) {
         ...
         int l2 = this.field_146989_A.xPos - this.touchUpX;
         int i3 = this.field_146989_A.yPos - this.touchUpY;
   ...
   protected void renderHoveredToolTip(int p_191948_1_, int p_191948_2_) {
      if (this.minecraft.player.inventory.getItemStack().isEmpty() && this.field_147006_u != null && this.field_147006_u.getHasStack()) {
         this.renderTooltip(this.field_147006_u.getStack(), p_191948_1_, p_191948_2_);
      }
   ...
   private void drawSlot(Slot slotIn) {
      ...
      boolean flag = false;
      boolean flag1 = slotIn == this.field_147005_v && !this.draggedStack.isEmpty() && !this.isRightMouseClick;
      ItemStack itemstack1 = this.minecraft.player.inventory.getItemStack();
      String s = null;
      if (slotIn == this.field_147005_v && !this.draggedStack.isEmpty() && this.isRightMouseClick && !itemstack.isEmpty()) {
         itemstack = itemstack.copy();
         ...
         if (Container.canAddItemToSlot(slotIn, itemstack1, true) && this.field_147002_h.canDragIntoSlot(slotIn)) {
   ...
   private Slot getSelectedSlot(double p_195360_1_, double p_195360_3_) {
      for(int i = 0; i < this.field_147002_h.inventorySlots.size(); ++i) {
         Slot slot = this.field_147002_h.inventorySlots.get(i);
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      if (super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
         ...
         this.doubleClick = this.field_146998_K == slot && i - this.lastClickTime < 250L && this.lastClickButton == p_mouseClicked_5_;
               ...
               if (this.minecraft.gameSettings.touchscreen) {
                  ...
                  if (this.minecraft.player.inventory.getItemStack().isEmpty()) {
                     if (this.minecraft.gameSettings.keyBindPickBlock.isActiveAndMatches(mouseKey)) {
                        ...
                        boolean flag2 = l != -999 && (InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 340) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 344));
   ...
   public boolean mouseDragged(double p_mouseDragged_1_, double p_mouseDragged_3_, int p_mouseDragged_5_, double p_mouseDragged_6_, double p_mouseDragged_8_) {
      ...
      ItemStack itemstack = this.minecraft.player.inventory.getItemStack();
      if (this.field_147005_v != null && this.minecraft.gameSettings.touchscreen) {
         if (p_mouseDragged_5_ == 0 || p_mouseDragged_5_ == 1) {
            if (this.draggedStack.isEmpty()) {
               if (slot != this.field_147005_v && !this.field_147005_v.getStack().isEmpty()) {
                  this.draggedStack = this.field_147005_v.getStack().copy();
               }
               ...
               if (this.field_146985_D == slot) {
                  if (i - this.dragItemDropDelay > 500L) {
                     this.handleMouseClick(this.field_147005_v, this.field_147005_v.slotNumber, 0, ClickType.PICKUP);
      ...
      } else if (this.dragSplitting && slot != null && !itemstack.isEmpty() && (itemstack.getCount() > this.dragSplittingSlots.size() || this.dragSplittingLimit == 2) && Container.canAddItemToSlot(slot, itemstack, true) && slot.isItemValid(itemstack) && this.field_147002_h.canDragIntoSlot(slot)) {
   ...
   public boolean mouseReleased(double p_mouseReleased_1_, double p_mouseReleased_3_, int p_mouseReleased_5_) {
      ...
      if (this.doubleClick && slot != null && p_mouseReleased_5_ == 0 && this.field_147002_h.canMergeSlot(ItemStack.EMPTY, slot)) {
         if (hasShiftDown()) {
            if (!this.shiftClickedSlot.isEmpty()) {
               for(Slot slot2 : this.field_147002_h.inventorySlots) {
         ...
         if (this.field_147005_v != null && this.minecraft.gameSettings.touchscreen) {
            if (p_mouseReleased_5_ == 0 || p_mouseReleased_5_ == 1) {
               if (this.draggedStack.isEmpty() && slot != this.field_147005_v) {
                  this.draggedStack = this.field_147005_v.getStack();
               }

               boolean flag2 = Container.canAddItemToSlot(slot, this.draggedStack, false);
               if (k != -1 && !this.draggedStack.isEmpty() && flag2) {
                  this.handleMouseClick(this.field_147005_v, this.field_147005_v.slotNumber, p_mouseReleased_5_, ClickType.PICKUP);
            ...
            if (this.minecraft.gameSettings.keyBindPickBlock.isActiveAndMatches(mouseKey)) {
               ...
               boolean flag1 = k != -999 && (InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 340) || InputMappings.func_216506_a(Minecraft.getInstance().mainWindow.getHandle(), 344));
               if (flag1) {
                  this.shiftClickedSlot = slot != null && slot.getHasStack() ? slot.getStack().copy() : ItemStack.EMPTY;
               }
   ...
   protected void handleMouseClick(Slot slotIn, int slotId, int mouseButton, ClickType type) {
      ...
      this.minecraft.field_71442_b.windowClick(this.field_147002_h.windowId, slotId, mouseButton, type, this.minecraft.player);
   }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         ...
         if (this.field_147006_u != null && this.field_147006_u.getHasStack()) {
            if (this.minecraft.gameSettings.keyBindPickBlock.isActiveAndMatches(mouseKey)) {
               this.handleMouseClick(this.field_147006_u, this.field_147006_u.slotNumber, 0, ClickType.CLONE);
               return true; // Forge MC-146650: Needs to return true when the key is handled.
            } else if (this.minecraft.gameSettings.keyBindDrop.isActiveAndMatches(mouseKey)) {
               this.handleMouseClick(this.field_147006_u, this.field_147006_u.slotNumber, hasControlDown() ? 1 : 0, ClickType.THROW);
               return true; // Forge MC-146650: Needs to return true when the key is handled.
            }
         }
   ...
   protected boolean func_195363_d(int p_195363_1_, int p_195363_2_) {
      if (this.minecraft.player.inventory.getItemStack().isEmpty() && this.field_147006_u != null) {
         for(int i = 0; i < 9; ++i) {
            if (this.minecraft.gameSettings.keyBindsHotbar[i].isActiveAndMatches(InputMappings.getInputByCode(p_195363_1_, p_195363_2_))) {
               this.handleMouseClick(this.field_147006_u, this.field_147006_u.slotNumber, i, ClickType.SWAP);
               return true;
            }
         }
      }
   ...
   public void removed() {
      if (this.minecraft.player != null) {
         this.field_147002_h.onContainerClosed(this.minecraft.player);
      }
   }
