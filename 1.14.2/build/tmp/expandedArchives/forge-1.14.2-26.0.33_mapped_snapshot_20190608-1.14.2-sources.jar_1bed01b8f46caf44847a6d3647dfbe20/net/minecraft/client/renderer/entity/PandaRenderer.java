...
public class PandaRenderer extends MobRenderer<PandaEntity, PandaModel<PandaEntity>> {
   ...
   protected void applyRotations(PandaEntity entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
      ...
      if (f6 > 0.0F) {
         ...
         GlStateManager.rotatef(MathHelper.func_219799_g(f6, entityLiving.rotationPitch, entityLiving.rotationPitch + 90.0F), 1.0F, 0.0F, 0.0F);
      ...
      if (f8 > 0.0F) {
         ...
         GlStateManager.rotatef(MathHelper.func_219799_g(f8, entityLiving.rotationPitch, entityLiving.rotationPitch + 180.0F), 1.0F, 0.0F, 0.0F);
      }

   }

   private float func_217775_a(float p_217775_1_, float p_217775_2_, int p_217775_3_, float p_217775_4_, float p_217775_5_) {
      return (float)p_217775_3_ < p_217775_5_ ? MathHelper.func_219799_g(p_217775_4_, p_217775_1_, p_217775_2_) : p_217775_1_;
   }
}