...
public class RecipeBookGui extends AbstractGui implements IRenderable, IGuiEventListener, IRecipeUpdateListener, IRecipePlacer<Ingredient> {
   ...
   private RecipeTabToggleWidget field_191913_x;
   protected ToggleWidget field_193960_m;
   protected RecipeBookContainer<?> field_201522_g;
   protected Minecraft mc;
   private TextFieldWidget field_193962_q;
   private String lastSearch = "";
   protected ClientRecipeBook field_193964_s;
   ...
   public void func_201520_a(int p_201520_1_, int p_201520_2_, Minecraft p_201520_3_, boolean p_201520_4_, RecipeBookContainer<?> p_201520_5_) {
      ...
      this.field_193964_s = p_201520_3_.player.getRecipeBook();
   ...
   public void func_201518_a(boolean p_201518_1_) {
      ...
      String s = this.field_193962_q != null ? this.field_193962_q.getText() : "";
      this.field_193962_q = new TextFieldWidget(this.mc.fontRenderer, i + 25, j + 14, 80, 9 + 5, I18n.format("itemGroup.search"));
      ...
      this.field_193962_q.setText(s);
      this.recipeBookPage.init(this.mc, i, j);
      this.recipeBookPage.addListener(this);
      this.field_193960_m = new ToggleWidget(i + 110, j + 12, 26, 16, this.field_193964_s.isFilteringCraftable(this.field_201522_g));
      this.func_205702_a();
      ...
      if (this.field_191913_x != null) {
         this.field_191913_x = this.recipeTabs.stream().filter((p_209505_1_) -> {
            return p_209505_1_.func_201503_d().equals(this.field_191913_x.func_201503_d());
         }).findFirst().orElse((RecipeTabToggleWidget)null);
      }

      if (this.field_191913_x == null) {
         this.field_191913_x = this.recipeTabs.get(0);
      }

      this.field_191913_x.setStateTriggered(true);
   ...
   protected void func_205702_a() {
      this.field_193960_m.initTextureValues(152, 41, 28, 18, RECIPE_BOOK);
   }
   ...
   protected void setVisible(boolean p_193006_1_) {
      this.field_193964_s.setGuiOpen(p_193006_1_);
      if (!p_193006_1_) {
   ...
   private void updateCollections(boolean p_193003_1_) {
      List<RecipeList> list = this.field_193964_s.getRecipes(this.field_191913_x.func_201503_d());
      list.forEach((p_193944_1_) -> {
         p_193944_1_.canCraft(this.stackedContents, this.field_201522_g.getWidth(), this.field_201522_g.getHeight(), this.field_193964_s);
      });
      ...
      if (this.field_193964_s.isFilteringCraftable(this.field_201522_g)) {
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      if (this.isVisible()) {
         ...
         this.field_193962_q.render(p_render_1_, p_render_2_, p_render_3_);
      ...
      if (this.isVisible()) {
         ...
         if (this.field_193960_m.isHovered()) {
            ...
            if (this.mc.field_71462_r != null) {
               this.mc.field_71462_r.renderTooltip(s, p_191876_3_, p_191876_4_);
            }
         }
   ...
   protected String func_205703_f() {
      return I18n.format(this.field_193960_m.isStateTriggered() ? "gui.recipebook.toggleRecipes.craftable" : "gui.recipebook.toggleRecipes.all");
   }
   ...
   private void renderGhostRecipeTooltip(int p_193015_1_, int p_193015_2_, int p_193015_3_, int p_193015_4_) {
      ...
      if (itemstack != null && this.mc.field_71462_r != null) {
         this.mc.field_71462_r.renderTooltip(this.mc.field_71462_r.getTooltipFromItem(itemstack), p_193015_3_, p_193015_4_);
      }
      ...
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (this.recipeBookPage.func_198955_a(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_, (this.width - 147) / 2 - this.xOffset, (this.height - 166) / 2, 147, 166)) {
            ...
            if (irecipe != null && recipelist != null) {
               ...
               this.ghostRecipe.clear();
               this.mc.field_71442_b.func_203413_a(this.mc.player.openContainer.windowId, irecipe, Screen.hasShiftDown());
            ...
            this.field_193960_m.setStateTriggered(flag);
            this.sendUpdateSettings();
            this.updateCollections(false);
            return true;
         } else {
            for(RecipeTabToggleWidget recipetabtogglewidget : this.recipeTabs) {
               if (recipetabtogglewidget.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_)) {
                  if (this.field_191913_x != recipetabtogglewidget) {
                     this.field_191913_x.setStateTriggered(false);
                     this.field_191913_x = recipetabtogglewidget;
                     this.field_191913_x.setStateTriggered(true);
   ...
   protected boolean toggleCraftableFilter() {
      boolean flag = !this.field_193964_s.isFilteringCraftable();
      this.field_193964_s.setFilteringCraftable(flag);
      return flag;
   }
   ...
   public boolean func_195604_a(double p_195604_1_, double p_195604_3_, int p_195604_5_, int p_195604_6_, int p_195604_7_, int p_195604_8_, int p_195604_9_) {
      if (!this.isVisible()) {
         ...
         return flag && !flag1 && !this.field_191913_x.isHovered();
      }
   }
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      ...
      if (this.isVisible() && !this.mc.player.isSpectator()) {
         if (p_keyPressed_1_ == 256 && !this.isOffsetNextToMainGUI()) {
            ...
            this.updateSearch();
            return true;
         } else if (this.field_193962_q.isFocused() && this.field_193962_q.getVisible() && p_keyPressed_1_ != 256) {
            return true;
         } else if (this.mc.gameSettings.keyBindChat.matchesKey(p_keyPressed_1_, p_keyPressed_2_) && !this.field_193962_q.isFocused()) {
            this.field_199738_u = true;
            this.field_193962_q.setFocused2(true);
            return true;
         } else {
            return false;
         }
   ...
   private void updateSearch() {
      String s = this.field_193962_q.getText().toLowerCase(Locale.ROOT);
      this.pirateRecipe(s);
   ...
   protected void sendUpdateSettings() {
      if (this.mc.getConnection() != null) {
         this.mc.getConnection().sendPacket(new CRecipeInfoPacket(this.field_193964_s.isGuiOpen(), this.field_193964_s.isFilteringCraftable(), this.field_193964_s.isFurnaceGuiOpen(), this.field_193964_s.isFurnaceFilteringCraftable(), this.field_193964_s.func_216758_e(), this.field_193964_s.func_216761_f()));
      }
