...
public class BlockModelRenderer {
   ...
   private void renderQuadsSmooth(IEnviromentBlockReader p_217630_1_, BlockState p_217630_2_, BlockPos p_217630_3_, BufferBuilder p_217630_4_, List<BakedQuad> p_217630_5_, float[] p_217630_6_, BitSet p_217630_7_, BlockModelRenderer.AmbientOcclusionFace p_217630_8_) {
      ...
      for(int j = p_217630_5_.size(); i < j; ++i) {
         ...
         if (bakedquad.hasTintIndex()) {
            int k = this.blockColors.func_216860_a(p_217630_2_, p_217630_1_, p_217630_3_, bakedquad.getTintIndex());
   ...
   private void renderQuadsFlat(IEnviromentBlockReader p_217636_1_, BlockState p_217636_2_, BlockPos p_217636_3_, int p_217636_4_, boolean p_217636_5_, BufferBuilder p_217636_6_, List<BakedQuad> p_217636_7_, BitSet p_217636_8_) {
      ...
      for(int j = p_217636_7_.size(); i < j; ++i) {
         ...
         if (bakedquad.hasTintIndex()) {
            int k = this.blockColors.func_216860_a(p_217636_2_, p_217636_1_, p_217636_3_, bakedquad.getTintIndex());
            float f = (float)(k >> 16 & 255) / 255.0F;
            float f1 = (float)(k >> 8 & 255) / 255.0F;
            float f2 = (float)(k & 255) / 255.0F;
            if(bakedquad.shouldApplyDiffuseLighting()) {
   ...
   public void renderModelBrightness(IBakedModel model, BlockState state, float brightness, boolean glDisabled) {
      ...
      int i = this.blockColors.func_216860_a(state, (IEnviromentBlockReader)null, (BlockPos)null, 0);
   ...
   class AmbientOcclusionFace {
      ...
      public void updateVertexBrightness(IEnviromentBlockReader reader, BlockState state, BlockPos pos, Direction dir, float[] p_217629_5_, BitSet bits) {
         ...
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[0]);
         ...
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[1]);
         ...
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[2]);
         ...
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[3]);
         ...
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[0]).move(dir);
         boolean flag = reader.getBlockState(blockpos$mutableblockpos).getOpacity(reader, blockpos$mutableblockpos) == 0;
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[1]).move(dir);
         boolean flag1 = reader.getBlockState(blockpos$mutableblockpos).getOpacity(reader, blockpos$mutableblockpos) == 0;
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[2]).move(dir);
         boolean flag2 = reader.getBlockState(blockpos$mutableblockpos).getOpacity(reader, blockpos$mutableblockpos) == 0;
         blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[3]).move(dir);
         ...
         if (!flag2 && !flag) {
            ...
            blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[0]).move(blockmodelrenderer$neighborinfo.field_178276_g[2]);
         ...
         if (!flag3 && !flag) {
            ...
            blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[0]).move(blockmodelrenderer$neighborinfo.field_178276_g[3]);
         ...
         if (!flag2 && !flag1) {
            ...
            blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[1]).move(blockmodelrenderer$neighborinfo.field_178276_g[2]);
         ...
         if (!flag3 && !flag1) {
            ...
            blockpos$mutableblockpos.setPos(blockpos).move(blockmodelrenderer$neighborinfo.field_178276_g[1]).move(blockmodelrenderer$neighborinfo.field_178276_g[3]);
   ...
   public static enum NeighborInfo {
      ...
      private static final BlockModelRenderer.NeighborInfo[] field_178282_n = Util.make(new BlockModelRenderer.NeighborInfo[6], (p_209260_0_) -> {
      ...
      public static BlockModelRenderer.NeighborInfo getNeighbourInfo(Direction facing) {
         return field_178282_n[facing.getIndex()];
      }
   }
