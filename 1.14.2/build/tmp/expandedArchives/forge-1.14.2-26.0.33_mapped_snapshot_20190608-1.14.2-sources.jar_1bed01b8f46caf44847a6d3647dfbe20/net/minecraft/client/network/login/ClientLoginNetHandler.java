...
public class ClientLoginNetHandler implements IClientLoginNetHandler {
   ...
   public void handleLoginSuccess(SLoginSuccessPacket packetIn) {
      ...
      this.networkManager.setNetHandler(new ClientPlayNetHandler(this.mc, this.field_147395_c, this.networkManager, this.gameProfile));
   }
   ...
   public void onDisconnect(ITextComponent reason) {
      if (this.field_147395_c != null && this.field_147395_c instanceof RealmsScreenProxy) {
         this.mc.displayGuiScreen((new DisconnectedRealmsScreen(((RealmsScreenProxy)this.field_147395_c).getScreen(), "connect.failed", reason)).getProxy());
      } else {
         this.mc.displayGuiScreen(new DisconnectedScreen(this.field_147395_c, "connect.failed", reason));
      }
