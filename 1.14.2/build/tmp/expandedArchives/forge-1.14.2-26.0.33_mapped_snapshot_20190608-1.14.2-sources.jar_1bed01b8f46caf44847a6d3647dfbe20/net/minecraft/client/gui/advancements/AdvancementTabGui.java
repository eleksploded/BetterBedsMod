...
public class AdvancementTabGui extends AbstractGui {
   ...
   public AdvancementTabGui(Minecraft p_i47589_1_, AdvancementsScreen p_i47589_2_, AdvancementTabType p_i47589_3_, int p_i47589_4_, Advancement p_i47589_5_, DisplayInfo p_i47589_6_) {
      ...
      this.field_191809_l = new AdvancementEntryGui(this, p_i47589_1_, p_i47589_5_, p_i47589_6_);
      this.addGuiAdvancement(this.field_191809_l, p_i47589_5_);
   }
   ...
   public void drawContents() {
      ...
      this.field_191809_l.drawConnectivity(i, j, true);
      this.field_191809_l.drawConnectivity(i, j, false);
      this.field_191809_l.draw(i, j);
   }
