...
public class EditSignScreen extends Screen {
   private final SignTileEntity field_146848_f;
   ...
   protected void init() {
      ...
      this.field_146848_f.setEditable(false);
      this.field_214267_d = new TextInputUtil(this.minecraft, () -> {
         return this.field_146848_f.getText(this.editLine).getString();
      }, (p_214265_1_) -> {
         this.field_146848_f.setText(this.editLine, new StringTextComponent(p_214265_1_));
      }, 90);
   }
   ...
   public void removed() {
      ...
      if (clientplaynethandler != null) {
         clientplaynethandler.sendPacket(new CUpdateSignPacket(this.field_146848_f.getPos(), this.field_146848_f.getText(0), this.field_146848_f.getText(1), this.field_146848_f.getText(2), this.field_146848_f.getText(3)));
      }

      this.field_146848_f.setEditable(true);
   }

   public void tick() {
      ++this.updateCounter;
      if (!this.field_146848_f.getType().isValidBlock(this.field_146848_f.getBlockState().getBlock())) {
         this.close();
      }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      BlockState blockstate = this.field_146848_f.getBlockState();
      float f1;
      ...
      this.field_146848_f.func_214062_a(this.editLine, this.field_214267_d.func_216896_c(), this.field_214267_d.func_216898_d(), this.updateCounter / 6 % 2 == 0);
      TileEntityRendererDispatcher.instance.render(this.field_146848_f, -0.5D, -0.75D, -0.5D, 0.0F);
