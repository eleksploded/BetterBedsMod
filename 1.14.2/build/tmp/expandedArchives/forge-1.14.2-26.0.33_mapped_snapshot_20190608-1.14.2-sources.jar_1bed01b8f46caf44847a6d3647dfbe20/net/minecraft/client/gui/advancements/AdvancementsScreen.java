...
public class AdvancementsScreen extends Screen implements ClientAdvancementManager.IListener {
   ...
   protected void init() {
      ...
      if (this.field_191940_s == null && !this.tabs.isEmpty()) {
         this.clientAdvancementManager.setSelectedTab(this.tabs.values().iterator().next().getAdvancement(), true);
      } else {
         this.clientAdvancementManager.setSelectedTab(this.field_191940_s == null ? null : this.field_191940_s.getAdvancement(), true);
      }
   ...
   public void renderWindow(int p_191934_1_, int p_191934_2_) {
      ...
      if (this.tabs.size() > 1) {
         ...
         for(AdvancementTabGui advancementtabgui : this.tabs.values()) {
            ...
            advancementtabgui.drawTab(p_191934_1_, p_191934_2_, advancementtabgui == this.field_191940_s);
         }
   ...
   private void renderToolTips(int p_191937_1_, int p_191937_2_, int p_191937_3_, int p_191937_4_) {
      ...
      if (this.field_191940_s != null) {
         ...
         this.field_191940_s.drawToolTips(p_191937_1_ - p_191937_3_ - 9, p_191937_2_ - p_191937_4_ - 18, p_191937_3_, p_191937_4_);
         GlStateManager.disableDepthTest();
         GlStateManager.popMatrix();
      }
   ...
   public void setSelectedTab(@Nullable Advancement advancementIn) {
      this.field_191940_s = this.tabs.get(advancementIn);
   }
