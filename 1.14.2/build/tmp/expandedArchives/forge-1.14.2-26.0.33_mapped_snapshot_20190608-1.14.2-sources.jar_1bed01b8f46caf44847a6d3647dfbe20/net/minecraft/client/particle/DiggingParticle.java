...
public class DiggingParticle extends SpriteTexturedParticle {
   ...
   public DiggingParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn, BlockState state) {
      ...
      this.func_217567_a(Minecraft.getInstance().getBlockRendererDispatcher().getBlockModelShapes().getTexture(state));
   ...
   public DiggingParticle setBlockPos(BlockPos pos) {
      this.sourcePos = pos;
      if (this.field_174847_a.getBlock() == Blocks.GRASS_BLOCK) {
         return this;
      } else {
   ...
   protected void multiplyColor(@Nullable BlockPos p_187154_1_) {
      int i = Minecraft.getInstance().getBlockColors().func_216860_a(this.field_174847_a, this.world, p_187154_1_, 0);
   ...
   protected float func_217563_c() {
      return this.field_217569_E.getInterpolatedU((double)((this.field_217587_G + 1.0F) / 4.0F * 16.0F));
   }

   protected float func_217564_d() {
      return this.field_217569_E.getInterpolatedU((double)(this.field_217587_G / 4.0F * 16.0F));
   }

   protected float func_217562_e() {
      return this.field_217569_E.getInterpolatedV((double)(this.field_217588_H / 4.0F * 16.0F));
   }

   protected float func_217560_f() {
      return this.field_217569_E.getInterpolatedV((double)((this.field_217588_H + 1.0F) / 4.0F * 16.0F));
   }
