...
public class ControlsScreen extends Screen {
   private static final AbstractOption[] field_146492_g = new AbstractOption[]{AbstractOption.field_216685_I, AbstractOption.field_216707_n, AbstractOption.field_216690_N, AbstractOption.field_216719_z};
   ...
   protected void init() {
      ...
      this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 29, 150, 20, I18n.format("gui.done"), (p_213124_1_) -> {
         this.minecraft.displayGuiScreen(this.field_146496_h);
      }));
   }
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_146494_r.render(p_render_1_, p_render_2_, p_render_3_);
