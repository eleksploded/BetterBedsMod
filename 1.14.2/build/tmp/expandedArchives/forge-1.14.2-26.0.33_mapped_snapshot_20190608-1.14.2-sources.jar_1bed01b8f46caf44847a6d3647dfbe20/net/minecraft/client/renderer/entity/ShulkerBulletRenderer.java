...
public class ShulkerBulletRenderer extends EntityRenderer<ShulkerBulletEntity> {
   ...
   private final ShulkerBulletModel<ShulkerBulletEntity> field_188349_b = new ShulkerBulletModel<>();
   ...
   public void doRender(ShulkerBulletEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      float f1 = MathHelper.func_219799_g(partialTicks, entity.prevRotationPitch, entity.rotationPitch);
      ...
      this.field_188349_b.render(entity, 0.0F, 0.0F, 0.0F, f, f1, 0.03125F);
