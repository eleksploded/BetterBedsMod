...
public class EnchantmentScreen extends ContainerScreen<EnchantmentContainer> {
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      ...
      for(int k = 0; k < 3; ++k) {
         ...
         if (d0 >= 0.0D && d1 >= 0.0D && d0 < 108.0D && d1 < 19.0D && this.field_147002_h.enchantItem(this.minecraft.player, k)) {
            this.minecraft.field_71442_b.sendEnchantPacket((this.field_147002_h).windowId, k);
            return true;
         }
      }
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      float f2 = MathHelper.func_219799_g(partialTicks, this.oOpen, this.open);
      ...
      float f3 = MathHelper.func_219799_g(partialTicks, this.oFlip, this.flip) + 0.25F;
      float f4 = MathHelper.func_219799_g(partialTicks, this.oFlip, this.flip) + 0.75F;
      ...
      field_147072_E.func_217103_a(0.0F, f3, f4, f2, 0.0F, 0.0625F);
      ...
      RenderHelper.disableStandardItemLighting();
      GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
      EnchantmentNameParts.getInstance().reseedRandomGenerator((long)this.field_147002_h.func_217005_f());
      int l = this.field_147002_h.getLapisAmount();
      ...
      for(int i1 = 0; i1 < 3; ++i1) {
         ...
         this.blitOffset = 0;
         this.minecraft.getTextureManager().bindTexture(ENCHANTMENT_TABLE_GUI_TEXTURE);
         int l1 = (this.field_147002_h).enchantLevels[i1];
         GlStateManager.color4f(1.0F, 1.0F, 1.0F, 1.0F);
         if (l1 == 0) {
            ...
            int j2 = 6839882;
            if (((l < i1 + 1 || this.minecraft.player.experienceLevel < l1) && !this.minecraft.player.playerAbilities.isCreativeMode) || this.field_147002_h.enchantClue[i1] == -1) { // Forge: render buttons as disabled when enchantable but enchantability not met on lower levels
               this.blit(j1, j + 14 + 19 * i1, 0, 185, 108, 19);
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      boolean flag = this.minecraft.player.playerAbilities.isCreativeMode;
      int i = this.field_147002_h.getLapisAmount();

      for(int j = 0; j < 3; ++j) {
         int k = (this.field_147002_h).enchantLevels[j];
         Enchantment enchantment = Enchantment.getEnchantmentByID((this.field_147002_h).enchantClue[j]);
         int l = (this.field_147002_h).worldClue[j];
         int i1 = j + 1;
         if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, (double)p_render_1_, (double)p_render_2_) && k > 0) {
            ...
            if (enchantment == null) {
               ...
               if (this.minecraft.player.experienceLevel < k) {
                  list.add(TextFormatting.RED + I18n.format("container.enchant.level.requirement", (this.field_147002_h).enchantLevels[j]));
               } else {
                  String s;
                  if (i1 == 1) {
   ...
   public void tickBook() {
      ...
      for(int i = 0; i < 3; ++i) {
         if ((this.field_147002_h).enchantLevels[i] != 0) {
            flag = true;
         }
      }
