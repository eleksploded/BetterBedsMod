...
public class DripParticle extends SpriteTexturedParticle {
   ...
   public static class DrippingLavaFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         DripParticle.DrippingLava dripparticle$drippinglava = new DripParticle.DrippingLava(worldIn, x, y, z, Fluids.LAVA, ParticleTypes.field_218423_k);
   ...
   public static class DrippingWaterFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         DripParticle dripparticle = new DripParticle.Dripping(worldIn, x, y, z, Fluids.WATER, ParticleTypes.field_218425_n);
   ...
   public static class FallingLavaFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         DripParticle dripparticle = new DripParticle.Falling(worldIn, x, y, z, Fluids.LAVA, ParticleTypes.field_218424_l);
   ...
   public static class FallingWaterFactory implements IParticleFactory<BasicParticleType> {
      ...
      public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
         DripParticle dripparticle = new DripParticle.Falling(worldIn, x, y, z, Fluids.WATER, ParticleTypes.field_218422_X);
         dripparticle.setColor(0.2F, 0.3F, 1.0F);
