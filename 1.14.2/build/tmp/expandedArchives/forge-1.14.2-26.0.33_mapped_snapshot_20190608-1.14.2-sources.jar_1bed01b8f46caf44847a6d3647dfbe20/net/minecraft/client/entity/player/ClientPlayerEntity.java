...
public class ClientPlayerEntity extends AbstractClientPlayerEntity {
   ...
   public ClientPlayerEntity(Minecraft p_i50990_1_, ClientWorld p_i50990_2_, ClientPlayNetHandler p_i50990_3_, StatisticsManager p_i50990_4_, ClientRecipeBook p_i50990_5_) {
      ...
      this.field_71174_a = p_i50990_3_;
      this.stats = p_i50990_4_;
      this.field_192036_cb = p_i50990_5_;
      this.mc = p_i50990_1_;
   ...
   public void tick() {
      if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
         super.tick();
         if (this.isPassenger()) {
            this.field_71174_a.sendPacket(new CPlayerPacket.RotationPacket(this.rotationYaw, this.rotationPitch, this.onGround));
            this.field_71174_a.sendPacket(new CInputPacket(this.moveStrafing, this.moveForward, this.movementInput.jump, this.movementInput.sneak));
            Entity entity = this.getLowestRidingEntity();
            if (entity != this && entity.canPassengerSteer()) {
               this.field_71174_a.sendPacket(new CMoveVehiclePacket(entity));
            }
         } else {
   ...
   private void onUpdateWalkingPlayer() {
      ...
      if (flag != this.serverSprintState) {
         ...
         this.field_71174_a.sendPacket(new CEntityActionPacket(this, centityactionpacket$action));
      ...
      if (flag3 != this.serverSneakState) {
         ...
         this.field_71174_a.sendPacket(new CEntityActionPacket(this, centityactionpacket$action1));
      ...
      if (this.isCurrentViewEntity()) {
         ...
         if (this.isPassenger()) {
            ...
            this.field_71174_a.sendPacket(new CPlayerPacket.PositionRotationPacket(vec3d.x, -999.0D, vec3d.z, this.rotationYaw, this.rotationPitch, this.onGround));
            flag1 = false;
         } else if (flag1 && flag2) {
            this.field_71174_a.sendPacket(new CPlayerPacket.PositionRotationPacket(this.posX, axisalignedbb.minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround));
         } else if (flag1) {
            this.field_71174_a.sendPacket(new CPlayerPacket.PositionPacket(this.posX, axisalignedbb.minY, this.posZ, this.onGround));
         } else if (flag2) {
            this.field_71174_a.sendPacket(new CPlayerPacket.RotationPacket(this.rotationYaw, this.rotationPitch, this.onGround));
         } else if (this.prevOnGround != this.onGround) {
            this.field_71174_a.sendPacket(new CPlayerPacket(this.onGround));
         }
   ...
   public ItemEntity dropItem(boolean dropAll) {
      ...
      this.field_71174_a.sendPacket(new CPlayerDiggingPacket(cplayerdiggingpacket$action, BlockPos.ZERO, Direction.DOWN));
   ...
   public void sendChatMessage(String message) {
      this.field_71174_a.sendPacket(new CChatMessagePacket(message));
   }

   public void swingArm(Hand hand) {
      super.swingArm(hand);
      this.field_71174_a.sendPacket(new CAnimateHandPacket(hand));
   }

   public void respawnPlayer() {
      this.field_71174_a.sendPacket(new CClientStatusPacket(CClientStatusPacket.State.PERFORM_RESPAWN));
   }
   ...
   public void closeScreen() {
      this.field_71174_a.sendPacket(new CCloseWindowPacket(this.openContainer.windowId));
   ...
   public void sendPlayerAbilities() {
      this.field_71174_a.sendPacket(new CPlayerAbilitiesPacket(this.playerAbilities));
   }
   ...
   protected void sendHorseJump() {
      this.field_71174_a.sendPacket(new CEntityActionPacket(this, CEntityActionPacket.Action.START_RIDING_JUMP, MathHelper.floor(this.getHorseJumpPower() * 100.0F)));
   }

   public void sendHorseInventory() {
      this.field_71174_a.sendPacket(new CEntityActionPacket(this, CEntityActionPacket.Action.OPEN_INVENTORY));
   }
   ...
   public void removeRecipeHighlight(IRecipe<?> p_193103_1_) {
      if (this.field_192036_cb.isNew(p_193103_1_)) {
         this.field_192036_cb.markSeen(p_193103_1_);
         this.field_71174_a.sendPacket(new CRecipeInfoPacket(p_193103_1_));
      }
   ...
   public void sendStatusMessage(ITextComponent chatComponent, boolean actionBar) {
      if (actionBar) {
         this.mc.field_71456_v.setOverlayMessage(chatComponent, false);
      } else {
         this.mc.field_71456_v.getChatGUI().printChatMessage(chatComponent);
      }
   ...
   public void sendMessage(ITextComponent component) {
      this.mc.field_71456_v.getChatGUI().printChatMessage(component);
   }
   ...
   public boolean func_213287_bg() {
      if (!this.playerAbilities.isFlying && !this.isSwimming() && this.func_213298_c(Pose.SNEAKING)) {
   ...
   public void livingTick() {
      ...
      if (!this.noClip) {
         ...
         this.func_213282_i(this.posX - (double)this.getWidth() * 0.35D, axisalignedbb.minY + 0.5D, this.posZ + (double)this.getWidth() * 0.35D);
         this.func_213282_i(this.posX - (double)this.getWidth() * 0.35D, axisalignedbb.minY + 0.5D, this.posZ - (double)this.getWidth() * 0.35D);
         this.func_213282_i(this.posX + (double)this.getWidth() * 0.35D, axisalignedbb.minY + 0.5D, this.posZ - (double)this.getWidth() * 0.35D);
         this.func_213282_i(this.posX + (double)this.getWidth() * 0.35D, axisalignedbb.minY + 0.5D, this.posZ + (double)this.getWidth() * 0.35D);
         }
      ...
      boolean flag7 = (float)this.getFoodStats().getFoodLevel() > 6.0F || this.playerAbilities.allowFlying;
      if ((this.onGround || this.canSwim()) && !flag1 && !flag2 && this.func_223110_ee() && !this.isSprinting() && flag7 && !this.isHandActive() && !this.isPotionActive(Effects.field_76440_q)) {
      ...
      if (!this.isSprinting() && (!this.isInWater() || this.canSwim()) && this.func_223110_ee() && flag7 && !this.isHandActive() && !this.isPotionActive(Effects.field_76440_q) && this.mc.gameSettings.keyBindSprint.isKeyDown()) {
         this.setSprinting(true);
      }
      ...
      if (this.playerAbilities.allowFlying) {
         if (this.mc.field_71442_b.isSpectatorMode()) {
      ...
      if (this.movementInput.jump && !flag && !this.onGround && this.getMotion().y < 0.0D && !this.isElytraFlying() && !this.playerAbilities.isFlying) {
         ItemStack itemstack = this.getItemStackFromSlot(EquipmentSlotType.CHEST);
         if (itemstack.getItem() == Items.ELYTRA && ElytraItem.isUsable(itemstack)) {
            this.field_71174_a.sendPacket(new CEntityActionPacket(this, CEntityActionPacket.Action.START_FALL_FLYING));
         }
      }
      ...
      if (this.playerAbilities.isFlying && this.isCurrentViewEntity()) {
         int j = 0;
         ...
         if (j != 0) {
            this.setMotion(this.getMotion().add(0.0D, (double)((float)j * this.playerAbilities.getFlySpeed() * 3.0F), 0.0D));
         }
      }
   ...
   private void func_213839_ed() {
      ...
      if (this.inPortal) {
         if (this.mc.field_71462_r != null && !this.mc.field_71462_r.isPauseScreen()) {
            if (this.mc.field_71462_r instanceof ContainerScreen) {
               this.closeScreen();
            }
         ...
         this.inPortal = false;
      } else if (this.isPotionActive(Effects.field_76431_k) && this.getActivePotionEffect(Effects.field_76431_k).getDuration() > 60) {
   ...
   public EffectInstance removeActivePotionEffect(@Nullable Effect potioneffectin) {
      if (potioneffectin == Effects.field_76431_k) {
                  ...
                  if (blockstate.getCollisionShape(this.world, blockpos, iselectioncontext).isEmpty()) {
                     ...
                     if (blockstate1.getCollisionShape(this.world, blockpos, iselectioncontext).isEmpty()) {
                        ...
                        if (this.isPotionActive(Effects.field_76430_j)) {
                           f7 += (float)(this.getActivePotionEffect(Effects.field_76430_j).getAmplifier() + 1) * 0.75F;
                        }
