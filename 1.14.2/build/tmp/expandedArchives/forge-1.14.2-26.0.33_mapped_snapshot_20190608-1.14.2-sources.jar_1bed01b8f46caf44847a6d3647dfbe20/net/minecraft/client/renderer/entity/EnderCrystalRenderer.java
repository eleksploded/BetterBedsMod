...
public class EnderCrystalRenderer extends EntityRenderer<EnderCrystalEntity> {
   ...
   private final EntityModel<EnderCrystalEntity> field_76995_b = new EnderCrystalModel<>(0.0F, true);
   private final EntityModel<EnderCrystalEntity> field_188316_g = new EnderCrystalModel<>(0.0F, false);
   ...
   public void doRender(EnderCrystalEntity entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (entity.shouldShowBottom()) {
         this.field_76995_b.render(entity, 0.0F, f * 3.0F, f1 * 0.2F, 0.0F, 0.0F, 0.0625F);
      } else {
