...
public class FontResourceManager implements AutoCloseable {
   ...
   private final IFutureReloadListener field_216889_f = new ReloadListener<Map<ResourceLocation, List<IGlyphProvider>>>() {
      protected Map<ResourceLocation, List<IGlyphProvider>> func_212854_a_(IResourceManager p_212854_1_, IProfiler p_212854_2_) {
      ...
      protected void func_212853_a_(Map<ResourceLocation, List<IGlyphProvider>> p_212853_1_, IResourceManager p_212853_2_, IProfiler p_212853_3_) {
   ...
   public void func_216883_a(boolean p_216883_1_, Executor p_216883_2_, Executor p_216883_3_) {
      if (p_216883_1_ != this.forceUnicodeFont) {
         ...
         this.field_216889_f.func_215226_a(ifuturereloadlistener$istage, iresourcemanager, EmptyProfiler.INSTANCE, EmptyProfiler.INSTANCE, p_216883_2_, p_216883_3_);
      }
   }
