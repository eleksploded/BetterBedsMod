...
public class ClientRecipeBook extends RecipeBook {
   ...
   private static RecipeBookCategories getCategory(IRecipe<?> recipe) {
      ...
      if (irecipetype == IRecipeType.field_222150_b) {
         if (recipe.getRecipeOutput().getItem().func_219971_r()) {
      ...
      } else if (irecipetype == IRecipeType.field_222151_c) {
      ...
      } else if (irecipetype == IRecipeType.field_222152_d) {
         return RecipeBookCategories.SMOKER_FOOD;
      } else if (irecipetype == IRecipeType.field_222154_f) {
         return RecipeBookCategories.STONECUTTER;
      } else if (irecipetype == IRecipeType.field_222153_e) {
