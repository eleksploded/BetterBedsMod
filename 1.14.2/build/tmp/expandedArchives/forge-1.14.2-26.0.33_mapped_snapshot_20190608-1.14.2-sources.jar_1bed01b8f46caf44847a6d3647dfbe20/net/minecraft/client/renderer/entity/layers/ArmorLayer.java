...
public abstract class ArmorLayer<T extends LivingEntity, M extends BipedModel<T>, A extends BipedModel<T>> extends LayerRenderer<T, M> {
   ...
   public void func_212842_a_(T p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      this.renderArmorLayer(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_4_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_, EquipmentSlotType.CHEST);
      this.renderArmorLayer(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_4_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_, EquipmentSlotType.LEGS);
      this.renderArmorLayer(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_4_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_, EquipmentSlotType.FEET);
      this.renderArmorLayer(p_212842_1_, p_212842_2_, p_212842_3_, p_212842_4_, p_212842_5_, p_212842_6_, p_212842_7_, p_212842_8_, EquipmentSlotType.HEAD);
   }
   ...
   private void renderArmorLayer(T entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale, EquipmentSlotType slotIn) {
      ...
      if (itemstack.getItem() instanceof ArmorItem) {
         ...
         if (armoritem.getEquipmentSlot() == slotIn) {
            ...
            this.func_215333_a(this.getArmorResource(entityLivingBaseIn, itemstack, slotIn, null));
            if (armoritem instanceof net.minecraft.item.IDyeableArmorItem) { // Allow this for anything, not only cloth
               ...
               this.func_215333_a(this.getArmorResource(armoritem, flag, "overlay"));
            }

            GlStateManager.color4f(this.colorR, this.colorG, this.colorB, this.alpha);
            a.render(entityLivingBaseIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
            if (!this.skipRenderGlint && itemstack.hasEffect()) {
               func_215338_a(this::func_215333_a, entityLivingBaseIn, a, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scale);
            }
   ...
   public A func_215337_a(EquipmentSlotType p_215337_1_) {
      return (A)(this.isLegSlot(p_215337_1_) ? this.field_177189_c : this.field_177186_d);
   }
