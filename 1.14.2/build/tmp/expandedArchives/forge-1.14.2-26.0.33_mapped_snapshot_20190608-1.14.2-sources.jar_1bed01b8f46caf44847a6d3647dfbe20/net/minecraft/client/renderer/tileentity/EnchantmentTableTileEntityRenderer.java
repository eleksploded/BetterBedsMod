...
public class EnchantmentTableTileEntityRenderer extends TileEntityRenderer<EnchantingTableTileEntity> {
   ...
   private final BookModel field_147541_c = new BookModel();
   ...
   public void render(EnchantingTableTileEntity tileEntityIn, double x, double y, double z, float partialTicks, int destroyStage) {
      ...
      float f3 = MathHelper.func_219799_g(partialTicks, tileEntityIn.field_195524_g, tileEntityIn.field_195523_f) + 0.25F;
      float f4 = MathHelper.func_219799_g(partialTicks, tileEntityIn.field_195524_g, tileEntityIn.field_195523_f) + 0.75F;
      ...
      float f5 = MathHelper.func_219799_g(partialTicks, tileEntityIn.field_195528_k, tileEntityIn.field_195527_j);
      GlStateManager.enableCull();
      this.field_147541_c.func_217103_a(f, f3, f4, f5, 0.0F, 0.0625F);
