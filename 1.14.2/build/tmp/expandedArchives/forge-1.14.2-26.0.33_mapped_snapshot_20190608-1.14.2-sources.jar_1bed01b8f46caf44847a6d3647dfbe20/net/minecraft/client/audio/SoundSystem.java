...
public class SoundSystem {
   ...
   private static final SoundSystem.IHandler field_216413_d = new SoundSystem.IHandler() {
      @Nullable
   ...
   private SoundSystem.IHandler field_216414_e = field_216413_d;
   private SoundSystem.IHandler field_216415_f = field_216413_d;
   ...
   public void func_216404_a() {
      ...
      if (ALUtils.func_216481_a(this.field_216411_b, "Get capabilities")) {
         ...
         this.field_216414_e = new SoundSystem.HandlerImpl(k);
         this.field_216415_f = new SoundSystem.HandlerImpl(j);
   ...
   public SoundSource func_216403_a(SoundSystem.Mode p_216403_1_) {
      return (p_216403_1_ == SoundSystem.Mode.STREAMING ? this.field_216415_f : this.field_216414_e).func_216398_a();
   }

   public void func_216408_a(SoundSource p_216408_1_) {
      if (!this.field_216414_e.func_216396_a(p_216408_1_) && !this.field_216415_f.func_216396_a(p_216408_1_)) {
