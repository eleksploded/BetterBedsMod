...
public class InputMappings {
   ...
   public static boolean func_216506_a(long p_216506_0_, int p_216506_2_) {
   ...
   public static enum Type {
      ...
      private final Int2ObjectMap<InputMappings.Input> field_197951_e = new Int2ObjectOpenHashMap<>();
      private final String name;
      ...
      private static void registerInput(InputMappings.Type type, String nameIn, int keyCode) {
         ...
         type.field_197951_e.put(keyCode, inputmappings$input);
      }
      ...
      public InputMappings.Input getOrMakeInput(int keyCode) {
         if (this.field_197951_e.containsKey(keyCode)) {
            return this.field_197951_e.get(keyCode);
         } else {
            String s;
            if (this == MOUSE) {
               if (keyCode <= 2) {
            ...
            this.field_197951_e.put(keyCode, inputmappings$input);
