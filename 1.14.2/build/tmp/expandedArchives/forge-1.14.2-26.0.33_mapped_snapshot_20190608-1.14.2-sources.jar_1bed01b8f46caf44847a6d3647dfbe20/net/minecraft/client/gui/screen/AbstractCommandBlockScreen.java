...
public abstract class AbstractCommandBlockScreen extends Screen {
   ...
   protected AbstractCommandBlockScreen.SuggestionsList field_209116_y;
   ...
   protected void init() {
      ...
      this.field_195240_g = this.addButton(new Button(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.done"), (p_214187_1_) -> {
         this.func_195234_k();
      }));
      this.field_195241_h = this.addButton(new Button(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, I18n.format("gui.cancel"), (p_214186_1_) -> {
         this.onClose();
      }));
      this.field_195242_i = this.addButton(new Button(this.width / 2 + 150 - 20, this.func_195236_i(), 20, 20, "O", (p_214184_1_) -> {
      ...
      this.field_195237_a = new TextFieldWidget(this.font, this.width / 2 - 150, 50, 300, 20, I18n.format("advMode.command"));
      this.field_195237_a.setMaxStringLength(32500);
      this.field_195237_a.setTextFormatter(this::formatCommand);
      this.field_195237_a.func_212954_a(this::func_214185_b);
      this.children.add(this.field_195237_a);
      this.field_195239_f = new TextFieldWidget(this.font, this.width / 2 - 150, this.func_195236_i(), 276, 20, I18n.format("advMode.previousOutput"));
      ...
      this.field_195237_a.setFocused2(true);
      this.computeSuggestions();
   }

   public void resize(Minecraft p_resize_1_, int p_resize_2_, int p_resize_3_) {
      String s = this.field_195237_a.getText();
   ...
   protected void updateTrackOutput() {
      if (this.getLogic().shouldTrackOutput()) {
         ...
         this.field_195239_f.setText(this.getLogic().getLastOutput().getString());
      } else {
   ...
   public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
      if (this.field_209116_y != null && this.field_209116_y.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         return true;
      } else if (this.getFocused() == this.field_195237_a && p_keyPressed_1_ == 258) {
         this.func_209109_s();
         return true;
      } else if (super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_)) {
         return true;
      } else if (p_keyPressed_1_ != 257 && p_keyPressed_1_ != 335) {
         if (p_keyPressed_1_ == 258 && this.getFocused() == this.field_195237_a) {
            this.func_209109_s();
         }
   ...
   public boolean mouseScrolled(double p_mouseScrolled_1_, double p_mouseScrolled_3_, double p_mouseScrolled_5_) {
      return this.field_209116_y != null && this.field_209116_y.mouseScrolled(MathHelper.clamp(p_mouseScrolled_5_, -1.0D, 1.0D)) ? true : super.mouseScrolled(p_mouseScrolled_1_, p_mouseScrolled_3_, p_mouseScrolled_5_);
   }

   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      return this.field_209116_y != null && this.field_209116_y.mouseClicked((int)p_mouseClicked_1_, (int)p_mouseClicked_3_, p_mouseClicked_5_) ? true : super.mouseClicked(p_mouseClicked_1_, p_mouseClicked_3_, p_mouseClicked_5_);
   }
   ...
   protected void computeSuggestions() {
      ...
      if (!this.field_212342_z) {
         this.field_195237_a.setSuggestion((String)null);
      ...
      if (this.field_209114_w == null) {
         this.field_209114_w = commanddispatcher.parse(stringreader, this.minecraft.player.field_71174_a.getSuggestionProvider());
      }

      int j = this.field_195237_a.getCursorPosition();
      if (j >= i && (this.field_209116_y == null || !this.field_212342_z)) {
   ...
   private void func_209107_u() {
      if (this.field_209115_x.join().isEmpty() && !this.field_209114_w.getExceptions().isEmpty() && this.field_195237_a.getCursorPosition() == this.field_195237_a.getText().length()) {
         int i = 0;
      ...
      this.field_209116_y = null;
      if (this.minecraft.gameSettings.autoSuggestions) {
         this.func_209109_s();
      }
   ...
   private void func_209108_a(TextFormatting p_209108_1_) {
      ...
      SuggestionContext<ISuggestionProvider> suggestioncontext = commandcontextbuilder.findSuggestionContext(this.field_195237_a.getCursorPosition());
      ...
      if (!list.isEmpty()) {
         ...
         this.field_209112_u = MathHelper.clamp(this.field_195237_a.func_195611_j(suggestioncontext.startPos), 0, this.field_195237_a.func_195611_j(0) + this.field_195237_a.getAdjustedWidth() - i);
   ...
   public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
      ...
      this.field_195237_a.render(p_render_1_, p_render_2_, p_render_3_);
      int i = 75;
      if (!this.field_195239_f.getText().isEmpty()) {
         ...
         this.field_195239_f.render(p_render_1_, p_render_2_, p_render_3_);
      }

      super.render(p_render_1_, p_render_2_, p_render_3_);
      if (this.field_209116_y != null) {
         this.field_209116_y.render(p_render_1_, p_render_2_);
      } else {
         i = 0;
   ...
   public void func_209109_s() {
      if (this.field_209115_x != null && this.field_209115_x.isDone()) {
         ...
         if (!suggestions.isEmpty()) {
            ...
            int j = MathHelper.clamp(this.field_195237_a.func_195611_j(suggestions.getRange().getStart()), 0, this.field_195237_a.func_195611_j(0) + this.field_195237_a.getAdjustedWidth() - i);
   ...
   protected void setCommand(String p_209102_1_) {
      this.field_195237_a.setText(p_209102_1_);
   }
   ...
   class SuggestionsList {
      ...
      private SuggestionsList(int p_i49843_2_, int p_i49843_3_, int p_i49843_4_, Suggestions p_i49843_5_) {
         ...
         this.field_212467_d = AbstractCommandBlockScreen.this.field_195237_a.getText();
         this.suggest(0);
      }
      ...
      public void suggest(int suggestionIndex) {
         ...
         AbstractCommandBlockScreen.this.field_195237_a.setSuggestion(AbstractCommandBlockScreen.func_212339_b(AbstractCommandBlockScreen.this.field_195237_a.getText(), suggestion.apply(this.field_212467_d)));
      }
      ...
      public void applySuggestion() {
         ...
         AbstractCommandBlockScreen.this.field_195237_a.func_212422_f(i);
         AbstractCommandBlockScreen.this.field_195237_a.setSelectionPos(i);
