...
public class ArrowLayer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
   ...
   public void func_212842_a_(T p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      int i = p_212842_1_.getArrowCountInEntity();
      if (i > 0) {
         Entity entity = new ArrowEntity(p_212842_1_.world, p_212842_1_.posX, p_212842_1_.posY, p_212842_1_.posZ);
         Random random = new Random((long)p_212842_1_.getEntityId());
         RenderHelper.disableStandardItemLighting();

         for(int j = 0; j < i; ++j) {
            GlStateManager.pushMatrix();
            RendererModel renderermodel = this.func_215332_c().getRandomModelBox(random);
            ...
            float f3 = MathHelper.func_219799_g(f, modelbox.posX1, modelbox.posX2) / 16.0F;
            float f4 = MathHelper.func_219799_g(f1, modelbox.posY1, modelbox.posY2) / 16.0F;
            float f5 = MathHelper.func_219799_g(f2, modelbox.posZ1, modelbox.posZ2) / 16.0F;
