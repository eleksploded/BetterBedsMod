...
public class SoundEngine {
   ...
   public void reload() {
      ...
      for(SoundEvent soundevent : Registry.field_212633_v) {
         ...
         if (this.sndHandler.getAccessor(resourcelocation) == null) {
            LOGGER.warn("Missing sound for event: {}", (Object)Registry.field_212633_v.getKey(soundevent));
   ...
   private synchronized void load() {
      if (!this.loaded) {
         try {
            ...
            this.field_217938_h.func_216466_a(this.options.getSoundLevel(SoundCategory.MASTER));
            ...
            if (this.field_217938_h.func_216467_a() <= 0.0F) {
               ...
               if (sound == SoundHandler.MISSING_SOUND) {
                  ...
                  if (f1 == 0.0F && !p_sound.canBeSilent()) {
                     ...
                     ChannelManager.Entry channelmanager$entry = this.field_217941_k.func_217895_a(sound.isStreaming() ? SoundSystem.Mode.STREAMING : SoundSystem.Mode.STATIC);
   ...
   public void pause() {
      if (this.loaded) {
         this.field_217941_k.func_217897_a((p_217929_0_) -> {
   ...
   public void resume() {
      if (this.loaded) {
         this.field_217941_k.func_217897_a((p_217936_0_) -> {
