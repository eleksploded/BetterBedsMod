...
public class ClientPlayNetHandler implements IClientPlayNetHandler {
   ...
   public void handleJoinGame(SJoinGamePacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      this.client.field_71442_b = new PlayerController(this.client, this);
      this.field_217287_m = packetIn.func_218728_h();
      this.field_147300_g = new ClientWorld(this, new WorldSettings(0L, packetIn.getGameType(), false, packetIn.isHardcoreMode(), packetIn.getWorldType()), packetIn.getDimension(), this.field_217287_m, this.client.getProfiler(), this.client.worldRenderer);
      this.client.loadWorld(this.field_147300_g);
      if (this.client.player == null) {
         this.client.player = this.client.field_71442_b.createPlayer(this.field_147300_g, new StatisticsManager(), new ClientRecipeBook(this.field_147300_g.getRecipeManager()));
      ...
      this.field_147300_g.func_217408_a(i, this.client.player);
      this.client.player.movementInput = new MovementInputFromOptions(this.client.gameSettings);
      this.client.field_71442_b.setPlayerCapabilities(this.client.player);
      ...
      this.client.field_71442_b.setGameType(packetIn.getGameType());
      ...
      this.client.func_213229_ar().func_216814_a();
   }
   ...
   public void handleSpawnObject(SSpawnObjectPacket packetIn) {
      ...
      EntityType<?> entitytype = packetIn.func_218694_l();
      Entity entity;
      if (entitytype == EntityType.CHEST_MINECART) {
         entity = new ChestMinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.FURNACE_MINECART) {
         entity = new FurnaceMinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.TNT_MINECART) {
         entity = new TNTMinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.SPAWNER_MINECART) {
         entity = new SpawnerMinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.HOPPER_MINECART) {
         entity = new HopperMinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.COMMAND_BLOCK_MINECART) {
         entity = new MinecartCommandBlockEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.MINECART) {
         entity = new MinecartEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.FISHING_BOBBER) {
         Entity entity1 = this.field_147300_g.getEntityByID(packetIn.getData());
         if (entity1 instanceof PlayerEntity) {
            entity = new FishingBobberEntity(this.field_147300_g, (PlayerEntity)entity1, d0, d1, d2);
         } else {
            entity = null;
         }
      } else if (entitytype == EntityType.ARROW) {
         entity = new ArrowEntity(this.field_147300_g, d0, d1, d2);
         Entity entity2 = this.field_147300_g.getEntityByID(packetIn.getData());
         if (entity2 != null) {
            ((AbstractArrowEntity)entity).setShooter(entity2);
         }
      } else if (entitytype == EntityType.SPECTRAL_ARROW) {
         entity = new SpectralArrowEntity(this.field_147300_g, d0, d1, d2);
         Entity entity3 = this.field_147300_g.getEntityByID(packetIn.getData());
         if (entity3 != null) {
            ((AbstractArrowEntity)entity).setShooter(entity3);
         }
      } else if (entitytype == EntityType.TRIDENT) {
         entity = new TridentEntity(this.field_147300_g, d0, d1, d2);
         Entity entity4 = this.field_147300_g.getEntityByID(packetIn.getData());
         if (entity4 != null) {
            ((AbstractArrowEntity)entity).setShooter(entity4);
         }
      } else if (entitytype == EntityType.SNOWBALL) {
         entity = new SnowballEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.LLAMA_SPIT) {
         entity = new LlamaSpitEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.ITEM_FRAME) {
         entity = new ItemFrameEntity(this.field_147300_g, new BlockPos(d0, d1, d2), Direction.byIndex(packetIn.getData()));
      } else if (entitytype == EntityType.LEASH_KNOT) {
         entity = new LeashKnotEntity(this.field_147300_g, new BlockPos(d0, d1, d2));
      } else if (entitytype == EntityType.ENDER_PEARL) {
         entity = new EnderPearlEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.EYE_OF_ENDER) {
         entity = new EyeOfEnderEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.FIREWORK_ROCKET) {
         entity = new FireworkRocketEntity(this.field_147300_g, d0, d1, d2, ItemStack.EMPTY);
      } else if (entitytype == EntityType.FIREBALL) {
         entity = new FireballEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.DRAGON_FIREBALL) {
         entity = new DragonFireballEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.SMALL_FIREBALL) {
         entity = new SmallFireballEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.WITHER_SKULL) {
         entity = new WitherSkullEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.SHULKER_BULLET) {
         entity = new ShulkerBulletEntity(this.field_147300_g, d0, d1, d2, packetIn.func_218693_g(), packetIn.func_218695_h(), packetIn.func_218692_i());
      } else if (entitytype == EntityType.EGG) {
         entity = new EggEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.EVOKER_FANGS) {
         entity = new EvokerFangsEntity(this.field_147300_g, d0, d1, d2, 0.0F, 0, (LivingEntity)null);
      } else if (entitytype == EntityType.POTION) {
         entity = new PotionEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.EXPERIENCE_BOTTLE) {
         entity = new ExperienceBottleEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.BOAT) {
         entity = new BoatEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.TNT) {
         entity = new TNTEntity(this.field_147300_g, d0, d1, d2, (LivingEntity)null);
      } else if (entitytype == EntityType.ARMOR_STAND) {
         entity = new ArmorStandEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.END_CRYSTAL) {
         entity = new EnderCrystalEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.ITEM) {
         entity = new ItemEntity(this.field_147300_g, d0, d1, d2);
      } else if (entitytype == EntityType.FALLING_BLOCK) {
         entity = new FallingBlockEntity(this.field_147300_g, d0, d1, d2, Block.getStateById(packetIn.getData()));
      } else if (entitytype == EntityType.AREA_EFFECT_CLOUD) {
         entity = new AreaEffectCloudEntity(this.field_147300_g, d0, d1, d2);
      } else {
         entity = null;
      }
      ...
      if (entity != null) {
         ...
         this.field_147300_g.func_217411_a(i, entity);
   ...
   public void handleSpawnExperienceOrb(SSpawnExperienceOrbPacket packetIn) {
      ...
      double d1 = packetIn.getY();
      double d2 = packetIn.getZ();
      Entity entity = new ExperienceOrbEntity(this.field_147300_g, d0, d1, d2, packetIn.getXPValue());
      entity.func_213312_b(d0, d1, d2);
      entity.rotationYaw = 0.0F;
      entity.rotationPitch = 0.0F;
      entity.setEntityId(packetIn.getEntityID());
      this.field_147300_g.func_217411_a(packetIn.getEntityID(), entity);
   }
   ...
   public void handleSpawnGlobalEntity(SSpawnGlobalEntityPacket packetIn) {
      ...
      if (packetIn.getType() == 1) {
         LightningBoltEntity lightningboltentity = new LightningBoltEntity(this.field_147300_g, d0, d1, d2, false);
   ...
   public void handleSpawnPainting(SSpawnPaintingPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      PaintingEntity paintingentity = new PaintingEntity(this.field_147300_g, packetIn.getPosition(), packetIn.getFacing(), packetIn.getType());
      paintingentity.setEntityId(packetIn.getEntityID());
      paintingentity.setUniqueId(packetIn.getUniqueId());
      this.field_147300_g.func_217411_a(packetIn.getEntityID(), paintingentity);
   }
   ...
   public void handleEntityVelocity(SEntityVelocityPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      Entity entity = this.field_147300_g.getEntityByID(packetIn.getEntityID());
      if (entity != null) {
   ...
   public void handleSpawnPlayer(SSpawnPlayerPacket packetIn) {
      ...
      this.field_147300_g.func_217408_a(i, remoteclientplayerentity);
   ...
   public void handleEntityMovement(SEntityPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      Entity entity = packetIn.getEntity(this.field_147300_g);
      if (entity != null) {
   ...
   public void handleDestroyEntities(SDestroyEntitiesPacket packetIn) {
      ...
      for(int i = 0; i < packetIn.getEntityIDs().length; ++i) {
         ...
         this.field_147300_g.removeEntityFromWorld(j);
      }
   ...
   public void handleMultiBlockChange(SMultiBlockChangePacket packetIn) {
      ...
      for(SMultiBlockChangePacket.UpdateData smultiblockchangepacket$updatedata : packetIn.getChangedBlocks()) {
         this.field_147300_g.invalidateRegionAndSetBlock(smultiblockchangepacket$updatedata.getPos(), smultiblockchangepacket$updatedata.getBlockState());
      }
   ...
   public void handleChunkData(SChunkDataPacket packetIn) {
      ...
      Chunk chunk = this.field_147300_g.getChunkProvider().func_217250_a(this.field_147300_g, i, j, packetIn.getReadBuffer(), packetIn.getHeightmapTags(), packetIn.getExtractedSize(), packetIn.isFullChunk());
      if (chunk != null && packetIn.isFullChunk()) {
         this.field_147300_g.func_217417_b(chunk);
      }

      for(int k = 0; k < 16; ++k) {
         this.field_147300_g.markSurroundingsForRerender(i, k, j);
      }
   ...
   public void processChunkUnload(SUnloadChunkPacket packetIn) {
      ...
      int i = packetIn.getX();
      int j = packetIn.getZ();
      this.field_147300_g.getChunkProvider().unloadChunk(i, j);
   ...
   public void handleBlockChange(SChangeBlockPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      this.field_147300_g.invalidateRegionAndSetBlock(packetIn.getPos(), packetIn.getState());
   }
   ...
   public void onDisconnect(ITextComponent reason) {
      ...
      if (this.field_147307_j != null) {
         if (this.field_147307_j instanceof RealmsScreenProxy) {
            this.client.displayGuiScreen((new DisconnectedRealmsScreen(((RealmsScreenProxy)this.field_147307_j).getScreen(), "disconnect.lost", reason)).getProxy());
         } else {
            this.client.displayGuiScreen(new DisconnectedScreen(this.field_147307_j, "disconnect.lost", reason));
         }
      } else {
   ...
   public void handleCollectItem(SCollectItemPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      Entity entity = this.field_147300_g.getEntityByID(packetIn.getCollectedItemEntityID());
      LivingEntity livingentity = (LivingEntity)this.field_147300_g.getEntityByID(packetIn.getEntityID());
      ...
      if (entity != null) {
         if (entity instanceof ExperienceOrbEntity) {
            this.field_147300_g.playSound(entity.posX, entity.posY, entity.posZ, SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP, SoundCategory.PLAYERS, 0.1F, (this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 0.35F + 0.9F, false);
         } else {
            this.field_147300_g.playSound(entity.posX, entity.posY, entity.posZ, SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.PLAYERS, 0.2F, (this.avRandomizer.nextFloat() - this.avRandomizer.nextFloat()) * 1.4F + 2.0F, false);
         }
         ...
         this.client.particles.addEffect(new ItemPickupParticle(this.field_147300_g, entity, livingentity, 0.5F));
         this.field_147300_g.removeEntityFromWorld(packetIn.getCollectedItemEntityID());
      }
   ...
   public void handleChat(SChatPacket packetIn) {
      ...
      this.client.field_71456_v.addChatMessage(packetIn.getType(), message);
   }
   ...
   public void handleSpawnMob(SSpawnMobPacket packetIn) {
      ...
      if (livingentity != null) {
         ...
         this.field_147300_g.func_217411_a(packetIn.getEntityID(), livingentity);
         List<EntityDataManager.DataEntry<?>> list = packetIn.getDataManagerEntries();
         if (list != null) {
   ...
   public void handleSetPassengers(SSetPassengersPacket packetIn) {
      ...
      if (entity == null) {
         ...
         for(int i : packetIn.getPassengerIds()) {
            Entity entity1 = this.field_147300_g.getEntityByID(i);
            if (entity1 != null) {
               entity1.startRiding(entity, true);
               if (entity1 == this.client.player && !flag) {
                  this.client.field_71456_v.setOverlayMessage(I18n.format("mount.onboard", this.client.gameSettings.keyBindSneak.getLocalizedName()), false);
               }
            }
         }
   ...
   public void handleEntityStatus(SEntityStatusPacket packetIn) {
      ...
      if (entity != null) {
         if (packetIn.getOpCode() == 21) {
            ...
            this.field_147300_g.playSound(entity.posX, entity.posY, entity.posZ, SoundEvents.ITEM_TOTEM_USE, entity.getSoundCategory(), 1.0F, 1.0F, false);
   ...
   public void handleRespawn(SRespawnPacket packetIn) {
      ...
      if (dimensiontype != clientplayerentity.dimension) {
         ...
         this.field_147300_g = new ClientWorld(this, new WorldSettings(0L, packetIn.getGameType(), false, this.client.world.getWorldInfo().isHardcore(), packetIn.getWorldType()), packetIn.getDimension(), this.field_217287_m, this.client.getProfiler(), this.client.worldRenderer);
         this.field_147300_g.setScoreboard(scoreboard);
         this.client.loadWorld(this.field_147300_g);
         this.client.displayGuiScreen(new DownloadTerrainScreen());
      }

      this.field_147300_g.setInitialSpawnLocation();
      this.field_147300_g.removeAllEntities();
      String s = clientplayerentity.getServerBrand();
      this.client.renderViewEntity = null;
      ClientPlayerEntity clientplayerentity1 = this.client.field_71442_b.createPlayer(this.field_147300_g, clientplayerentity.getStats(), clientplayerentity.getRecipeBook());
      ...
      this.client.field_71442_b.setPlayerCapabilities(clientplayerentity1);
      clientplayerentity1.setReducedDebug(clientplayerentity.hasReducedDebug());
      if (this.client.field_71462_r instanceof DeathScreen) {
         this.client.displayGuiScreen((Screen)null);
      }
   ...
   public void func_217271_a(SOpenHorseWindowPacket p_217271_1_) {
      PacketThreadUtil.func_218797_a(p_217271_1_, this, this.client);
      Entity entity = this.field_147300_g.getEntityByID(p_217271_1_.func_218703_d());
   ...
   public void func_217272_a(SOpenWindowPacket p_217272_1_) {
      PacketThreadUtil.func_218797_a(p_217272_1_, this, this.client);
      ScreenManager.openScreen(p_217272_1_.func_218749_c(), this.client, p_217272_1_.func_218750_b(), p_217272_1_.func_218748_d());
   }
   ...
   public void handleSetSlot(SSetSlotPacket packetIn) {
      ...
      if (packetIn.getWindowId() == -1) {
         if (!(this.client.field_71462_r instanceof CreativeScreen)) {
         ...
         boolean flag = false;
         if (this.client.field_71462_r instanceof CreativeScreen) {
            CreativeScreen creativescreen = (CreativeScreen)this.client.field_71462_r;
   ...
   public void handleSignEditorOpen(SOpenSignMenuPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      TileEntity tileentity = this.field_147300_g.getTileEntity(packetIn.getSignPosition());
      if (!(tileentity instanceof SignTileEntity)) {
         tileentity = new SignTileEntity();
         tileentity.setWorld(this.field_147300_g);
   ...
   public void handleUpdateTileEntity(SUpdateTileEntityPacket packetIn) {
      ...
      if (this.client.world.isBlockLoaded(packetIn.getPos())) {
         ...
         if (flag && this.client.field_71462_r instanceof CommandBlockScreen) {
            ((CommandBlockScreen)this.client.field_71462_r).updateGui();
         }
      }
   ...
   public void handleChangeGameState(SChangeGameStatePacket packetIn) {
      ...
      if (i == 1) {
         ...
         this.client.field_71442_b.setGameType(GameType.getByID(j));
      } else if (i == 4) {
         if (j == 0) {
            this.client.player.field_71174_a.sendPacket(new CClientStatusPacket(CClientStatusPacket.State.PERFORM_RESPAWN));
            this.client.displayGuiScreen(new DownloadTerrainScreen());
         } else if (j == 1) {
         ...
         if (f == 0.0F) {
            ...
            this.client.field_71456_v.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.movement", gamesettings.keyBindForward.getLocalizedName(), gamesettings.keyBindLeft.getLocalizedName(), gamesettings.keyBindBack.getLocalizedName(), gamesettings.keyBindRight.getLocalizedName()));
         } else if (f == 102.0F) {
            this.client.field_71456_v.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.jump", gamesettings.keyBindJump.getLocalizedName()));
         } else if (f == 103.0F) {
            this.client.field_71456_v.getChatGUI().printChatMessage(new TranslationTextComponent("demo.help.inventory", gamesettings.keyBindInventory.getLocalizedName()));
         } else if (f == 104.0F) {
            this.client.field_71456_v.getChatGUI().printChatMessage(new TranslationTextComponent("demo.day.6", gamesettings.keyBindScreenshot.getLocalizedName()));
         }
      } else if (i == 6) {
         this.field_147300_g.playSound(playerentity, playerentity.posX, playerentity.posY + (double)playerentity.getEyeHeight(), playerentity.posZ, SoundEvents.ENTITY_ARROW_HIT_PLAYER, SoundCategory.PLAYERS, 0.18F, 0.45F);
      } else if (i == 7) {
         this.field_147300_g.setRainStrength(f);
      } else if (i == 8) {
         this.field_147300_g.setThunderStrength(f);
      } else if (i == 9) {
         this.field_147300_g.playSound(playerentity, playerentity.posX, playerentity.posY, playerentity.posZ, SoundEvents.ENTITY_PUFFER_FISH_STING, SoundCategory.NEUTRAL, 1.0F, 1.0F);
      } else if (i == 10) {
         this.field_147300_g.addParticle(ParticleTypes.ELDER_GUARDIAN, playerentity.posX, playerentity.posY, playerentity.posZ, 0.0D, 0.0D, 0.0D);
         this.field_147300_g.playSound(playerentity, playerentity.posX, playerentity.posY, playerentity.posZ, SoundEvents.ENTITY_ELDER_GUARDIAN_CURSE, SoundCategory.HOSTILE, 1.0F, 1.0F);
      }
   ...
   public void handlePlayerLook(SPlayerLookPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      Vec3d vec3d = packetIn.getTargetPosition(this.field_147300_g);
      if (vec3d != null) {
   ...
   public void handleStatistics(SStatisticsPacket packetIn) {
      ...
      if (this.client.field_71462_r instanceof IProgressMeter) {
         ((IProgressMeter)this.client.field_71462_r).onStatsUpdated();
      }
   ...
   public void handleRecipeBook(SRecipeBookPacket packetIn) {
      ...
      case REMOVE:
         for(ResourceLocation resourcelocation3 : packetIn.getRecipes()) {
            this.recipeManager.func_215367_a(resourcelocation3).ifPresent(clientrecipebook::lock);
         }
         break;
      case INIT:
         for(ResourceLocation resourcelocation1 : packetIn.getRecipes()) {
            this.recipeManager.func_215367_a(resourcelocation1).ifPresent(clientrecipebook::unlock);
         }

         for(ResourceLocation resourcelocation2 : packetIn.getDisplayedRecipes()) {
            this.recipeManager.func_215367_a(resourcelocation2).ifPresent(clientrecipebook::markNew);
         }
         break;
      case ADD:
         for(ResourceLocation resourcelocation : packetIn.getRecipes()) {
            this.recipeManager.func_215367_a(resourcelocation).ifPresent((p_217278_2_) -> {
      ...
      if (this.client.field_71462_r instanceof IRecipeShownListener) {
         ((IRecipeShownListener)this.client.field_71462_r).recipesUpdated();
      }
   ...
   public void handleEntityEffect(SPlayEntityEffectPacket packetIn) {
      ...
      if (entity instanceof LivingEntity) {
         Effect effect = Effect.getPotionById(packetIn.getEffectId() & 0xFF);
         if (effect != null) {
   ...
   public void handleTags(STagsListPacket packetIn) {
      ...
      if (!this.netManager.isLocalChannel()) {
         ...
         EntityTypeTags.func_219759_a(this.networkTagManager.func_215297_d());
      }
   ...
   public void handleCombatEvent(SCombatPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      if (packetIn.field_179776_a == SCombatPacket.Event.ENTITY_DIED) {
         Entity entity = this.field_147300_g.getEntityByID(packetIn.playerId);
         if (entity == this.client.player) {
            this.client.displayGuiScreen(new DeathScreen(packetIn.deathMessage, this.field_147300_g.getWorldInfo().isHardcore()));
         }
      }
   ...
   public void handleWorldBorder(SWorldBorderPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      packetIn.apply(this.field_147300_g.getWorldBorder());
   }
   ...
   public void handleTitle(STitlePacket packetIn) {
      ...
      case SUBTITLE:
         ...
         break;
      case ACTIONBAR:
         this.client.field_71456_v.setOverlayMessage(s2, false);
         return;
      case RESET:
         this.client.field_71456_v.displayTitle("", "", -1, -1, -1);
         this.client.field_71456_v.setDefaultTitlesTimes();
         return;
      }

      this.client.field_71456_v.displayTitle(s, s1, packetIn.getFadeInTime(), packetIn.getDisplayTime(), packetIn.getFadeOutTime());
   }

   public void handlePlayerListHeaderFooter(SPlayerListHeaderFooterPacket packetIn) {
      this.client.field_71456_v.getTabList().setHeader(packetIn.getHeader().getFormattedText().isEmpty() ? null : packetIn.getHeader());
      this.client.field_71456_v.getTabList().setFooter(packetIn.getFooter().getFormattedText().isEmpty() ? null : packetIn.getFooter());
   }
   ...
   public void handlePlayerAbilities(SPlayerAbilitiesPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      PlayerEntity playerentity = this.client.player;
      playerentity.playerAbilities.isFlying = packetIn.isFlying();
      playerentity.playerAbilities.isCreativeMode = packetIn.isCreativeMode();
      playerentity.playerAbilities.disableDamage = packetIn.isInvulnerable();
      playerentity.playerAbilities.allowFlying = packetIn.isAllowFlying();
      playerentity.playerAbilities.setFlySpeed(packetIn.getFlySpeed());
      playerentity.playerAbilities.setWalkSpeed(packetIn.getWalkSpeed());
   }
   ...
   public void func_217266_a(SSpawnMovingSoundEffectPacket p_217266_1_) {
      PacketThreadUtil.func_218797_a(p_217266_1_, this, this.client);
      Entity entity = this.field_147300_g.getEntityByID(p_217266_1_.func_218762_d());
      if (entity != null) {
   ...
   public void handleUpdateBossInfo(SUpdateBossInfoPacket packetIn) {
      PacketThreadUtil.func_218797_a(packetIn, this, this.client);
      this.client.field_71456_v.getBossOverlay().read(packetIn);
   }
   ...
   public void func_217268_a(SOpenBookWindowPacket p_217268_1_) {
      PacketThreadUtil.func_218797_a(p_217268_1_, this, this.client);
      ItemStack itemstack = this.client.player.getHeldItem(p_217268_1_.func_218746_b());
   ...
   public void handleCustomPayload(SCustomPayloadPlayPacket packetIn) {
      ...
      try {
         ...
         if (SCustomPayloadPlayPacket.BRAND.equals(resourcelocation)) {
            ...
            this.client.debugRenderer.field_188286_a.addPath(i, path, f);
            ...
            this.client.debugRenderer.field_201747_g.addCave(blockpos1, list1, list);
            ...
            this.client.debugRenderer.field_201748_h.addStructure(mutableboundingbox, list2, list3, i2);
            ...
            for(int j3 = 0; j3 < j2; ++j3) {
               this.client.debugRenderer.field_217741_m.func_217701_a(packetbuffer.func_218667_g());
            }

            int k3 = packetbuffer.readInt();

            for(int j4 = 0; j4 < k3; ++j4) {
               this.client.debugRenderer.field_217741_m.func_217700_b(packetbuffer.func_218667_g());
            }
         } else if (SCustomPayloadPlayPacket.field_218697_h.equals(resourcelocation)) {
            BlockPos blockpos2 = packetbuffer.readBlockPos();
            String s6 = packetbuffer.func_218666_n();
            ...
            String s1 = packetbuffer.func_218666_n();
            String s2 = packetbuffer.func_218666_n();
            ...
            for(int k1 = 0; k1 < j1; ++k1) {
               String s3 = packetbuffer.func_218666_n();
            ...
            for(int j6 = 0; j6 < i6; ++j6) {
               String s4 = packetbuffer.func_218666_n();
            ...
            for(int l6 = 0; l6 < k6; ++l6) {
               String s5 = packetbuffer.func_218666_n();
   ...
   public void handleParticles(SSpawnParticlePacket packetIn) {
      ...
      if (packetIn.getParticleCount() == 0) {
         ...
         try {
            this.field_147300_g.addParticle(packetIn.getParticle(), packetIn.isLongDistance(), packetIn.getXCoordinate(), packetIn.getYCoordinate(), packetIn.getZCoordinate(), d0, d2, d4);
         ...
         for(int i = 0; i < packetIn.getParticleCount(); ++i) {
            ...
            try {
               this.field_147300_g.addParticle(packetIn.getParticle(), packetIn.isLongDistance(), packetIn.getXCoordinate() + d1, packetIn.getYCoordinate() + d3, packetIn.getZCoordinate() + d5, d6, d7, d8);
   ...
   public void handlePlaceGhostRecipe(SPlaceGhostRecipePacket packetIn) {
      ...
      if (container.windowId == packetIn.getWindowId() && container.getCanCraft(this.client.player)) {
         this.recipeManager.func_215367_a(packetIn.getRecipeId()).ifPresent((p_217285_2_) -> {
            if (this.client.field_71462_r instanceof IRecipeShownListener) {
               RecipeBookGui recipebookgui = ((IRecipeShownListener)this.client.field_71462_r).func_194310_f();
   ...
   public void func_217269_a(SUpdateLightPacket p_217269_1_) {
      PacketThreadUtil.func_218797_a(p_217269_1_, this, this.client);
      int i = p_217269_1_.func_218716_b();
      int j = p_217269_1_.func_218714_c();
      WorldLightManager worldlightmanager = this.field_147300_g.getChunkProvider().getLightManager();
      int k = p_217269_1_.func_218715_d();
      int l = p_217269_1_.func_218717_e();
      Iterator<byte[]> iterator = p_217269_1_.func_218712_f().iterator();
      this.func_217284_a(i, j, worldlightmanager, LightType.SKY, k, l, iterator);
      int i1 = p_217269_1_.func_218718_g();
      int j1 = p_217269_1_.func_218719_h();
      Iterator<byte[]> iterator1 = p_217269_1_.func_218713_i().iterator();
      this.func_217284_a(i, j, worldlightmanager, LightType.BLOCK, i1, j1, iterator1);
   }

   public void func_217273_a(SMerchantOffersPacket p_217273_1_) {
      PacketThreadUtil.func_218797_a(p_217273_1_, this, this.client);
      Container container = this.client.player.openContainer;
   ...
   public void func_217270_a(SUpdateViewDistancePacket p_217270_1_) {
      PacketThreadUtil.func_218797_a(p_217270_1_, this, this.client);
      this.field_217287_m = p_217270_1_.func_218758_b();
      this.field_147300_g.getChunkProvider().setViewDistance(p_217270_1_.func_218758_b());
   }

   public void func_217267_a(SUpdateChunkPositionPacket p_217267_1_) {
      PacketThreadUtil.func_218797_a(p_217267_1_, this, this.client);
      this.field_147300_g.getChunkProvider().setCenter(p_217267_1_.func_218755_b(), p_217267_1_.func_218754_c());
   }

   private void func_217284_a(int p_217284_1_, int p_217284_2_, WorldLightManager p_217284_3_, LightType p_217284_4_, int p_217284_5_, int p_217284_6_, Iterator<byte[]> p_217284_7_) {
      for(int i = 0; i < 18; ++i) {
         int j = -1 + i;
         boolean flag = (p_217284_5_ & 1 << i) != 0;
         boolean flag1 = (p_217284_6_ & 1 << i) != 0;
         if (flag || flag1) {
            p_217284_3_.func_215574_a(p_217284_4_, SectionPos.of(p_217284_1_, j, p_217284_2_), flag ? new NibbleArray((byte[])p_217284_7_.next().clone()) : new NibbleArray());
            this.field_147300_g.markSurroundingsForRerender(p_217284_1_, j, p_217284_2_);
         }
      }
