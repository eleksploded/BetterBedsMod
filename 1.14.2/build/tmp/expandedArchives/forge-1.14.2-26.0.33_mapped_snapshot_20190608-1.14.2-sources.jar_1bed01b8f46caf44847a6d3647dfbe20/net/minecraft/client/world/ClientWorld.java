...
public class ClientWorld extends World {
   ...
   public ClientWorld(ClientPlayNetHandler p_i51056_1_, WorldSettings p_i51056_2_, DimensionType p_i51056_3_, int p_i51056_4_, IProfiler p_i51056_5_, WorldRenderer p_i51056_6_) {
      ...
      this.field_73035_a = p_i51056_1_;
      this.field_217430_d = p_i51056_6_;
   ...
   public void tick(BooleanSupplier hasTimeLeft) {
      ...
      this.field_73020_y.tick(hasTimeLeft);
      this.func_217426_j();
   ...
   public void func_217418_a(Entity p_217418_1_) {
      if (p_217418_1_ instanceof PlayerEntity || this.getChunkProvider().func_217204_a(p_217418_1_)) {
         ...
         if (p_217418_1_.addedToChunk) {
            ...
            this.getProfiler().startSection(() -> {
               return Registry.field_212629_r.getKey(p_217418_1_.getType()).toString();
            });
   ...
   public void func_217420_a(Entity p_217420_1_, Entity p_217420_2_) {
      if (!p_217420_2_.removed && p_217420_2_.getRidingEntity() == p_217420_1_) {
         if (p_217420_2_ instanceof PlayerEntity || this.getChunkProvider().func_217204_a(p_217420_2_)) {
   ...
   public void onChunkUnloaded(Chunk p_217409_1_) {
      ...
      this.field_73020_y.getLightManager().func_215571_a(p_217409_1_.getPos(), false);
   }
   ...
   public void sendQuittingDisconnectingPacket() {
      this.field_73035_a.getNetworkManager().closeChannel(new TranslationTextComponent("multiplayer.status.quitting"));
   }
   ...
   public void animateTick(int posX, int posY, int posZ) {
      ...
      boolean flag = this.mc.field_71442_b.getCurrentGameType() == GameType.CREATIVE && !itemstack.isEmpty() && itemstack.getItem() == Blocks.BARRIER.asItem();
   ...
   public void animateTick(int x, int y, int z, int offset, Random random, boolean holdingBarrier, BlockPos.MutableBlockPos pos) {
      ...
      if (!ifluidstate.isEmpty()) {
         ...
         if (iparticledata != null && this.rand.nextInt(10) == 0) {
            boolean flag = Block.func_220056_d(blockstate, this, pos, Direction.DOWN);
   ...
   private void spawnParticle(double p_211834_1_, double p_211834_3_, double p_211834_5_, double p_211834_7_, double p_211834_9_, IParticleData p_211834_11_) {
      this.addParticle(p_211834_11_, MathHelper.func_219803_d(this.rand.nextDouble(), p_211834_1_, p_211834_3_), p_211834_9_, MathHelper.func_219803_d(this.rand.nextDouble(), p_211834_5_, p_211834_7_), 0.0D, 0.0D, 0.0D);
   }
   ...
   public void playSound(double x, double y, double z, SoundEvent soundIn, SoundCategory category, float volume, float pitch, boolean distanceDelay) {
      double d0 = this.mc.gameRenderer.func_215316_n().func_216785_c().squareDistanceTo(x, y, z);
   ...
   public void sendPacketToServer(IPacket<?> packetIn) {
      this.field_73035_a.sendPacket(packetIn);
   }

   public RecipeManager getRecipeManager() {
      return this.field_73035_a.getRecipeManager();
   }
   ...
   public NetworkTagManager getTags() {
      return this.field_73035_a.getTags();
   }
   ...
   public void notifyBlockUpdate(BlockPos pos, BlockState oldState, BlockState newState, int flags) {
      this.field_217430_d.notifyBlockUpdate(this, pos, oldState, newState, flags);
   }

   public void markForRerender(BlockPos p_217396_1_) {
      this.field_217430_d.markBlockRangeForRenderUpdate(p_217396_1_.getX(), p_217396_1_.getY(), p_217396_1_.getZ(), p_217396_1_.getX(), p_217396_1_.getY(), p_217396_1_.getZ());
   }
   ...
   public void sendBlockBreakProgress(int breakerId, BlockPos pos, int progress) {
      this.field_217430_d.sendBlockBreakProgress(breakerId, pos, progress);
   }

   public void playBroadcastSound(int id, BlockPos pos, int data) {
      this.field_217430_d.broadcastSound(id, pos, data);
   }

   public void playEvent(@Nullable PlayerEntity p_217378_1_, int p_217378_2_, BlockPos p_217378_3_, int p_217378_4_) {
      try {
         this.field_217430_d.playEvent(p_217378_1_, p_217378_2_, p_217378_3_, p_217378_4_);
      } catch (Throwable throwable) {
         CrashReport crashreport = CrashReport.makeCrashReport(throwable, "Playing level event");
         CrashReportCategory crashreportcategory = crashreport.makeCategory("Level event being played");
         crashreportcategory.addDetail("Block coordinates", CrashReportCategory.getCoordinateInfo(p_217378_3_));
         crashreportcategory.addDetail("Event source", p_217378_1_);
         crashreportcategory.addDetail("Event type", p_217378_2_);
         crashreportcategory.addDetail("Event data", p_217378_4_);
         throw new ReportedException(crashreport);
      }
   }

   public void addParticle(IParticleData particleData, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      this.field_217430_d.addParticle(particleData, particleData.getType().getAlwaysShow(), x, y, z, xSpeed, ySpeed, zSpeed);
   }
   ...
   public void addParticle(IParticleData particleData, boolean forceAlwaysRender, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      this.field_217430_d.addParticle(particleData, particleData.getType().getAlwaysShow() || forceAlwaysRender, x, y, z, xSpeed, ySpeed, zSpeed);
   }
   ...
   public void addOptionalParticle(IParticleData particleData, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
      this.field_217430_d.addParticle(particleData, false, true, x, y, z, xSpeed, ySpeed, zSpeed);
   }
   ...
   public void func_217404_b(IParticleData p_217404_1_, boolean p_217404_2_, double p_217404_3_, double p_217404_5_, double p_217404_7_, double p_217404_9_, double p_217404_11_, double p_217404_13_) {
      this.field_217430_d.addParticle(p_217404_1_, p_217404_1_.getType().getAlwaysShow() || p_217404_2_, true, p_217404_3_, p_217404_5_, p_217404_7_, p_217404_9_, p_217404_11_, p_217404_13_);
   }
