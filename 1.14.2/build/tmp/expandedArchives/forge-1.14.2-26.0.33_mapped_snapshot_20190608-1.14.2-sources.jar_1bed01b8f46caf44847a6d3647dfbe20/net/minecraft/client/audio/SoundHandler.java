...
public class SoundHandler extends ReloadListener<SoundHandler.Loader> {
   ...
   public SoundHandler(IResourceManager manager, GameSettings gameSettingsIn) {
      this.field_147694_f = new SoundEngine(this, gameSettingsIn, manager);
   }

   protected SoundHandler.Loader func_212854_a_(IResourceManager p_212854_1_, IProfiler p_212854_2_) {
   ...
   protected void func_212853_a_(SoundHandler.Loader p_212853_1_, IResourceManager p_212853_2_, IProfiler p_212853_3_) {
      p_212853_1_.func_217946_a(this.soundRegistry, this.field_147694_f);
      ...
      if (LOGGER.isDebugEnabled()) {
         for(ResourceLocation resourcelocation1 : this.soundRegistry.keySet()) {
            if (!Registry.field_212633_v.containsKey(resourcelocation1)) {
               LOGGER.debug("Not having sound event for: {}", (Object)resourcelocation1);
            }
         }
      }

      this.field_147694_f.reload();
   }
   ...
   public void play(ISound sound) {
      this.field_147694_f.play(sound);
   }
   ...
   public void playDelayed(ISound sound, int delay) {
      this.field_147694_f.playDelayed(sound, delay);
   }
   ...
   public void setSoundLevel(SoundCategory category, float volume) {
      ...
      this.field_147694_f.setVolume(category, volume);
   }

   public void stop(ISound soundIn) {
      this.field_147694_f.stop(soundIn);
   }
   ...
   public void addListener(ISoundEventListener listener) {
      this.field_147694_f.addListener(listener);
   }

   public void removeListener(ISoundEventListener listener) {
      this.field_147694_f.removeListener(listener);
   }

   public void stop(@Nullable ResourceLocation id, @Nullable SoundCategory category) {
      this.field_147694_f.stop(id, category);
   }
