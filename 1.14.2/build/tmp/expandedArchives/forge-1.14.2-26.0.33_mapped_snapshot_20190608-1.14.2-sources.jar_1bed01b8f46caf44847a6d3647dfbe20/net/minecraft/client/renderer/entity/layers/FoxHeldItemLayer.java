...
public class FoxHeldItemLayer extends LayerRenderer<FoxEntity, FoxModel<FoxEntity>> {
   ...
   public void func_212842_a_(FoxEntity p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
      ItemStack itemstack = p_212842_1_.getItemStackFromSlot(EquipmentSlotType.MAINHAND);
      if (!itemstack.isEmpty()) {
         boolean flag = p_212842_1_.isPlayerSleeping();
         boolean flag1 = p_212842_1_.isChild();
         ...
         GlStateManager.translatef((this.func_215332_c()).field_217115_a.rotationPointX / 16.0F, (this.func_215332_c()).field_217115_a.rotationPointY / 16.0F, (this.func_215332_c()).field_217115_a.rotationPointZ / 16.0F);
         float f1 = p_212842_1_.func_213475_v(p_212842_4_) * (180F / (float)Math.PI);
