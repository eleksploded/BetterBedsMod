...
public class ConfirmBackupScreen extends Screen {
   ...
   protected final ConfirmBackupScreen.ICallback field_212109_a;
   ...
   public ConfirmBackupScreen(Screen p_i51122_1_, ConfirmBackupScreen.ICallback p_i51122_2_, ITextComponent p_i51122_3_, ITextComponent p_i51122_4_, boolean p_i51122_5_) {
      super(p_i51122_3_);
      this.field_212110_s = p_i51122_1_;
      this.field_212109_a = p_i51122_2_;
      this.field_212111_t = p_i51122_4_;
   ...
   protected void init() {
      ...
      this.wrappedMessage.addAll(this.font.listFormattedStringToWidth(this.field_212111_t.getFormattedText(), this.width - 50));
      ...
      this.addButton(new Button(this.width / 2 - 155 + 80, 124 + i, 150, 20, this.cancelText, (p_212991_1_) -> {
         this.minecraft.displayGuiScreen(this.field_212110_s);
      }));
