...
public class IllusionerRenderer extends IllagerRenderer<IllusionerEntity> {
   ...
   public IllusionerRenderer(EntityRendererManager p_i47477_1_) {
      ...
      this.addLayer(new HeldItemLayer<IllusionerEntity, IllagerModel<IllusionerEntity>>(this) {
         public void func_212842_a_(IllusionerEntity p_212842_1_, float p_212842_2_, float p_212842_3_, float p_212842_4_, float p_212842_5_, float p_212842_6_, float p_212842_7_, float p_212842_8_) {
            if (p_212842_1_.isSpellcasting() || p_212842_1_.func_213398_dR()) {
