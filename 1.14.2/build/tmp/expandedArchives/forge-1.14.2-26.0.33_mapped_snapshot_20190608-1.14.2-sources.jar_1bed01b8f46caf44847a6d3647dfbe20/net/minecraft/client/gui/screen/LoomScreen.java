...
public class LoomScreen extends ContainerScreen<LoomContainer> {
   ...
   protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
      ...
      Slot slot = this.field_147002_h.func_217024_f();
      Slot slot1 = this.field_147002_h.func_217022_g();
      Slot slot2 = this.field_147002_h.func_217025_h();
      Slot slot3 = this.field_147002_h.func_217026_i();
      if (!slot.getHasStack()) {
      ...
      if (this.field_214123_u) {
         ...
         for(int k1 = this.field_214128_z; k1 < j1 && k1 < this.field_214122_t.length - 5; ++k1) {
            ...
            this.minecraft.getTextureManager().bindTexture(field_214113_k);
            int k2 = this.ySize;
            if (k1 == this.field_147002_h.func_217023_e()) {
               k2 += 14;
         ...
         int j3 = this.field_147002_h.func_217023_e();
   ...
   public boolean mouseClicked(double p_mouseClicked_1_, double p_mouseClicked_3_, int p_mouseClicked_5_) {
      ...
      if (this.field_214123_u) {
         ...
         for(int l = this.field_214128_z; l < k; ++l) {
            ...
            if (d0 >= 0.0D && d1 >= 0.0D && d0 < 14.0D && d1 < 14.0D && this.field_147002_h.enchantItem(this.minecraft.player, l)) {
               Minecraft.getInstance().getSoundHandler().play(SimpleSound.master(SoundEvents.field_219716_mi, 1.0F));
   ...
   private void func_214111_b() {
      ItemStack itemstack = this.field_147002_h.func_217026_i().getStack();
      ...
      ItemStack itemstack3 = this.field_147002_h.func_217024_f().getStack();
      ItemStack itemstack1 = this.field_147002_h.func_217022_g().getStack();
      ItemStack itemstack2 = this.field_147002_h.func_217025_h().getStack();
