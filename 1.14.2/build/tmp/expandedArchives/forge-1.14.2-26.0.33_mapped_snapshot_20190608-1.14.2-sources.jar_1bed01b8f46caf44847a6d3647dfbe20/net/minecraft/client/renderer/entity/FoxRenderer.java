...
public class FoxRenderer extends MobRenderer<FoxEntity, FoxModel<FoxEntity>> {
   ...
   protected void applyRotations(FoxEntity entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
      ...
      if (entityLiving.func_213480_dY() || entityLiving.func_213472_dX()) {
         GlStateManager.rotatef(-MathHelper.func_219799_g(partialTicks, entityLiving.prevRotationPitch, entityLiving.rotationPitch), 1.0F, 0.0F, 0.0F);
      }
   ...
   protected ResourceLocation getEntityTexture(FoxEntity entity) {
      if (entity.func_213471_dV() == FoxEntity.Type.RED) {
         return entity.isPlayerSleeping() ? field_217768_j : field_217767_a;
      } else {
         return entity.isPlayerSleeping() ? field_217770_l : field_217769_k;
      }
   }
}