...
public abstract class LivingRenderer<T extends LivingEntity, M extends EntityModel<T>> extends EntityRenderer<T> implements IEntityRenderer<T, M> {
   ...
   public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      this.field_77045_g.field_217112_c = this.getSwingProgress(entity, partialTicks);
      ...
      this.field_77045_g.field_217114_e = entity.isChild();
      ...
      try {
         ...
         this.field_77045_g.func_212843_a_(entity, f6, f5, partialTicks);
         this.field_77045_g.func_212844_a_(entity, f6, f5, f8, f2, f7, f4);
   ...
   protected void renderLivingAt(T entityLivingBaseIn, double x, double y, double z) {
      if (entityLivingBaseIn.getPose() == Pose.SLEEPING) {
         ...
         if (direction != null) {
            float f = entityLivingBaseIn.func_213307_e(Pose.STANDING) - 0.1F;
   ...
   protected void renderLayers(T entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scaleIn) {
      for(LayerRenderer<T, M> layerrenderer : this.layerRenderers) {
         ...
         layerrenderer.func_212842_a_(entitylivingbaseIn, limbSwing, limbSwingAmount, partialTicks, ageInTicks, netHeadYaw, headPitch, scaleIn);
         if (flag) {
            this.unsetBrightness();
         }
      }
   ...
   public void renderName(T entity, double x, double y, double z) {
      ...
      if (this.canRenderName(entity)) {
         double d0 = entity.getDistanceSq(this.field_76990_c.field_217783_c.func_216785_c());
   ...
   protected boolean canRenderName(T entity) {
      ...
      return Minecraft.isGuiEnabled() && entity != this.field_76990_c.field_217783_c.func_216773_g() && flag && !entity.isBeingRidden();
   }
}