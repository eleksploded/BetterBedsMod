...
public class EffectInstance implements Comparable<EffectInstance>, net.minecraftforge.common.extensions.IForgeEffectInstance {
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return this.duration == effectinstance.duration && this.amplifier == effectinstance.amplifier && this.isSplashPotion == effectinstance.isSplashPotion && this.ambient == effectinstance.ambient && this.field_188420_b.equals(effectinstance.field_188420_b);
      }
   }
   ...
   public CompoundNBT write(CompoundNBT nbt) {
      nbt.putByte("Id", (byte)Effect.getIdFromPotion(this.getPotion()));
   ...
   public static EffectInstance read(CompoundNBT nbt) {
      ...
      Effect effect = Effect.getPotionById(i);
      if (effect == null) {
         return null;
      } else {
