...
public class PotionUtils {
   ...
   public static int getColor(ItemStack p_190932_0_) {
      ...
      if (compoundnbt != null && compoundnbt.contains("CustomPotionColor", 99)) {
         ...
         return getPotionFromItem(p_190932_0_) == Potions.field_185229_a ? 16253176 : getPotionColorFromEffectList(getEffectsFromStack(p_190932_0_));
      }
   }

   public static int getPotionColor(Potion potionIn) {
      return potionIn == Potions.field_185229_a ? 16253176 : getPotionColorFromEffectList(potionIn.getEffects());
   }
   ...
   public static Potion getPotionTypeFromNBT(@Nullable CompoundNBT tag) {
      return tag == null ? Potions.field_185229_a : Potion.getPotionTypeForName(tag.getString("Potion"));
   }

   public static ItemStack addPotionToItemStack(ItemStack itemIn, Potion potionIn) {
      ResourceLocation resourcelocation = Registry.field_212621_j.getKey(potionIn);
      if (potionIn == Potions.field_185229_a) {
   ...
   public static void addPotionTooltip(ItemStack itemIn, List<ITextComponent> lores, float durationFactor) {
         ...
         for(EffectInstance effectinstance : list) {
            ...
            if (!map.isEmpty()) {
               for(Entry<IAttribute, AttributeModifier> entry : map.entrySet()) {
                  ...
                  AttributeModifier attributemodifier1 = new AttributeModifier(attributemodifier.getName(), effect.getAttributeModifierAmount(effectinstance.getAmplifier(), attributemodifier), attributemodifier.func_220375_c());
            ...
            lores.add(itextcomponent.applyTextStyle(effect.func_220303_e().func_220306_a()));
         }
      }
      ...
      if (!list1.isEmpty()) {
         ...
         for(Tuple<String, AttributeModifier> tuple : list1) {
            ...
            double d1;
            if (attributemodifier2.func_220375_c() != AttributeModifier.Operation.MULTIPLY_BASE && attributemodifier2.func_220375_c() != AttributeModifier.Operation.MULTIPLY_TOTAL) {
            ...
            if (d0 > 0.0D) {
               lores.add((new TranslationTextComponent("attribute.modifier.plus." + attributemodifier2.func_220375_c().func_220371_a(), ItemStack.DECIMALFORMAT.format(d1), new TranslationTextComponent("attribute.name." + (String)tuple.getA()))).applyTextStyle(TextFormatting.BLUE));
            } else if (d0 < 0.0D) {
               d1 = d1 * -1.0D;
               lores.add((new TranslationTextComponent("attribute.modifier.take." + attributemodifier2.func_220375_c().func_220371_a(), ItemStack.DECIMALFORMAT.format(d1), new TranslationTextComponent("attribute.name." + (String)tuple.getA()))).applyTextStyle(TextFormatting.RED));
            }
         }
      }
