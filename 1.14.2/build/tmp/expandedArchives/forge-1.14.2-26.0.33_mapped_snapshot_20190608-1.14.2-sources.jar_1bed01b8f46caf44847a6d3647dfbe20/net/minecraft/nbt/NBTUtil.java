...
public final class NBTUtil {
   ...
   public static BlockState readBlockState(CompoundNBT tag) {
      if (!tag.contains("Name", 8)) {
         ...
         Block block = Registry.field_212618_g.getOrDefault(new ResourceLocation(tag.getString("Name")));
   ...
   public static CompoundNBT writeBlockState(BlockState tag) {
      CompoundNBT compoundnbt = new CompoundNBT();
      compoundnbt.putString("Name", Registry.field_212618_g.getKey(tag.getBlock()).toString());
