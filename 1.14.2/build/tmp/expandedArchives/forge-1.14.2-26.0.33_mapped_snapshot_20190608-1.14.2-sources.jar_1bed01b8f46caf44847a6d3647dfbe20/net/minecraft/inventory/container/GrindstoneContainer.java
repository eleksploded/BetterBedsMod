...
public class GrindstoneContainer extends Container {
   ...
   public GrindstoneContainer(int p_i50081_1_, PlayerInventory p_i50081_2_, final IWorldPosCallable p_i50081_3_) {
      super(ContainerType.field_221521_o, p_i50081_1_);
         ...
         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            p_i50081_3_.consume((p_216944_1_, p_216944_2_) -> {
               ...
               while(l > 0) {
                  ...
                  l -= i1;
                  p_216944_1_.func_217376_c(new ExperienceOrbEntity(p_216944_1_, (double)p_216944_2_.getX(), (double)p_216944_2_.getY() + 0.5D, (double)p_216944_2_.getZ() + 0.5D, i1));
               }
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return isWithinUsableDistance(this.field_217015_e, playerIn, Blocks.field_222427_lP);
   }
