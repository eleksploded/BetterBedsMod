...
public class CartographyContainer extends Container {
   ...
   public CartographyContainer(int p_i50094_1_, PlayerInventory p_i50094_2_, final IWorldPosCallable p_i50094_3_) {
      super(ContainerType.field_221528_v, p_i50094_1_);
      ...
      this.addSlot(new Slot(this.field_216998_c, 1, 15, 52) {
         ...
         public boolean isItemValid(ItemStack stack) {
            ...
            return item == Items.PAPER || item == Items.MAP || item == Items.field_221792_df;
         }
      });
      this.addSlot(new Slot(this.field_217001_f, 2, 145, 39) {
         ...
         public ItemStack decrStackSize(int amount) {
            ...
            ItemStack itemstack1 = p_i50094_3_.apply((p_216936_2_, p_216936_3_) -> {
               if (!CartographyContainer.this.field_217000_e && CartographyContainer.this.field_216998_c.getStackInSlot(1).getItem() == Items.field_221792_df) {
         ...
         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            ...
            p_i50094_3_.consume((p_216935_0_, p_216935_1_) -> {
               p_216935_0_.playSound((PlayerEntity)null, p_216935_1_, SoundEvents.field_219718_mk, SoundCategory.BLOCKS, 1.0F, 1.0F);
            });
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return isWithinUsableDistance(this.field_216999_d, playerIn, Blocks.field_222425_lN);
   }
   ...
   private void func_216993_a(ItemStack p_216993_1_, ItemStack p_216993_2_, ItemStack p_216993_3_) {
      this.field_216999_d.consume((p_216996_4_, p_216996_5_) -> {
         ...
         if (mapdata != null) {
            ...
            } else if (item == Items.field_221792_df && !mapdata.field_215161_h) {
               itemstack = p_216993_1_.copy();
               itemstack.setCount(1);
               this.detectAndSendChanges();
            } else {
   ...
   public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
      ...
      if (slot != null && slot.getHasStack()) {
         ...
         if (index == 2) {
            if (this.field_216998_c.getStackInSlot(1).getItem() == Items.field_221792_df) {
            ...
            } else if (item != Items.PAPER && item != Items.MAP && item != Items.field_221792_df) {
               if (index >= 3 && index < 30) {
