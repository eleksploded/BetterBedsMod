...
public class BeaconContainer extends Container {
   ...
   public BeaconContainer(int p_i50100_1_, IInventory p_i50100_2_, IIntArray p_i50100_3_, IWorldPosCallable p_i50100_4_) {
      ...
      this.field_82864_f = new BeaconContainer.BeaconSlot(this.tileBeacon, 0, 136, 110);
      this.addSlot(this.field_82864_f);
   ...
   public void onContainerClosed(PlayerEntity playerIn) {
      ...
      if (!playerIn.world.isRemote) {
         ItemStack itemstack = this.field_82864_f.decrStackSize(this.field_82864_f.getSlotStackLimit());
   ...
   public Effect func_216967_f() {
      return Effect.getPotionById(this.field_216972_f.func_221476_a(1));
   }

   @Nullable
   @OnlyIn(Dist.CLIENT)
   public Effect func_216968_g() {
      return Effect.getPotionById(this.field_216972_f.func_221476_a(2));
   }

   public void func_216966_c(int p_216966_1_, int p_216966_2_) {
      if (this.field_82864_f.getHasStack()) {
         this.field_216972_f.func_221477_a(1, p_216966_1_);
         this.field_216972_f.func_221477_a(2, p_216966_2_);
         this.field_82864_f.decrStackSize(1);
      }
