...
public class MerchantInventory implements IInventory {
   ...
   public boolean isUsableByPlayer(PlayerEntity player) {
      return this.field_70476_a.getCustomer() == player;
   }
   ...
   public void resetRecipeAndSlots() {
      ...
      if (itemstack.isEmpty()) {
         ...
         MerchantOffers merchantoffers = this.field_70476_a.func_213706_dY();
         ...
         this.field_70476_a.verifySellingItem(this.getStackInSlot(2));
      }
   }
