...
public class MerchantContainer extends Container {
   ...
   public MerchantContainer(int p_i50069_1_, PlayerInventory p_i50069_2_, IMerchant p_i50069_3_) {
      ...
      this.addSlot(new Slot(this.field_75176_f, 0, 136, 37));
      this.addSlot(new Slot(this.field_75176_f, 1, 162, 37));
      this.addSlot(new MerchantResultSlot(p_i50069_2_.player, p_i50069_3_, this.field_75176_f, 2, 220, 37));
   ...
   public void onCraftMatrixChanged(IInventory inventoryIn) {
      this.field_75176_f.resetRecipeAndSlots();
      super.onCraftMatrixChanged(inventoryIn);
   }

   public void setCurrentRecipeIndex(int currentRecipeIndex) {
      this.field_75176_f.setCurrentRecipeIndex(currentRecipeIndex);
   }
   ...
   public boolean canInteractWith(PlayerEntity playerIn) {
      return this.field_75178_e.getCustomer() == playerIn;
   }

   @OnlyIn(Dist.CLIENT)
   public int func_217048_e() {
      return this.field_75178_e.func_213708_dV();
   }

   @OnlyIn(Dist.CLIENT)
   public int func_217047_f() {
      return this.field_75176_f.func_214024_h();
   }

   @OnlyIn(Dist.CLIENT)
   public void func_217052_e(int p_217052_1_) {
      this.field_75178_e.func_213702_q(p_217052_1_);
   }
   ...
   private void func_223132_j() {
      if (!this.field_75178_e.getWorld().isRemote) {
         Entity entity = (Entity)this.field_75178_e;
         this.field_75178_e.getWorld().playSound(entity.posX, entity.posY, entity.posZ, this.field_75178_e.func_213714_ea(), SoundCategory.NEUTRAL, 1.0F, 1.0F, false);
      }
   ...
   public void onContainerClosed(PlayerEntity playerIn) {
      ...
      this.field_75178_e.setCustomer((PlayerEntity)null);
      if (!this.field_75178_e.getWorld().isRemote) {
         if (!playerIn.isAlive() || playerIn instanceof ServerPlayerEntity && ((ServerPlayerEntity)playerIn).hasDisconnected()) {
            ItemStack itemstack = this.field_75176_f.removeStackFromSlot(0);
            if (!itemstack.isEmpty()) {
               playerIn.dropItem(itemstack, false);
            }

            itemstack = this.field_75176_f.removeStackFromSlot(1);
            if (!itemstack.isEmpty()) {
               playerIn.dropItem(itemstack, false);
            }
         } else {
            playerIn.inventory.placeItemBackInInventory(playerIn.world, this.field_75176_f.removeStackFromSlot(0));
            playerIn.inventory.placeItemBackInInventory(playerIn.world, this.field_75176_f.removeStackFromSlot(1));
         }
   ...
   public void func_217046_g(int p_217046_1_) {
      if (this.func_217051_h().size() > p_217046_1_) {
         ItemStack itemstack = this.field_75176_f.getStackInSlot(0);
         if (!itemstack.isEmpty()) {
            if (!this.mergeItemStack(itemstack, 3, 39, true)) {
               return;
            }

            this.field_75176_f.setInventorySlotContents(0, itemstack);
         }

         ItemStack itemstack1 = this.field_75176_f.getStackInSlot(1);
         if (!itemstack1.isEmpty()) {
            if (!this.mergeItemStack(itemstack1, 3, 39, true)) {
               return;
            }

            this.field_75176_f.setInventorySlotContents(1, itemstack1);
         }

         if (this.field_75176_f.getStackInSlot(0).isEmpty() && this.field_75176_f.getStackInSlot(1).isEmpty()) {
      ...
      if (!p_217053_2_.isEmpty()) {
         for(int i = 3; i < 39; ++i) {
            ...
            if (!itemstack.isEmpty() && this.func_217050_b(p_217053_2_, itemstack)) {
               ItemStack itemstack1 = this.field_75176_f.getStackInSlot(p_217053_1_);
               ...
               this.field_75176_f.setInventorySlotContents(p_217053_1_, itemstack2);
   ...
   public void func_217044_a(MerchantOffers p_217044_1_) {
      this.field_75178_e.func_213703_a(p_217044_1_);
   }
