...
public class RepairContainer extends Container {
   ...
   private final IntReferenceHolder field_82854_e = IntReferenceHolder.single();
   ...
   public RepairContainer(int p_i50102_1_, PlayerInventory p_i50102_2_, final IWorldPosCallable p_i50102_3_) {
      ...
      this.addSlot(new Slot(this.outputSlot, 2, 134, 47) {
         ...
         public boolean canTakeStack(PlayerEntity playerIn) {
            return (playerIn.playerAbilities.isCreativeMode || playerIn.experienceLevel >= RepairContainer.this.field_82854_e.get()) && RepairContainer.this.field_82854_e.get() > 0 && this.getHasStack();
         }

         public ItemStack onTake(PlayerEntity thePlayer, ItemStack stack) {
            if (!thePlayer.playerAbilities.isCreativeMode) {
               thePlayer.addExperienceLevel(-RepairContainer.this.field_82854_e.get());
            }
            ...
            RepairContainer.this.field_82854_e.set(0);
            p_i50102_3_.consume((p_216931_1_, p_216931_2_) -> {
               BlockState blockstate = p_216931_1_.getBlockState(p_216931_2_);
               if (!thePlayer.playerAbilities.isCreativeMode && blockstate.isIn(BlockTags.ANVIL) && thePlayer.getRNG().nextFloat() < breakChance) {
   ...
   public void updateRepairOutput() {
      ...
      this.field_82854_e.set(1);
      int i = 0;
      int j = 0;
      int k = 0;
      if (itemstack.isEmpty()) {
         this.outputSlot.setInventorySlotContents(0, ItemStack.EMPTY);
         this.field_82854_e.set(0);
      } else {
            ...
            if (itemstack1.isDamageable() && itemstack1.getItem().getIsRepairable(itemstack, itemstack2)) {
               ...
               for(Enchantment enchantment1 : map1.keySet()) {
                  if (enchantment1 != null) {
                     ...
                     if (this.field_82855_n.playerAbilities.isCreativeMode || itemstack.getItem() == Items.ENCHANTED_BOOK) {
                        flag1 = true;
                     }
         ...
         this.field_82854_e.set(j + i);
         if (i <= 0) {
            itemstack1 = ItemStack.EMPTY;
         }

         if (k == i && k > 0 && this.field_82854_e.get() >= 40) {
            this.field_82854_e.set(39);
         }

         if (this.field_82854_e.get() >= 40 && !this.field_82855_n.playerAbilities.isCreativeMode) {
            itemstack1 = ItemStack.EMPTY;
         }
   ...
   public int func_216976_f() {
      return this.field_82854_e.get();
   }

   public void setMaximumCost(int value) {
      this.field_82854_e.set(value);
   }
}