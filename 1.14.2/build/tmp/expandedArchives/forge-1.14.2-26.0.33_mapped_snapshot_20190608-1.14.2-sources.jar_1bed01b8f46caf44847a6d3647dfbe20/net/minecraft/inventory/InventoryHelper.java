...
public class InventoryHelper {
   ...
   public static void func_219961_a(World p_219961_0_, BlockPos p_219961_1_, NonNullList<ItemStack> p_219961_2_) {
   ...
   public static void spawnItemStack(World worldIn, double x, double y, double z, ItemStack stack) {
      double d0 = (double)EntityType.ITEM.func_220333_h();
      double d1 = 1.0D - d0;
      double d2 = d0 / 2.0D;
