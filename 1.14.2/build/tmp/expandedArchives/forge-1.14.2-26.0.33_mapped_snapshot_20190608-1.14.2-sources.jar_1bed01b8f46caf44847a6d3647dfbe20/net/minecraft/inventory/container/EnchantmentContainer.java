...
public class EnchantmentContainer extends Container {
   ...
   private final IntReferenceHolder field_178149_f = IntReferenceHolder.single();
   ...
   public EnchantmentContainer(int p_i50086_1_, PlayerInventory p_i50086_2_, IWorldPosCallable p_i50086_3_) {
      super(ContainerType.field_221519_m, p_i50086_1_);
      ...
      this.func_216958_a(this.field_178149_f).set(p_i50086_2_.player.getXPSeed());
      ...
      if (inventoryIn == this.tableInventory) {
         ...
         if (!itemstack.isEmpty() && itemstack.isEnchantable()) {
            this.field_217006_g.consume((p_217002_2_, p_217002_3_) -> {
               ...
               this.rand.setSeed((long)this.field_178149_f.get());
               ...
               for(int j1 = 0; j1 < 3; ++j1) {
                  if (this.enchantLevels[j1] > 0) {
                     ...
                     if (list != null && !list.isEmpty()) {
                        ...
                        this.enchantClue[j1] = Registry.field_212628_q.getId(enchantmentdata.enchantment);
   ...
   public boolean enchantItem(PlayerEntity playerIn, int id) {
      ...
      int i = id + 1;
      if ((itemstack1.isEmpty() || itemstack1.getCount() < i) && !playerIn.playerAbilities.isCreativeMode) {
         return false;
      } else if (this.enchantLevels[id] <= 0 || itemstack.isEmpty() || (playerIn.experienceLevel < i || playerIn.experienceLevel < this.enchantLevels[id]) && !playerIn.playerAbilities.isCreativeMode) {
         return false;
      } else {
         this.field_217006_g.consume((p_217003_6_, p_217003_7_) -> {
            ...
            if (!list.isEmpty()) {
               ...
               this.field_178149_f.set(playerIn.getXPSeed());
   ...
   private List<EnchantmentData> getEnchantmentList(ItemStack stack, int enchantSlot, int level) {
      this.rand.setSeed((long)(this.field_178149_f.get() + enchantSlot));
   ...
   public int func_217005_f() {
      return this.field_178149_f.get();
   }
