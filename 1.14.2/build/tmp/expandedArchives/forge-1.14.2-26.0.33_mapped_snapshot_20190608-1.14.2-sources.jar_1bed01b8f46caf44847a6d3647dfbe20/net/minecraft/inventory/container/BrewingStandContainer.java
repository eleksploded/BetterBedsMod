...
public class BrewingStandContainer extends Container {
   ...
   public BrewingStandContainer(int p_i50096_1_, PlayerInventory p_i50096_2_, IInventory p_i50096_3_, IIntArray p_i50096_4_) {
      ...
      this.field_75186_f = this.addSlot(new BrewingStandContainer.IngredientSlot(p_i50096_3_, 3, 79, 17));
   ...
   public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
      ...
      if (slot != null && slot.getHasStack()) {
         ...
         if ((index < 0 || index > 2) && index != 3 && index != 4) {
            if (this.field_75186_f.isItemValid(itemstack1)) {
   ...
   public int func_216982_e() {
      return this.field_216983_d.func_221476_a(1);
   }

   @OnlyIn(Dist.CLIENT)
   public int func_216981_f() {
      return this.field_216983_d.func_221476_a(0);
   }
