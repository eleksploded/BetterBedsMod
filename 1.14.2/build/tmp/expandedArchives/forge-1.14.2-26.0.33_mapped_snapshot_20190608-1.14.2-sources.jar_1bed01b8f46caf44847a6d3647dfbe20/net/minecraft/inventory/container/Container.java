...
public abstract class Container {
   ...
   public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, PlayerEntity player) {
      ...
      } else if (clickTypeIn == ClickType.CLONE && player.playerAbilities.isCreativeMode && playerinventory.getItemStack().isEmpty() && slotId >= 0) {
   ...
   public static boolean isValidDragMode(int dragModeIn, PlayerEntity player) {
      if (dragModeIn == 0) {
         ...
         return dragModeIn == 2 && player.playerAbilities.isCreativeMode;
      }
   }
