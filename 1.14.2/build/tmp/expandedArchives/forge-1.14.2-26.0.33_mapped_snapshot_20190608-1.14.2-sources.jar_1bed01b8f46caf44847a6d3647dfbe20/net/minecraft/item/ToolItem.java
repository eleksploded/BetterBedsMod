...
public class ToolItem extends TieredItem {
   ...
   public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
      stack.func_222118_a(2, attacker, (p_220039_0_) -> {
         p_220039_0_.func_213361_c(EquipmentSlotType.MAINHAND);
      });
      return true;
   }
   ...
   public boolean onBlockDestroyed(ItemStack stack, World worldIn, BlockState state, BlockPos pos, LivingEntity entityLiving) {
      if (!worldIn.isRemote && state.getBlockHardness(worldIn, pos) != 0.0F) {
         stack.func_222118_a(1, entityLiving, (p_220038_0_) -> {
            p_220038_0_.func_213361_c(EquipmentSlotType.MAINHAND);
         });
      }
