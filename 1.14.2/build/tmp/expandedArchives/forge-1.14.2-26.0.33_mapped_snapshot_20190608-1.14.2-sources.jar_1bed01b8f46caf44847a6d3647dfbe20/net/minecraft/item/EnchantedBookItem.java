...
public class EnchantedBookItem extends Item {
   ...
   public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
      ...
      ItemStack.func_222120_a(tooltip, getEnchantments(stack));
   }
   ...
   public static void addEnchantment(ItemStack p_92115_0_, EnchantmentData stack) {
      ...
      boolean flag = true;
      ResourceLocation resourcelocation = Registry.field_212628_q.getKey(stack.enchantment);
   ...
   public void fillItemGroup(ItemGroup group, NonNullList<ItemStack> items) {
      if (group == ItemGroup.SEARCH) {
         ...
         for(Enchantment enchantment1 : Registry.field_212628_q) {
            if (group.hasRelevantEnchantmentType(enchantment1.field_77351_y)) {
