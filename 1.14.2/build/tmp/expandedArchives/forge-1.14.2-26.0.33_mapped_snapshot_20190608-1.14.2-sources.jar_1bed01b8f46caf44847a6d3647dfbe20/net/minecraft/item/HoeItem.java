...
public class HoeItem extends TieredItem {
         ...
         if (blockstate != null) {
            ...
            if (!world.isRemote) {
               ...
               if (playerentity != null) {
                  context.getItem().func_222118_a(1, playerentity, (p_220043_1_) -> {
   ...
   public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
      stack.func_222118_a(1, attacker, (p_220042_0_) -> {
         p_220042_0_.func_213361_c(EquipmentSlotType.MAINHAND);
      });
      return true;
   }
