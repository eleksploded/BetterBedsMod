...
public class ServerRecipePlacerFurnace<C extends IInventory> extends ServerRecipePlacer<C> {
   ...
   protected void tryPlaceRecipe(IRecipe<C> p_201508_1_, boolean placeAll) {
      this.matches = this.field_201515_d.matches(p_201508_1_);
      int i = this.recipeItemHelper.getBiggestCraftableStack(p_201508_1_, (IntList)null);
      if (this.matches) {
         ItemStack itemstack = this.field_201515_d.getSlot(0).getStack();
      ...
      if (this.recipeItemHelper.canCraft(p_201508_1_, intlist, j)) {
         if (!this.matches) {
            this.giveToPlayer(this.field_201515_d.getOutputSlot());
            this.giveToPlayer(0);
         }
   ...
   protected void func_201516_a(int p_201516_1_, IntList p_201516_2_) {
      ...
      Slot slot = this.field_201515_d.getSlot(0);
