...
public class DyeItem extends Item {
   ...
   public DyeItem(DyeColor dyeColorIn, Item.Properties builder) {
      super(builder);
      this.field_195964_b = dyeColorIn;
   ...
   public boolean itemInteractionForEntity(ItemStack stack, PlayerEntity playerIn, LivingEntity target, Hand hand) {
      if (target instanceof SheepEntity) {
         ...
         if (sheepentity.isAlive() && !sheepentity.getSheared() && sheepentity.getFleeceColor() != this.field_195964_b) {
            sheepentity.setFleeceColor(this.field_195964_b);
            stack.shrink(1);
         }
