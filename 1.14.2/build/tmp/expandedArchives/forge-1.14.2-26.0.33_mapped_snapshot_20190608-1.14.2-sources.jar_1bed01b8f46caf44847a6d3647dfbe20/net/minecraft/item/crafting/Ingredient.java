...
public class Ingredient implements Predicate<ItemStack> {
   ...
   public static Ingredient.IItemList deserializeItemList(JsonObject json) {
      ...
      if (json.has("item") && json.has("tag")) {
         ...
         Item item = Registry.field_212630_s.func_218349_b(resourcelocation1).orElseThrow(() -> {
   ...
   public static class SingleItemList implements Ingredient.IItemList {
      ...
      public JsonObject serialize() {
         ...
         jsonobject.addProperty("item", Registry.field_212630_s.getKey(this.stack.getItem()).toString());
         return jsonobject;
      }
   }
