...
public class SpawnEggItem extends Item {
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (world.isRemote) {
         ...
         if (entitytype.func_220331_a(world, itemstack, context.getPlayer(), blockpos1, SpawnReason.SPAWN_EGG, true, !Objects.equals(blockpos, blockpos1) && direction == Direction.UP) != null) {
            itemstack.shrink(1);
         }
   ...
   public EntityType<?> getType(@Nullable CompoundNBT p_208076_1_) {
      if (p_208076_1_ != null && p_208076_1_.contains("EntityTag", 10)) {
         ...
         if (compoundnbt.contains("id", 8)) {
            return EntityType.func_220327_a(compoundnbt.getString("id")).orElse(this.typeIn);
         }
      }
