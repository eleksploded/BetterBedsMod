...
public class FlintAndSteelItem extends Item {
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (func_219996_a(iworld.getBlockState(blockpos1), iworld, blockpos1)) {
         ...
         if (playerentity instanceof ServerPlayerEntity) {
            ...
            itemstack.func_222118_a(1, playerentity, (p_219999_1_) -> {
               p_219999_1_.func_213334_d(context.func_221531_n());
            });
         }
         ...
         if (func_219997_a(blockstate)) {
            ...
            if (playerentity != null) {
               context.getItem().func_222118_a(1, playerentity, (p_219998_1_) -> {
                  p_219998_1_.func_213334_d(context.func_221531_n());
               });
            }
   ...
   public static boolean func_219997_a(BlockState p_219997_0_) {
      return p_219997_0_.getBlock() == Blocks.field_222433_lV && !p_219997_0_.get(BlockStateProperties.WATERLOGGED) && !p_219997_0_.get(BlockStateProperties.LIT);
   }
