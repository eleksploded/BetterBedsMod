...
public class MinecartItem extends Item {
   private static final IDispenseItemBehavior field_96602_b = new DefaultDispenseItemBehavior() {
      private final DefaultDispenseItemBehavior field_96465_b = new DefaultDispenseItemBehavior();
      ...
      public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
         ...
         if (blockstate.isIn(BlockTags.RAILS)) {
            ...
            if (!blockstate.isAir(world, blockpos) || !world.getBlockState(blockpos.down()).isIn(BlockTags.RAILS)) {
               return this.field_96465_b.dispense(source, stack);
            }
   ...
   public MinecartItem(AbstractMinecartEntity.Type minecartTypeIn, Item.Properties builder) {
      ...
      DispenserBlock.registerDispenseBehavior(this, field_96602_b);
   }
