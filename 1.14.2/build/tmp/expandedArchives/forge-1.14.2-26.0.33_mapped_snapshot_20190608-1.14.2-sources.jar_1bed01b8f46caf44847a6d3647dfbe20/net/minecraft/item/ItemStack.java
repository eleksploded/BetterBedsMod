...
public final class ItemStack extends net.minecraftforge.common.capabilities.CapabilityProvider<ItemStack> implements net.minecraftforge.common.extensions.IForgeItemStack {
   ...
   private ItemStack(CompoundNBT compound) {
      ...
      this.item = Registry.field_212630_s.getOrDefault(new ResourceLocation(compound.getString("id")));
      this.count = compound.getByte("Count");
      if (compound.contains("tag", 10)) {
         this.field_77990_d = compound.getCompound("tag");
   ...
   private ActionResultType onItemUse(ItemUseContext context, java.util.function.Function<ItemUseContext, ActionResultType> callback) {
      ...
      if (playerentity != null && !playerentity.playerAbilities.allowEdit && !this.canPlaceOn(context.getWorld().getTags(), cachedblockinfo)) {
   ...
   public CompoundNBT write(CompoundNBT nbt) {
      ResourceLocation resourcelocation = Registry.field_212630_s.getKey(this.getItem());
      nbt.putString("id", resourcelocation == null ? "minecraft:air" : resourcelocation.toString());
      nbt.putByte("Count", (byte)this.count);
      if (this.field_77990_d != null) {
         nbt.put("tag", this.field_77990_d);
      }
   ...
   public int getDamage() {
      return this.field_77990_d == null ? 0 : this.field_77990_d.getInt("Damage");
   }
   ...
   public <T extends LivingEntity> void func_222118_a(int p_222118_1_, T p_222118_2_, Consumer<T> p_222118_3_) {
      if (!p_222118_2_.world.isRemote && (!(p_222118_2_ instanceof PlayerEntity) || !((PlayerEntity)p_222118_2_).playerAbilities.isCreativeMode)) {
         if (this.isDamageable()) {
   ...
   public ItemStack copy() {
      ...
      if (this.field_77990_d != null) {
         itemstack.field_77990_d = this.field_77990_d.copy();
      }
   ...
   private boolean isItemStackEqual(ItemStack other) {
      if (this.count != other.count) {
         ...
         return false;
      } else if (this.field_77990_d == null && other.field_77990_d != null) {
         return false;
      } else {
   ...
   public boolean func_222122_m() {
      return this.getItem().func_219970_i(this);
   }
   ...
   public boolean hasTag() {
      return !this.isEmpty && this.field_77990_d != null && !this.field_77990_d.isEmpty();
   }
   ...
   public CompoundNBT getOrCreateChildTag(String key) {
      if (this.field_77990_d != null && this.field_77990_d.contains(key, 10)) {
         return this.field_77990_d.getCompound(key);
      } else {
   ...
   public CompoundNBT getChildTag(String key) {
      return this.field_77990_d != null && this.field_77990_d.contains(key, 10) ? this.field_77990_d.getCompound(key) : null;
   }

   public void removeChildTag(String p_196083_1_) {
      if (this.field_77990_d != null && this.field_77990_d.contains(p_196083_1_)) {
         this.field_77990_d.remove(p_196083_1_);
   ...
   public ListNBT getEnchantmentTagList() {
      return this.field_77990_d != null ? this.field_77990_d.getList("Enchantments", 10) : new ListNBT();
   }
   ...
   public List<ITextComponent> getTooltip(@Nullable PlayerEntity playerIn, ITooltipFlag advanced) {
      ...
      int i = 0;
      if (this.hasTag() && this.field_77990_d.contains("HideFlags", 99)) {
         i = this.field_77990_d.getInt("HideFlags");
      }
      ...
      if (this.hasTag()) {
         if ((i & 1) == 0) {
            func_222120_a(list, this.getEnchantmentTagList());
         }

         if (this.field_77990_d.contains("display", 10)) {
            CompoundNBT compoundnbt = this.field_77990_d.getCompound("display");
      ...
      for(EquipmentSlotType equipmentslottype : EquipmentSlotType.values()) {
         ...
         if (!multimap.isEmpty() && (i & 2) == 0) {
            ...
            for(Entry<String, AttributeModifier> entry : multimap.entries()) {
               ...
               if (flag) {
                  list.add((new StringTextComponent(" ")).appendSibling(new TranslationTextComponent("attribute.modifier.equals." + attributemodifier.func_220375_c().func_220371_a(), DECIMALFORMAT.format(d1), new TranslationTextComponent("attribute.name." + (String)entry.getKey()))).applyTextStyle(TextFormatting.DARK_GREEN));
               } else if (d0 > 0.0D) {
                  list.add((new TranslationTextComponent("attribute.modifier.plus." + attributemodifier.func_220375_c().func_220371_a(), DECIMALFORMAT.format(d1), new TranslationTextComponent("attribute.name." + (String)entry.getKey()))).applyTextStyle(TextFormatting.BLUE));
               } else if (d0 < 0.0D) {
                  d1 = d1 * -1.0D;
                  list.add((new TranslationTextComponent("attribute.modifier.take." + attributemodifier.func_220375_c().func_220371_a(), DECIMALFORMAT.format(d1), new TranslationTextComponent("attribute.name." + (String)entry.getKey()))).applyTextStyle(TextFormatting.RED));
               }
            }
         }
      }
      ...
      if (this.hasTag() && this.field_77990_d.contains("CanDestroy", 9) && (i & 8) == 0) {
         ListNBT listnbt1 = this.field_77990_d.getList("CanDestroy", 8);
         if (!listnbt1.isEmpty()) {
            list.add(new StringTextComponent(""));
      ...
      if (this.hasTag() && this.field_77990_d.contains("CanPlaceOn", 9) && (i & 16) == 0) {
         ListNBT listnbt2 = this.field_77990_d.getList("CanPlaceOn", 8);
         if (!listnbt2.isEmpty()) {
            list.add(new StringTextComponent(""));
      ...
      if (advanced.isAdvanced()) {
         ...
         list.add((new StringTextComponent(Registry.field_212630_s.getKey(this.getItem()).toString())).applyTextStyle(TextFormatting.DARK_GRAY));
         if (this.hasTag()) {
   ...
   public static void func_222120_a(List<ITextComponent> p_222120_0_, ListNBT p_222120_1_) {
      for(int i = 0; i < p_222120_1_.size(); ++i) {
         ...
         Registry.field_212628_q.func_218349_b(ResourceLocation.tryCreate(compoundnbt.getString("id"))).ifPresent((p_222123_2_) -> {
   ...
   public void addEnchantment(Enchantment ench, int level) {
      this.getOrCreateTag();
      if (!this.field_77990_d.contains("Enchantments", 9)) {
         this.field_77990_d.put("Enchantments", new ListNBT());
      }

      ListNBT listnbt = this.field_77990_d.getList("Enchantments", 10);
      CompoundNBT compoundnbt = new CompoundNBT();
      compoundnbt.putString("id", String.valueOf((Object)Registry.field_212628_q.getKey(ench)));
   ...
   public boolean isEnchanted() {
      if (this.field_77990_d != null && this.field_77990_d.contains("Enchantments", 9)) {
         return !this.field_77990_d.getList("Enchantments", 10).isEmpty();
      } else {
         return false;
      }
   }
   ...
   public ItemFrameEntity getItemFrame() {
      return this.isEmpty ? null : this.field_82843_f;
   }
   ...
   public int getRepairCost() {
      return this.hasTag() && this.field_77990_d.contains("RepairCost", 3) ? this.field_77990_d.getInt("RepairCost") : 0;
   }
   ...
   public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
      ...
      if (this.hasTag() && this.field_77990_d.contains("AttributeModifiers", 9)) {
         multimap = HashMultimap.create();
         ListNBT listnbt = this.field_77990_d.getList("AttributeModifiers", 10);
   ...
   public void addAttributeModifier(String attributeName, AttributeModifier modifier, @Nullable EquipmentSlotType equipmentSlot) {
      this.getOrCreateTag();
      if (!this.field_77990_d.contains("AttributeModifiers", 9)) {
         this.field_77990_d.put("AttributeModifiers", new ListNBT());
      }
   ...
   public boolean canDestroy(NetworkTagManager p_206848_1_, CachedBlockInfo p_206848_2_) {
      if (isStateAndTileEntityEqual(p_206848_2_, this.field_179552_h)) {
         return this.canDestroyCacheResult;
      } else {
         this.field_179552_h = p_206848_2_;
         if (this.hasTag() && this.field_77990_d.contains("CanDestroy", 9)) {
            ListNBT listnbt = this.field_77990_d.getList("CanDestroy", 8);
   ...
   public boolean canPlaceOn(NetworkTagManager p_206847_1_, CachedBlockInfo p_206847_2_) {
      if (isStateAndTileEntityEqual(p_206847_2_, this.field_179550_j)) {
         return this.canPlaceOnCacheResult;
      } else {
         this.field_179550_j = p_206847_2_;
         if (this.hasTag() && this.field_77990_d.contains("CanPlaceOn", 9)) {
            ListNBT listnbt = this.field_77990_d.getList("CanPlaceOn", 8);
   ...
   public boolean func_222117_E() {
      return this.getItem().func_219971_r();
   }
