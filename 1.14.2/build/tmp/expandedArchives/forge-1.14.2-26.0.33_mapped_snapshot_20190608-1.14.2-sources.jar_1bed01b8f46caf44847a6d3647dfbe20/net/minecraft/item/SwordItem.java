...
public class SwordItem extends TieredItem {
   ...
   public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
      stack.func_222118_a(1, attacker, (p_220045_0_) -> {
         p_220045_0_.func_213361_c(EquipmentSlotType.MAINHAND);
      });
      return true;
   }
   ...
   public boolean onBlockDestroyed(ItemStack stack, World worldIn, BlockState state, BlockPos pos, LivingEntity entityLiving) {
      if (state.getBlockHardness(worldIn, pos) != 0.0F) {
         stack.func_222118_a(2, entityLiving, (p_220044_0_) -> {
            p_220044_0_.func_213361_c(EquipmentSlotType.MAINHAND);
         });
      }
