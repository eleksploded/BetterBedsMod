...
public class ServerRecipeBook extends RecipeBook {
   ...
   public void read(CompoundNBT tag) {
      ...
      for(int i = 0; i < listnbt.size(); ++i) {
         ...
         Optional<? extends IRecipe<?>> optional = this.recipeManager.func_215367_a(resourcelocation);
      ...
      for(int j = 0; j < listnbt1.size(); ++j) {
         ...
         Optional<? extends IRecipe<?>> optional1 = this.recipeManager.func_215367_a(resourcelocation1);
