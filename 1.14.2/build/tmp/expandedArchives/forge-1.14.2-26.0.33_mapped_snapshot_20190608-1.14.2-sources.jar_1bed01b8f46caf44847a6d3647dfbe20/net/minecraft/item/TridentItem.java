...
public class TridentItem extends Item {
      ...
      if (entityLiving instanceof PlayerEntity) {
         ...
         if (i >= 10) {
            ...
            if (j <= 0 || playerentity.isWet()) {
               if (!worldIn.isRemote) {
                  stack.func_222118_a(1, playerentity, (p_220047_1_) -> {
                     p_220047_1_.func_213334_d(entityLiving.getActiveHand());
                  });
                  if (j == 0) {
                     ...
                     worldIn.func_217376_c(tridententity);
   ...
   public boolean hitEntity(ItemStack stack, LivingEntity target, LivingEntity attacker) {
      stack.func_222118_a(1, attacker, (p_220048_0_) -> {
   ...
   public boolean onBlockDestroyed(ItemStack stack, World worldIn, BlockState state, BlockPos pos, LivingEntity entityLiving) {
      if ((double)state.getBlockHardness(worldIn, pos) != 0.0D) {
         stack.func_222118_a(2, entityLiving, (p_220046_0_) -> {
