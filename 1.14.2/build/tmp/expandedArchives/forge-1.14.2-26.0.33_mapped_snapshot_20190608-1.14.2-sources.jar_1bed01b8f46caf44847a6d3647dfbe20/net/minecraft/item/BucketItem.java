...
public class BucketItem extends Item {
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      RayTraceResult raytraceresult = func_219968_a(worldIn, playerIn, this.containedBlock == Fluids.EMPTY ? RayTraceContext.FluidMode.SOURCE_ONLY : RayTraceContext.FluidMode.NONE);
   ...
   protected ItemStack emptyBucket(ItemStack p_203790_1_, PlayerEntity p_203790_2_) {
      return !p_203790_2_.playerAbilities.isCreativeMode ? new ItemStack(Items.BUCKET) : p_203790_1_;
   }
