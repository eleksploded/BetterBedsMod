...
public class SuspiciousStewRecipe extends SpecialRecipe {
      ...
      for(int i = 0; i < inv.getSizeInventory(); ++i) {
         ...
         if (!itemstack.isEmpty()) {
            if (itemstack.getItem() == Blocks.BROWN_MUSHROOM.asItem() && !flag2) {
               ...
               flag1 = true;
            } else if (itemstack.getItem().isIn(ItemTags.field_219770_E) && !flag) {
               flag = true;
            } else {
   ...
   public ItemStack getCraftingResult(CraftingInventory inv) {
      ...
      for(int i = 0; i < inv.getSizeInventory(); ++i) {
         ...
         if (!itemstack1.isEmpty() && itemstack1.getItem().isIn(ItemTags.field_219770_E)) {
      ...
      if (itemstack.getItem() instanceof BlockItem && ((BlockItem)itemstack.getItem()).getBlock() instanceof FlowerBlock) {
         ...
         SuspiciousStewItem.func_220037_a(itemstack2, effect, flowerblock.func_220095_e());
      }
