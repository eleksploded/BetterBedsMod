...
public class CookingRecipeSerializer<T extends AbstractCookingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
   ...
   public void write(PacketBuffer buffer, T recipe) {
      buffer.writeString(recipe.field_222141_c);
      recipe.field_222142_d.write(buffer);
      buffer.writeItemStack(recipe.field_222143_e);
      buffer.writeFloat(recipe.field_222144_f);
      buffer.writeVarInt(recipe.field_222145_g);
   }
