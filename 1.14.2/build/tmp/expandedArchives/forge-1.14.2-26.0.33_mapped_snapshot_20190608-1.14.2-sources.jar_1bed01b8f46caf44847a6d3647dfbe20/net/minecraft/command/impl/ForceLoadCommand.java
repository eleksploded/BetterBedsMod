...
public class ForceLoadCommand {
   ...
   private static int func_212713_a(CommandSource p_212713_0_, ColumnPos p_212713_1_) throws CommandSyntaxException {
      ChunkPos chunkpos = new ChunkPos(p_212713_1_.field_219439_a >> 4, p_212713_1_.field_219440_b >> 4);
      DimensionType dimensiontype = p_212713_0_.getWorld().getDimension().getType();
      boolean flag = p_212713_0_.getServer().getWorld(dimensiontype).func_217469_z().contains(chunkpos.asLong());
      if (flag) {
   ...
   private static int func_212721_a(CommandSource p_212721_0_) {
      ...
      LongSet longset = p_212721_0_.getServer().getWorld(dimensiontype).func_217469_z();
      int i = longset.size();
      if (i > 0) {
   ...
   private static int func_212722_b(CommandSource p_212722_0_) {
      ...
      LongSet longset = serverworld.func_217469_z();
      longset.forEach((long p_212720_1_) -> {
         serverworld.func_217458_b(ChunkPos.getX(p_212720_1_), ChunkPos.getZ(p_212720_1_), false);
      });
   ...
   private static int func_212719_a(CommandSource p_212719_0_, ColumnPos p_212719_1_, ColumnPos p_212719_2_, boolean p_212719_3_) throws CommandSyntaxException {
      int i = Math.min(p_212719_1_.field_219439_a, p_212719_2_.field_219439_a);
      int j = Math.min(p_212719_1_.field_219440_b, p_212719_2_.field_219440_b);
      int k = Math.max(p_212719_1_.field_219439_a, p_212719_2_.field_219439_a);
      int l = Math.max(p_212719_1_.field_219440_b, p_212719_2_.field_219440_b);
         ...
         if (i2 > 256L) {
            ...
            for(int k2 = i1; k2 <= k1; ++k2) {
               for(int l2 = j1; l2 <= l1; ++l2) {
                  boolean flag = serverworld.func_217458_b(k2, l2, p_212719_3_);
                  if (flag) {
                     ++j2;
                     if (chunkpos == null) {
