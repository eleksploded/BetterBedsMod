...
public class Commands {
   ...
   public Commands(boolean isDedicatedServer) {
      ...
      LootCommand.func_218886_a(this.dispatcher);
      ...
      ScheduleCommand.func_218909_a(this.dispatcher);
      ...
      TeamMsgCommand.func_218915_a(this.dispatcher);
   ...
   public int handleCommand(CommandSource source, String command) {
      ...
      source.getServer().func_213185_aS().startSection(command);
      ...
      try {
         ...
         source.getServer().func_213185_aS().endSection();
      }
   }
