...
public class ItemInput implements Predicate<ItemStack> {
   ...
   public boolean test(ItemStack p_test_1_) {
      return p_test_1_.getItem() == this.item && NBTUtil.areNBTEquals(this.field_197324_c, p_test_1_.getTag(), true);
   }
   ...
   public ItemStack createStack(int count, boolean allowOversizedStacks) throws CommandSyntaxException {
      ...
      if (this.field_197324_c != null) {
         itemstack.setTag(this.field_197324_c);
      }

      if (allowOversizedStacks && count > itemstack.getMaxStackSize()) {
         throw STACK_TOO_LARGE.create(Registry.field_212630_s.getKey(this.item), itemstack.getMaxStackSize());
      } else {
         return itemstack;
      }
   }
   ...
   public String serialize() {
      StringBuilder stringbuilder = new StringBuilder(Registry.field_212630_s.getId(this.item));
      if (this.field_197324_c != null) {
         stringbuilder.append((Object)this.field_197324_c);
      }
