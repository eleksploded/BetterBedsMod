...
public class ScheduleCommand {
   ...
   public static void func_218909_a(CommandDispatcher<CommandSource> p_218909_0_) {
   ...
   private static int func_218908_a(CommandSource p_218908_0_, Either<FunctionObject, Tag<FunctionObject>> p_218908_1_, int p_218908_2_) throws CommandSyntaxException {
      if (p_218908_2_ == 0) {
         ...
         p_218908_1_.ifLeft((p_218910_4_) -> {
            ...
            p_218908_0_.getWorld().getWorldInfo().func_215763_z().func_216326_b(resourcelocation.toString(), i, new TimedFunction(resourcelocation));
            ...
            p_218908_0_.getWorld().getWorldInfo().func_215763_z().func_216326_b("#" + resourcelocation.toString(), i, new TimedFunctionTag(resourcelocation));
