...
public class LootCommand {
   ...
   public static void func_218886_a(CommandDispatcher<CommandSource> p_218886_0_) {
   ...
   private static int func_218879_a(CommandContext<CommandSource> p_218879_0_, BlockPos p_218879_1_, ItemStack p_218879_2_, LootCommand.ITargetHandler p_218879_3_) throws CommandSyntaxException {
      ...
      LootContext.Builder lootcontext$builder = (new LootContext.Builder(serverworld)).withParameter(LootParameters.field_216286_f, p_218879_1_).withParameter(LootParameters.field_216287_g, blockstate).withNullableParameter(LootParameters.field_216288_h, tileentity).withNullableParameter(LootParameters.field_216281_a, commandsource.getEntity()).withParameter(LootParameters.field_216289_i, p_218879_2_);
   ...
   private static int func_218869_a(CommandContext<CommandSource> p_218869_0_, Entity p_218869_1_, LootCommand.ITargetHandler p_218869_2_) throws CommandSyntaxException {
      if (!(p_218869_1_ instanceof LivingEntity)) {
         ...
         if (entity instanceof PlayerEntity) {
            lootcontext$builder.withParameter(LootParameters.field_216282_b, (PlayerEntity)entity);
         }

         lootcontext$builder.withParameter(LootParameters.field_216283_c, DamageSource.MAGIC);
         lootcontext$builder.withNullableParameter(LootParameters.field_216285_e, entity);
         lootcontext$builder.withNullableParameter(LootParameters.field_216284_d, entity);
         lootcontext$builder.withParameter(LootParameters.field_216281_a, p_218869_1_);
         lootcontext$builder.withParameter(LootParameters.field_216286_f, new BlockPos(commandsource.getPos()));
         LootTable loottable = commandsource.getServer().getLootTableManager().getLootTableFromLocation(resourcelocation);
         List<ItemStack> list = loottable.func_216113_a(lootcontext$builder.build(LootParameterSets.field_216263_d));
   ...
   private static int func_218887_a(CommandContext<CommandSource> p_218887_0_, ResourceLocation p_218887_1_, LootCommand.ITargetHandler p_218887_2_) throws CommandSyntaxException {
      ...
      LootContext.Builder lootcontext$builder = (new LootContext.Builder(commandsource.getWorld())).withNullableParameter(LootParameters.field_216281_a, commandsource.getEntity()).withParameter(LootParameters.field_216286_f, new BlockPos(commandsource.getPos()));
      return func_218871_a(p_218887_0_, p_218887_1_, lootcontext$builder.build(LootParameterSets.field_216261_b), p_218887_2_);
   }
   ...
   private static int func_218876_a(CommandContext<CommandSource> p_218876_0_, ResourceLocation p_218876_1_, BlockPos p_218876_2_, ItemStack p_218876_3_, LootCommand.ITargetHandler p_218876_4_) throws CommandSyntaxException {
      ...
      LootContext lootcontext = (new LootContext.Builder(commandsource.getWorld())).withParameter(LootParameters.field_216286_f, p_218876_2_).withParameter(LootParameters.field_216289_i, p_218876_3_).build(LootParameterSets.field_216262_c);
   ...
   private static int func_218871_a(CommandContext<CommandSource> p_218871_0_, ResourceLocation p_218871_1_, LootContext p_218871_2_, LootCommand.ITargetHandler p_218871_3_) throws CommandSyntaxException {
      ...
      List<ItemStack> list = loottable.func_216113_a(p_218871_2_);
