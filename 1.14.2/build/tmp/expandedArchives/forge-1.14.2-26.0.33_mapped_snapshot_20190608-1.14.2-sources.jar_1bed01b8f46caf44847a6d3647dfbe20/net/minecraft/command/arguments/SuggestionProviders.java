...
public class SuggestionProviders {
   ...
   public static final SuggestionProvider<CommandSource> SUMMONABLE_ENTITIES = register(new ResourceLocation("summonable_entities"), (p_201210_0_, p_201210_1_) -> {
      return ISuggestionProvider.func_201725_a(Registry.field_212629_r.stream().filter(EntityType::isSummonable), p_201210_1_, EntityType::getId, (p_201209_0_) -> {
         return new TranslationTextComponent(Util.makeTranslationKey("entity", EntityType.getId(p_201209_0_)));
      });
   });
