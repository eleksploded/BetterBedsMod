...
public class ParticleArgument implements ArgumentType<IParticleData> {
   ...
   public static IParticleData parseParticle(StringReader reader) throws CommandSyntaxException {
      ...
      ParticleType<?> particletype = Registry.field_212632_u.func_218349_b(resourcelocation).orElseThrow(() -> {
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> p_listSuggestions_1_, SuggestionsBuilder p_listSuggestions_2_) {
      return ISuggestionProvider.suggestIterable(Registry.field_212632_u.keySet(), p_listSuggestions_2_);
   }
}