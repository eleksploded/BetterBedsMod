...
public class ItemParser {
   ...
   public void readItem() throws CommandSyntaxException {
      ...
      this.item = Registry.field_212630_s.func_218349_b(resourcelocation).orElseThrow(() -> {
   ...
   public void readNBT() throws CommandSyntaxException {
      this.field_197338_f = (new JsonToNBT(this.reader)).readStruct();
   }
   ...
   private CompletableFuture<Suggestions> func_197331_c(SuggestionsBuilder p_197331_1_) {
      ...
      return ISuggestionProvider.suggestIterable(Registry.field_212630_s.keySet(), p_197331_1_);
   }
