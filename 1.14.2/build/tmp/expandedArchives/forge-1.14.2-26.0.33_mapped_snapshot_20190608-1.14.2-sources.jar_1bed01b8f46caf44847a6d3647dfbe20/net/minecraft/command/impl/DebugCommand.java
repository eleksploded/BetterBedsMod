...
public class DebugCommand {
   ...
   private static int startDebug(CommandSource source) throws CommandSyntaxException {
      ...
      DebugProfiler debugprofiler = minecraftserver.func_213185_aS();
   ...
   private static int stopDebug(CommandSource source) throws CommandSyntaxException {
      ...
      if (!debugprofiler.func_219899_d().func_219936_a()) {
         ...
         source.sendFeedback(new TranslationTextComponent("commands.debug.stopped", String.format(Locale.ROOT, "%.2f", f), iprofileresult.func_219925_g(), String.format("%.2f", f1)), true);
