...
public class EntitySelectorParser {
   ...
   public EntitySelector build() {
      ...
      return new EntitySelector(this.limit, this.includeNonPlayers, this.currentWorldOnly, this.filter, this.distance, function, axisalignedbb, this.sorter, this.self, this.username, this.uuid, this.field_202008_N, this.checkPermission);
   }
