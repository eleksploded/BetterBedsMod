...
public class CloneCommand {
            ...
            if (serverworld.isAreaLoaded(beginPos, endPos) && serverworld.isAreaLoaded(destPos, blockpos)) {
               ...
               if (cloneMode == CloneCommand.Mode.MOVE) {
                  for(BlockPos blockpos4 : deque) {
                     ...
                     IClearable.func_213131_a(tileentity1);
               ...
               for(CloneCommand.BlockInfo clonecommand$blockinfo : list4) {
                  ...
                  IClearable.func_213131_a(tileentity2);
               ...
               for(CloneCommand.BlockInfo clonecommand$blockinfo1 : list3) {
                  if (serverworld.setBlockState(clonecommand$blockinfo1.pos, clonecommand$blockinfo1.field_198252_b, 2)) {
                     ++i1;
                  }
               }
               ...
               for(CloneCommand.BlockInfo clonecommand$blockinfo2 : list1) {
                  ...
                  if (clonecommand$blockinfo2.field_198253_c != null && tileentity3 != null) {
                     clonecommand$blockinfo2.field_198253_c.putInt("x", clonecommand$blockinfo2.pos.getX());
                     clonecommand$blockinfo2.field_198253_c.putInt("y", clonecommand$blockinfo2.pos.getY());
                     clonecommand$blockinfo2.field_198253_c.putInt("z", clonecommand$blockinfo2.pos.getZ());
                     tileentity3.read(clonecommand$blockinfo2.field_198253_c);
                     tileentity3.markDirty();
                  }

                  serverworld.setBlockState(clonecommand$blockinfo2.pos, clonecommand$blockinfo2.field_198252_b, 2);
               }

               for(CloneCommand.BlockInfo clonecommand$blockinfo3 : list4) {
                  serverworld.notifyNeighbors(clonecommand$blockinfo3.pos, clonecommand$blockinfo3.field_198252_b.getBlock());
               }
   ...
   static class BlockInfo {
      ...
      public BlockInfo(BlockPos posIn, BlockState stateIn, @Nullable CompoundNBT tagIn) {
         this.pos = posIn;
         this.field_198252_b = stateIn;
         this.field_198253_c = tagIn;
      }
   }
