...
public class EntityOptions {
      ...
      if (REGISTRY.isEmpty()) {
         ...
         register("type", (p_197447_0_) -> {
            p_197447_0_.setSuggestionHandler((p_202052_1_, p_202052_2_) -> {
               ISuggestionProvider.suggestIterable(Registry.field_212629_r.keySet(), p_202052_1_, String.valueOf('!'));
               ISuggestionProvider.suggestIterable(EntityTypeTags.func_219762_a().getRegisteredTags(), p_202052_1_, "!#");
               if (!p_197447_0_.isTypeLimitedInversely()) {
                  ISuggestionProvider.suggestIterable(Registry.field_212629_r.keySet(), p_202052_1_);
                  ISuggestionProvider.suggestIterable(EntityTypeTags.func_219762_a().getRegisteredTags(), p_202052_1_, String.valueOf('#'));
               }
            ...
            if (p_197447_0_.isTypeLimitedInversely() && !flag) {
               ...
               if (p_197447_0_.func_218115_f()) {
                  ...
                  Tag<EntityType<?>> tag = EntityTypeTags.func_219762_a().get(resourcelocation);
                  if (tag == null) {
                     p_197447_0_.getReader().setCursor(i);
                  ...
                  EntityType<?> entitytype = Registry.field_212629_r.func_218349_b(resourcelocation1).orElseThrow(() -> {
                     p_197447_0_.getReader().setCursor(i);
   ...
   public static EntityOptions.IFilter get(EntitySelectorParser parser, String id, int cursor) throws CommandSyntaxException {
      ...
      if (entityoptions$optionhandler != null) {
         if (entityoptions$optionhandler.canHandle.test(parser)) {
            return entityoptions$optionhandler.field_202012_a;
         } else {
   ...
   static class OptionHandler {
      public final EntityOptions.IFilter field_202012_a;
