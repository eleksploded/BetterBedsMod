...
public class TimerCallbackSerializers<C> {
   ...
   public <T extends ITimerCallback<C>> CompoundNBT func_216339_a(T p_216339_1_) {
      ...
      serializer.func_212847_a_(compoundnbt, p_216339_1_);
   ...
   public ITimerCallback<C> func_216341_a(CompoundNBT p_216341_1_) {
      ...
      if (serializer == null) {
         field_216343_b.error("Failed to deserialize timer callback: " + p_216341_1_);
         return null;
      } else {
         try {
            return serializer.func_212846_b_(p_216341_1_);
         } catch (Exception exception) {
            field_216343_b.error("Failed to deserialize timer callback: " + p_216341_1_, (Throwable)exception);
            return null;
         }
      }
   }
